...
<%webstatus.setCurrent("HPinterior.jsp");%>
...
<%rset= sessionBeanHP.setRset("select","SELECT id,date_post,headnews,author,detail FROM  home_interior  WHERE id="+id+" ORDER BY 1 DESC");   %>
<%rset.next();
...
<table width="85%" border="0" align="center">
  <tr> 
    <td height="26" width="15%" bgcolor="#CCFFFF"><font face="MS Sans Serif" size="2">ชื่อเรื่อง 
      </font></td>
