...
<%webstatus.setCurrent("HPaddinterior.jsp");%>
...
<%headnews=request.getParameter("headnews");
	...
	if(auther==null|| auther.equals(""))
		auther="-";
       rset=sessionBeanHP.setRset("select","SELECT MAX(id) FROM  home_interior");
       rset.next();
       maxid=rset.getInt(1);
%>
<html>
<head>
<title>เพิ่มเติมหัวเรื่องการตกแต่งบ้าน</title>
</head>
<body bgcolor="#FFFFFF">
<div align="center"><a href="HPindex.jsp"><img src="/www/picture/logo/Home_t.gif" width="64" height="87" border="0"> 
  </a><br>
  <font color="#00CCCC"><b><font face="CordiaUPC" size="7">เพิ่มหัวข้อการตกแต่งบ้าน
  </font></b></font><br>
</div>
      ...
      <td height="26" width="35%" bgcolor="#CCCCCC"><font face="MS Sans Serif" size="2">วันที่ลงหัวข้อ 
        :<%=dateTemp%></font></td>
          ...
          +++ <input type="reset" name="Reset" value="Reset Form">
			...
			{%> 
			<%maxid++;%>
			<%sessionBeanHP.setRset("insert","INSERT INTO  home_interior(id,headnews,detail,author,date_post) VALUES("+maxid+",'"+headnews+"','"+detail+"','"+auther+"','"+dateTemp+"')");%>	
			<table width="85%" border="0" align="center">
			<tr> 
		        
    <td height="26" width="15%" bgcolor="#CCFFFF"><font face="MS Sans Serif" size="2">หัวข้อตกแต่งบ้าน
      </font></td>
