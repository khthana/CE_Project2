...
<%webstatus.setCurrent("HPallhomecare.jsp");%>

<html>
<head>
<title>หัวข้อการดูแลรักษาบ้านทั้งหมด</title>
</head>
...
<table width="85%" border="0" align="center">
  <tr> 
    ...
    <td height="26" width="50%" bgcolor="#FFCCCC"> 
      <div align="center"><font face="MS Sans Serif" size="2">หัวข้อการดูแลรักษาบ้าน</font></div>
    </td>
  ...
  <tr> 
    ...
    <td height="26" width="50%" bgcolor="#FFCCCC"><font face="MS Sans Serif" size="1">
				<a href="HPhomecare.jsp?id=<%=rset.getInt(1)%>">
						<%=headnews%></font></td></a>
