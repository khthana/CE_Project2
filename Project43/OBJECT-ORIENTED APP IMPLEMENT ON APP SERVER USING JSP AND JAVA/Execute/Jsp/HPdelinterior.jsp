...
<%webstatus.setCurrent("HPdelinterior.jsp");%>

 <%newsid=request.getParameterValues("newsid");%>
<% if(newsid != null)      
           {       query="DELETE FROM  home_interior  WHERE id IN( "; 
...
<div align="center"><a href="HPindex.jsp"><img src="/www/picture/logo/Home_t.gif" width="64" height="87" border="0"></a><br>
  <font color="#009999"><b><font face="CordiaUPC" size="7">ลบ!! หัวข้อการตกแต่งบ้าน</font></b></font> 
</div>
...
{%>
        ...
        <div align="center"><font face="MS Sans Serif" size="2">หัวข้อการตกแต่งบ้าน 
          </font></div>
			    </td>
