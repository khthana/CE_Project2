...
<%webstatus.setCurrent("HPhomenews.jsp");%>
...
<%headnews=request.getParameter("headnews");
	...
	if(auther==null|| auther.equals(""))
		auther="-";
       rset=sessionBeanHP.setRset("select","SELECT MAX(id) FROM  home_webnews");
       rset.next();
       maxid=rset.getInt(1);
%>
<html>
<head>
<title>เพิ่มเติมหัวข้อข่าว @"_"@</title>
</head>
<body bgcolor="#FFFFFF">
<div align="center"><a href="HPindex.jsp"><img src="/www/picture/logo/Home_t.gif" width="64" height="87" border="0"> 
  </a><br>
  <font color="#00CCCC"><b><font face="CordiaUPC" size="7">เพิ่มข่าว </font></b></font><br>
</div>
	...
	{%>		<form method="post" action="">
			...
			<tr> 
		        ...
		        <td height="26" width="50%" bgcolor="#FFCCCC"><font face="MS Sans Serif" size="2"><input type="text" name="headnews" maxlength="100" size="20">
	                ...
	                <td height="26" width="35%" bgcolor="#CCCCCC"><font face="MS Sans Serif" size="2">วันที่ลงข่าว :<%=dateTemp%></font></td>
			</tr>
		        <tr bgcolor="#CCFFCC"> 
                        <td colspan="3"> 
			 ...
			 <td bgcolor="#99CCFF" colspan="3"> 
		         <div align="center"> ++ 
                         <input type="submit" name="Submit" value="Add news">+++ <input type="reset" name="Reset" value="Reset Form">
			     ++</div>
			   </td>
			  </tr>
			  </table>
			...
			{%> 
			<%maxid++;%>
			<%sessionBeanHP.setRset("insert","INSERT INTO  home_webnews(id,headnews,detail,author,date_post) VALUES("+maxid+",'"+headnews+"','"+detail+"','"+auther+"','"+dateTemp+"')");%>	
			<table width="85%" border="0" align="center">
			<tr> 
		        <td height="26" width="15%" bgcolor="#CCFFFF"><font face="MS Sans Serif" size="2">ข่าวอสังหาริมทรัพย์ 
		        </font></td>
		        <td height="26" width="50%" bgcolor="#FFCCCC"><font face="MS Sans Serif" size="2"><%=headnews%>
	                ...
	                <td height="26" width="35%" bgcolor="#CCCCCC"><font face="MS Sans Serif" size="2">::::</font></td>
			</tr>
		        <tr bgcolor="#CCFFCC"> 
                        <td colspan="3"> 
