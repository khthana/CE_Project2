...
<%webstatus.setCurrent("HPhomecare.jsp");%>
...
<%rset= sessionBeanHP.setRset("select","SELECT id,date_post,headnews,author,detail FROM  home_care  WHERE id="+id+" ORDER BY 1 DESC");   %>
<%rset.next();
