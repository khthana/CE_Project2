...
<%webstatus.setCurrent("HPeditnews.jsp");%>

<html>
<head>
<title>หัวข้อข่าว(แก้ไขข่าว)</title>
</head>

<body bgcolor="#FFFFFF">

<div align="center"><a href="HPindex.jsp"><img src="/www/picture/logo/Home_t.gif" width="64" height="87" border="0"></a><br>
  <b><font face="CordiaUPC" size="7" color="#006699">แก้ไขข่าว </font></b><br>
</div>
...
{%>
      <% if(!newsid.equals("-"))      
         {%> <%  query="SELECT headnews,author,detail,date_post FROM  home_webnews  WHERE id ="+newsid;
		...
		<table width="85%" border="0" align="center">
		   <tr> 
			      ...
			      <td height="26" width="35%" bgcolor="#CCCCCC"><font face="MS Sans Serif" size="2">วันที่ลงข่าว 
			      :<%=date_post%></font></td>
	           </tr>
		   <tr bgcolor="#CCFFCC"> 
			      <td colspan="3"> 
	...
	{%>
	   <% headnews=request.getParameter("headnews");
		  ...
		  newsid=request.getParameter("edit_ID");
	          query="UPDATE home_webnews SET headnews='"+headnews+"',detail='"+detail+"' ,author='"+author+"'   WHERE id="+newsid; 
