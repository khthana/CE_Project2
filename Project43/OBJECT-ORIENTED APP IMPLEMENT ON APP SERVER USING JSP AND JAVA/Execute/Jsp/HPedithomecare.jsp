...
<%webstatus.setCurrent("HPedithomecare.jsp");%>

<html>
<head>
<title>หัวข้อการดูแลรักษาบ้าน</title>
</head>

<body bgcolor="#FFFFFF">

<div align="center"><a href="HPindex.jsp"><img src="/www/picture/logo/Home_t.gif" width="64" height="87" border="0"></a><br>
  <b><font face="CordiaUPC" size="7" color="#006699">แก้ไขหัวข้อดูแลรักษาบ้าน 
  </font></b><br>
</div>
...
{%>
      <% if(!newsid.equals("-"))      
         {%> <%  query="SELECT headnews,author,detail,date_post FROM  home_care  WHERE id ="+newsid;
      ...
      <td height="26" width="35%" bgcolor="#CCCCCC"><font face="MS Sans Serif" size="2">วันที่ลง 
        :<%=date_post%></font></td>
	           </tr>
		   <tr bgcolor="#CCFFCC"> 
			      <td colspan="3"> 
          ...
          <input type="submit" name="SubmitEdit" value="Edit Topic">
	...
	{%>
	   <% headnews=request.getParameter("headnews");
		  ...
		  newsid=request.getParameter("edit_ID");
	          query="UPDATE home_care SET headnews='"+headnews+"',detail='"+detail+"' ,author='"+author+"'   WHERE id="+newsid; 
