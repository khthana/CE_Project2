...
<%webstatus.setCurrent("HPdelnews.jsp");%>

 <%newsid=request.getParameterValues("newsid");%>
<% if(newsid != null)      
           {       query="DELETE FROM  home_webnews  WHERE id IN( "; 
		...
		<table width="85%" border="0" align="center">
		  <tr> 
			    ...
			    <td height="26" width="35%" bgcolor="#CCCCCC"><font face="MS Sans Serif" size="2">วันที่ 
			     ...
			     <% sb.delete(0,sb.length());%> <%rset= sessionBeanHP.setRset("select","SELECT id,date_post,headnews,author,detail FROM  home_webnews  ORDER BY 1 DESC");   %> 
			     <%while(rset.next())
				    ...
				    <td height="26" width="50%" bgcolor="#FFCCCC"><font face="MS Sans Serif" size="1"> <a href="HPnews.jsp?id=<%=rset.getInt(1)%>"> 
				      <%=headnews%></font></td></a>
