...
public class NNfile {
  ...
  public void Save(String save_file_name) {
    try {
      ...
      ps.println();
	  ps.println("# Input layer to hidden layer weights:");
	  ps.println();
      for (int i=0; i<NumInput; i++) {
	  ...
	  ps.println();
      ps.println("# Hidden layer to output layer weights:");
	  ps.println();
      for (int h=0; h<NumHidden; h++) {
        for (int o=0; o<NumOutput; o++) {
          ps.print(GetW2(h, o) + " ");
      ...
      if (SpecialFlag > 0) {
		ps.println();
        ps.println("# Special network data:");
		ps.println();
...
//	  ps.println(GetInput(0,0)+ "    " + GetOutput(0,0));
//	  ps.println(GetInput(1,0)+ "    " + GetOutput(1,0));
//	  ps.println(GetInput(2,0)+ "    " + GetOutput(2,0));
//	  ps.println(GetInput(3,0)+ "    " + GetOutput(3,0));
//	  ps.println("NumTraining = " + NumTraining);
