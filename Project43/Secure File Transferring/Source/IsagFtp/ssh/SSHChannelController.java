...
public final class SSHChannelController extends SSH implements SSHChannelListener {
  ...
  public void receive(SSHPdu pdu) {
	...
	throw new Exception("Unknown packet type (" + inPdu.type + "), disconnecting...");
      ...
      System.out.println("\nplease send a mail to s0010058.ce.kmitl.ac.th with:");
      System.out.println("(I found a bug in IsagFTP!), error: " + e.getMessage());
      System.out.println(sw.toString());
      sendDisconnect("please send a mail to s0010088@ce.kmitl.ac.th with:" + "\n\r" +
		     "(I found a bug in IsagFTP!), error: " + e.getMessage() + "\n\r" +
