...
<FORM METHOD="POST" ENCTYPE="multipart/form-data" ACTION="Attr_Script.asp">
		
<TABLE BORDER="1" CELLPADDING="0" CELLSPACING="0">
		<TR>
				<TD WIDTH="150" ALIGN="LEFT"><FONT COLOR="BLUE">&nbsp ไฟล์ชื่อ</FONT><FONT FACE="Arial, sans-serif" COLOR="red" STYLE="{font-family: Arial, sans-serif; color: red; font-weight: bold; font-size: 8pt}"> &nbsp<%=Request("image_file")%> &nbsp</FONT>
				</TD>
