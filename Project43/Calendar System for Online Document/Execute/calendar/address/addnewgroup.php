...
if($newgroupname=='')
{$msg='<div align="center"><font face="MS Sans Serif" size="2" color="#FF3333"><b>ใส่ชื่อกลุ่มไม่ถูกต้อง</b></font></div>';
$boo=1;
}
elseif($data[0]==0)
{$msg='<div align="center"><font face="MS Sans Serif" size="2" color="#333333"><b>ต้องการเพิ่มกลุ่มใหม่ ชื่อ '.$newgroupname.'</b></font></div>';
$boo=0;
}
elseif($data[0]==1)
{$msg='<div align="center"><font face="MS Sans Serif" size="2" color="#FF3333"><b>ชื่อกลุ่มซ้ำกับกลุ่มที่มีอยู่แล้ว</b></font></div>';
$boo=1;
$newgroupname='';
}
if(($lastpage=='addnewgroup')&&($boo==0))
...
if($boo==1)
{
echo'					<font face="MS Sans Serif" size="2" color="#000000">';
echo'						กรุณาใส่ชื่อกลุ่มใหม่ &nbsp;';
echo'					</font>';
echo'					<input type="text" name="newgroupname" size="20" maxlength="30">';
}
elseIf($boo==0)
echo'                      <input type="hidden" name="newgroupname" value="'.$newgroupname.'">';
mysql_close($link);
?>						
                      <input type="submit" name="Submit" value="ดำเนินการต่อไป">
                      <input type="hidden" name="lastpage" value="addnewgroup">
                    </form>
              ...
              <tr valign="bottom"> 
                <td height="65"> 
                  <div align="center"><font face="MS Sans Serif" size="2" color="#FF0000"></font> 
                  </div>
                </td>
              </tr>
            </table>
