...
?> 
          ...
          <TD vAlign=top width="727" height="497">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#99CCFF" align="center" valign="middle"> 
                <td height="41"> 
                  <form method="post" action="./addnewgroup.php">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="38%" align="right"><font size="2" face="MS Sans Serif" color="#003333"><b><font color="#666666">ต้องการเพิ่มกลุ่มใหม่ 
                          ชื่อ : &nbsp;</font> </b></font></td>
                        <td width="23%"> 
                          <input type="text" name="newgroupname" size="20" maxlength="40">
                        </td>
                        <td width="39%"> &nbsp; 
                          <input type="submit" name="Submit" value="เพิ่มชื่อกลุ่ม">
                        </td>
                      </tr>
                    </table>
                  </form>
              ...
              <tr>
                <td height="33"> 
                  <div align="center"><b><font size="3" face="MS Sans Serif" color="#666666">รายชื่อกลุ่มทั้งหมด</font></b></div>
                </td>
              </tr>
              <tr> 
                <td> 
                  <form method="post" action="./deletegroup.php">
                    <table width="520" border="1" cellspacing="0" cellpadding="0">
                      <tr bgcolor="#00CCFF"> 
                        <td align="center" width="5%"><b><font face="MS Sans Serif" size="1" color="#FFFFFF"> 
                          </font></b></td>
                        <td align="center" width="35%"><b><font face="MS Sans Serif" size="2" color="#FFFFFF">ชื่อกลุ่ม</font></b></td>
                        <td align="left" width="30%"> 
                          <div align="center"><b><font face="MS Sans Serif" size="1" color="#FFFFFF">จำนวนคนในกลุ่ม</font></b></div>
                        </td>
                        <td align="left" width="30%"> 
                          <div align="center"><font face="MS Sans Serif" size="1" color="#FFFFFF"><b>แก้ไขชื่อกลุ่ม</b></font></div>
                        </td>
                      </tr>
                      <?
$link=mysql_connect($host,$user,$pass) or die("ไม่สามารถติดต่อฐานข้อมูลได้");
$sql="select t1.grp_id,t1.grp_name from group_name t1 where t1.mem_id=$user_id order by t1.grp_id";
		$result=mysql_db_query($db,$sql);
		$row=mysql_num_rows($result);
	for($i=1 ;$i<=$row;$i++)
{$data=mysql_fetch_array($result);
	$sql1="select count(*) from contact where mem_id=$user_id && grp_id=$data[0]";
		$result1=mysql_db_query($db,$sql1);
$data1=mysql_fetch_array($result1);
  echo'                  <tr valign="middle"> ';
echo'                        <td align="center" width="5%"> ';
echo'                          <input type="checkbox" name="checkbox['.$data[0].']" value="'.$data[0].'">';
echo'                        </td>';
echo'                        <td align="center" width="35%">';
echo'<a href="./addressbook.php?groupid='.$data[0].'">';
echo'<font face="MS Sans Serif" size="2" color="#333333"><b>';
echo$data[1];
echo'</b></font></a></td>';
echo'                        <td align="center" width="30%">';
echo'<font face="MS Sans Serif" size="1" color="#333333">';
echo$data1[0];
echo'</font></td>';
echo'                        <td align="center" width="30%" valign="middle" align="center">';
echo'<a href="./changegroupname.php?group_id='.$data[0].'"><font face="MS Sans Serif" size="1" color="#3399FF"><b>แก้ไขชื่อกลุ่ม</b></font></a>';
echo'                        </td>';
echo'                      </tr>';
}
mysql_close($link);
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="21%" align="center"> 
                          <input type="submit" name="Submit2" value="ลบชื่อกลุ่ม">
                        </td>
                        <td width="45%">&nbsp;</td>
                        <td width="34%">&nbsp;</td>
                      </tr>
