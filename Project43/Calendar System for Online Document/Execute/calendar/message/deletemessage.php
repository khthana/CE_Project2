...
?> 
          ...
          <TD vAlign=top width="727" height="497">
            <form name="form1" method="post" action="./do_delete_message.php">
              <font color="#FFFFFF"> </font> 
              <table width="100%" border="1">
                <tr bgcolor="#3366FF" align="center"> 
                  <td width="40%"> <font size="2"><b><font color="#FFFFFF" face="MS Sans Serif">หัวเรื่อง</font></b></font></td>
                  <td width="35%"><font size="2"><b><font color="#FFFFFF" face="MS Sans Serif">ชื่อผู้ส่ง</font></b></font></td>
...
<font  face="MS Sans Serif" size="2">
                <?php
					...
					$sql='select message.msg_id,member.mem_username,message.msg_title,message.msg_date 
						from member,message,message_receiver where message.msg_id=message_receiver.msg_id 
						&&member.mem_id=message.mem_id&& message_receiver.friend_id='.$user_id.' order by message.msg_date,message.msg_time asc';
					...
					echo '<td width="40%"><font color="#000000" size="2" face="MS Sans Serif">'.$data[2].'</font></td>';
					echo '<td width="35%"><font color="#000000" size="2" face="MS Sans Serif">'.$data[1].'</font></td>';
					$year=substr($data[3],0,4)+543;
					$month=$thaimonth[substr($data[3],5,2)-1];
					$date=substr($data[3],8,2).' '.$month.' '.$year;
					echo '<td width="25%"><font color="#000000" size="2" face="MS Sans Serif">'.$date.'</font></td>';
					echo '</tr>';
...
mysql_close($link);
            ...
            <table width="100%" border="0">
              <tr>
                  ...
                  <td align="center"><font face="MS Sans Serif" size="2">ยืนยันการลบข้อความจำนวน
                    <?php echo $count; ?> ข้อความ </font></td>
              </tr>
              <tr>
