          ...
          <TD width="79%"> 
            ...
            <table width="80%" border="0" cellspacing="2" cellpadding="0">
              ...
              <tr> 
                <td width="5%">&nbsp;</td>
                <td width="75%"> 
                  <div align="center"><font size="2" face="MS Sans Serif, Microsoft Sans Serif"><b><font color="#FF6600">การนัดหมายในวันที่ 
                    <font color="#999933"><? echo $schdate; ?></font><? echo $thaimonth[$schmonth-1]; ?><font color="#999933"><? echo $schyear+543; ?></font> 
                    เรียบร้อยแล้ว </font></b></font> </div>
                </td>
              </tr>
              <tr> 
                <td width="5%">&nbsp;</td>
                <td width="75%"> 
                  <div align="center"><font color="#006699"><b><font size="2" face="MS Sans Serif, Microsoft Sans Serif" color="#FF6633">โปรดรอการตอบรับของบุคคลที่ท่านนัด</font></b></font></div>
                </td>
              </tr>
              <tr> 
                <td width="5%">&nbsp;</td>
                ...
                <td width="75%"> 
                  <div align="center">
				   <a href="../welcome.php"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#0000FF">กลับไปหน้าแรก</font></a>&nbsp;&nbsp;&nbsp;
					<a href="../schedule/sch_add.php?schday=<? echo $schday; ?>&amp;schdate=<? echo $schdate; ?>&amp;schmonth=<? echo $schmonth; ?>&amp;schyear=<? echo $schyear; ?>%20"><font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#0000FF">กลับไปหน้าปฎิทินนัดหมาย</font></a> 
