...
}elseif($num_app<>"2")
{
	...
	$sql_app="select app_time,app_date,app_title,app_note,app_duration,app_remind_before,app_remind_before_hour,app_remind_mail from appointment where app_id=$app_id and mem_id=$user_id";
        ...
        <TR>
          <TD vAlign=top align=left width="21%"> 
              ...
              <table width="98%" border="0" cellpadding="0" cellspacing="0">
                ...
                <td colspan="2" bgcolor="#FFFFFF" nowrap height="718"> 
                  <div align="center"> 
...
<? //-------------หมดquickbutton------- ?>
                    ...
                    <table width="120" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr align="left" valign="top"> 
                        <td colspan="2" bgcolor="#FFFFFF" height="112"> 
                          <div align="center"> 
          ...
          <TD width="79%"> 
      <form method="post" action="app_add_again.php">
...
if($err<>"")
{
		...
		{
			echo "รายละเอียดการนัดหมายเกิน 200 ตัวอักษรค่ะ";
		}
...
?> </font></b></font></div>
                      ...
                      <tr> 
                        <td width="10%">&nbsp;</td>
                        <td width="60%"><font color="#666666">ถึง &nbsp; <font color="#0033CC"> 
                          <?
$host="localhost";
...
mysql_select_db("magazine") or die("ไม่สามารถติดต่อแฟ้มข้อมูลได้"); 
$sql_friend="select mem_username,mem_fname from member where mem_id=$friend_id";
...
?> 
                      ...
                      <tr> 
                        <td width="10%" height="27">&nbsp;</td>
                        <td width="60%" height="27"><font color="#666666" size="2" face="MS Sans Serif, Microsoft Sans Serif">กำหนดให้มีการเตือนก่อน 
...
?> 
                      ...
                      <tr>
                        <td width="10%">&nbsp;</td>
                        <td width="60%"><?
if($app_remind_mail=="yes" || $app_remind_mail=="Y")
{ $tmp=" checked";
}else
{ $tmp="";
}
...
$appmonth=$month;
$appyear=$year;
$appday=(int) date("w",mktime(1,1,0,$appmonth,$appdate,$appyear));
//echo $sqlupdate;
//echo "<br> $sqlupdate2";
header("Location:app_add_again2.php?appday=$appday&appdate=$appdate&appmonth=$appmonth&appyear=$appyear");
}
?>
