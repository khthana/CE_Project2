...
if($appoint=="ทำการนัดหมาย" || $editlist=="แก้ไขรายชื่อผู้ถูกนัด")
{
		$schdate=$date1;
		$schmonth=$month;
		$schyear=$year;
...
if($num_chk=="F" || $num_app<>"2") //เมื่อ Fail หรือ เพิ่งเข้าหน้านี้ครั้งแรก
{
?>
...
<? //-------------หมดquickbutton------- ?>
          ...
          <TD width="79%"> 
      <form method="post" action="app_add_all_list2.php">
...
?> </font></b></font></div>
                      ...
                      <tr>
                        <td width="10%" height="27">&nbsp;</td>
                        <td width="60%" height="27"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#666666">ถึง 
...
?> </td>
                      ...
                      <tr> 
                        <td width="10%">&nbsp;</td>
                        <td width="60%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#666666">รายละเอียด<br>
...
?> 
                      ...
                      <tr> 
                        ...
                        <td width="60%"> 
                          <div align="center">
                            <input type="submit" name="editlist" value="แก้ไขรายชื่อผู้ถูกนัด">&nbsp;&nbsp;
...
$schday=(int) date("w",mktime(1,1,0,$schmonth,$schdate,$schyear));
	...
	}elseif($editlist=="แก้ไขรายชื่อผู้ถูกนัด")
	{
