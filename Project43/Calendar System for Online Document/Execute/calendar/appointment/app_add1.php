...
if($quick_butt=="Y")
{
		...
		$app_remind_before="";
		$app_remind_mail="";
} //ถ้ามาจากปุ่มนัดหมายรวดเร็วต้องมีการรีจิสเตอร์ตัวแปรก่อนเพราะถ้ามาจากธรรมดามันรีจิสอยู่แล้ว

if($num_app=="2")
{
		include("app_chkdetail.inc");
}
...
<? //-------------หมดquickbutton------- ?>
                    ...
                    <table width="120" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr align="left" valign="top"> 
                        <td colspan="2" bgcolor="#FFFFFF" height="151"> 
                          <div align="center"> 
          ...
          <TD width="79%"> 
      <form method="post" action="app_add1.php">
...
{
		if($err==1)		
		{ echo " กรุณาใส่ชื่อเรื่องการนัดหมายด้วยคะ ";
		 }elseif($err==2)
		...
		{
			echo "กรุณาเลือกชื่อบุคคลที่ต้องการนัดด้วยค่ะ";
		}elseif($err==5)
		{
			echo "รายละเอียดที่คุณใส่เกิน 200 ตัวอักษรค่ะ";
		}
...
?> 
                      ...
                      <tr> 
                        <td width="10%" height="27">&nbsp;</td>
                        <td width="60%" height="27"><font face="MS Sans Serif, Microsoft Sans Serif" color="#666666" size="2">เรื่อง </font></td>
                      </tr>
                      <tr> 
                        <td width="10%">&nbsp;</td>
                        <td width="60%"> 
...
{
	echo " <option value=",$i;
	if ( $app_duration<>"" and $app_duration==$i)
	{	
		 echo " selected"; 
	}else
	{ 	if($i==1)
...
?> 
                      ...
                      <tr> 
                        ...
                        <td width="60%" height="38"><font color="#666666" size="2" face="MS Sans Serif, Microsoft Sans Serif">กำหนดให้มีการเตือนก่อน 
                      ...
                      <tr bgcolor="#666666"> 
                        <td colspan="2"> 
                          <table width="100%" border="1" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td bgcolor="#CCCCCC"> 
                                <div align="center"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#0000FF">นัดรายบุคคล</font></div>
                              </td>
                              <td bgcolor="#999999"> 
                                <div align="center"> 
                                  <input type="submit" name="appoint_grp" value="นัดเป็นกลุ่ม">
                                </div>
                              </td>
                            </tr>
                          </table>
...
for($i=0;$i<$numrow;$i++)
{
		   $row=mysql_fetch_array($result);
			...
			if($group1<>"" and $group1==$row[0])
			{
				echo "selected> ";
				$grp_num=$row[0];
			}elseif($group1=="" and $i==0)
			{
				echo "selected> ";
				$grp_num=$row[0];				
			}else
...
?> 
                          ...
                          <input type="submit" name="grp_button" value="ไป">
                          <input type="hidden" name="grp_num" value=<? echo $grp_num; ?>>
                        </td>
                      </tr>
                      <tr> 
                        <td colspan="2" height="35"> <font size="1" face="MS Sans Serif, Microsoft Sans Serif" > 
                          <?
...
{
		$numrow2=$numrow;
} // เช็คให้มีลิสต์ในหน้านี้แค่ 15 คน ถ้ามีมากกว่านี้ก็ไปแสดงหน้าอื่น
for($i=0;$i<$numrow2;$i++)
{
	   $row=mysql_fetch_array($result);		
		$tmpname=$row[1];
     ...
     echo " <font color=#0066CC>&nbsp;", $row[1],"&nbsp; (",$row[2]," ) </font>";
	   echo "<a href=checkfree.php?group_id=$grp_num&friend_id=$row[0]&time=$time&schday=$schday&schdate=$schdate&schmonth=$schmonth&schyear=$schyear&lastpage=app_add1>";
...
{
?> 
                          <input type="submit" name="more_button" value="ทั้งหมด>>">
                          <?
} //if $numrow เช็คว่าจะแสดงbutton "ทั้งหมด" ไหม
?> </font></td>
                      </tr>
                      <tr bgcolor="#CCCCCC"> 
                        <td colspan="2" height="35">
                          <div align="center">
                            <input type="submit" name="list_all" value="รายชื่อเพื่อนทั้งหมด">
                          </div>
                        </td>
                      </tr>
...
header("Location:app_add2.php?time=$time&schday=$schday&schdate=$schdate&schmonth=$schmonth&schyear=$schyear&grp_num=$grp_num");
}
?>
