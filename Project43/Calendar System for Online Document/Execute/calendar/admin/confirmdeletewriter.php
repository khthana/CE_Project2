...
$sql="select count(*) from admin where mem_id=$user_id";
      ...
      <TABLE height=464 width="100%" border=0>
        ...
        <TR align="left" bgcolor="#FFFFFF"> 
          ...
          <TD vAlign=top width="727" height="497"> 
            <form method="post" action="./dodeletewriter.php">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" height="206">
                <tr bgcolor="#0000CC"> 
                  <td height="32"> 
                    <div align="center"><b><font face="MS Sans Serif" size="3" color="#FFFFFF">ยืนยันการลบรายชื่อผู้เขียน</font></b></div>
                  </td>
                </tr>
                <tr align="left" valign="top"> 
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        ...
                        <td width="77%" height="13"> <font face="MS Sans Serif" size="2" color="#000000"> 
                          <?
						if($deletetype=='deleteall')
						{
echo'						ต้องการลบชื่อ <b>'.$writername.'</b>&nbsp;ออกจาก';
echo'						<font color="#FF0000"><b><font size="3">ฐานข้อมูลของระบบปฏิทินนัดหมาย</font></b></font>';
						}
						elseif($deletetype=='onlywriter')
						{
echo'						ต้องการลบชื่อ <b>'.$writername.'</b>&nbsp;ออกจาก';
echo'                          <b> <font color="#FF0000"> <font size="3"> ฐานข้อมูลรายชื่อผู้เขียนบทความ</font></font></b>';
						}
						?> </font> </td>
                      </tr>
                      <tr> 
                        ...
                        <td width="77%" height="57"> 
                          <input type="submit" name="Submit" value="ยืนยันการลบชื่อผู้ใช้ออกจากฐานข้อมูล">
