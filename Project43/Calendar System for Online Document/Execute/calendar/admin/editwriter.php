...
if($lastpage=='editwriter')
{$sql="select count(*) from member t1,writer t2 where t1.mem_username='$writername' && t1.mem_id=t2.mem_id";
$result=mysql_db_query($db,$sql);
$data=mysql_fetch_array($result);
if($data[0]==1)
{
session_register("writername");
header("Location:./editdetailwriter.php");
}
else
{$sql1="select count(*) from member where mem_username='$writername'";
$result1=mysql_db_query($db,$sql1);
$data1=mysql_fetch_array($result1);
if($data1[0]==0){
$msg='ชื่อผู้เขียนบทความไม่ถูกต้อง กรุณาใส่ชื่อผู้เขียนบทความอีกครั้ง';
}
else
{
$msg='ชื่อผู้ใช้ไม่ได้เป็นผู้เขียนบทความ กรุณาใส่ชื่อผู้เขียนบทความอีกครั้ง';
}
}
}
?>
      ...
      <TABLE height=464 width="100%" border=0>
        ...
        <TR align="left" bgcolor="#FFFFFF"> 
                                  ...
                                  <tr> 
                                    <td height="26" align="center" valign="middle"> 
                                      <table width="100%" border="1">
                                        ...
                                        <tr>
                                          <td align="center"><a href="./addwriter.php"><font size="2"><font face="MS Sans Serif" color="666666"><b>เพิ่มรายชื่อผู้เขียน</b></font></font></a></td>
                                        </tr>
                                        <tr> 
                                          <td align="center"><a href="./editwriter.php"><font size="2"><font face="MS Sans Serif" color="666666"><b><font color="#FF6600">แก้ไขข้อมูลผู้เขียน</font></b></font></font></a></td>
                                        </tr>
                                        <tr> 
                                          <td align="center"><font size="2"><a href="./deletewriter.php"><font face="MS Sans Serif" color="666666"><b>ลบรายชื่อผู้เขียน</b></font></a></font></td>
                                        </tr>
                                      </table>
                                    </td>
                                  </tr>
          ...
          <TD vAlign=top width="727" height="497"> 
            <form method="post" action="./editwriter.php">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" height="206">
                <tr bgcolor="#0000CC"> 
                  <td height="32"> 
                    <div align="center"><b><font face="MS Sans Serif" size="3" color="#FFFFFF">แก้ไขข้อมูลผู้เขียน</font></b></div>
                  </td>
                </tr>
                <tr align="left" valign="top"> 
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td width="77%" height="45"> 
                          <input type="text" name="writername" size="20" maxlength="30">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"><font face="MS Sans Serif" size="1" color="#FF0033"><?echo$msg;?></font></td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                          <div align="center"><font size="2"><font size="2"><font face="MS Sans Serif"><font face="MS Sans Serif"><font color="#666666"></font></font></font></font></font></div>
                        ...
                        <td width="77%"> 
                          <input type="submit" name="Submit" value="แก้ไขข้อมูลของผู้เขียน">
                          <input type="hidden" name="lastpage" value="editwriter">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
