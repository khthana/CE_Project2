...
session_register("educate");
session_register("exp");
session_register("skill");
session_register("writername");
session_register("lastpage");
$lastpage='confirmeditwriter';
$position=$newposition;
$educate=$neweducation;
$exp=$newexperience;
$skill=$newskill;
?>
      ...
      <TABLE height=464 width="100%" border=0>
        ...
        <TR align="left" bgcolor="#FFFFFF"> 
          ...
          <TD vAlign=top width="727" height="497"> 
            <form method="post" action="./updatedetailwriter.php">
                  ...
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td width="77%" height="45"><font face="MS Sans Serif" size="2" color="#000000"> 
                          <? echo $writername;?>
                          </font></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        ...
                        <td width="77%"> 
                          <input type="submit" name="Submit" value="ยืนยันการแก้ไขข้อมูลของผู้เขียน">
                          <input type="hidden" name="writerid" value="<?echo$writerid;?>">
                          <input type="hidden" name="writername" value="<?echo$writername;?>">
                          <input type="hidden" name="newposition" value="<?echo$newposition;?>">
                          <input type="hidden" name="neweducation" value="<?echo$neweducation;?>">
                          <input type="hidden" name="newexperience" value="<?echo$newexperience;?>">
                          <input type="hidden" name="newskill" value="<?echo$newskill;?>">
                          <a href="./editdetailwriter.php"><font face="MS Sans Serif" size="2" color="#0000FF">กลับไปหน้าจอที่แล้ว</font></a> 
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
