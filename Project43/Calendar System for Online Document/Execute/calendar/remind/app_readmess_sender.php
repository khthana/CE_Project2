...
mysql_select_db("magazine") or die("ไม่สามารถติดต่อแฟ้มข้อมูลได้"); 
		...
		$sql_job="select app_time,app_date,app_title,app_note,app_duration,app_remind_before,apr_status,apr_comment,app_remind_before_hour,app_remind_mail from appointment a1,appoint_receiver  a2 where a1.app_id=a2.app_id and a1.app_id=$app_id and friend_id=$friend_id";
		$result=mysql_db_query("magazine",$sql_job);
	$numrow=@mysql_num_rows($result);
 	  $row=mysql_fetch_array($result);
$app_time=(int) substr($row[0],0,2);
$appdate=(int) substr($row[1],8,2);
$appmonth=(int) substr($row[1],5,2);
$appyear= substr($row[1],0,4);

$app_title=$row[2];
$app_note=$row[3];
$app_duration=$row[4];
$app_remind_before=$row[5];
$apr_status=$row[6];
$apr_comment=$row[7];
$app_remind_before_hour=$row[8];
$app_remind_mail=$row[9];

$sql_friend="select mem_username,mem_fname,mem_lname from member where mem_id=$friend_id";
$result=mysql_db_query("magazine",$sql_friend);
$row=mysql_fetch_array($result);
$friend=$row[0]." ( ".$row[1]." ".$row[2]." )";

?>
          </TD>
          <TD width="79%"> 
      <form method="post" action="app_replymess_sender.php">
              ...
              <table width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><font size="1" face="MS Sans Serif, Microsoft Sans Serif"><b><font color="#666666">ผู้ตอบรับ 
                    : </font></b><font  face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#0033CC">&nbsp; 
                    <? echo $friend; ?></font></font></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><b><font color="#666666" size="1" face="MS Sans Serif, Microsoft Sans Serif">การนัดหมายเรื่อง 
                ...
                <tr> 
                  ...
                  <td colspan="2"><font color="#666666"><b><font size="1" face="MS Sans Serif, Microsoft Sans Serif">วันนัดหมาย 
                    ...
                    <? echo $appdate," ",$thaimonth[$appmonth-1]," ",$appyear+543; ?><b><font color="#666666" size="1"> 
                    &nbsp;&nbsp;&nbsp;&nbsp;เวลา : </font></b><font color="#0033CC" size="2"><? echo $app_time,":00น."; ?> 
                    </font></font></font></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><font size="1" face="MS Sans Serif, Microsoft Sans Serif"><b><font color="#666666">ระยะเวลาที่นัด 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp; กำหนดให้มีการเตือนการนัดก่อน : </b><font color="#0033CC" size="2">&nbsp; 
                    <? echo $app_remind_before; ?></font></font><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#666666"> <b>วัน&nbsp;</b><font color="#0033CC" size="2"> 
                    <? echo $app_remind_before_hour; ?></font> <b> ชม.</b></font></td>
                </tr>
                <tr>
                  <td width="10%">&nbsp;</td>
                <?
if($app_remind_mail=="Y")
{
	$tmp_remind_mail="ใช่";
}else
{
...
?> 
                  ...
                  <td colspan="2"><font color="#666666" size="1" face="MS Sans Serif, Microsoft Sans Serif"><b>เตือนงานผ่านอีเมล์: 
                    </b><font color="#0033CC" size="2">&nbsp; <? echo $tmp_remind_mail; ?></font> 
                    </font></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><font size="1"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#666666">สถานะการตอบรับ 
                    : </font></b><font face="MS Sans Serif, Microsoft Sans Serif" color="#FF0000">&nbsp; 
                    <? 
if($apr_status=="AC")
{ echo "ยอมรับการนัดหมาย";
}elseif($apr_status=="UN")
{
	 echo "ปฎิเสธการนัดหมาย";
}elseif($apr_status=="NE")
{
	echo "ยังไม่ได้ดูการนัดหมาย";
}elseif($apr_status=="PS")
{
	echo "ขอคิดดูก่อน";
}
?> </font></font></td>
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><b><font color="#666666" size="1" face="MS Sans Serif, Microsoft Sans Serif">ข้อความจากผู้ตอบรับ 
                    : </font></b></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
...
?> </font></td>
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><img src="../images/orange_point.gif" width="200" height="1"></td>
                </tr>
                <tr> 
                  <td width="10%" height="27">&nbsp;</td>
                  <td colspan="2"><b><font color="#666666" size="1" face="MS Sans Serif, Microsoft Sans Serif">ข้อความเดิม 
                    : </font></b></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="55%"> <font color="#999999" size="1" face="MS Sans Serif, Microsoft Sans Serif"> 
                ...
                <tr> 
                  ...
                  <td colspan="2"> 
                    ...
                    <input type="hidden" name="apr_status" value="<? echo $apr_status; ?>">
                  </td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"> <?
if($apr_status=="UN" || $apr_status=="PS" || $apr_status=="NE")
{
?> 
                    <input type="submit" name="del_appoint" value="ลบการนัดหมาย">
                    <input type="submit" name="appoint_again" value="นัดหมายอีกครั้ง">
                    <?
}elseif($apr_status=="AC")
{
?> 
                    <input type="submit" name="appoint_ok" value="ตกลง">
                    <?
	}
?> </td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td> 
                    <div align="center"><a href="../welcome.php"><font color="#0000FF" size="1" face="MS Sans Serif, Microsoft Sans Serif"> 
                      กลับไปหน้าแรก</font></a></div>
                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr> 
