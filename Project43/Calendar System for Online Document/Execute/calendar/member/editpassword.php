...
if(isset($oldpass)&isset($newpass1)&&isset($newpass2) )
	...
	$sql="select mem_username,mem_password	from member 
	...
	if($password<>$oldpass) 	{$msg="ใส่รหัสผ่านไม่ถูกต้อง";	} //check old password is valid
		elseif ($newpass1<>$newpass2) {$msg="ใส่รหัสผ่าน ใหม่ ไม่ตรงกัน";}  //check re-type new password
			elseif(strlen($newpass1)<4)	{$msg="รหัสผ่านใหม่ความยาวน้อยกว่า 4 ตัวอักษร";	}
				else
					{ $sql="update member set mem_password='".$newpass1."'"
		                 ."where mem_username='".$username."'";
		                $result=mysql_db_query($db,$sql);
		                 mysql_close($link);

				  $crp_password=crypt($newpass1,"mg");
                    ...
                    <tr> 
                      <td height="75" valign="top"> 
                        <table width="100%" border="1">
                          ...
                          <tr> 
                            <td align="center"><a href="./editpassword.php"><font face="MS Sans Serif" size="2" color="#000000"><font color="#FF6600">แก้ไขรหัสผ่าน</font></font></a></td>
                          </tr>
                          <tr> 
...
<? //-------------หมดquickbutton------- ?>
          ...
          <TD vAlign=top width="678" height="497"> 
            <div align="left"></div>
            <form name="" method="post" action="./editpassword.php">
              <table width="325" border="0" cellpadding="0" cellspacing="0" align="center" height="300">
                <tr align="left" valign="top"> 
                  <td nowrap colspan="2" height="18"> 
                    <div align="left"><img src="../images/head_table.gif" width="324" height="20"></div>
                  </td>
                </tr>
                <tr align="left" valign="top"> 
                  <td colspan="2" bgcolor="#FFFFFF" height="185"> 
                    <div align="center"> 
                              ...
                              <tr> 
                                <td height="272" valign="top"> 
                                  <table width="100%" border="0" cellspacing="0" cellpadding="3" height="116">
                                    ...
                                    <tr> 
                                      <td height="26" colspan="3" align="center" valign="middle"><font size="2" face="MS Sans Serif"><b><font size="3" color="#6666CC">แก้ไขรหัสผ่าน</font></b></font></td>
                                    </tr>
                                    <tr valign="top"> 
                                      <td height="13" colspan="3" align="center"> 
                                        <table width="100%" border="0" height="100%">
                                          <tr align="left"> 
                                            <td width="53%" height="38"><font size="2"><b><font face="MS Sans Serif" color="#993399">ชื่อผู้ใช้ 
                                              : </font></b></font></td>
                                            <td width="47%" height="38"><font color="#333333" size="2" face="MS Sans Serif"><b><?php echo $username  ?></b></font></td>
                                          </tr>
                                          <tr align="left"> 
                                            <td width="53%"><font face="MS Sans Serif" size="2"><b><font color="#993399">รหัสผ่าน 
                                              เก่า: </font></b></font></td>
                                            <td width="47%"><font face="MS Sans Serif"> 
                                              <input type="password" name="oldpass" size="15" maxlength="40">
                                              </font></td>
                                          </tr>
                                          <tr align="left"> 
                                            <td width="53%"> 
                                              <p><font color="#993399" face="MS Sans Serif" size="2"><b>รหัสผ่าน 
                                                ใหม่ : </b><br>
                                                <font size="1">(ความยาวอย่างน้อย 
                                                4ตัวอักษร )</font></font></p>
                                            </td>
                                            <td width="47%"><font face="MS Sans Serif"><b><font color="#000000" size="5"> 
                                              </font><font face="MS Sans Serif"> 
                                              <input type="password" name="newpass1" size="15" maxlength="40">
                                              </font></b></font><font face="MS Sans Serif" size="3"></font></td>
                                          </tr>
                                          <tr align="left"> 
                                            <td width="53%"><font color="#993399" face="MS Sans Serif" size="2"><b>รหัสผ่าน 
                                              ใหม่อีกครั้ง :</b></font></td>
                                            <td width="47%"><font face="MS Sans Serif"> 
                                              <input type="password" name="newpass2" size="15" maxlength="40">
                                              </font></td>
                                          </tr>
                                          <tr align="left"> 
                                            <td width="53%">&nbsp;</td>
                                            <td width="47%"><font face="MS Sans Serif"> 
                                              <input type="submit" name="Submit" value="แก้ไขรหัสผ่าน">
                                              </font> 
                      ...
                      <font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b><img src="../images/login_line.gif" width="324" height="18"></b></font></div>
                  </td>
                </tr>
              </table>
            </form>
