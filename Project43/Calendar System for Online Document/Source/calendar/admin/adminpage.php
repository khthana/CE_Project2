        ...
        <TR align="left" bgcolor="#FFFFFF"> 
                                  ...
                                  <tr> 
                                    <td height="26" align="center" valign="middle"> 
                                      <table width="100%" border="1">
                                        <tr> 
                                          <td align="center"><a href="./adminpage.php"><font size="2"><font size="2"><font face="MS Sans Serif" color="666666"><b><font color="#FF6600">รายชื่อผู้เขียน</font></b></font></font></font></a></td>
                                        </tr>
                                        <tr> 
                                        ...
                                        <tr> 
                                          <td align="center"><font size="2"><font size="2"><a href="./deletewriter.php"><font face="MS Sans Serif" color="666666"><b>ลบชื่อผู้เขียน</b></font></a> 
                                            </font></font></td>
                                        </tr>
                                      </table>
                                    </td>
          ...
          <TD vAlign=top width="727" height="497">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="#0000cc"> 
                <td> 
                  <div align="center"><font color="#333333"><b><font size="3" color="#FFFFFF">รายชื่อผู้เขียน</font></b></font></div>
                </td>
              </tr>
              <tr>
                <td> 
                  <form method="post" action="./gdeletewriter.php">
                    <table width="100%" border="1">
                      <tr bgcolor="#3366FF" align="center">
                        <td width="5%">&nbsp;</td>
                        <td width="30%"><font size="2"><b><font color="#FFFFFF" face="MS Sans Serif">ชื่อผู้ใช้</font></b></font></td>
                        <td width="35%"><font size="2"><b><font color="#FFFFFF" face="MS Sans Serif">ชื่อ-นามสกุล</font></b></font></td>
                        <td width="15%" valign="middle"><font color="#FFFFFF" face="MS Sans Serif" size="2"><b>ชื่อเล่น</b></font></td>
                        <td width="20%"><font color="#FFFFFF" face="MS Sans Serif" size="2"></font></td>
                      </tr>
                      <font face="MS Sans Serif" size="2"> <?
					$sql1="select count(*) from writer";
					$result1=mysql_db_query($db,$sql1);
					$data1=mysql_fetch_array($result1);
					$num_of_row=$data1[0];					
					$num_of_page=$num_of_row/25;
					...
					$sql2="select t1.mem_id, t1.mem_username,t1.mem_fname,t1.mem_lname,t1.mem_nickname from member t1, writer t2 where t1.mem_id=t2.mem_id order by t1.mem_username asc".$sql_tail;
					...
					for($i=$begin;$i<$row2;$i++)
					{$data2=mysql_fetch_array($result2);
					echo '<tr align="center">';
					echo'<td width="5%"><input type="checkbox" name="checkbox['.$data2[0].']" value="'.$data2[0].'">';
					echo '<td width="30%"><font color="#910000" size="1" face="MS Sans Serif"><b>'.$data2[1].'</b></font></td>';
					echo '<td width="35%"><font color="#000000" size="1" face="MS Sans Serif"><b>'.$data2[2].' '.$data2[3].'&nbsp;</b></font></a></td>';
					echo '<td width="15%"><b><font face="MS Sans Serif" size="1">'.$data2[4].'&nbsp;</font></b></td>';
					echo '<td width="20%" align="center" valign="middle">';
					echo'<a href="./editdetailwriter.php?writername='.$data2[1].'"><font color="#000000" size="1" face="MS Sans Serif">แก้ไขข้อมูลผู้เขียน</font></a>';
					echo'</td>';
					echo '</tr>';
					}
				?> </font> 
                      <tr align="left"> 
                        <input type="submit" name="" value="ลบชื่อผู้เขียนบทความ">
                      </tr>
                      <tr align="right"> <?
				  echo'<td colspan="5" height="24"> <font color="#333333" size="2" face="MS Sans Serif">แสดงรายชื่อที่ ';
				  if($num_of_row==0)$start=0;
					else $start=($page-1)*15+1;
				  ...
				  echo'  <a href="./adminpage.php?page=1"><font color="#666666" size="2" face="MS Sans Serif">ไปที่หน้าแรก</font></a>';
				  $prepage=$page-1;
				  if($page!=1){echo' | <a href="./adminpage.php?page='.$prepage.'"><font color="#666666" size="2" face="MS Sans Serif">ไปที่หน้าที่แล้ว</font></a>';}
					$nextpage=$page+1;
				  if($nextpage<=$num_of_page){echo ' | <a href="./adminpage.php?page='.$nextpage.'"><font color="#666666" size="2" face="MS Sans Serif">ไปที่หน้าต่อไป</font></a>';}
					echo' | <a href="./adminpage.php?page='.$num_of_page.'"><font color="#666666" size="2" face="MS Sans Serif">ไปที่หน้าสุดท้าย</font></a>';
				   echo'</font> </td>';
				   ?> </tr>
                    </table>
                  </form>
