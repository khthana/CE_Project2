      ...
      <TABLE height=464 width="100%" border=0>
        ...
        <TR align="left" bgcolor="#FFFFFF"> 
                                  ...
                                  <tr> 
                                    <td height="26" align="center" valign="middle"> 
                                      <table width="100%" border="1">
                                        <tr> 
                                          <td align="center"><font size="2"><font face="MS Sans Serif" color="666666"><a href="./adminpage.php"><font size="2"><font face="MS Sans Serif" color="666666"><b><font color="#FF6600">รายชื่อผู้เขียน</font></b></font></font></a></font></font></td>
                                        </tr>
                                        <tr>
          ...
          <TD vAlign=top width="727" height="497"> 
            <form method="post" action="./confirmaddwriter.php">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" height="206">
                <tr bgcolor="#0000CC"> 
                  <td height="32"> 
                    <div align="center"><b><font face="MS Sans Serif" size="3" color="#FFFFFF">เพิ่มชื่อผู้เขียน</font></b></div>
                  </td>
                </tr>
                <tr align="left" valign="top"> 
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td width="77%" height="45"> 
                          <input type="text" name="writername" size="15" maxlength="30" value="<? echo$old_username;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="position" size="30" maxlength="50" value="<?echo$old_position;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="education" size="30" maxlength="50" value="<?echo $old_educate;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="experience" size="30" maxlength="50" value="<? echo$old_exp;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="skill" size="30" maxlength="50" value="<?echo $old_skill;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                      ...
                      <tr> 
                        ...
                        <td width="77%"> 
                          <input type="submit" name="Submit" value="เพิ่มชื่อผู้เขียน">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
