...
if($lastpage<>'confirmeditwriter')
{
$sql="select  member.mem_id,wri_position,wri_education,wri_experience,wri_skill from writer ,member where member.mem_id=writer.mem_id && member.mem_username='$writername'";
$result=mysql_db_query($db,$sql);
      ...
      <TABLE height=464 width="100%" border=0>
        ...
        <TR align="left" bgcolor="#FFFFFF"> 
                                  ...
                                  <tr> 
                                    <td height="26" align="center" valign="middle"> 
                                      <table width="100%" border="1">
                                        ...
                                        <tr> 
                                          <td align="center"><a href="./deletewriter.php"><font size="2"><font face="MS Sans Serif" color="666666"><b>ลบรายชื่อผู้เขียน</b></font></font></a></td>
                                        </tr>
                                      </table>
                                    </td>
                                  </tr>
          ...
          <TD vAlign=top width="727" height="497"> 
            <form method="post" action="./confirmdetailwriter.php">
                  ...
                  <td> 
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td width="77%" height="45"><font face="MS Sans Serif" size="2" color="#000000"><? echo $writername;?></font></td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="newposition" size="30" maxlength="50" value="<? echo $position;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="neweducation" size="30" maxlength="50" value="<? echo $educate;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="newexperience" size="30" maxlength="50" value="<? echo $exp;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
                        ...
                        <td width="77%"> 
                          <input type="text" name="newskill" size="30" maxlength="50" value="<? echo $skill;?>">
                        </td>
                      </tr>
                      <tr> 
                        <td width="23%"> 
