...
<TABLE width="120%" border=0 cellpadding="0" cellspacing="0">
  ...
  <TR>
    <TD height=8> <img src="../images/label1.gif" width="126" height="54" border="0"> 
      <A onmouseover="MM_swapImage('Image1','','../image/redpoint.gif',1)" 
      onmouseout=MM_swapImgRestore() 
      href="../member/welcome.php"><IMG 
      height=33 src="../images/home.gif" width=90 border=0 
      name=Image1></A><a href="../../article/index.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image15','','../image/docyellow.gif',1)"><img name="Image15" border="0" src="../images/document.gif" width="90" height="33"></a><A onmouseover="MM_swapImage('Image2','','../image/carblue.gif',1)" 
      onmouseout=MM_swapImgRestore() 
      href="sch_add.php"><IMG 
      height=33 src="../images/carlendar.gif" width=90 border=0 
      name=Image2></A><A 
      onmouseover="MM_swapImage('Image4','','../image/sendpink.gif',1)" 
      onmouseout=MM_swapImgRestore() 
      href="../message/send_message.php"><IMG 
      height=33 src="../images/send.gif" width=90 border=0 
      name=Image4></A><a href="../friend/friendlist.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image14','','../image/addresspink.gif',1)"><img name="Image14" border="0" src="../images/address.gif" width="90" height="33"></a><A 
      onmouseover="MM_swapImage('Image5','','../image/detailblue.gif',1)" 
      onmouseout=MM_swapImgRestore() 
      href="../member/editprofile.php"><IMG 
      height=33 src="../images/detail.gif" width=90 border=0 
      name=Image5></A><A 
      onmouseover="MM_swapImage('Image6','','../image/logoutorg.gif',1)" 
      onmouseout=MM_swapImgRestore() 
      href="../member/quit.php"><IMG 
