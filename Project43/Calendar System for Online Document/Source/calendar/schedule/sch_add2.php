...
<BODY bgColor=#ffffff 
onload="MM_preloadImages('../redpoint.gif','../carblue.gif','../sendpink.gif','../detailblue.gif','../logoutorg.gif','../docyellow.gif','../addresspink.gif','../images/messagegreen.gif')">
<?
...
<? //-------------หมดquickbutton------- ?>
                    ...
                    <table width="120" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr align="left" valign="top"> 
                        <td colspan="2" bgcolor="#FFFFFF" height="113"> 
                          <div align="center"> 
          ...
          <TD width="79%"> 
      <form method="post" action="sch_add2.php">
...
if($err<>"")
{
		...
		{
			echo "รายละเอียดของงานเกิน 200 ตัวอักษรค่ะ";
		}
...
?> 
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="64%"> <font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#666666">เวลา</font> 
                    <select name="time">
                      <?
...
?> 
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="64%"><font face="MS Sans Serif, Microsoft Sans Serif" color="#666666" size="2">เรื่อง</font></td>
                  <td width="26%">&nbsp;</td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
...
?>
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="64%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#666666">รายละเอียด</font></td>
                  <td width="26%">&nbsp;</td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="64%"> <font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#666666"> 
...
?></textarea>
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="64%"><font face="MS Sans Serif, Microsoft Sans Serif" color="#666666" size="2">ระยะเวลา 
...
?> 
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td width="64%"><font color="#666666" size="2" face="MS Sans Serif, Microsoft Sans Serif">กำหนดให้มีการเตือนก่อน 
...
?>
                ...
                <tr> 
                  ...
                  <td width="64%"> 
                    <div align="center"> 
                      <input type="submit" name="schedule" value="จัดตาราง">
                      ...
                      <input type="submit" name="appoint" value="นัดหมายเพื่อน">
                      </font> </div>
                  </td>
                  <td width="26%">&nbsp; </td>
                </tr>
