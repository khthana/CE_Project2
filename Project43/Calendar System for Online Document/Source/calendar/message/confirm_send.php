...
?> 
          ...
          <TD vAlign=top width="727" height="497"> 
            <form name="will" method="post" action="./dosend.php">
              <table width="430" border="0" height="277" cellpadding="0" cellspacing="0">
                <tr> 
                  <td height="20"><img src="../images/head_table.gif" width="432" height="18"></td>
                </tr>
                <tr> 
                  <td bordercolor="#CCCCCC" height="233"> 
                    <table width="100%" border="1" bordercolor="#FF9900" height="240" cellpadding="0" cellspacing="0">
                      <tr> 
                        <td height="226" align="left" valign="top"> 
                          <table width="99%" border="0" bordercolor="#FF6600" height="208">
                            <tr> 
                              <td height="31">&nbsp;</td>
                            </tr>
                            <tr> 
                              <td height="29"><font face="MS Sans Serif" size="2">ยืนยันการส่งข้อความถึง 
                                <b>คุณ <?php echo $rec_name2; ?></b></font> </td>
                            </tr>
                            <tr> 
                              <td height="42"> 
                                <div align="center"> 
                ...
                <tr> 
                  <td><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b><img src="../images/login_line.gif" width="432" height="18"></b></font></td>
                </tr>
              </table>
              <input type="hidden" name="count3" value="<?php echo$count; ?>">
              <input type="hidden" name="rec_name3" value="<?php echo$rec_name2; ?>">
              <input type="hidden" name="title3" value="<?php echo$title; ?>">
            ...
            <font color="#FFFFFF"> </font></TD>
              ...
              <?php session_unregister('rec_name2');
