...
mysql_select_db("magazine") or die("ไม่สามารถติดต่อแฟ้มข้อมูลได้"); 
		...
		$sql_job="select app_time,app_date,app_title,app_note,app_duration,app_remind_before,app_remind_before_hour,app_remind_mail from appointment where app_id=$app_id and mem_id=$user_id";
...
$app_remind_before_hour=$row[6];
$app_remind_mail=$row[7];
?>
              <table width="90%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><b><font color="#FF6600" size="2" face="MS Sans Serif, Microsoft Sans Serif">การนัดหมาย 
                    &gt;&gt; </font></b></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><font size="1"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#666666">ถึง 
                    ...
                    <?
$sql_receiver="select mem_username,mem_fname from appoint_receiver a1,member m1 where mem_id=friend_id and app_id=$app_id order by mem_fname";
...
?> </font></font></td>
                ...
                <tr> 
                  ...
                  <td colspan="2"><font color="#666666"><b><font size="1" face="MS Sans Serif, Microsoft Sans Serif">วันนัดหมาย 
                    ...
                    <? echo $appdate," ",$thaimonth[$appmonth-1]," ",$appyear+543; ?><b><font size="1" color="#666666">&nbsp;&nbsp;เวลา 
                    :</font></b><font  face="MS Sans Serif, Microsoft Sans Serif" color="#0033CC" size="2">&nbsp;<? echo $app_time.":00น."; ?></font></font></font></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                ...
                <tr> 
                  ...
                  <td colspan="2"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#666666"><b>กำหนดให้มีการเตือนการนัดก่อน 
                    ...
                    <font color="#0033CC" size="2">&nbsp; <? echo $app_remind_before_hour; ?></font><b> 
                    ชม. </b></font></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
...
?> 
                ...
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td colspan="2"><img src="../images/orange_point.gif" width="400" height="1"></td>
                </tr>
                <tr> 
                  <td width="10%">&nbsp;</td>
                  <td> <?
...
{
	 $link="../welcome.php";
	  $namelink="กลับไปหน้าแรก";
}elseif($frompage=="app_list")
{
	$link="app_list.php";
	$namelink="กลับไปหน้าก่อนนี้";
}
?> 
                    <div align="center"><a href="<? echo $link; ?>"><font color="#0000FF" size="1" face="MS Sans Serif, Microsoft Sans Serif"><? echo $namelink; ?></font></a></div>
                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr> 
