...
if($err=="4")
{
		echo "<b>กรุณาเลือกชื่อผู้รับ </b><br>";
}
?>
</font>				
                    <table width="100%" border="1" cellspacing="0" cellpadding="0">
                      ...
                      <tr bgcolor="#CCCCCC"> 
                        <td colspan="4" height="30"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#003399">กลุ่ม 
                          : </font> <?
$host="localhost";
...
if($grp_num<>"all")
{
	...
	$result= mysql_db_query("magazine",$sqlgrpname);
	$numrow=@mysql_num_rows($result);
	if ($numrow>0)
	{
  	 $row=mysql_fetch_array($result);		
		  $grp_name=$row[0];
	}//แสดงชื่อกลุ่มที่จะแสดงรายชื่อเพื่อน
}else
{
	$grp_name="ทั้งหมด";
}
 //เช็คกรณีที่ต้องการชื่อเพื่อนทั้งหมด
?> <font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#003399"><b><? echo $grp_name; ?></b></font> 
                      ...
                      <tr bgcolor="#999999"> 
                        ...
                        <td> 
                          <div align="center"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#CCFFFF">ชื่อผู้ใช้</font></div>
                        </td>
                        <td> 
                          <div align="center"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#CCFFFF">ชื่อ-นามสกุล</font></div>
                        </td>
                        <td> 
                          <div align="center"><font size="1" face="MS Sans Serif, Microsoft Sans Serif" color="#CCFFFF">ชื่อเล่น</font></div>
                        </td>
                      </tr>
 <?
if($grp_num<>"all")
...
?>
		...
		} // เช็คว่าเพื่อนคนไหนถูกเช็คจากหน้าที่แล้วบ้าง
		echo ">";							
?> </td>
...
header("Location:app_add_all_list2.php?time=$time&schday=$schday&schdate=$schdate&schmonth=$schmonth&schyear=$schyear&grp_num=$grp_num");
}
?>
