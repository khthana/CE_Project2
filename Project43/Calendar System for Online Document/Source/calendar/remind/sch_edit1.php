...
{
?>
                                          <td valign=top align=right height="26"><font face="MS Sans Serif,Microsoft Sans Serif" size="2" color="#000000"> 
                                            <?
	$num_show=$start+$i;
...
?>
      <form method="post" action="../schedule/sch_edit1.php">
...
<?
		...
		{
			echo "นัด : ";			
			$sql_app="select mem_username,mem_fname from member,appoint_receiver where friend_id=mem_id and app_id=$app_id and friend_id<>$user_id order by mem_username";
                ...
                <tr> 
                  ...
                  <td width="60%"> 
                    <div align="center"><font color="#0000FF" size="1" face="MS Sans Serif, Microsoft Sans Serif"><a href="../welcome.php"><font color="#0000FF" size="1" face="MS Sans Serif, Microsoft Sans Serif">กลับไปหน้าแรก</font></a> 
                      &nbsp;&nbsp;<a href="../schedule/sch_add.php?schday=<? echo $schday; ?>&amp;schdate=<? echo $schdate; ?>&amp;schmonth=<? echo $schmonth; ?>&amp;schyear=<? echo $schyear; ?>"><font color="#0000FF" size="1" face="MS Sans Serif, Microsoft Sans Serif">กลับไปหน้าจัดตาราง</font></a></font></div>
                  </td>
                  <td width="30%">&nbsp;</td>
                </tr>
              </table>
...
header("Location:../schedule/sch_add.php?schday=$schday&schdate=$schdate&schmonth=$schmonth&schyear=$schyear");
