...
public class InReqAuthorizeFrame extends JFrame
{
  ...
  TitledBorder titleRequest = new TitledBorder(defaultBorder, "Request for Authorization");
  JPanel jPanel1        = new JPanel();
  JPanel panelSendMsg   = new JPanel();
  JPanel panelMsg       = new JPanel();
  JPanel panelHead      = new JPanel();
  JButton btAuthorize   = new JButton("Authorize");
  JButton btIgnore      = new JButton("Ignore");
  JLabel labelUIN       = new JLabel("ICQ#");
  JLabel labelNick      = new JLabel("NICK:");
  JLabel labelEmail     = new JLabel("E-MAIL:");
  JLabel labelHeadMsg   = new JLabel("This user has requested your authorization to add you to his/her "+"contact list.");
  ...
  public InReqAuthorizeFrame(OwnerUserInfo oUserInfo,ContactUserInfo cUserInfo,DataReceive dReceive)
  {
  ...
  {
    setIconImage(this.imageFrameHead);
    setTitle("Incoming Request Your Authorization");
    ...
    btAuthorize.setFont(defaultFont);
    ...
    btAuthorize.setBorder(defaultBorder);
    ...
    btAuthorize.setMaximumSize(new Dimension(85, 30));
    btAuthorize.setMinimumSize(new Dimension(85, 30));
    btAuthorize.setPreferredSize(new Dimension(85, 30));
    ...
    labelHeadMsg.setPreferredSize(new Dimension(400, 25));
    labelHeadMsg.setMinimumSize(new Dimension(400, 25));
    labelHeadMsg.setMaximumSize(new Dimension(400, 25));
    taMessage.setMargin(new Insets(2, 2, 2, 2));
    btAuthorize.setMargin(new Insets(2, 2, 2, 2));
    ...
    panelMsg.add(jScrollPane1, new GridBagConstraints(0, 2, 1, 1, 1.0, 1.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 3, 3, 3), 0, 0));
    panelMsg.add(labelHeadMsg, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0), 0, 0));
    jPanel1.add(btIgnore, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0, 0, 5), 0, 0));
    jPanel1.add(btAuthorize, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0
    ...
    panelSendMsg.add(jPanel1, new GridBagConstraints(0, 2, 1, 1, 1.0, 0.0
		...
		btAuthorize.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
        oUserInfo.authAccept(cUserInfo);
				dispose();
			}
		});
		btIgnore.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
        oUserInfo.authIgnore(cUserInfo);
				dispose();
			}
		});
  }
