////////////////////This class use for add Keyboard specification//////////////////////
import java.io.*;
...
public  class AddKeyboard extends HttpServlet
{
    ...
    String Str_Query ;
    String Brand_keyboard ;
    String Interface ;
    String Quantity_keyboard;
    int rowCount ;
    out.println("<html>");
    out.println("<head>");
    ...
    out.println(" Keyboard Details :<br>");
    out.println(" <br>");
    ...
    out.println("          <font color=\"#000066\">Choose Keyboard Details ...</font></i></b></font></div>");
    out.println("    </td>");
    out.println("  </tr>");

    Brand_keyboard    = req.getParameter("Brand_keyboard") ;
    Interface        = req.getParameter("Interface");
    Quantity_keyboard = req.getParameter("Quantity_keyboard");
    if (Brand_keyboard == null)
    {
      out.println("<form method = \"Get\" action = \"AddKeyboard\">");
      ...
      out.println("Brand Keyboard");
      out.println("           <select name=\"Brand_keyboard\" size=\"1\">");
                              Query.Query("Brand_keyboard","Keyboard","",out);
      out.println("</select>");
  ...
  //    out.println("Your Select Brand Cpu >>>>> " + Brand_cpu+"<br>");
     ...
     //row1
      ...
      {
        Query.Query("Interface","keyboard","",out);
      }
      else
      {
       Query.Query("Interface","keyboard"," where Brand_keyboard  ='" + Brand_keyboard +"'",out) ;
      }
      out.println("</select>");
      out.println("</font></b> </font>");
      out.println("    </td>");
      out.println("    <td height=\"33\" align=\"center\" width=\"50%\" >");
      out.println(" <input type=hidden Name = \"Brand_keyboard\" value = \"" + Brand_keyboard + "\">" );
      out.println("<input type=\"submit\" name=\"Sumbit\" value=\"Choose Interface\">");
      out.println("    </td>");
      out.println("</tr>");
      out.println("</form>");
    }
    else if (Quantity_keyboard == null)
    {
      out.println("<form method = \"Get\" action = \"AddKeyboard\" name = \"form\" >");
      out.println("<tr bgcolor=\"#FFcc99\" bordercolor=\"#FFFFFF\">");
      out.println("    <td height=\"33\" align=\"center\" width=\"50%\"><font size=\"2\"><font face=\"Arial, Helvetica, sans-serif\" color=\"#333333\"><b></b></font></font>");
      ...
      out.println("<font color=\"#006666\">KEYBOARD</font>   " + Brand_keyboard + "<br>");
      ...
      out.println("<input type=\"text\" name=\"Quantity_keyboard\" size=\"2\" maxlength=\"2\">");
      out.println("<br>");
      out.println("<br>");
...
//////////////////////////  End script /////////////
      ...
      out.println("<input type=\"button\" name=\"OK\" value=\"Submit\" onClick = \"validate(Quantity_keyboard)\">");
      out.println("    </td>");
      out.println("  </tr>");
      out.println("</form>");
    }
     else
     {
      ...
      out.println("<font color=\"#006666\">KEYBOARD</font>   " + Brand_keyboard + "<br>");
      out.println("<font color=\"#006666\">INTERFACE</font>  " + Interface  + "<br>");
      out.println("<font color=\"#006666\">QUANTITY</font> " + Quantity_keyboard + "<br>");
      out.println("<br>");
      out.println("<form method = \"Post\" action = \"Sendspec\">");
      out.println("<input type=hidden Name = \"Brand_keyboard\" value = \"" + Brand_keyboard + "\">" );
      out.println("<input type=hidden Name = \"Interface\" value = \"" + Interface + "\">" );
      out.println("<input type=hidden Name = \"Quantity_keyboard\" value = \"" + Quantity_keyboard + "\">" );
      out.println("<input type=hidden Name = \"Device_name\" value = \"" + "KEYBOARD" + "\">" );
