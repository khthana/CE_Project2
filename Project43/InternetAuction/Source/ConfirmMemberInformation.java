...
import  java.util.*;
public class ConfirmMemberInformation extends HttpServlet
{
...
out.println("      <html>");
out.println("<head>");
out.println("<title> Confirm Member Information : CE.KMITL</title>");
...
out.println("                  <font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\"><a href=\"Bidding\">Bidding</a></font></font><br>");
out.println("                </p>");
out.println("              </div>");
...
out.println("     <td width=\"82%\" height=\"393\" align=\"left\" valign=\"top\">");
 ...
 out.println("  <tr bgcolor=\"#89D8D8\">");
    ...
    out.println("  </tr>");
    out.println("</table>");
    out.println(" <form method=\"Post\" action=\"InsertNewMember\"> ");
