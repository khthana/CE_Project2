...
import java.util.*;
public class ViewSellerDetail extends HttpServlet implements Serializable
{
...
out.println("     <td width=\"82%\" height=\"393\" align=\"left\" valign=\"top\">");
      ...
      try
      {
        ...
        String findmax_specid = "select  tech_req_id,seller_name,Seller_spec  from bidding_table where tech_req_id =" + Tech_req_id ;
        findmax_specid += " and seller_name ='" + Sellername + "'" ;
  //      String findmax_specid = new String("select standard_spec from standard_spec where spec_type = 'Basic PC'");
   ...
   //     blob = ((OracleResultSet)rs).getBLOB(1);
        ...
        out.println(" <td bgcolor = #ffffff rowspan = \"4\" width = \"70%\">");
       ...
       out.println("    </td>");
        ...
        out.println("    <td height=\"5\" width=\"20%\">");
        out.println("      <div align=\"left\"><b><font face=\"Arial, Helvetica, sans-serif\" color=\"#000000\">Seller company");
        ...
        out.println(" <center>     <input type=\"submit\" name=\"Submit\" value=\"Contact seller\"> <center>");
        out.println("</form>");
        out.println(" </td>");
        out.println("  </tr>");
