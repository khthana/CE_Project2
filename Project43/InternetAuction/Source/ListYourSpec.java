...
import java.util.*;
public class ListYourSpec extends HttpServlet implements Serializable
{
...
out.println("          <br>");
out.println("          <hr>");
out.println("          <div align=\"center\"><font size=\"+2\"> List your spec  </font><br>");
out.println("            <br>");
out.println("          </div>");
...
/////////////////////////////List seller spec////////////////////////////////////
      ...
      try
      {
        ...
        String select_standard = new String("select seller_spec,standard_price,detail,company,username,last_update,spec_id,spec_type");
               select_standard += " from seller_standard_spec where username = '" + username + "'";
        ...
        String Spec_type = Seller_rs.getString(8);
        String Spec_id   =  Seller_rs.getString(7);
...
out.println(" <form method=\"Post\" action=\"RemoveYourSpec\"> ");
out.println(" <input type=hidden Name = \"Spec_id\" value = \"" + Spec_id + "\">" );
out.println("      <input type=\"submit\" name=\"submit\" value=\"Remove Spec\">");
out.println("</form>");
out.println("              </td>");
out.println("            </tr>");
out.println("          </table>");
