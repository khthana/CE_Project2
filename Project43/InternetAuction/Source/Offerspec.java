...
import java.util.*;
public class Offerspec extends HttpServlet implements Serializable
{
    ...
    throws ServletException, java.io.IOException
      ...
      out.println("      <html>");
out.println("<head>");
out.println("<title>Internet Auction [Project List] : CE.KMITL</title>");
...
out.println("  <tr>");
out.println("     <td colspan=\"2\" height=\"110\"><img src=\"/picture/Projectdetail.jpg\" width=\"970\" height=\"98\"></td>");
out.println("  </tr>");
out.println("  <tr>");
...
out.println("                <p><font face=\"Arial, Helvetica, sans-serif\" size=\"2\" ><a href=\"index.html\"><font size=\"3\" >Home<font face=\"Arial, Helvetica,   sans-serif\">");
...
out.println("                  </i><a href=\"ChangeInfo.html\"><font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\">C</font><font face=\"Arial, Helvetica,   sans-serif\">hange");
...
out.println("                  </font></font></a><a href=\"ProjectList.html\"><font size=\"3\"><font face=\"Arial, Helvetica, sans-serif\">Project");
out.println("                  List </font></font></a><a href=\"OfferSpec.html\"><font size=\"3\"><font face=\"Arial, Helvetica, sans-serif\"><br>");
out.println("                  </font></font></a><a href=\"ranking.html\"><font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\">Member");
...
out.println("                  <font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\"><a href=\"rankingl\">General");
out.println("                  Requirement</a></font></font><br>");
out.println("                  <font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\"><a href=\"rankingl\">Add");
...
out.println("                  <font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\"><a href=\"ranking\">Add");
out.println("                  Specification</a></font></font><br>");
out.println("                  <font size=\"3\"><font  face=\"Arial, Helvetica, sans-serif\"><a href=\"ranking\">Bidding</a></font></font><br>");
out.println("                </p>");
out.println("              </div>");
...
out.println("     <td width=\"82%\" height=\"393\" align=\"left\" valign=\"top\">");
 Connection con = null;
      ...
      try
      {
        ...
        out.println("      Price (Baht)</font></b></td>");
        ...
        out.println("  <br>");
        out.println("  <br>");
        out.println("<table border=1 cellpadding=1 cellspacing=0 height=180 width=\"99%\">");
        out.println("<tbody>");
        int i_count_part ;
