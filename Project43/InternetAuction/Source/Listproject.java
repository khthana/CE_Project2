...
import java.util.*;
public class Listproject extends HttpServlet implements Serializable
{
...
out.println("      <html>");
out.println("<head>");
out.println("<title>  Project List: CE.KMITL</title>");
...
out.println("  <tr>");
out.println("     <td colspan=\"2\" height=\"110\"><img src=\"/picture/ProjectList.jpg\" width=\"970\" height=\"98\"></td>");
out.println("  </tr>");
out.println("  <tr>");
...
out.println(" <font color=\"#330033\"><b>. . P r o j e c t &nbsp;&nbsp;   L i s t  . .</b></font></font><br><br><br>");
      ...
      try
     {
      ...
      //////----Find Max spec_id-----///
      String findproject = new String("select project_name,project_desc,username,company_name,end_date,tech_req_id,maxprice,finished from buyer_tech_req order by tech_req_id");
      ...
      while (rs.next())
         ...
         out.println("<td width=\"23%\"> <div align=\"center\"><font size=\"2\" color=\"#0000ff\"><b>" +  date +  "</b></font></div></td>");
