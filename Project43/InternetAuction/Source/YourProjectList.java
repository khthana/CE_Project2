...
import java.util.*;
public class YourProjectList extends HttpServlet implements Serializable
{
    ...
    throws ServletException, java.io.IOException
      ...
      out.println("      <html>");
out.println("<head>");
out.println("<title> Your project list: CE.KMITL</title>");
...
out.println(" <font color=\"#330033\"><b>. .Y o u r &nbsp;&nbsp;  P r o j e c t &nbsp;&nbsp;   L i s t  . .</b></font></font><br><br><br>");
      ...
      out.println("      </td>");
      out.println("      <td width=\"13%\">");
      out.println("        <div align=\"center\"><font size=\"4\" color=\"#000000\">Finished</font></div>");
      out.println("      </td>");
      ...
      try
     {
      ...
      //////----Find Max spec_id-----///
      String findmax_specid = "select project_name,project_desc,username,company_name,end_date,tech_req_id,maxprice,finished ";
      findmax_specid += " from buyer_tech_req where username ='"+ username + "' order by tech_req_id";
      ...
      while (rs.next())
         ...
         out.println("<td width=\"13%\"> <div align=\"center\"><font size=\"2\" color=\"#0000ff\"><b>" +  rs.getString(8) +  "</b></font></div></td>");

         out.println("<td width=\"13%\">");
         out.println("  <form method=\"Post\" action=\"Showproject\" name=\"Test\">");
     //    if (rs.getString(8).compareTo("yes") == 0)
         ...
         out.println("<td width=\"13%\">");
         out.println("  <form method=\"Post\" action=\"SellerList\" name=\"Test\">");
         if (rs.getString(8).compareTo("yes") == 0)
         {
         out.println(" <input type=hidden Name = \"Tech_req_id\" value = \"" + rs.getString(6) + "\">" );
         out.println("  <input type=\"submit\" name=\"projectnumber\" value=\"Seller List\">");
         }
         out.println("   </form> ");
         out.println("</td>");
         out.println("</tr>");
