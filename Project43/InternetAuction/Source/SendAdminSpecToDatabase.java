...
import java.util.*;
public class SendAdminSpecToDatabase extends HttpServlet implements Serializable
{
    ...
    throws ServletException, java.io.IOException
      ...
      try
     {
      ...
      /////--------Delete old data--------/////
      String delete ;
      delete = "delete from standard_spec where spec_type = '" + Spec_type  +"'";
      ...
      String insert ;
      insert = "insert into standard_spec(standard_spec,spec_type,standard_price,last_update)";
      insert += " values(empty_BLOB(),'" + Spec_type + "',"+ Price + ",to_date('" + time + "','" + "DD/MM/YYYY HH24:MI'))";;
