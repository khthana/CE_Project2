          ...
          <td valign="top" height="7" colspan="3"> 
            <table width="100%" border="0" cellspacing="3" cellpadding="0">
              ...
              <tr> 
                <td> 
                  <?
	$sql = "select art_id,art_name,abstract,location,last_update,p1.col_id,template from article p1,col p2 where p1.col_id=p2.col_id and art_status='A' order by last_update desc";
	$SQLresult = mysql_db_query($dbName,$sql);
