      ...
      <form  name="searchEdit" method="post" action="../../search/searchBasic.php">
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <td width="23">
              <input type=image width="29" height="23" src="../../../document/image/go.gif" name="go">
            </td>
          </tr>
          <tr height="6"> 
            <td colspan="3" height="6"> 
              <p align="right"><spacer height="6" width="6" 
type="block"><font face="Arial" size="1"> Search Articles for delete</font> 
            </td>
          </tr>
          </tbody> 
        </table>
...
?>
          ...
          <td align="left" vAlign="top" width="699" height="630"><!-- #BeginEditable "form" --> 
                      ...
                      <td><font color="#FF3333" size="2" face="MS Sans Serif, Microsoft Sans Serif">บทความที่ท่านสามารถลบได้ 
                        </font> </td>
                                                  </tr>
                                                  <tr> 
...
<form method =" post" action = " ../../../document/edit_article/delete_article.php">
<?session_start();
include ('connect.inc');
...
//====================SELECT article for edit =========================== 
	...
	//=====swap date		
		...
		echo "<font  size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\"> \n";
    		echo "<input type=\"checkbox\" name=\"delete_art_id$num_art\" value= $art_id> ";
		echo "$art_name  ";
		echo "<font color = \"#00cccc\"> ";
		echo "&nbsp &nbsp[ $last_update ] <br>\n";
		echo "</font>";
		echo "</font> \n";	

	}
	echo "<input type = \"hidden\" name=\"num_delete\" value = $nf> ";
?> 
<br>	
              ...
              <tr> 
                <td><img alt="line" height="40" src="" width="1"></td>
                  ...
                  search</a></font><br>
                                             ...
                                             <a href="file:///C%7C/magazine%20project/www/document/onweb/health.php"><font size="2"><br>
                                             </font></a><br>
                                             </font></td>
              </tr>
              <tr> 
          ...
          <td align="middle" height="2"> 
            <table border="0" cellPadding="0" cellSpacing="0" width="695">
                ...
                <td bgColor="#ffffff" width="693" height="2"> 
					    ...
					    King Mongkut's Institute of Technology Landkrabang Department of Computer Engineering
					    </font></p>
                    </td>
                  </tr>
                </tbody>
