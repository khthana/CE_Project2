...
//=============relate======select * from article where art_id
	


	
	echo "<form method=\"post\" action= upload_vote.php> \n";
	for($line=1; $line<=$nf; $line++) {
...
echo"$col_name <br>\n";
echo"$abstract <br>\n";
echo"$key1 \t $key2 \t $key3 \t $key4 \t $key5 \t $key6 \t $key7 \t $key8 \t $key9 \t $key19 <br>\n";
echo"$date_write/$mount/$year <br>\n";
echo"$num_poll <br>\n";
