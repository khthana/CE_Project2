...
?>
	...
	<!-- ########## begin form ############ -->				      
					      <form method="post" action="upload_choice.php">
					          <table width="330" border="0" cellspacing="0" cellpadding="5" bgcolor="#FFFFCE">
                                ...
                                <!--                      <tr> 
                                                            <td height="62"> <font color="#0000CC" size="1" face="MS Sans Serif, Microsoft Sans Serif">คำถามที่หนึ่ง</font><font size="1" face="MS Sans Serif, Microsoft Sans Serif"> 
                                                                 <input type="text" name="textfield" size="50">
                                                                 </font></td>
                                                       </tr>
                                                       <tr> 
                                                            <td height="33"> 
                                                                 <p><font color="#0000CE" size="1" face="MS Sans Serif, Microsoft Sans Serif">จำนวนตัวเลือกที่ต้องการ</font>
                                                                      <input type="text" name="textfield2" size="5">
                                                                      <font size="1" face="MS Sans Serif, Microsoft Sans Serif"></font> 
...
for ( $num_vote = 1 ;$num_vote <= $num_poll; $num_vote++) { 
    ...
    echo "    คำถามที่ $num_vote \n";
    echo "      <input type=\"text\" name=\"poll$num_vote\" size =\"50\" maxlength=\"50\"><br> \n";
    echo "      จำนวนตัวเลือก \n";
    echo "      <input type=\"text\" name=\"num_choice$num_vote\" size=\"3\" maxlength=\"3\"> \n";
    echo "     \n";
    echo "  </td> \n";
    echo "</tr> \n";
}
...
type="block"> </td>
                <form action="http://papower.state.pa.us/PAPower/Default.asp" id="form1" method="post" name="form1">
                  <td align="left" vAlign="top" width="191" height="141"> 
                                                  ...
                                                  <p><a href="../../../document/onweb/onweb.html"><font size="1" face="MS Sans Serif, Microsoft Sans Serif">Create 
              ...
              <tr> 
                ...
                <td width="191" valign="top"><font face="geneva,veranda,arial" size="1"><br>
                                             ...
                                             </font></font><font face="geneva,veranda,arial" size="1"></font><font face="geneva,veranda,arial" size="1"><br>
                                             </font>
		</td>
              </tr>
              <tr> 
