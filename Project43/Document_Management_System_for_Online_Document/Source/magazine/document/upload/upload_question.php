                              ...
                              <table width="350" cellspacing="0" cellpadding="0" height="377">
                                   ...
                                   <tr> 
                                        ...
                                        <td colspan="2" align="left" valign="top" bgcolor="#FFFFFF" height="496"> 
                                              <form method="post" action="upload_complete.php">
...
for ($line = 1; $line <=$num_poll; $line++){
	...
	$num_choice = "num_choice".$line;
	$num_choice = ${$num_choice};

	$poll_id = "poll_id".$line;
	$poll_id = ${$poll_id};

	for ($number_choice = 1; $number_choice <= $num_choice; $number_choice++)
	{
		$choice = "choice".$line.$number_choice;
		$choice = ${$choice};
	//	echo "$choice <br>\n";
...
//echo " number of question $num_question ";
for ($num_op=  1; $num_op <= $num_question; $num_op++)
	{
		echo "<tr> \n";
		echo " <td colspan=\"2\" align=\"left\"> \n";
		echo " คำถามที่ $num_op  <input type=\"text\" name=\"question$num_op\" size =\"50\" maxlength=\"50\"><br> \n";
              ...
              <tr> 
                <td><img alt="line" height="40" src="" width="1"></td>
                                        <td width="191" valign="top"><font face="geneva,veranda,arial" size="1"><br>
                                             <a href="health.php"><font face="geneva,veranda,arial" size="1"><font size="2" face="MS Sans Serif, Microsoft Sans Serif"><a href="../../../reader.php">read 
