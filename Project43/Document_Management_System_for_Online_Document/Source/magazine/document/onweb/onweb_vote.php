...
?>
          ...
          <td align="left" vAlign="top" width="699" height="630"><!-- #BeginEditable "form" --> 
                              <table width="350" cellspacing="0" cellpadding="0" height="377">
                                   ...
                                   <tr> 
                                        ...
                                        <td colspan="2" align="left" valign="top" bgcolor="#FFFFFF" height="496"> 
                                             ...
                                             <form method="post" action="onweb_choice.php">
				...
				// begin vote
					echo "<tr> \n"; 
					echo "<td><font color=\"#FF3333\" size=\"2\" face=\"MS Sans Serif, Microsoft Sans Serif\">คำถามสำหรับการลงคะแนนเสียง ";
                                        echo "</font> </td> \n ";
                                        echo "</tr> \n";
				   for ( $num_vote = 1 ;$num_vote <= $num_poll; $num_vote++) { 

                                                       echo "<tr> \n";
                                                            echo "<td height=\"62\"> <font color=\"#0000CC\" size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\">คำถามที่ $num_vote<br></font><font size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\"> \n"; 
                                                                 echo "<input type=\"text\" name=\"poll$num_vote\" size=\"40\"> \n";
                                                                 echo "</font></td> \n";
                                                       echo "</tr> \n";

						       echo "<tr> \n"; 
                                                            echo "<td height=\"33\"> \n"; 
                                                                 echo "<p><font color=\"#0000CE\" size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\">จำนวนตัวเลือกที่ต้องการ</font> \n";
                                                                      echo "<input type=\"text\" name=\"num_choice$num_vote\" size=\"5\"> \n";
                                                                      echo "<font size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\"></font> \n"; 
                                                                      echo "<font size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\"> \n"; 
                                                                      echo "</font> \n"; 
                                                                 echo "</p> \n";
                                                                 echo "</td> \n";
                                                        echo "</tr> \n";
...
type="block"> </td>
              ...
              <tr> 
                ...
                <td width="191" valign="top"><font face="geneva,veranda,arial" size="1"><br>
                                             ...
                                             </font></font><font face="geneva,veranda,arial" size="1"></font><font face="geneva,veranda,arial" size="1"></font><font size="2"><br>
                                             </font><br>
                                             </font></td>
              </tr>
              <tr> 
