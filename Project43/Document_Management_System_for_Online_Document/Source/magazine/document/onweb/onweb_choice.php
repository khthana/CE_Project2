                              ...
                              <table width="350" cellspacing="0" cellpadding="0" height="377">
                                   ...
                                   <tr> 
                                        ...
                                        <td colspan="2" align="left" valign="top" bgcolor="#FFFFFF" height="496"> 
                                              <form method="post" action="onweb_question.php">
...
for ($line = 1; $line <=$num_poll; $line++){
        $poll = "poll".$line;
	$poll_question = ${$poll};
	echo "<tr> \n";
	echo " <td colspan=\"2\" align=\"left\"> \n";
	echo "<br><font color=\"#0000FF\" size=\"1\" face=\"MS Sans Serif, Microsoft Sans Serif\">$poll_question </font><br>\n";
	echo "  </td> \n";
	echo "</tr> \n";
	$choice = "num_choice".$line;
	$choice_vote = ${$choice};
	echo "		<input type=\"hidden\" name=\"num_choice$line\" value=\"$choice_vote\"> \n";
...
//	}
	...
	echo "		<input type=\"hidden\" name=\"poll_id$line\" value=\"$poll_id\"> \n";
	echo " <ul> \n";
	for ($num_choice = 1; $num_choice <= $choice_vote; $num_choice++)
	{
		echo "<tr> \n";
		echo " <td colspan=\"2\" align=\"left\"> \n";
		echo "      <li><input type=\"text\" name=\"choice$line$num_choice\" size =\"30\" maxlength=\"50\"></li><br> \n";
		echo " </td> \n";
		echo "</tr> \n";
              ...
              <tr> 
                <td><img alt="line" height="40" src="" width="1"></td>
                                        <td width="191" valign="top"><br>
                                             ...
                                             <font face="MS Sans Serif, Microsoft Sans Serif"><a href="../../calendar/member/edit_profile.html">member</a></font></font></font><font size="2"><br>
