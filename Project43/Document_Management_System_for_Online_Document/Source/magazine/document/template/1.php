...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="86" align="left">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr> 
          <td valign="top" width="1%" rowspan="2"><img src="../../image/my/3/bg2_6.jpg" width="15" height="57"></td>
          <td valign="top" rowspan="2" width="17%"><img src="../../image/my/3/bg3_6.jpg" width="100%" height="57"></td>
          <td valign="top" rowspan="2" colspan="2" background="../../image/my/3/bg9_6.jpg"><img src="../../image/my/3/bg1_6.jpg" width="50" height="57"></td>
          <td height="2" valign="top" colspan="2"><img src="../../image/my/lhome_bg_6.jpg" width="100%" height="20"></td>
        </tr>
        <tr> 
                ...
                <td align="right"> 
                  ...
                  bgcolor=#dcedf5 border=0>
                      ...
                      <tr> 
                        ...
                        width=3 border=0 align=middle> <a href="../../search/search_tips.html"><img 
                        height=10 
        ...
        <tr> 
          <td valign="top" width="1%"><img src="../../image/my/3/bg4_6.jpg" width="15" height="20"></td>
          ...
          <td valign="top" colspan="2"><img src="../../image/my/3/bg5_6.jpg" width="50" height="20"></td>
          <td valign="middle" width="4%" align="right">&nbsp;</td>
        </tr>
        <tr> 
          <td valign="top" width="1%" height="7" background="../../image/my/3/bg4_6.jpg"><img src="../../image/my/3/bg4_6.jpg" width="15" height="20"></td>
          <td valign="top" height="7" width="17%" bgcolor="#D9D9D9"> 
...
?>
          ...
          <td valign="top" height="7" width="1%" background="../../image/my/3/bg7_6.jpg"><img src="../../image/my/3/bg7_6.jpg" width="15" height="20"></td>
...
?>
        ...
        <tr> 
          <td valign="top" height="5" width="1%"><img src="../../image/my/3/bg11_6.jpg" width="15" height="22"></td>
          <td valign="top" height="5" width="17%"><img src="../../image/my/3/bg12_6.jpg" width="100%" height="22"></td>
          <td valign="top" height="5" width="1%"><img src="../../image/my/3/bg10_6.jpg" width="15" height="22"></td>
