...
public class ai extends HttpServlet
{
	...
	{	
		...
		try
		{
			...
			rs = stmt.executeQuery("SELECT title,abstract,url,cate FROM tt_describe where cate ='ai'");
			...
			out.println("<div align=\"center\"><img src=\"http://161.246.5.184/ai.gif\" width=\"568\" height=\"73\">");
			out.println("<hr> ");
