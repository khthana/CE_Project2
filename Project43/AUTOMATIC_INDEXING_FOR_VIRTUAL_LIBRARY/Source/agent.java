...
public class agent extends HttpServlet
{
	...
	{	
		...
		try
		{
			...
			rs = stmt.executeQuery("SELECT title,abstract,url,cate FROM tt_describe where cate ='agent'");
			...
			out.println("<div align=\"center\"><img src=\"http://161.246.5.184/agent.gif\" width=\"289\" height=\"70\">");
			out.println("<br><hr> ");			
			//out.println ("<BR><font face=\"Courier New, Courier, mono\" color=\"#ffffFF\" size=\"+2\"><b>Categeory : AGENT </b></font></td><br>");
