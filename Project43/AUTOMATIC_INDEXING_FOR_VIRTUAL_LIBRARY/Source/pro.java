...
public class pro extends HttpServlet
{
	...
	{	
		...
		try
		{
			...
			rs = stmt.executeQuery("SELECT title,abstract,url,cate FROM tt_describe where cate ='programming'");
			...
			out.println("<div align=\"center\"><img src=\"http://161.246.5.184/programming.gif\" width=\"564\" height=\"94\">");
			out.println("<hr> ");
