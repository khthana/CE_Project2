...
import java.sql.*;
public class ViewAGwap2 extends HttpServlet
 {   String DefaultURL="http://161.246.5.233:8080/planny";
      ...
      protected void doGet(HttpServletRequest req , HttpServletResponse res) throws ServletException, IOException
       {     HttpSession session = req.getSession(true);
             ...
             session.putValue("login.choicegr",No);
            ...
            PrintWriter out = res.getWriter(); 
             out.println("<!DOCTYPE wml PUBLIC \"-//WAPFORUM//DTD WML 1.1//EN\" \"http://www.wapforum.org/DTD/wml_1_1.xml\">");
               ...
               out.println("<do type =\"accept\" label=\"Choose\">");
               out.println("<go href=\"http://161.246.5.233:8080/planny/servlet/DeleteGrwap2\" method=\"post\">");
