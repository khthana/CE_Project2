...
{    String DefaultURL = "http://161.246.5.233:8080/planny";
 ...
 {          HttpSession session = req.getSession(true);
            String  UserID = session.getValue("login.username").toString();	
             ...
             String Memname      = req.getParameter("AddMName");
             String Status      = req.getParameter("AddMStatus");
             String MemID      = req.getParameter("AddMID");
             String Note      = req.getParameter("AddMNote");
             String Namegr      = req.getParameter("AddMGroup");
             String Typegr = req.getParameter("AddMType");
