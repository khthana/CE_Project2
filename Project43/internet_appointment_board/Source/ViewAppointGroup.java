...
import java.sql.*;
public class ViewAppointGroup extends HttpServlet
 {   String DefaultURL="http://161.246.5.233:8080/planny";
      ...
      protected void doGet(HttpServletRequest req , HttpServletResponse res) throws ServletException, IOException
       {     HttpSession session = req.getSession(true);
            ...
            out.println("<FORM action=\""+DefaultURL+"/servlet/DeleteEventGroup\"  method=post>"); 
             ...
             out.println("<td valign=bottom width=\"28%\"><b><font size=2>From</font></b></td><td width=\"73%\">");
             ...
             out.println("<tbody> <tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"28%\"><b><font size=2>Title</font></b></td><td valign=bottom width=\"73%\">"); 
             out.println("<input name=GATitle size=30 value=\""+theResult.getString(2)+"\"></td></tr><tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"28%\"><b><font size=2>Place</font></b></td>");
             out.println("<td width=\"73%\"><input name=GAPlace size=30 value=\""+theResult.getString(4)+"\"></td></tr><tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"28%\"><b><font  size=2>Type</font>");
             out.println("</b></td><td valign=bottom width=\"73%\"><select name=GAType size=1>");
           ...
           out.println(">Wedding</option>");    
             out.println("</select></td></tr><tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"28%\"><font size=2><b>Start Date & Time</b>");
             out.println("</font></td><td valign=bottom width=\"73%\"><select name=GADay>");
            for (int i=1;i<=31;i++)  
             ...
             out.println("<tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"28%\"><font size=2><b>Final Date & Time</b>");
             out.println("</font></td><td valign=bottom width=\"73%\"><select name=GAFDay>");
            for (int i=1;i<=31;i++)  
                  {          out.print("<option value=\"");
          	         if ( i<10 )      out.print("0");
          	         out.print(i+"\"");
             ...
             out.println("</select></td></tr>");
             out.println("<tr><td width=\"5%\">&nbsp;</td><td valign=top width=\"28%\"><font size=2><b>Note</b></font></td>");
             out.println("<td width=\"73%\"><textarea cols=30 name=GANote>"+theResult.getString(5)+"</textarea></td></tr><tr><td height=35 width=\"5%\">");
