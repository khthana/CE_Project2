...
import java.sql.*;
public class ViewAppointGroup2 extends HttpServlet
 {   String DefaultURL="http://161.246.5.233:8080/planny";
      ...
      protected void doGet(HttpServletRequest req , HttpServletResponse res) throws ServletException, IOException
       {     HttpSession session = req.getSession(true);
            ...
            out.println("<FORM action=\""+DefaultURL+"/servlet/DeleteEventGroup2\"  method=post>"); 
             out.println("<table border=0 width=\"100%\"><tr><td height=25 width=65>&nbsp;</td><td height=25 width=165>&nbsp;</td><td height=25 width=155>&nbsp;</td>");
             ...
             out.println("<td valign=bottom width=\"27%\"><b><font size=2>From</font></b></td><td width=\"67%\">");
             ...
             out.println("<tbody> <tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"27%\"><b><font size=2>Title</font></b></td><td valign=bottom width=\"67%\">"); 
             out.println("<input name=GATitle size=30 value=\""+theResult.getString(2)+"\"></td></tr><tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"27%\"><b><font size=2>Place</font></b></td>");
             out.println("<td width=\"67%\"><input name=GAPlace size=30 value=\""+theResult.getString(4)+"\"></td></tr><tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"27%\"><b><font  size=2>Type</font>");
             out.println("</b></td><td valign=bottom width=\"67%\"><select name=GAType size=1>");
           ...
           out.println(">Wedding</option>");    
             out.println("</select></td></tr><tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"27%\"><font size=2><b>Start Date & Time</b>");
             out.println("</font></td><td valign=bottom width=\"67%\"><select name=GADay>");
            for (int i=1;i<=31;i++)  
             ...
             out.println("<tr><td width=\"5%\">&nbsp;</td><td valign=bottom width=\"27%\"><font size=2><b>Final Date & Time</b>");
             out.println("</font></td><td valign=bottom width=\"67%\"><select name=GAFDay>");
            for (int i=1;i<=31;i++)  
                  {          out.print("<option value=\"");
          	         if ( i<10 )      out.print("0");
          	         out.print(i+"\"");
             ...
             out.println("<tr><td width=\"5%\">&nbsp;</td><td valign=top width=\"27%\"><font size=2><b>Note</b></font></td>");
             out.println("<td width=\"67%\"><textarea cols=30 name=GANote>"+theResult.getString(5)+"</textarea></td></tr><tr><td height=35 width=\"5%\">");
             out.println("<input type=\"hidden\" name=\"HiddenNo\" value=\""+no+"\">&nbsp;</td>");
             out.println("<td align=center colspan=2 height=35 valign=bottom>");
             ...
             out.println("</tr></tbody></table></TD></TR></TBODY></TABLE></BODY></HTML>");
               }//while
