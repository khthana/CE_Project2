                 ...
                 try{   Statement  theStatement=theConnection.createStatement();      
                            ...
                            while (theResult.next())
                                {  nomem = theResult.getInt(2);
                                   ...
                                   if  ((theResult.getString(1).equals(" "+UserID)) &&( ( EventCalendar.after(CurCalendar))  ||   (EventCalendar.equals(CurCalendar)) ))  
                                      {   out.println("<tr bgcolor=#99CCFF><td align=center height=23><font size=\"3\">"+Num+".</font> </td><td align=middle height=23>");
                  ...
                  try {    Statement  theStatement=theConnection.createStatement();      
                          ResultSet theResult = theStatement.executeQuery(    
                                            ...
                                            while (theResult.next()) 
                                           {out.println("<TD align=middle height=23 width=\"16%\"><font size=\"2\"><b>"+theResult.getString(2)+"</b></font></TD>");
                                            out.println("<TD align=middle height=23 width=\"14%\"><font size=\"2\"><b>"+theResult.getString(3)+"</b></font></TD>");
                 ...
                 //out.println(no_count);     
                  ...
                  theStatement.close();
                   ...
                   Calendar EventCalendar = new GregorianCalendar(DBYear,DBMonth,DBDate);  
                    try{   Statement  theStatement=theConnection.createStatement();      
                          ResultSet theResult = theStatement.executeQuery(    
                         "select  id,no_mem  from groupcal  where no_group="+no_groupView );
                            while (theResult.next())
                                { nomem = theResult.getInt(2);
                                   MemID2 = theResult.getString(1);
                                   if ((!(theResult.getString(1).equals(" "+UserID))) &&( ( EventCalendar.after(CurCalendar))  ||   (EventCalendar.equals(CurCalendar)) )  )
	   ...
	   if (from != null) 
           ...
           from="";
            ...
            MemID2 = "";
             ...
             Num=1;
             out.println("</tbody></table><table bgcolor=#ffffff border=0 height=29 width=\"100%\"><tr><td align=middle height=26 colspan=\"5\">&nbsp;</td></tr>");
             out.println("<tr bgcolor=#FFFFCC valign=\"middle\" align=\"center\"><td height=26 colspan=\"5\"><font size=\"2\"><b>Send Appointment</b></font></td>");
             out.println("</tr> <tbody><tr><td align=middle height=26 width=\"3%\" bgcolor=\"#d0d0d0\"><b><font  size=2>No.</font></b></td>");
             out.println("<td align=middle height=26 width=\"16%\" bgcolor=\"#d0d0d0\"><b><font size=2>Title</font></b></td>");
             out.println("<TD align=center height=25 width=\"16%\" bgcolor=\"#d0d0d0\"><b><font size=\"2\">Group</font></b></TD>");
             out.println("<TD align=center height=25 width=\"14%\" bgcolor=\"#d0d0d0\"><B><font size=\"2\">Type</font></B></TD>");
             out.println("<td align=middle height=26 width=\"14%\" bgcolor=\"#d0d0d0\">");
          ...
          MemID2 = "";
                  ...
                  theStatement.close();
                    ...
                    if  (MemID2.equals(" "+UserID))           {          
                     try{   Statement  theStatement=theConnection.createStatement();      
                          ResultSet theResult = theStatement.executeQuery(    
                          "select membername,groupname,grouptype  from member where no_mem= "+Mname);                       
