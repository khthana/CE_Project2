...
Begin VB.Form frmEditSd 
   ...
   Begin TabDlg.SSTab sstabSd 
      ...
      TabPicture(0)   =   "frmEditSd.frx":0000
...
Private Sub LoadlvSd()
   ...
   lvSdNameE.ColumnHeaders.Add , , "ชื่อ", 1300, lvwColumnLeft
   ...
   lvSdSurname.ColumnHeaders.Add , , "นามสกุล", 1300, lvwColumnLeft
...
Private Sub cmdSdIdAdd_Click()
    ...
    If txtSdIdFromDate = "" Then
        MsgBox "โปรดใส่ช่วงเวลาให้ครบ", vbInformation
        txtSdIdFromDate.SetFocus
        Exit Sub
    End If
    
    If txtSdIdToDate = "" Then
        MsgBox "โปรดใส่ช่วงเวลาให้ครบ", vbInformation
        txtSdIdToDate.SetFocus
        Exit Sub
    End If
    
    Set Std = cache.Static("Student")
    id = Student.sys_Id
    dup = Std.FindSdIdPeriod(txtSdId.text, txtSdIdFromDate.text, txtSdIdToDate.text)
    If (dup = 0) Or (dup = id) Then
      ...
      LoadlvSdId
    Else
    MsgBox "รหัสนักศึกษา " + txtSdId.text + " เกิดคความซ้ำซ้อนในช่วงเวลาเดียวกัน"
    End If
End Sub
...
Private Sub cmdAddSdName_Click()
    ...
    If txtSdName = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdName.SetFocus
        Exit Sub
    End If
    If txtSdNameF = "" Then
...
Private Sub cmdAddSdSurname_Click()
    Dim message As String
        If txtSdSurname = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdSurname.SetFocus
        Exit Sub
    End If
    If txtSdSurnameF = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdSurnameF.SetFocus
        Exit Sub
    End If
    If txtSdSurnameT = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdSurnameT.SetFocus
        Exit Sub
    End If
...
Private Sub cmdAddSdNameE_Click()
    ...
    If txtSdNameEF = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdNameEF.SetFocus
        Exit Sub
    End If
    If txtSdNameET = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdNameET.SetFocus
        Exit Sub
    End If
...
Private Sub cmdAddSdSurNameE_Click()
    Dim message As String
      If txtSdSurNameE = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdSurNameE.SetFocus
        Exit Sub
    End If
    If txtSdSurNameEF = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdSurNameEF.SetFocus
        Exit Sub
    End If
    If txtSdSurNameET = "" Then
        MsgBox "โปรดใส่ข้อมูลให้ครบ", vbInformation
        txtSdSurNameET.SetFocus
        Exit Sub
    End If
