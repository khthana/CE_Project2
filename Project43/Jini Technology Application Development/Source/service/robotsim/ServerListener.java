...
public class ServerListener implements DiscoveryListener, Runnable {
	...
	private DisplayFrame displayBoard; // The Display of RobotSim

    public ServerListener(LookupDiscovery ld, Object object,DisplayFrame board) {
        item = new ServiceItem(null, object, null);
        this.ld = ld;
		this.displayBoard = board;
        // Start the new thread to renew the leases
		System.out.println("Start Looking for Lookup Service.");
    ...
    public synchronized void discovered(DiscoveryEvent dev) {
		...
		System.out.println("Found "+lookup.length+" new Lookup Service(s)");
