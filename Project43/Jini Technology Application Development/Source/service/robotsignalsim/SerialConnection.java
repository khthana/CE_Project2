...
//    private KeyHandler keyHandler;
    ...
    */
    public SerialConnection(ControlPanel parent,
...
//		this.messageAreaOut = messageAreaOut;
   ...
   public void setDisplay(TextArea messageAreaIn){
	 this.messageAreaIn = messageAreaIn;
   }
   ...
   */
   public void openConnection() throws SerialConnectionException {
	...
	// wants to.
	try {
	    sPort = (SerialPort)portId.open("CommTerminal", 10000);
    ...
    public void serialEvent(SerialPortEvent e) {
		...
		switch (e.getEventType()) {
			...
			case SerialPortEvent.DATA_AVAILABLE:
				...
				parent.receive(inputBuffer.charAt(0));
				break;
