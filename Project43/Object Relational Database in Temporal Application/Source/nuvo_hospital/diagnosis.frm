...
Begin VB.Form diagnosis 
   Caption         =   "DIAGNOSIS RESULTS"
   ClientHeight    =   9600
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "diagnosis.frx":0000
   LinkTopic       =   "Form3"
   Picture         =   "diagnosis.frx":030A
   ScaleHeight     =   9600
   ScaleWidth      =   11880
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   882
      TabCaption(0)   =   "Query"
      TabPicture(0)   =   "diagnosis.frx":17667C
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame2"
      Tab(0).Control(1)=   "cmd_exit(0)"
      Tab(0).ControlCount=   2
      TabCaption(1)   =   "New Record"
      TabPicture(1)   =   "diagnosis.frx":176996
      ...
      TabPicture(2)   =   "diagnosis.frx":176CB0
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Frame5"
      Tab(2).Control(1)=   "cmd_exit(2)"
      Tab(2).ControlCount=   2
      TabCaption(3)   =   "X-RAY RESULT"
      TabPicture(3)   =   "diagnosis.frx":176FCA
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Frame14"
      Tab(3).Control(1)=   "cmd_exit(3)"
      Tab(3).ControlCount=   2
      TabCaption(4)   =   "MEDICAL RESULT"
      TabPicture(4)   =   "diagnosis.frx":1772E4
