				 ...
				 if($key_resultarry['Key_name']=="PRIMARY")

				  {
...

						{
							...
							if ($key_resultarry['Column_name']!=$primary_key[$l])

							{

								$oldprimary[$oldpri]=$key_resultarry['Column_name'];
  ...
  <tr>
    ...
    <td bgcolor="#FFFFCC" valign="top" align="center">
      ...
      <p><a href="db_detail.php"><font color="#3333FF" face="MS Sans Serif, Microsoft Sans Serif" size="4"><b>Helpdesk 
        ...
        Insert Field intoTable <?echo $table?></b></font></p>

		

      <form method="post" action="tbl_addfield.php" name="create_tbl">
