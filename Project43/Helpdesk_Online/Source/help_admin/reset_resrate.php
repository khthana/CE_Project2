...
if($Yes)
{
	$sql = "update EXPERTIN set ResRate = 0 , NumRate = 0";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tr>
    ...
    <td bgcolor="#FFFFCC" valign="top" align="center"> 
      ...
      <form method="post" action="reset_resrate.php">
        <p><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#3333FF"><b>คุณต้องการ 
          Reset Response Rate และ จำนวนครั้งในการให้คะแนน ให้เป็น 0</b></font></p>
        <p> 
