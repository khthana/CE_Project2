...
include('dbconnect.inc');
...

	{
		...
		if ($asker != "Anonymous")
		{
			...
			$mmesg = $loginname." has answered your question about ";
...
?>
                  ...
                  <form method="post" action="ansquestion.php" name="changeq">
                    ...
                    <div align="center"> 
                      ...
                      <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr> 
                          ...
                          <td width="18%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#CC3300">คำตอบ 
