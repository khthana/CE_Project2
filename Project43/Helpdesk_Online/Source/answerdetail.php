...
<title>&quot;รายละเอียดของคำตอบ&quot;</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="80">
  ...
  <tr>
    ...
    <td width="30%" bgcolor="#FFFFFF" height="84"><img src="image/logo3.gif" width="231" height="77"></td>
...
<?		$sql1 = "select distinct Subject,Question,Askdate,LoginName from QUESTIONS,ASK where CatID = '$CatID' and QUESTIONS.QuestionID = $QuestionID and QUESTIONS.QuestionID = ASK.QuestionID";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="344">
              ...
              <tr> 
                ...
                <td colspan="2" bgcolor="#FFFFCC" rowspan="2"> 
                  ...
                  <table width="100%" border="1" height="86" cellspacing="2" cellpadding="0" bordercolor="#000000">
                    <tr bgcolor="#333399"> 
                      <td height="27"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#FFFFFF">หัวข้อ 
                        : <?echo htmlspecialchars($result1arr[0])?></font></b></td>
...
?>
                  ...
                  <table width="100%" border="1" cellspacing="2" cellpadding="0" bordercolor="#000000">
					...
					$sql3 = "select * from ANS where QuestionID = '$QuestionID' and LoginName = '$LoginName' order by AnswerDate";

					$result3 = mysql_db_query($dbname,$sql3);

					$result3arr = mysql_fetch_array($result3);

?> 

                    <tr bgcolor="#003399"> 

                      <td height="30"><font face="MS Sans Serif, Microsoft Sans Serif" size="1"><b><font color="#FFFFFF"><?echo $result3arr[0]?> 

                        ตอบไว้เมื่อ <?echo $result3arr[3]?></font> </b></font></td>

                    </tr>

                    <tr bgcolor="#99CCCC"> 
                      <td height="80"> 
                        <table width="6400%" border="0" cellspacing="1" cellpadding="0" height="8">
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="0">
                          ...
                          <tr> 
                            ...
                            <td> 
                              ...
                              <p><font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#000000"><?echo htmlspecialchars($result3arr[2])?></font></p>
                        ...
                        <form method="post" action="rate.php" name="rating">
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr> 
                              ...
                              <td width="40%"><font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#FFFFFF">ให้คะแนนแก่ผู้เชี่ยวชาญสำหรับคำตอบนี้ 
                              ...
                              <td width="34%"> 
                                ...
                                <input type="hidden" name="expert" value="<?echo $LoginName?>">

                                <input type="hidden" name="target" value="questionboard.php?CatName=<? echo $CatName ?>&CatID=<? echo $CatID ?>">
              ...
              <tr> 
                ...
                <td width="44%" bgcolor="#FFFFCC" height="27">&nbsp;</td>
