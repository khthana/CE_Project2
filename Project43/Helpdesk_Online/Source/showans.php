<?
	...
	$sql = 'select QuestionID,ExpertName  from ASK where LoginName = "'.$loginname.'" and AnsStatus="Y" and QuestionID='.$QID;
              ...
              <tr valign="middle" align="center"> 
                ...
                <td> 
                  ...
                  <div align="center"> <? if ($num_new==0)
                    ...
                    <p align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><b>&quot;ยังไม่มีคำตอบส่งถึงคุณ&quot;</b></font></p>
                    ...
                    <? }else
...

						{
							...
							$totalpage = round($num_new/10)+$plus;
							...
							$sql = 'select QUESTIONS.QuestionID,Subject,ExpertName,AskDate,EditStatus  from ASK ,QUESTIONS where LoginName = "'.$loginname.'" and QUESTIONS.QuestionID = ASK.QuestionID and AnsStatus="Y" and ASK.QuestionID='.$QID.' order by AskDate desc limit '.$goto.',10';
                    ...
                    <p align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><b>มีคำตอบถึงคุณ 
				...
				?> 
					  ...
					  <?
...

								{
			                        ...
			                        echo '<td width="50%">&nbsp;&nbsp;<a href="addinf.php?QID='.$askarry["QuestionID"].'&EName='.$askarry["ExpertName"].'"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"  color="#333399" >'.$askarry["Subject"]."</font></a>";
                        ...
                        <td width="50%">&nbsp;&nbsp;<a href="viewans.php?QID=<?echo $askarry["QuestionID"];?>&EName=<?echo $askarry["ExpertName"];?>"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"  color="#333399" ><? echo $askarry["Subject"]; ?></font></a></td>
				...
				?> 
                    ...
                    <form method="post" action="showans.php">
                        ...
                        <tr> 
                          ...
                          <td width="50%"> 
                            ...
                            <div align="left"> <font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399">หน้าที่ 
                              ...
                              <? echo $page;?> / <?echo $totalpage;?></font> </div>
