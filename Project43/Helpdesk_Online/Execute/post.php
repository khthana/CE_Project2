	...
	{	
		...
		{	
			...
			if($Flag03 != "F3")
			{
				...
				$sql3	= "select LoginName from EXPERTIN where CatID = '$CatID'";
...
?>
				 ...
				 <font size="2" face="MS Sans Serif, Microsoft Sans Serif"><b><font color="#CC3300">กรุณาใส่ชื่อหัวข้อด้วย</font></b></font><br>
...
?> 				  
              ...
              <tr> 
				...
				?>
                  ...
                  <form method="post" action="post.php?CatID=$CatID&CatName=$CatName" name="Questionpost">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        ...
                        <td colspan="2" height="189"> 
                          ...
                          <textarea name="Question" rows="10" cols="45"><?echo $Question;?></textarea>
