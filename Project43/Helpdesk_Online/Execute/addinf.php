...
include('dbconnect.inc');
...

	{
			...
			if($Flag03 != "F3")
			{
				...
				$sql = "update ASK set AnsStatus='N' , ViewStatus='N' , EditStatus='A'  where QuestionID = '$QID' and ExpertName = '$EName' and LoginName = '$loginname'";

				$result = mysql_db_query($dbname,$sql);

				echo mysql_error();

				$sql = "select Email from MEMBER where LoginName = '$EName'";
				...
				$msub = "Get an added information question.";
				...
				$mmesg = $loginname." has added information of question about ";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="80">
  ...
  <tr>
    ...
    <td width="30%" bgcolor="#FFFFFF" height="85"><img src="image/logo3.gif" width="231" height="77"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            src="image/tbl.gif" width=4></td>
                ...
                <th class=tbTD noWrap bgcolor="#FFFFCC" width="15%"><font color="#FFFFFF" size="1" face="MS Sans Serif, Microsoft Sans Serif"><b><font color="#9999CC">ดูประวัติการถาม</font></b></font></th>
...
?>
                    ...
                    <form method="post" action="addinf.php">
                      ...
                      <table width="90%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr> 
                          ...
                          <td width="36%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#6666FF">Answ<?echo $showarry["LoginName"];?>er 
                        ...
                        <tr> 
                          ...
                          <td rowspan="2"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"></font><font face="MS Sans Serif, Microsoft Sans Serif" size="2">&nbsp; 
                    		<? if ($Flag03 == "F3")
								{   
							?>     
					                <textarea name="Question" cols="40" rows="10"><?echo $Question;?></textarea>
							<?
								}else
								{							
							?>
		                            <textarea name="Question" cols="40" rows="10"><?echo $showarry["Question"];?></textarea>
							<?
								}
							?>
</font></td>
                        ...
                        <tr> 
                          ...
                          <td height="27" width="64%"> 
                            ...
                            <input type="hidden" name="EName" value="<? echo $EName;?>">
              ...
              <tr> 
                ...
                <td> 
                  ...
                  <div align="center"><font color="#9999FF"><a href="new.php"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#6666FF">คลิ๊กที่นี่เพื่อกลับไปดูคำถามใหม่</font></a></font></div>
