...
include('dbconnect.inc');
	...
	$sql = 'select QuestionID ,AnsStatus from ASK where ExpertName = "'.$loginname.'"';
...
<title>See Your History Questions</title>
              ...
              <tr valign="middle" align="center"> 
                ...
                <td> 
                  ...
                  <div align="center"> <? if ($num_a==0)
                    ...
                    <p align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><b>&quot;ยังไม่มีคำถามส่งถึงคุณ&quot;</b></font></p>
                    ...
                    <? }else
...

						{
							...
							$sql = "select distinct QUESTIONS.QuestionID,Subject,AskDate,AnsStatus,EditStatus from QUESTIONS,ASK where QUESTIONS.QuestionID=ASK.QuestionID and ExpertName = '$loginname' order by AskDate desc limit $goto,10";



							$aresult = mysql_db_query($dbname,$sql);
                    ...
                    <table width="90%" border="1" cellspacing="0" cellpadding="0" bordercolor="#333399">
                      ...
                      <tr> 
                        ...
                        <td align="center" height="27" bgcolor="#333399" width="20%" valign="middle"> 
                          ...
                          <div align="center"><font color="#FFFFFF" face="MS Sans Serif, Microsoft Sans Serif" size="2"><b>สถานะการตอบ</b></font></div>
                      ...
                      <?	while ($aarry=mysql_fetch_array($aresult))
				...
				?> 
                      ...
                      <tr> 
                        ...
                        <td width="50%">&nbsp;&nbsp;<a href="viewask.php?QID=<?echo $aarry["QuestionID"];?>"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><? echo $aarry["Subject"]; ?></font></a>

                      <?

                        		if ($aarry['EditStatus'] == 'A')
                        ...
                        <td align="center" valign="middle" width="20%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><? echo $aarry["AnsStatus"];?></font></td>



                        <td align="center" valign="middle" width="20%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><? echo $aarry["AskDate"]; ?></font></td>
				...
				?> 
                    ...
                    <form method="post" action="historya.php">
