...
include('dbconnect.inc');
	...
	$sql = 'select distinct QuestionID from ASK where LoginName = "'.$loginname.'"';
...
<title>See Your History of Asks</title>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFCC">
              ...
              <tr valign="middle" align="center"> 
                ...
                <td> 
                  ...
                  <div align="center"> <? if ($num_q==0)

						{

					?> 

                    <p align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><b>&quot;คุณยังไม่เคยถามคำถาม&quot;  </b></font></p>
                  ...
                  <? }else
...

						{
							...
							$sql = "select distinct QUESTIONS.QuestionID,Subject,AskDate from QUESTIONS,ASK where QUESTIONS.QuestionID=ASK.QuestionID and ASK.LoginName = '$loginname' order by AskDate desc limit $goto,10";

							$qresult = mysql_db_query($dbname,$sql);
                    ...
                    <table width="90%" border="1" cellspacing="0" cellpadding="0" bordercolor="#333399">
                      ...
                      <tr> 
                        ...
                        <td align="center" height="27" bgcolor="#333399" width="20%" valign="middle"> 
                          ...
                          <div align="center"><font color="#FFFFFF" face="MS Sans Serif, Microsoft Sans Serif" size="2"><b>จำนวนคำตอบ</b></font></div>
                      ...
                      <?	while ($qarry=mysql_fetch_array($qresult))

						{

							$sql = 'select QuestionID from ASK where LoginName = "'.$loginname.'" and AnsStatus = "Y" and QuestionID= '.$qarry["QuestionID"];

							$result = mysql_db_query($dbname,$sql);

							$num_a = mysql_num_rows($result);

							$sql = 'select QuestionID from ASK where LoginName = "'.$loginname.'" and QuestionID= '.$qarry["QuestionID"];
				...
				?> 
                      ...
                      <tr> 
                        ...
                        <td width="50%">&nbsp;&nbsp;<a href="showans.php?QID=<?echo $qarry["QuestionID"];?>"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><? echo $qarry["Subject"]; ?></font></a></td>

                        <td align="center" valign="middle" width="20%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><? echo $num_a;?> 

                          / <? echo $num_q;?></font></td>

                        <td align="center" valign="middle" width="20%"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#333399"><? echo $qarry["AskDate"]; ?></font></td>
