...
<?
	...
	$sql1 = "select  distinct QUESTIONS.QuestionID,Subject,Question,AskDate,LoginName from QUESTIONS,ASK where QUESTIONS.CatID = '$CatID' and QUESTIONS.QuestionID=ASK.QuestionID  order by QUESTIONS.QuestionID DESC";
...
<? if ($count1 == 0)
		...
		{ ?>
			   ...
			   <tr> 
                ...
                <td colspan="2" height="40"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b><font color="#CC3300">ยังไม่มีคำถามในประเภทนี้</font></b></font></td>
		...
		{ ?>	
              ...
              <tr> 
                ...
                <td colspan="2" height="40"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b><font color="#CC3300">Question 
                  Board ของคำถามประเภท </font><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b><font color="#CC3300"><?echo $CatName ?></font></b></font></b></font></td>
                ...
                <td colspan="2" bgcolor="#FFFFCC">
                  ...
                  <table width="100%"  border="0" cellpadding="1" cellspacing="2" height="95">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#003898" >
                            <tr bgcolor="#003399"> 
                              <td height="27" width="51%"> 
                                <div align="center"><font face="MS Sans Serif, Microsoft Sans Serif"><font face="MS Sans Serif, Microsoft Sans Serif"><font size="2"><font size="2"><font color="#FFFFFF"><b>หัวข้อ</b></font></font></font></font></font></div>
                            </td>
                            <td height="27" width="1%" bgcolor="#FFFFCC">&nbsp;</td>
                            <td height="27" width="28%"> 
                              <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#FFFFFF">ผู้ถาม</font></b></div>
                            </td>
                            <td height="27" width="1%" bgcolor="#FFFFCC">&nbsp;</td>
                            <td height="27" width="20%"> 
                              <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#FFFFFF">&nbsp;จำนวนคำตอบ&nbsp;</font></b></div>
                            </td>
                          </tr>
                        </table>
						</div>
					...
					<?
							...
							$sql1 = "select  distinct QUESTIONS.QuestionID,Subject,Question,AskDate,LoginName from QUESTIONS,ASK where QUESTIONS.CatID = '$CatID' and QUESTIONS.QuestionID=ASK.QuestionID  order by QUESTIONS.QuestionID DESC limit $goto,10 ";
						...
						{ 
							...
							$sql2 = "select count(*) from ASK where QuestionID = '$result1arr[0]' and AnsStatus = 'Y' ";
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#003498" bgcolor="#6699CC" height="88">
                          <tr bgcolor="#99CCCC"> 
                            ...
                            <td  height="29" width="28%"> 
                              <div align="center"> 
                                <font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#CC3300"><b><?echo $result1arr[4]?><br></b></font>
									<font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#000000">เมื่อ 
                            ...
                            <td width="21%" height="29"> 
                              <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#CC3300"><?echo $result2arr[0]?></font></b></div>
                          ...
                          <tr bgcolor="#99CCCC"> 
                            <td  colspan="3" height="55" width="51%"><font size="1"><font size="1"><font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#000000"><?echo htmlspecialchars($result1arr[2])?> 
                              ( <a href="questiondetail.php?CatName=<? echo $CatName; ?>&CatID=<? echo $CatID ?>&QuestionID=<? echo $result1arr[0] ?>"><font color="#CC3300">ดูคำตอบที่นี่</font></a> 
                              )</font></font></font></td>
                           </tr>
