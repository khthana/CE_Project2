...
<title>&quot; เกี่ยวกับ CE-Helpdesk &quot;</title>
          ...
          <td height="485" bgcolor="#FFFFFF" align="center" valign="top"> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="168">
              <tr> 
                ...
                <td width="35%" height="19"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b></b></font></td>
              ...
              <tr> 
                <td colspan="3" height="30"> 
                  <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#CC3300">ิยินดีต้อนรับสู่ 
                    CE - Helpdesk</font></b></div>
                </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td width="1%">&nbsp;</td>
                <td rowspan="9" bgcolor="#FFFFCC" width="35%"><img src="image/people.gif" width="214" height="211"></td>
                <td width="5%" bgcolor="#FFFFCC">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC"><font face="MS Sans Serif, Microsoft Sans Serif" size="1" color="#CC3300">CE 
                  - Helpdesk</font><font face="MS Sans Serif, Microsoft Sans Serif" size="1"> 
                  เป็นเว็บไซต์ที่ให้บริการตอบปัญหาต่าง ๆ</font></td>
                <td width="3%">&nbsp;</td>
              </tr>
              <tr> 
                <td width="1%" rowspan="7">&nbsp;</td>
                <td width="5%" bgcolor="#FFFFCC" height="26">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="26"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">่ทางด้านคอมพิวเตอร์ 
                  เราได้เปิดรับสมัครผู้เชี่ยวชาญ ซึ่งได้แก่</font></td>
                <td width="3%" rowspan="7">&nbsp;</td>
              </tr>
              <tr>
                <td width="5%" bgcolor="#FFFFCC" height="24">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="24"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">ผู้ใช้อินเทอร์เน็ตทั่ว 
                  ๆ ไป ที่คิดว่าตนเองมีความถนัด </font></td>
              </tr>
              <tr>
                <td width="5%" bgcolor="#FFFFCC" height="26">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="26"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">มีความเชี่ยวชาญในด้านนั้น 
                  ๆ ซึ่งผู้เชี่ยวชาญแต่ละคน จะได้รับ</font></td>
              </tr>
              <tr>
                <td width="5%" bgcolor="#FFFFCC" height="25">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="25"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">คะแนนจากการตอบคำถาม 
                  ซึ่งจะเป็นสิ่งชี้ถึงความสามารถของ </font></td>
              </tr>
              <tr>
                <td width="5%" bgcolor="#FFFFCC" height="23">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="23"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">ผู้เชี่ยวชาญแต่ละคนด้วย 
                  </font></td>
              </tr>
              <tr>
                <td width="5%" bgcolor="#FFFFCC" height="24">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="24"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">ทางผู้จัดทำหวังว่า 
                  ผู้ใช้งานทุกท่านจะได้รับคำตอบที่เป็น </font></td>
              </tr>
              <tr>
                <td width="5%" bgcolor="#FFFFCC" height="24">&nbsp;</td>
                <td width="56%" bgcolor="#FFFFCC" height="24"><font face="MS Sans Serif, Microsoft Sans Serif" size="1">ประโยชน์สูงสุดจากผู้เชี่ยวชาญของเรา..... 
                  </font></td>
              </tr>
              <tr> 
                <td width="1%">&nbsp;</td>
