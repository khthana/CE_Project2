...
<head>
<title>&quot; Welcome to CE-Helpdesk &quot;</title>
        ...
        <tr>
          ...
          <td height="485" bgcolor="#FFFFFF" align="left" valign="top"><img src="image/whitedot.jpg" width="1" height="1">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td width="6%" height="31">&nbsp;</td>
                <td width="86%" height="31" bgcolor="#FFFFCC">&nbsp;</td>
                <td width="8%" height="31">&nbsp;</td>
              </tr>
              <tr> 
                <td width="6%" height="31">&nbsp;</td>
                <td width="86%" height="31" bgcolor="#FFFFCC"> 
                  <div align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b>ยินดีต้อนรับคุณ 
                    <font color="#CC3300"><?echo $loginname ?></font> สู่ <font color="#CC3300">CE-Helpdesk</font></b></font></div>
                </td>
                <td width="8%" height="31">&nbsp;</td>
              </tr>
              <tr> 
                ...
                <td width="86%" bgcolor="#FFFFCC"> 
                  <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="2">ขอบคุณที่สมัครเป็นผู้เชี่ยวชาญกับเรา</font></b></div>
                </td>
                <td width="8%">&nbsp;</td>
              </tr>
              <tr>
                <td width="6%">&nbsp;</td>
                <td width="86%" bgcolor="#FFFFCC">&nbsp;</td>
                <td width="8%">&nbsp;</td>
              </tr>
            </table>
          </td>
