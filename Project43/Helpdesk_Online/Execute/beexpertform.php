...
if ($Submit)

	{
		...
		}else
		{
			...
			if ($bannum != 0)
			{
				...
				while ($banarry = mysql_fetch_array($banresult))
				{
					...
					if ($found1)
					{
						...
						{
							$place = "Login Name";
						}elseif($place=="ประวัติส่วนตัว")
						{
							$place = "Login Name และ ประวัติส่วนตัว";
						}
					}
			...
			if($Flag03 != "F3")
			{
				$sql=" insert into MEMBER  (LoginName,Password,FirstName,LastName,Email,Link,Detail,MemberStatus,SubDate) 
				...
				values ('$LoginName',password('$Password'),'$FirstName','$LastName','$Email','$Link','$detail','E','$subdate')";
			...
			mail($mto,$msub,$mmesg,$mheader);
				...
				header("Location: selectnewcat.php"); 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="476">
          ...
          <td height="485" bgcolor="#FFFFFF" align="left" valign="top"><img src="image/whitedot.jpg" width="1" height="1">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" height="484">
              ...
              <?
                ...
                <td width="7%">&nbsp;</td>
	             <td colspan="2"> 
                <div align="center"><font size="1"><b><font face="MS Sans Serif, Microsoft Sans Serif">สมัครสมาชิก</font></b></font></div>
                </td>
                <td width="7%">&nbsp;</td>
              </tr>
              <tr> 
               <td width="7%">&nbsp;</td>
                <td colspan="2">
                  <div align="center"><b><font size="1" face="MS Sans Serif, Microsoft Sans Serif">กรุณากรอกแบบฟอร์ม</font></b></div>
                </td>
                <td width="7%">&nbsp;</td>
              </tr>';
		} elseif ($flag01 == "T0") {
              ...
              <tr> 
                ...
                <td width="86%" height="450" bgcolor="#FFFFCC"> 
 ...
 <?
				if ($Flag03 == "F3")
				{
					$flag01 = "F"; 
			?>
                <div align="center"><font size="1" face="MS Sans Serif, Microsoft Sans Serif"><b><font color="#CC3300">พบคำหยาบใน <? echo $place;?>ของคุณ</font></b></font></div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" height="363">
                      ...
                      <tr> 
                        ...
                        <td width="48%" height="34"> 
                          ...
                          <div align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="1"><b>Password</b> 
                      ...
                      <tr> 
                        ...
                        <td width="48%" height="33"> 
                          ...
                          <div align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2"><b>ชื่อ</b></font></div>
                      ...
                      <tr> 
                        ...
                        <td width="48%" height="33"> 
                          ...
                          <div align="center"><font face="MS Sans Serif, Microsoft Sans Serif"><b><font size="2">นามสกุล</font></b></font></div>
                      ...
                      <tr> 
                        ...
                        <td width="48%" height="36"> 
                          <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="1">E-mail</font></b></div>
                      ...
                      <tr> 
                        ...
                        <td width="48%" height="39"> 
                          ...
                          <div align="center"> 
                            ...
                            <p><b><font face="MS Sans Serif, Microsoft Sans Serif" size="1">Picture</font></b></p>
                        ...
                        <td width="52%" height="39"> <b><font face="MS Sans Serif, Microsoft Sans Serif" size="1"> 
                          ...
                          รูปต้องเป็น file.gif ขนาด150x150 pixel</font></b> 
                      ...
                      <tr> 
                        ...
                        <td width="48%" height="37"> 
                          ...
                          <div align="center"><b><font face="MS Sans Serif, Microsoft Sans Serif" size="1">Link</font></b></div>
                      ...
                      <tr>
                        ...
                        <td width="48%" height="42">
                          ...
                          <div align="center"><font face="MS Sans Serif, Microsoft Sans Serif"><b><font size="2">ใส่ประวัติ 



                            หรือ แนะนำตัวเอง</font></b></font></div>
                        ...
                        <td width="52%" height="42">
                          ...
                          <textarea name="detail" cols="35" rows="10"><?echo $detail;?></textarea>
