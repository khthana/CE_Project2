...
public class ToUnicode {
  public String toUnicode(String txtInput) throws IOException {
	String BOOK_NAME="";
  int i=1,j=0;
    try {
	    BOOK_NAME=txtInput;
      BufferedReader reader2 = new BufferedReader(
        new InputStreamReader(new StringBufferInputStream(BOOK_NAME), "ISO-8859-1"));
  ...
  //-----------------------------Decode Unicode---------------------------------
  public String toUnicodeEscapeString(String str) {
