...
//  int indeximage = 100001;
  ...
  TOPICREPLY=t.toUnicode(req.getParameter("topicreply"));
  USERPOST = t.toUnicode(req.getParameter("userpost"));
  POSTREPLY =t.toUnicode(req.getParameter("postreply"));
 ...
 //--------------------------Data Base-------------------------------
	...
	try {
        ...
        ResultSet rset;
        ResultSet rset1;
        rset = stmt.executeQuery("SELECT count(*) FROM topicpost");
	      rset.next();
        N_Row = rset.getInt(1);
        TopicID = N_Row;
        TopicID++;
        TOPICREPLY  =TOPICREPLY.trim();
        USERPOST   =USERPOST.trim();
        POSTREPLY    =POSTREPLY.trim();
        Date DateTopic = new java.util.Date();
        String d = DateTopic.toLocaleString();
//        int i = d.indexOf(',');
//        d = d.substring(0,i);
        stmt.executeUpdate("INSERT INTO  topicpost VALUES ("+"'"+TopicID+"'"+",'"+TOPICREPLY+"','"+USERPOST+"','"+d+"','"+POSTREPLY+"')");
        stmt.executeUpdate("INSERT INTO  replypost VALUES ("+"'"+TopicID+"'"+",'"+POSTREPLY+"','"+d+"','"+USERPOST+"')");
...
out.println("  <tr>                                                                                                                                                                                                        ");
out.println("    <td bgcolor=\"#000033\"> <img src=\"file:///E|/HomeProject/www/image/ehomeproject3.gif\" width=\"283\" height=\"85\"></td>                                                                                ");
...
out.println("      <div id=\"Layer1\" style=\"position:absolute; left:570px; top:95px; width:263px; height:104px; z-index:3\"><img src=\"file:///E|/HomeProject/www/image/talkHome1.gif\" width=\"244\" height=\"115\"></div>");
out.println("      <div id=\"Layer2\" style=\"position:absolute; left:777px; top:27px; width:144px; height:158px; z-index:2\"><img src=\"file:///E|/HomeProject/jimHomePage/logo_webboard1.gif\" width=\"143\" height=\"158\"></div>");
...
out.println("  <tr>                                                                                                                                                                                                        ");
out.println("    <td width=\"3%\" height=\"29\">&nbsp;</td>                                                                                                                                                                ");
out.println("    <td height=\"29\" colspan=\"6\" width=\"97%\"><a href=\"TopicPost.html\"><img src=\"file:///E|/HomeProject/www/image/postNew.jpg\" width=\"91\" height=\"21\" border=\"0\"></a></td>                      ");
out.println("  </tr>                                                                                                                                                                                                       ");
out.println("  <tr>                                                                                                                                                                                                        ");
out.println("    <td width=\"3%\" height=\"29\">&nbsp;</td>                                                                                                                                                                ");
