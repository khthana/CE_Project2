...
import java.sql.*;
import java.lang.*;
public class appointment_cviewe
{
	...
	private static String table_namets = "reschedule_table";
	private static String column_s1 = "reschedule_id";
	...
	private static String column_s12 = "user_name";
	...
	public String getYear()
	{
		try
		{
		reschedule_id = rs.getInt(column_s1);
	...
	public String getUser_name()
	{
		try
		{
			return rs.getString(column_s12);
		}
		catch (Exception e)
		{
			e.printStackTrace(System.err);
	...
	{
		String link ="appointment_cdelete.jsp?reschedule_id="+reschedule_id;
		return link;
	}
