...
import java.sql.*;
import java.lang.*;
public class appointment_dviewe
{
	...
	private static int tschedule_id;
	...
	private static String column_s1 = "tschedule_id";
	...
	public String getYear()
	{
		try
		{
		tschedule_id = rs.getInt(column_s1);
	...
	{
		String link ="appointment_delete.jsp?tschedule_id="+tschedule_id;
		return link;
	}
