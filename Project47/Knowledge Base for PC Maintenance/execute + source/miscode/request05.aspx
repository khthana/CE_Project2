...
<script runat="server">
    ...
    dim UName ,UId ,UTel ,UDep ,USec ,ULoc,UStatus
         ...
         Sub myDataBinding()
                 ...
                 Dim queryString As String = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2,T_Request.Type As Expr3 ," & _
                                             "T_Request.Times AS Expr4, T_Request.Status AS Expr5, T_Users.Name AS Expr6 " & _
                                             "FROM T_Request INNER JOIN T_Users ON T_Request.User_ID = T_Users.User_ID " & _
                                             "WHERE (T_Request.Type = 'borrow') ORDER BY Expr1 DESC"
         ...
         Sub sortDataGrid(o As Object , e As DataGridSortCommandEventArgs)
                 ...
                 mySortDataBinding(e.SortExpression)
         End Sub

              Sub mySortDataBinding(Optional sortExpr As String = "Ref") 'User
                 Dim connectionString As String ="server='(local)'; trusted_connection=true; database='misjob_order'"
                 Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)
                 Dim queryString As String
                 If dir_sort.Text = sortExpr Then
                     queryString  = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2,T_Request.Type As Expr3 ," & _
                                             "T_Request.Times AS Expr4, T_Request.Status AS Expr5, T_Users.Name AS Expr6 " & _
                                             "FROM T_Request INNER JOIN T_Users ON T_Request.User_ID = T_Users.User_ID " & _
                                             "WHERE (T_Request.Type = 'borrow') ORDER BY " & sortExpr &" DESC"
                     dir_sort.Text = ""
                 Else
                     queryString  = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2,T_Request.Type As Expr3 ," & _
                                             "T_Request.Times AS Expr4, T_Request.Status AS Expr5, T_Users.Name AS Expr6 " & _
                                             "FROM T_Request INNER JOIN T_Users ON T_Request.User_ID = T_Users.User_ID " & _
                                             "WHERE (T_Request.Type = 'borrow') ORDER BY " & sortExpr &" ASC"
         ...
         Sub MyDataGrid_Select(sender As Object, e As EventArgs)
                      ...
                      Response.Redirect("bdetail.aspx")
         End Sub
...
<head>
    ...
    <meta http-equiv="refresh" content="360;request05.aspx" />
                ...
                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="673" background="images/bgheader_admin.gif" height="45">
                                            <span class="style1"><font color="red" size="4"><font face="Comic Sans MS"><font color="yellow" size="4">Essilor
                                            Manufacturing (Thailand) co.,ltd.<br />
                                            MIS Section</font>&nbsp;</font></font></span></td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            &nbsp;<span class="style1"><font color="#ffff00"><font face="Comic Sans MS" color="yellow"><font size="4"> </font><span class="style1"><font face="Comic Sans MS" color="yellow" size="2">Borrow</font></span></font></font></span></td>
                                                        <td align="middle">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            <asp:DataGrid id="DataGrid1" runat="server" Visible="true" Width="666px" BorderColor="#999999" AutoGenerateColumns="false" AllowSorting="true" OnSortCommand="sortDataGrid" AllowPaging="true" PageSize="15" OnPageIndexChanged="pageDataGrid" OnSelectedIndexChanged="MyDataGrid_Select">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="Expr4" HeaderText="Date/Time " SortExpression="Expr4">
                                        <HeaderStyle width="3cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr3" HeaderText="Type" SortExpression="Expr3">
                                        <HeaderStyle width="1.8cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr5" HeaderText="Status" SortExpression="Expr5">
