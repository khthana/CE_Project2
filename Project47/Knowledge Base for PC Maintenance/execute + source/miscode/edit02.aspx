    ...
    dim UName ,UId ,UTel ,UDep ,USec ,ULoc,UStatus
       ...
       End If
         ...
         Sub myDataBinding()
                 ...
                 queryString = "SELECT T_Users.User_ID AS Expr0,T_Users.Name AS Expr1, T_Users.Login AS Expr2, T_Users.Password AS Expr3, T_Department.Department AS Expr4, T_Section.[Section] AS Expr5, " & _
                               "T_Location.Location AS Expr6, T_Users.Tel AS Expr7, T_Users.Email AS Expr8, T_Users.Status AS Expr9 " & _
                               ...
                               "T_Section ON T_Users.Section_ID = T_Section.Section_ID"
         ...
         Sub DataGrid_DeleteCommand(sender As Object, e As DataGridCommandEventArgs)
             Dim aa As Integer
             Dim dataset
             Dim Name As String = DataGrid1.DataKeys(e.Item.ItemIndex)
             dataset = ReturnStatus_SentName(Name)
             Dim temp_status As String = DataSet.Tables(0).Rows(0)(0)
             if (temp_status <> "Admin")  then
                 aa = MyDeleteMethod(Name)
                 myDataBinding()
             end if
         End Sub

             Function ReturnStatus_SentName(ByVal name As String) As System.Data.DataSet
                 Dim connectionString As String = "server='(local)'; trusted_connection=true; database='misjob_order'"
                 Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)

                 Dim queryString As String = "SELECT [T_Users].[Status] FROM [T_Users] WHERE ([T_Users].[Name] = @Name)"
                 Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
                 dbCommand.CommandText = queryString
                 dbCommand.Connection = dbConnection
         ...
         Function MyDeleteMethod(ByVal name As String) As Integer
             Dim connectionString As String = "server='(local)'; trusted_connection=true; database='misjob_order'"
             Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)

             Dim queryString As String = "DELETE FROM [T_Users] WHERE ([T_Users].[Name] = @Name)"
             Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
             dbCommand.CommandText = queryString
             dbCommand.Connection = dbConnection
         ...
         Sub mySortDataBinding(Optional sortExpr As String = "Expr1") 'Suport
                 Dim connectionString As String ="server='(local)'; trusted_connection=true; database='misjob_order'"
                 Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)
                 Dim queryString As String
                 If dir_sort.Text = sortExpr Then
                     queryString = "SELECT T_Users.User_ID AS Expr0,T_Users.User_ID AS Expr0,T_Users.Name AS Expr1, T_Users.Login AS Expr2, T_Users.Password AS Expr3, T_Department.Department AS Expr4, T_Section.[Section] AS Expr5, " & _
                               "T_Location.Location AS Expr6, T_Users.Tel AS Expr7, T_Users.Email AS Expr8, T_Users.Status AS Expr9 " & _
                               "FROM T_Users INNER JOIN " & _
                               "T_Department ON T_Users.Department_ID = T_Department.Department_ID INNER JOIN " & _
                               "T_Location ON T_Users.Location_ID = T_Location.Location_ID INNER JOIN " & _
                               "T_Section ON T_Users.Section_ID = T_Section.Section_ID Order by " & sortExpr &" DESC"
                     dir_sort.Text = ""
                 Else
                     queryString = "SELECT T_Users.User_ID AS Expr0,T_Users.Name AS Expr1, T_Users.Login AS Expr2, T_Users.Password AS Expr3, T_Department.Department AS Expr4, T_Section.[Section] AS Expr5, " & _
                               "T_Location.Location AS Expr6, T_Users.Tel AS Expr7, T_Users.Email AS Expr8, T_Users.Status AS Expr9 " & _
                               ...
                               "T_Department ON T_Users.Department_ID = T_Department.Department_ID INNER JOIN " & _
                               "T_Location ON T_Users.Location_ID = T_Location.Location_ID INNER JOIN " & _
                               "T_Section ON T_Users.Section_ID = T_Section.Section_ID Order by " & sortExpr &" ASC"
         ...
         End Sub
             ...
             Sub ItemsGrid_Command(sender As Object, e As DataGridCommandEventArgs)
                  ...
                  Select (CType(e.CommandSource, LinkButton)).CommandName
                     ...
                     Case "Edit"
                         Dim dataReader As System.Data.IDataReader = QueryID(DataGrid1.DataKeys(e.Item.ItemIndex))
                         Dim Ref as Integer
                         Ref = 0
                         dim xxx
                         dataReader.Read()
                         try
                             Ref = dataReader.GetInt32(0)
                             xxx = dataReader.GetInt32(0).ToString()
                         ...
                         Response.Redirect("musermodify.aspx")
                         End try
                     Case Else
                        ' Do nothing.
                  End Select
         ...
         Function QueryID(name as string ) As System.Data.IDataReader
             Dim connectionString As String ="server='(local)'; trusted_connection=true; database='misjob_order'"
             Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)

             Dim queryString As String = "SELECT User_ID AS Expr1 FROM T_Users WHERE Name = '" + name + "'"
             Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
             dbCommand.CommandText = queryString
             dbCommand.Connection = dbConnection
             dbConnection.Open
                    ...
                    <tr>
                        <td valign="top" align="middle" width="95" bgcolor="#1f1fe2" height="370">
                            <p>
                                ...
                                <br />
                                <hr />
                                <asp:ImageButton id="ImageButton3" onclick="ImageButton1_Click" runat="server" Width="37px" Height="33px" src="images/commond/images03.gif" AlternateText="Logout"></asp:ImageButton>
                                <br />
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            <asp:DataGrid id="DataGrid1" runat="server" Width="666px" OnSelectedIndexChanged="DataGrid1_SelectedIndexChanged" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" OnSortCommand="sortDataGrid" AllowPaging="True" PageSize="15" OnPageIndexChanged="pageDataGrid" OnDeleteCommand="DataGrid_DeleteCommand" DataKeyField="Expr1" OnItemCommand="ItemsGrid_Command">
                                <HeaderStyle backcolor="#DDDDDD"></HeaderStyle>
                                <PagerStyle horizontalalign="Right" mode="NumericPages"></PagerStyle>
                                <SelectedItemStyle backcolor="Yellow"></SelectedItemStyle>
                                <Columns>
                                    <asp:BoundColumn DataField="Expr0" SortExpression="Expr0" HeaderText="#">
                                        <HeaderStyle width="0.3cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:ButtonColumn Text="Delete" CommandName="Delete"></asp:ButtonColumn>
                                    <asp:ButtonColumn Text="Edit" CommandName="Edit"></asp:ButtonColumn>
                                    <asp:BoundColumn DataField="Expr1" SortExpression="Expr1" HeaderText="Name">
                                        <HeaderStyle width="3cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr2" SortExpression="Expr2" HeaderText="Login">
                                        <HeaderStyle width="1cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr3" SortExpression="Expr3" HeaderText="Password">
                                        <HeaderStyle width="1cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr4" SortExpression="Expr4" HeaderText="Department">
                                        <HeaderStyle width="3cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr5" SortExpression="Expr5" HeaderText="Section">
                                        <HeaderStyle width="3cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr6" SortExpression="Expr6" HeaderText="Location">
                                        <HeaderStyle width="1.8cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr7" SortExpression="Expr7" HeaderText="Tel">
                                        <HeaderStyle width="1.9cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr8" SortExpression="Expr8" HeaderText="Email">
                                        <HeaderStyle width="1.9cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="Expr9" SortExpression="Expr9" HeaderText="Status">
                                        <HeaderStyle width="1cm"></HeaderStyle>
                                    </asp:BoundColumn>
                                </Columns>
                            </asp:DataGrid>
