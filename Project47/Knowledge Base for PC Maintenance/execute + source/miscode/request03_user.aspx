...
<script runat="server">
    ...
    Sub myDataBinding()
            ...
            queryString = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2, T_Request.Times AS Expr4, T_Request.Status AS Expr5, T_Request.Priority AS Expr6, " & _
                          ...
                          "WHERE (T_Request.Type = 'Normal') AND (T_Request.User_ID = " + UId + ") AND (T_Request.Status = 'Pending')"
    ...
    Sub mySortDataBinding2(Optional sortExpr As String = "Request_ID") 'Suport
            ...
            If dir_sort.Text = sortExpr Then
                queryString = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2, T_Request.Times AS Expr4, T_Request.Status AS Expr5, T_Request.Priority AS Expr6, " & _
                          ...
                          "T_Users ON T_Request.User_ID = T_Users.User_ID INNER JOIN " & _
                          "T_Machine ON T_Request.Machine_ID = T_Machine.Machine_ID " & _
                          "WHERE (T_Request.Type = 'Normal') AND (T_Request.User_ID = " + UId + ") AND (T_Request.Status = 'Pending') " & _
                ...
                <tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            ...
                                                            &nbsp;<span class="style1"><font face="Comic Sans MS" color="#ffffff"><span style="COLOR: white">Pending</span></font></span></td>
                                                        <td align="middle">
                    ...
                    <tr>
                        <td valign="top" align="middle" width="95" bgcolor="#009cc6" height="370">
                            <p>
                                <asp:table id="menu1" runat="server" visible="false" Width="95" Border="0" CellPadding="0" CellSpacing="0" BackColor="#009CC6"></asp:table>
                                <asp:table id="menu2" runat="server" visible="false" Width="95" Border="0" CellPadding="0" CellSpacing="0" BackColor="#009CC6"></asp:table>
                                <asp:table id="menu3" runat="server" visible="false" Width="95" Border="0" CellPadding="0" CellSpacing="0" BackColor="#009CC6"></asp:table>
                                <hr />
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            <asp:DataGrid id="DataGrid1" runat="server" Visible="true" Width="666px" BorderColor="#999999" AutoGenerateColumns="false" AllowSorting="true" OnSortCommand="sortDataGrid" AllowPaging="true" PageSize="15" OnPageIndexChanged="pageDataGrid" OnSelectedIndexChanged="MyDataGrid_Select" Font-Names="Comic Sans MS">
