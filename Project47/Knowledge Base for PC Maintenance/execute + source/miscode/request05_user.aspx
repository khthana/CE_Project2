...
<script runat="server">
    ...
    dim UName ,UId ,UTel ,UDep ,USec ,ULoc,UStatus
         ...
         Sub myDataBinding()
                 ...
                 Dim queryString As String = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2,T_Request.Type As Expr3, " & _
                                             ...
                                             "WHERE (T_Request.User_ID = " + UId + " and T_Request.Type = 'borrow')"
         ...
         Sub sortDataGrid(o As Object , e As DataGridSortCommandEventArgs)
             If UStatus = "MIS" Then
                 mySortDataBinding2(e.SortExpression) 'Suport
            Else
         ...
         Sub mySortDataBinding(Optional sortExpr As String = "Ref") 'Suport
                 ...
                 If dir_sort.Text = sortExpr Then
                     queryString  = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2,T_Request.Type As Expr3 ," & _
                                    "T_Request.Times AS Expr4, T_Request.Status AS Expr5, T_Users.Name AS Expr6 " & _
                                    "FROM T_Request INNER JOIN T_Users ON T_Request.User_ID = T_Users.User_ID " & _
                                    "WHERE (T_Request.User_ID = " + UId + " and T_Request.Type = 'borrow') " & _
    ...
    '            msgbox(queryString )
         ...
         Sub MyDataGrid_Select(sender As Object, e As EventArgs)
                      ...
                      Response.Redirect("bdetail_user.aspx")
         End Sub
          ...
          Sub Search()
             ...
             Sub All_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs)
                 ...
                 if (Sender.ID = "Sea01") then
                     ...
                     Response.Redirect("search03_user.aspx")
                 end if
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            <asp:ImageButton id="ButtonRefresh" runat="server" ImageUrl="images/refresh.gif" AlternateText="Refresh" height="20" width="20"></asp:ImageButton>
                                                            &nbsp;<span class="style1"><font face="Comic Sans MS" color="#ffffff">Borrow</font></span></td>
                                                        <td align="middle">
