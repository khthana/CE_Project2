...
<head>
    ...
    <meta http-equiv="refresh" content="360;search03show.aspx" />
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            ...
                                                            <font face="Comic Sans MS" color="#ffff00" size="2">Show Search Cost</font></td>
                                                        <td align="middle">
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            <p>
                                <asp:DataGrid id="DataGrid1" runat="server" Width="666px" OnSelectedIndexChanged="MyDataGrid_Select" OnPageIndexChanged="pageDataGrid" PageSize="15" AllowPaging="true" OnSortCommand="sortDataGrid" AllowSorting="true" AutoGenerateColumns="false" BorderColor="#999999" Visible="true">
                                    ...
                                    <Columns>
                                        <asp:BoundColumn DataField="Expr1" HeaderText="Requester" SortExpression="Expr1">
                                            <HeaderStyle width="2cm"></HeaderStyle>
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Expr2" HeaderText="Date/Time" SortExpression="Expr2" >
                                            <HeaderStyle width="3cm" ></HeaderStyle>
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Expr3" HeaderText="Department" SortExpression="Expr3">
                                            <HeaderStyle width="2cm"></HeaderStyle>
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Expr4" HeaderText="Section" SortExpression="Expr4">
                                            <HeaderStyle width="2cm"></HeaderStyle>
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Expr5" HeaderText="Location" SortExpression="Expr5">
                                            <HeaderStyle width="2cm"></HeaderStyle>
                                        </asp:BoundColumn>
                                        <asp:BoundColumn DataField="Expr6" HeaderText=" Cost" SortExpression="Expr6">
                                            <HeaderStyle width="2cm"></HeaderStyle>
                                        </asp:BoundColumn>
                                    </Columns>
