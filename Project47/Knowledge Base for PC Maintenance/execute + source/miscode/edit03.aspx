...
<script runat="server">
    ...
    Sub BAddDep_Click(sender As Object, e As EventArgs)
        if (TextBoxDep.Text <> "") then
            AddItem(TextBoxDep.Text,"T_Department","Department_ID","Department")
            TextBoxDep.Text = ""
            QueryDepartment()
        end if
    End Sub
    ...
    Sub BAddSec_Click(sender As Object, e As EventArgs)
        if (TextBoxSec.Text <> "") then
            AddItem(TextBoxSec.Text,"T_Section","Section_ID","Section")
            TextBoxSec.Text = ""
            QuerySection()
        end if
    ...
    Sub BAddLoc_Click(sender As Object, e As EventArgs)
        if (TextBoxLoc.Text <> "") then
            AddItem(TextBoxLoc.Text,"T_Location","Location_ID","Location")
            TextBoxLoc.Text = ""
            QueryLocation()
        end if
