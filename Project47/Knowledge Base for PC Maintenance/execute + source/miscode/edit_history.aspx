...
<script runat="server">
    ...
    Dim HisComName,HisUpdate
         ...
         Function MyUpdateMethod(ByVal nO As Integer, ByVal computerName As String, ByVal user As String, ByVal type As String, ByVal dept As String, ByVal section As String, ByVal location As String, ByVal project As String, ByVal oS As String, ByVal model As String, ByVal cPU As String, ByVal rAM As String, ByVal hDD As String, ByVal service As String, ByVal remark As String) As Integer
             Dim connectionString As String = "server='(local)'; trusted_connection=true; database='misjob_order'"
             Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)

             Dim queryString As String = "UPDATE [History] SET [Type]=@Type, [Dept]=@Dept, [Service]=@Service, [OS]=@OS, [H"& _
    "DD]=@HDD, [Remark]=@Remark, [Location]=@Location, [ComputerName]=@ComputerName, "& _
    "[Model]=@Model, [RAM]=@RAM, [User]=@User, [CPU]=@CPU, [Project]=@Project, [Secti"& _
    "on]=@Section WHERE ([History].[NO] = @NO)"
             Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
             dbCommand.CommandText = queryString
             dbCommand.Connection = dbConnection

             Dim dbParam_nO As System.Data.IDataParameter = New System.Data.SqlClient.SqlParameter
             dbParam_nO.ParameterName = "@NO"
             dbParam_nO.Value = nO
             dbParam_nO.DbType = System.Data.DbType.Int32
             dbCommand.Parameters.Add(dbParam_nO)
         ...
         Function ReturnLocation() As System.Data.DataSet
             ...
             Return dataSet
         End Function
        Function ReturnAll_SentComName(ByVal computerName As String) As System.Data.DataSet
                 Dim connectionString As String = "server='(local)'; trusted_connection=true; database='misjob_order'"
                 Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)
        ...
        ")"
         ...
         Sub ShowData()
                  ...
                  Dataset1 = ReturnAll_SentComName(HisComName)

              TextNO.text = DataSet1.Tables(0).Rows(0)(0)
              TextName.text = DataSet1.Tables(0).Rows(0)(1)
              TextUser.text = DataSet1.Tables(0).Rows(0)(2)
              TextType.text = DataSet1.Tables(0).Rows(0)(3)

              TextProject.text = DataSet1.Tables(0).Rows(0)(7)
              TextOS.text = DataSet1.Tables(0).Rows(0)(8)
              TextModel.text = DataSet1.Tables(0).Rows(0)(9)
              TextCPU.text = DataSet1.Tables(0).Rows(0)(10)
              TextRAM.text = DataSet1.Tables(0).Rows(0)(11)
              TextHDD.text = DataSet1.Tables(0).Rows(0)(12)
              TextService.text = DataSet1.Tables(0).Rows(0)(13)
              TextRemark.text = DataSet1.Tables(0).Rows(0)(14)

              DropDownDept.Items.Item(0).Selected = False
              DropDownDept.Items.FindByValue(DataSet1.Tables(0).Rows(0)(4)).Selected = True
              DropDownSection.Items.Item(0).Selected = False
              DropDownSection.Items.FindByValue(DataSet1.Tables(0).Rows(0)(5)).Selected = True
              DropDownLocation.Items.Item(0).Selected = False
              DropDownLocation.Items.FindByValue(DataSet1.Tables(0).Rows(0)(6)).Selected = True
         ...
         Sub GetSession()
             ...
             HisComName = Trim(Session.Contents("HComName"))
             HisUpdate = Trim(Session.Contents("HUpdate"))
    ...
    Sub Button1_Click_1(sender As Object, e As EventArgs)
        Dim aa As integer
        aa = MyUpdateMethod(TextNO.text,TextName.text,TextUser.text,TextType.text,DropDownDept.SelectedItem.Value,DropDownSection.SelectedItem.Value,DropDownLocation.SelectedItem.Value,TextProject.text,TextOS.text,TextModel.text,TextCPU.text,TextRAM.text,TextHDD.text,TextService.text,TextRemark.text)
        Response.Redirect("show_edit.aspx")
    End Sub
                ...
                <tbody>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            <font face="Comic Sans MS" color="yellow">&nbsp;Edit History</font></td>
                                                        <td align="middle">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            ...
                            <h2>
                                <table style="WIDTH: 599px; HEIGHT: 305px">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <asp:Label id="NO" runat="server" forecolor="Black" enabled="False">NO :</asp:Label></td>
                                            <td>
                                                <asp:TextBox id="TextNO" runat="server" Enabled="False" width="200px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label id="ComName" runat="server" forecolor="Black">ComName :</asp:Label></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label id="LabelProject" runat="server" forecolor="Black">Project : </asp:Label></td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label id="LabelType" runat="server" forecolor="Black">Type :</asp:Label></td>
                                            <td>
                                                <asp:TextBox id="TextType" runat="server" width="200px"></asp:TextBox>
                                            </td>
                                            <td>
                                                <asp:Label id="OS" runat="server" forecolor="Black">OS :</asp:Label></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                &nbsp;<asp:Label id="Service" runat="server" forecolor="Black">Service :</asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                &nbsp;<asp:Label id="Remark" runat="server" forecolor="Black">Remark :</asp:Label>
                                            </td>
                                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label id="Label3" visible="False" runat="server" forecolor="Red">Invalid
                                Computer Name</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </h2>
                            <p>
                            </p>
                            <p>
                            ...
                            <p>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Button id="Button1" onclick="Button1_Click_1" runat="server" Text="Summit"></asp:Button>
                            </p>
                        </td>
                    </tr>
                </tbody>
