                ...
                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="673" background="images/bgheader_admin.gif" height="45">
                                            ...
                                            Essilor Manufacturing (Thailand) co.,ltd.<br />
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            MIS Section</font>&nbsp;</font></font></span></font></span></td>
                                    </tr>
                                    <tr>
                                        <td width="673" background="images/bgheader_admin.gif" height="20">
                                            <table style="WIDTH: 883px; HEIGHT: 20px" height="20" cellspacing="0" cellpadding="0" width="883" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            &nbsp; <font face="Comic Sans MS" color="yellow">Show All History</font></td>
                                                        <td align="middle">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            <p>
                                <asp:DataGrid id="DataGrid1" runat="server" Width="883px" BorderColor="#999999" AutoGenerateColumns="False" AllowSorting="True" OnSortCommand="sortDataGrid" AllowPaging="True" PageSize="15" OnPageIndexChanged="pageDataGrid" OnSelectedIndexChanged="MyDataGrid_Select">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn DataField="ComputerName" SortExpression="ComputerName" HeaderText="ComName"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="User" SortExpression="User" HeaderText="User"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="Type" SortExpression="Type" HeaderText=" Type"></asp:BoundColumn>
                                        <asp:BoundColumn DataField="Dept" SortExpression="Dept" HeaderText=" Dept"></asp:BoundColumn>
