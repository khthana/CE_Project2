...
<script runat="server">
    ...
    Sub GetSession()
        ...
        UStatus = Trim(Session.Contents("UStatus"))
                  ...
                  HisCom = Trim(Session.Contents("HComName"))
    ...
    Sub ShowData()
                 ...
                 Dataset1 = ReturnAll_SentComName(HisCom)
    ...
    Sub mySortDataBinding(Optional sortExpr As String = "NO") 'User
            ...
            If dir_sort.Text = sortExpr Then
                queryString = "SELECT [History].* FROM [History] WHERE ([History].[ComputerName] = @HisCom"& _
            ...
            dbParam_computerName.ParameterName = "@HisCom"
            dbParam_computerName.Value = HisCom
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            <font face="Comic Sans MS" color="yellow">&nbsp;Show Add History Complete</font></td>
                                                        <td align="middle">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            ...
                            <p>
                                &nbsp;&nbsp;&nbsp;
                                <br />
                                <asp:DataGrid id="DataGrid1" runat="server" OnSelectedIndexChanged="MyDataGrid_Select" OnPageIndexChanged="pageDataGrid" PageSize="15" AllowPaging="True" OnSortCommand="sortDataGrid" AllowSorting="True" AutoGenerateColumns="False" BorderColor="#999999">
