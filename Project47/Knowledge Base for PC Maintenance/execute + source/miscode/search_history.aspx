...
<script runat="server">
    ...
    Function ReturnDept() As System.Data.DataSet
        ...
        Dim queryString As String = "SELECT [Dept].[Dept] FROM [Dept]"
    ...
    Function ReturnSection() As System.Data.DataSet
        ...
        Dim queryString As String = "SELECT [Section].[Section] FROM [Section]"
        Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
        dbCommand.CommandText = queryString
        dbCommand.Connection = dbConnection
    ...
    Function ReturnLocation() As System.Data.DataSet
        ...
        Dim queryString As String = "SELECT [Location].[Location] FROM [Location]"
        Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
        dbCommand.CommandText = queryString
        dbCommand.Connection = dbConnection
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            ...
                            <p>
                                <asp:Table id="Table1" runat="server">
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Label runat="server" forecolor="Black" id="Dept">Dept :</asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell>
                                            <asp:DropDownList runat="server" ID="DropDownDept"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Label runat="server" forecolor="Black" id="Section">Section :</asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell>
                                            <asp:DropDownList runat="server" ID="DropDownSection"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Label runat="server" forecolor="Black" id="Location">Location :</asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell>
                                            <asp:DropDownList runat="server" ID="DropDownLocation"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Label runat="server" forecolor="Black" id="Project">Project :</asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell>
                                            <asp:DropDownList runat="server" ID="DropDownProject"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:Label runat="server" forecolor="Black" id="Type">Type :</asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell>
                                            <asp:DropDownList runat="server" ID="DropDownType"></asp:DropDownList>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </p>
