...
<script runat="server">
    ...
    sub QueryRquests()
            ...
            queryString = "SELECT     User_ID,Name " & _
                          "FROM         T_Users " & _
                          "WHERE     (Status = N'USER')"
            ...
            while(dataReader.Read())
                DropDownReq.Items.Add(New ListItem(Trim(dataReader.GetString(1)),dataReader.GetInt32(0).ToString))
            end while
    end sub
    ...
    sub QueryProblem()
            ...
            Dim queryString As String
            queryString = "SELECT Problem  " & _
                          "FROM T_Reply " & _
                          "GROUP BY Problem " & _
                          "HAVING (Problem <> N'NULL')"
            Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
            dbCommand.CommandText = queryString
            dbCommand.Connection = dbConnection
            dbConnection.Open
            Dim dataReader As System.Data.IDataReader = dbCommand.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
            while(dataReader.Read())
                DropDownProT.Items.Add(New ListItem(Trim(dataReader.GetString(0)),dataReader.GetString(0)))
            end while
    end sub


    sub QueryComputerNum()
            'DropDownLoc.Items.Clear()
            Dim connectionString As String ="server='(local)'; trusted_connection=true; database='misjob_order'"
            Dim dbConnection As System.Data.IDbConnection = New System.Data.SqlClient.SqlConnection(connectionString)

            Dim queryString As String
            queryString = "SELECT ComputerNumber " & _
                          "FROM T_Request " & _
                          "GROUP BY ComputerNumber " & _
                          "HAVING (ComputerNumber <> N'NULL')"
            Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
            dbCommand.CommandText = queryString
            dbCommand.Connection = dbConnection
            dbConnection.Open
            Dim dataReader As System.Data.IDataReader = dbCommand.ExecuteReader(System.Data.CommandBehavior.CloseConnection)
            while(dataReader.Read())
                DropDownWor.Items.Add(New ListItem(Trim(dataReader.GetString(0)),dataReader.GetString(0)))
            end while
    end sub
    ...
    Sub FindButton_Click(sender As Object, e As ImageClickEventArgs)
        ...
        If (TextBoxRef.Text = "") Then
            If (DropDownReq.SelectedItem.Text <> "All Rquests") Then
                ...
                queryString = queryString & " T_Request.User_ID='" + DropDownReq.SelectedItem.Value + "'"
            End If
            ...
            If (DropDownSup.SelectedItem.Text <> "All Support Reps") Then
                ...
                queryString = queryString & " T_Reply.User_ID='" + DropDownSup.SelectedItem.Value + "'"
            End If
            If (DropDownDep.SelectedItem.Text <> "All Departments") Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Users.Department_ID='" + DropDownDep.SelectedItem.Value + "'"
            End If
            If (DropDownSec.SelectedItem.Text <> "All Sections") Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Users.Section_ID='" + DropDownSec.SelectedItem.Value + "'"
            End If
            If (DropDownLoc.SelectedItem.Text <> "All Locations") Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Users.Location_ID='" + DropDownLoc.SelectedItem.Value + "'"
            End If
            If (DropDownStatus.SelectedItem.Text <> "All Status") Then
                 if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Request.Status='" + DropDownStatus.SelectedItem.Text + "'"
            End If
            If (DropDownPro.SelectedItem.Text <> "All Problem Requests") Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Request.Problem='" + DropDownPro.SelectedItem.Text + "'"
            End If
            If (DropDownProT.SelectedItem.Text <> "All Problem Types") Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Reply.Problem LIKE '%" + DropDownProT.SelectedItem.Text + "%'"
            end if
            If (DropDownMac.SelectedItem.Text <> "All Machines") Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Request.Machine_ID='" + DropDownMac.SelectedItem.Value + "'"
            end if
            If DropDownWor.SelectedItem.Text <> "All Workstation" Then
                if (queryString <> "") then
                    queryString = queryString + " AND"
                end if
                queryString = queryString & " T_Request.ComputerNUmber LIKE '%" + DropDownWor.SelectedItem.Text + "%'"
            end if
            ...
            if (queryString <> "") then
                ...
                If ((DropDownSup.SelectedItem.Text <> "All Support Reps") or (DropDownProT.SelectedItem.Text <> "All Problem Types")) 'Reply Search
                ...
                queryString = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2, T_Request.Times AS Expr3, T_Request.Status AS Expr4, T_Request.Priority AS Expr5, " & _
                              "T_Users.Name AS Expr6 " & _
                              "FROM T_Request INNER JOIN T_Users ON T_Request.User_ID = T_Users.User_ID " & _
                              "where (T_Request.Dates BETWEEN " + From1 + " AND " + To1 + ")"
            end if
        ...
        Else
           queryString = "SELECT T_Request.Request_ID AS Expr1, T_Request.Title AS Expr2, T_Request.Times AS Expr3, T_Request.Status AS Expr4, T_Request.Priority AS Expr5, " & _
                          "T_Users.Name AS Expr6 FROM T_Request INNER JOIN T_Users ON T_Request.User_ID = T_Users.User_ID WHERE Request_ID =" + TextBoxRef.Text
           Session("queryString") = queryString
           Response.Redirect("searchshow.aspx")
        End If
    End Sub
                ...
                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="673" background="images/bgheader_admin.gif" height="45">
                                            ...
                                            MIS Section</font>&nbsp;</font></font><font color="#000000"> </font></span></font></span></td>
                                    </tr>
                                    <tr>
                    ...
                    <tr>
                        <td valign="top" align="middle" width="95" bgcolor="#1f1fe2" height="370">
                            ...
                            <hr />
                            <asp:ImageButton id="ImageButton4" onclick="ImageButton1_Click" runat="server" Width="37px" Height="33px" src="images/commond/images03.gif" AlternateText="Logout"></asp:ImageButton>
                        ...
                        <td valign="top" align="middle" width="673" height="370">
                            <p>
                                ...
                                <table style="WIDTH: 286px; HEIGHT: 372px">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:DropDownList id="DropDownReq" runat="server" Width="150px">
                                                    <asp:ListItem>All Rquests</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="left">
                                                Department</td>
                                            <td align="right">
                                                <asp:DropDownList id="DropDownDep" runat="server" Width="150px">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:DropDownList id="DropDownSec" runat="server" Width="150px">
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:DropDownList id="DropDownLoc" runat="server" Width="150px">
                                        ...
                                        <tr>
                                            <td align="left">
                                                Problem Type</td>
                                            <td align="right">
                                                <asp:DropDownList id="DropDownProT" runat="server" Width="150px">
                                                    <asp:ListItem Value="All Problem Types">All Problem Types</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right">
                                                <asp:DropDownList id="DropDownWor" runat="server" Width="150px">
                                                    <asp:ListItem Value="All Workstation">All Workstation</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <br />
                                <asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" ValidationExpression="\d+" ControlToValidate="TextBoxRef" ErrorMessage="RegularExpressionValidator"></asp:RegularExpressionValidator>
                            </p>
                        </td>
                    </tr>
                </tbody>
