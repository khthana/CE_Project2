...
<script runat="server">
    ...
    dim UName ,UId ,UTel ,UDep ,USec ,ULoc,UStatus,Ref
    ...
    function checkPassword(pass As String)' as Integer
            ...
            queryString = "SELECT User_ID FROM T_Users " & _
                          "WHERE (User_ID = " & Ref & ") AND (Password = N'" & pass & "')"
            Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
            dbCommand.CommandText = queryString
            dbCommand.Connection = dbConnection
            dbConnection.Open
    ...
    function checkname(pass As String)' as Integer
            ...
            queryString = "SELECT     COUNT(User_ID) AS Expr1 " & _
                          "FROM         T_Users " & _
                          "WHERE     (Name = N'" & pass & "') AND (User_ID <> " & Ref & ") "
    ...
    function checklogin(pass As String)' as Integer
            ...
            queryString = "SELECT     COUNT(User_ID) AS Expr1 " & _
                          "FROM         T_Users " & _
                          "WHERE     (Login = N'" & pass & "') AND (User_ID <> " & Ref & ") "
            Dim dbCommand As System.Data.IDbCommand = New System.Data.SqlClient.SqlCommand
            dbCommand.CommandText = queryString
            dbCommand.Connection = dbConnection
            dbConnection.Open
                ...
                <tbody>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="673" background="images/bgheader_admin.gif" height="45">
                                            <span class="style1"><font color="#ffffff"><span class="style1"><font color="#ffffff"><span class="style1"><font color="#ffffff"><span class="style1"><font color="red" size="4"><font face="Comic Sans MS" color="white"><font color="yellow" size="4">Essilor
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="left" width="150">
                                                            ...
                                                            &nbsp;<span class="style1"><font face="Comic Sans MS" color="yellow">Edit</font></span></td>
                                                        <td align="middle">
                    ...
                    <tr>
                        <td valign="top" align="middle" width="95" bgcolor="#1f1fe2" height="370">
                            ...
                            <p>
                                <font face="Comic Sans MS" color="yellow">Login</font>
                            </p>
                        </td>
