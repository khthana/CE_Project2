...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td>&nbsp;</td>
    <td width="308" height="176" background="pictures/administratorpleaselogin.gif"><form action="admin2.php" method="post" name="form1" target="_top">
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="300"><a href="../index.php" target="_top"><img src="pictures/userclickhere.gif" width="182" height="26" border="0"></a></td>
    <td>&nbsp;</td>
  </tr>
</table>
</body>
