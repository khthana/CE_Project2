            ...
            <form name="form1" method="post" action="all files.php<?php if($Folder!="") {echo "?Folder=".$Folder; }?>">
			  ...
			  while ($orderaction1=mysql_fetch_array($action1)) {//while loop
			   ...
			   if (($countstringSet<=2)&&($statuss=="Create Folder")) { //if path over folw
					...
					if (((mysql_num_rows($permissionfolders))==1)&&(($PerCon=="RW")||($PerCon=="RWS")||($PerCon=="R"))) {// check folder permission
			  ?>
                <tr>
                  <td scope="col"><div align="left">
				  <input name="statuss" type="hidden" id="statuss" value="<?php echo $statuss;?>"> 
                   <input name="cVirtualSet" type="radio" value="<?php echo $echoorder1; ?>" <?php if($echoorder1=="ALL/") {echo "checked";}?>>
			  ...
			  ?>
				...
				if  ($cPriorityFolder=="Set Folder Priority") { ?>
                <tr>
                ...
                <tr>
                  ...
                  <div align="left">
				   <font size="2" face="MS Sans Serif, Tahoma, sans-serif">
                   <input name="radioChoose" type="radio" value="R">
อ่านอย่างเดียว				   </font></div></td>
                </tr>
				<tr>
                  <td valign="top" scope="col">
                  <div align="left">
				   <font size="2" face="MS Sans Serif, Tahoma, sans-serif">
                   <input name="radioChoose" type="radio" value="RW">
อ่านและเขียน   </font></div></td>
                </tr>
				<tr>
                  <td valign="top" scope="col">
                  <div align="left">
				   <font size="2" face="MS Sans Serif, Tahoma, sans-serif">
                   <input name="radioChoose" type="radio" value="RWS">
อ่าน,เขียนและเปลี่ยนPriorityได้   </font></div></td>
                </tr>
				<tr>
                  <td valign="top" scope="col">
                  <div align="left">
                ...
                <tr>
                  <th scope="col"><div align="left">
					...
					<font color="#FF0000" size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>คำเตือน!! การลบโฟลเดอร์ ระบบจะทำการลบไฟล์ที่อยู่ภายในโฟลเดอร์โดยอัตโนมัติ</strong></font>
                    <?php } ?>
                  </div></th>
                </tr>
                <tr>
