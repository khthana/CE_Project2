...
<html>
<head>
<title>DMS Project : Search : <?php if ($priority=="Set Priority") { echo "Set Priority";} if($copy=="Copy to"){echo "Copy File";}  if($move=="Move to") {echo "Move File";} if($delete=="Delete from Virtual") {echo "Delete from virtual folder";}?></title>
