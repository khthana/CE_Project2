...
<html>
<head>
<title>DMS Project : All Files : <?php if ($priority=="Set Priority") { echo "Set Priority";} if($copy=="Copy to"){echo "Copy File";}  if($move=="Move to") {echo "Move File";} if($delete=="Delete from Virtual") {echo "Delete from virtual folder";}?></title>
  ...
  <tr> 
    <td><img src="pictures/head2.gif" width="778" height="69" border="0" usemap="#Map">
      <map name="Map">
        ...
        <area shape="rect" coords="437,35,526,55" href="profile.php">
        <area shape="rect" coords="335,37,424,57" href="search.php">
  ...
  <tr> 
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
		  ...
		  <?php if($move=="Move to") {?><img src="pictures/movefile.gif"><?php } if($copy=="Copy to"){?><img src="pictures/copyfile.gif"><?php } if($delete=="Delete") {?><img src="pictures/deletefile.gif"><?php }  
		  if($priority=="Set Priority"){?><img src="pictures/serpriority.gif"><?php echo "<br>&nbsp;For : "; echo $SetsShow;}?>
            ...
            <form name="form1" method="post" action="all files.php<?php if($Folder!="") {echo "?Folder=".$Folder; }?>">
			  ...
			  $TestPri = mysql_query("SELECT * FROM folderpermission WHERE FolderPath LIKE '$echoorder1' AND GroupPermiss LIKE '$usergroup'");
			  if ((mysql_num_rows($TestPri))!=0) { //if pri
				  ?>
                   <input name="cRadioMove" type="radio" value="<?php echo $echoorder1; ?>"> 
				   <font size="2" face="MS Sans Serif, Tahoma, sans-serif">
                  <?php  
				  echo $echoorder1;} //end if pri
				 } ?></font></div></td>
                </tr>
				<?php
				} // end while loop
				...
				for ($k=1;$k<=$group;$k++) {
				 ...
				 $TestPri1 = mysql_query("SELECT * FROM folderpermission WHERE  FolderPath LIKE '$hidden1' AND GroupPermiss LIKE '$k'");
                ...
                <tr>
				  ...
				  <?php } else {if($delete=="Delete") {?>
				  <input name="hidden3" type="hidden" id="hidden3" value="<?php echo $hidden1;?>">
				  <input name="hidden4" type="hidden" id="hidden4" value="<?php echo $hidden2;?>">  <?php if($delete=="Delete") { $statuss=$delete; } ?>
				  <input name="statuss" type="hidden" id="statuss" value="<?php echo $statuss;?>"> 
				  <font color="#FF0000" size="3" face="MS Sans Serif, Tahoma, sans-serif"><strong>ยืนยันการลบไฟล์</strong></font><br>
				  <br>
