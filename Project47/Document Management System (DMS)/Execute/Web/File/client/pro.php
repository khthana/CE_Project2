...
if ($check1==$check2) {
if($new==$new2){ $NewPass = md5($new);
mysql_query("UPDATE user SET Password='$NewPass' WHERE UserName='$user'");
///////////////////////////////////////////LOGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG
$LogFile = "[".date ("d-m-Y  H:i:s")."]   ".$user." เปลี่ยน Password เป็น ".$NewPass."<br>";  //echo $LogFile;
...
<html>
<head>
<title>DMS Project : Administrator : Profile</title>
...
<table width="778" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><img src="pictures/admin-head4.gif" width="778" height="69" border="0" usemap="#Map">
      <map name="Map">
            ...
            <table width="95%" border="0" align="center" cellpadding="3" cellspacing="0">
              ...
              <tr>
                <th scope="row"><div align="left">
                  <form name="form1" method="post" action="pro.php">
                    <table width="95%"  border="0" align="center" cellpadding="3" cellspacing="0">
                      <tr>
              ...
              <tr>
                <td scope="row"><form name="form2" method="post" action="pro.php">
                  <table width="95%"  border="0" align="center" cellpadding="3" cellspacing="0">
                    <tr>
