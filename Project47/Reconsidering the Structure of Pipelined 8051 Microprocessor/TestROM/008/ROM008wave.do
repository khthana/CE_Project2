...
add wave -noupdate -format Logic /datapath/carry
add wave -noupdate -format Logic /datapath/overflow
add wave -noupdate -format Logic /datapath/aux_carry
...
WaveRestoreCursors {{Cursor 1} {1387 ps} 0}
WaveRestoreZoom {313 ps} {3173 ps}
