...
public interface SSH2TransportEventHandler {
    ...
    /**
     * Called when key exchange starts (i.e. when KEXINIT message is sent to
     * peer).
     *
     * @param tp the transport layer
     */
    ...
    /**
     * Called when key exchange have agreed on algorithms (i.e. when KEXINIT
    ...
    /**
     * Called when key exchange has been successfully completed (i.e. new
     * keys and algorithms are now active).
     *
     * @param tp the transport layer
     */
     ...
     *
     * @param tp   the transport layer
     * @param type type of message which we didn't understand
     */
