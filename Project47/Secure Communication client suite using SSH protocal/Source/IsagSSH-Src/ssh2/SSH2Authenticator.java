...
public class SSH2Authenticator {
     ...
     * canceled the given authentication method (i.e. a
     ...
     * authentication method failed (i.e. not an error, authentication will
     * continue if more methods are available). This method does nothing, it
     * should be implemented in a subclass.
     *
     * @param method the authentication method that failed
     * @param partial a boolean indicating if this failure was a partial success
     * or not (i.e. the method succeeded but more methods are needed for full
     * authentication).
     */
     ...
     * occured (e.g. the server disconnected) or that the authentication has
