...
import jce.crypto.KeyAgreement;
import jce.crypto.interfaces.DHPublicKey;
import jce.crypto.interfaces.DHPrivateKey;
...
public class SSH2KEXDHGroup1SHA1 extends SSH2KeyExchanger {
	...
	security.publickey.ModPGroups.oakleyGroup2P;

    public final static BigInteger group1G =
	security.publickey.ModPGroups.oakleyGroup2G;
