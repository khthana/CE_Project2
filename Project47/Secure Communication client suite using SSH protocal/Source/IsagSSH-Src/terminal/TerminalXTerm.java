...
public final class TerminalXTerm extends TerminalInterpreter {
  ...
  public final static int DEFAULT_TERM = EMUL_VT100;
  ...
  public final static String[][] specialKeyMap = {
    ...
    { "23~",  "23~",  "W",    "Z",    "234z", "011q", null,   null,   null,   null },
    { "24~",  "24~",  "X",    "A",    "235z", "012q", null,   null,   null,   null },
  ...
  public final static String[][] specialKeyMapShift = {
    ...
    { "23~",  "23~",  "Y",    "P",    "224z", "013q", "P",    "P",    "P",    "P"  },
    { "24~",  "24~",  "Z",    "Q",    "225z", "014q", "Q",    "Q",    "Q",    "Q"  },
    { "25~",  "25~",  "a",    "R",    "226z", "015q", "R",    "R",    "R",    "R"  },
    { "26~",  "26~",  "b",    "S",    "227z", "016q", "S",    "S",    "S",    "S"  },
    { "28~",  "28~",  "c",    "T",    "228z", "017q", "17~",  null,   null,   null },
    { "29~",  "29~",  "d",    "U",    "229z", "018q", "18~",  null,   null,   null },
    { "31~",  "31~",  "e",    "V",    "230z", "019q", "19~",  null,   null,   null },
    { "32~",  "32~",  "f",    "W",    "231z", "020q", "20~",  null,   null,   null },
    { "33~",  "33~",  "g",    "X",    "232z", "021q", "21~",  null,   null,   null },
    { "34~",  "34~",  "h",    "Y",    "233z", "022q", "29~",  null,   null,   null },
  ...
  public final static String[][] specialKeyMapCtrl = {
    ...
    { "15^",  null,   "o",    "T",    "228z", "029q", "17~",  null,   null,   null },
    { "17^",  null,   "p",    "U",    "229z", "030q", "18~",  null,   null,   null },
    { "18^",  null,   "q",    "V",    "230z", "031q", "19~",  null,   null,   null },
    { "19^",  null,   "r",    "W",    "231z", "032q", "20~",  null,   null,   null },
    { "20^",  null,   "s",    "X",    "232z", "033q", "21~",  null,   null,   null },
    { "21^",  null,   "t",    "Y",    "233z", "034q", "29~",  null,   null,   null },
  ...
  public final static String[][] specialKeyMapCtrlShift = {
    ...
    { "28^",  null,   "@",    "T",    "228z", "005q", "17~",  null,   null,   null },
    { "29^",  null,   "[",    "U",    "229z", "006q", "18~",  null,   null,   null },
    { "31^",  null,   "\\",   "V",    "230z", "007q", "19~",  null,   null,   null },
    { "32^",  null,   "]",    "W",    "231z", "008q", "20~",  null,   null,   null },
    { "33^",  null,   "^",    "X",    "232z", "009q", "21~",  null,   null,   null },
    { "34^",  null,   "_",    "Y",    "233z", "010q", "29~",  null,   null,   null },
  ...
  public int interpretChar(char c) {
	...
	if(DEBUG) System.out.println("ANSI_PRINTER");
	val = param[0];
	if(val == PARAMNOTUSED)
	    val = 0;
	ansiPrinterCtrl(val);
  ...
  protected void ansiPrinterCtrl(int val) {
      switch(val) {
      case 0:
	  if(DEBUG) System.out.println("ANSI print screen");
	  term.printScreen();
	  break;
      case 4:
	  if(DEBUG) System.out.println("ANSI stop printer");
	  term.stopPrinter();
	  break;
      case 5:
	  if(DEBUG) System.out.println("ANSI start printer");
	  term.startPrinter();
	  break;
      default:
	  if(DEBUGNOTIMPL) notImplemented("<esc>[: " + val + "i not suppored");
	  break;
      }
  }
