...
import jca.security.KeyStoreSpi;
import jca.security.PrivateKey;
import jca.security.KeyFactory;
import jca.security.KeyStoreException;
import jca.security.UnrecoverableKeyException;
import jca.security.InvalidKeyException;
import jca.security.NoSuchAlgorithmException;

import jca.security.cert.Certificate;
import jca.security.cert.CertificateException;

import jca.security.spec.DSAPrivateKeySpec;
import jca.security.spec.RSAPrivateCrtKeySpec;

import jce.crypto.Cipher;
import jce.crypto.Mac;
import jce.crypto.spec.SecretKeySpec;
import jce.crypto.spec.IvParameterSpec;
...
import security.x509.X509Certificate;

import security.pkcs7.ContentInfo;
import security.pkcs7.EncryptedData;

import security.pkcs8.PrivateKeyInfo;
import security.pkcs8.EncryptedPrivateKeyInfo;

import security.pkcs12.PFX;
import security.pkcs12.AuthenticatedSafe;
import security.pkcs12.SafeContents;
import security.pkcs12.SafeBag;
import security.pkcs12.PKCS12PbeParams;
import security.pkcs12.CertBag;
...
public class PKCS12KeyStore extends KeyStoreSpi {
	...
	ASN1OIDRegistry.addModule("security.pkcs12");
	...
	try {
	    ...
	    ba = new ByteArrayInputStream(pki.privateKey.getRaw());
            ...
            if (isrsakey) {                
                security.pkcs1.RSAPrivateKey rsa =
                    new security.pkcs1.RSAPrivateKey();
                ber.decode(ba, rsa);
            ...
            security.pkcs1.DSAParams params = 
                (security.pkcs1.DSAParams)pki.privateKeyAlgorithm.parameters.getValue();
