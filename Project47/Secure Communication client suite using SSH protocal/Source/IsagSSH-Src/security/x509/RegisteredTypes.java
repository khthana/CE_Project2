...
public class RegisteredTypes extends ASN1OIDRegistry {
	 ...
	 */
	put("2.5.29.14", "security.x509.SubjectKeyIdentifier");
	put("2.5.29.15", "security.x509.KeyUsage");
	put("2.5.29.16", "security.x509.PrivateKeyUsagePeriod");
	put("2.5.29.17", "security.x509.SubjectAltName");
	put("2.5.29.18", "security.x509.IssuerAltName");
	put("2.5.29.19", "security.x509.BasicConstraints");
	put("2.5.29.30", "security.x509.NameConstraints");
	put("2.5.29.32", "security.x509.CertificatePolicies");
	put("2.5.29.33", "security.x509.PolicyMappings");
	put("2.5.29.35", "security.x509.AuthorityKeyIdentifier");
	put("2.5.29.36", "security.x509.PolicyConstraints");
	...
	// commonName
	put("2.5.4.3", "security.x509.DirectoryString");
	// surname
	put("2.5.4.4", "security.x509.DirectoryString");
	// serialNumber
	put("2.5.4.5", "ASN1PrintableString");
	// countryName
	put("2.5.4.6", "ASN1PrintableString");
	// localityName
	put("2.5.4.7", "security.x509.DirectoryString");
	// stateOrProvinceName
	put("2.5.4.8", "security.x509.DirectoryString");
	// streetAddress
	put("2.5.4.9", "security.x509.DirectoryString");
	// organizationName
	put("2.5.4.10", "security.x509.DirectoryString");
	// organizationalUnitName
	put("2.5.4.11", "security.x509.DirectoryString");
	// title
	put("2.5.4.12", "security.x509.DirectoryString");
	// description
	put("2.5.4.13", "security.x509.DirectoryString");
	// businessCategory
	put("2.5.4.15", "security.x509.DirectoryString");
	// postalAddress
	put("2.5.4.16", "security.x509.PostalAddress");
	// postalCode
	put("2.5.4.17", "security.x509.DirectoryString");
	// postOfficeBox
	put("2.5.4.18", "security.x509.DirectoryString");
	// telephoneNumber
	put("2.5.4.20", "ASN1PrintableString");
	// name
	put("2.5.4.41", "security.x509.DirectoryString");
	// givenName
	put("2.5.4.42", "security.x509.DirectoryString");
	// initials
	put("2.5.4.43", "security.x509.DirectoryString");
	// generationQualifier
	put("2.5.4.44", "security.x509.DirectoryString");
	// uniqueIdentifier
	put("2.5.4.45", "ASN1BitString");
	// dnQualifier
	put("2.5.4.46", "ASN1PrintableString");
	// pseudonym
	put("2.5.4.65", "security.x509.DirectoryString");
	...
	// placeOfBirth
	put("1.3.6.1.5.5.7.9.2", "security.x509.DirectoryString");
	// gender
	...
	put("0.9.2342.19200300.100.1.3", "ASN1IA5String");
        ...
        put("1.2.840.10040.4.1","security.pkcs1.DSAParams");
