...
import jca.security.interfaces.RSAPrivateCrtKey;
...
public abstract class SSH {
  ...
  public final static String CVS_NAME      = "$Name: v2_4_2 $";
  public final static String CVS_DATE      = "$Date: 2004/06/19 11:37:58 $";
  ...
  public static int getAuthType(String authName) throws IllegalArgumentException {
    int i;
    if("sdi-token".equals(authName) || "kbd-interact".equals(authName) ||
       "secureid".equals(authName)) {
	authName = "securid";
  ...
  public static String generateKeyFiles(RSAPrivateCrtKey key,
