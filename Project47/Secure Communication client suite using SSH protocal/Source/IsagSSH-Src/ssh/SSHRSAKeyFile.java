...
public class SSHRSAKeyFile {
  ...
  static public void createKeyFile(RSAPrivateCrtKey privKey,
  ...
  public SSHRSAKeyFile(String name) throws IOException {
    ...
    pubKey       = new security.publickey.RSAPublicKey(n, e);
  ...
  public RSAPrivateCrtKey getPrivate(String passwd) {
	...
	return null;
      ...
      privKey =
	  new security.publickey.RSAPrivateCrtKey(pubKey.getModulus(),
