...
public final class SSHPropertyHandler implements SSHClientUser, SSHAuthenticator, ProxyAuthenticator {
	...
	{ "jar-path", "."},
	// !!! REMOVE ???
	{ "module0", "application.ModuleTelnet" },
	{ "module1", "application.ModuleSFTP" },
	{ "module2", "application.ModuleSCP" },
	{ "module3", "application.ModuleFTPOverSFTP" },
	{ "module4", "application.ModuleTelnetProxy" },
	{ "module5", "application.ModuleTerminal" },
	...
	if(!interactor.quietPrompts() || (host == null || host.equals(""))) {
	    ...
	    String input =
                interactor.promptLine("\r\33[2KSSH Server/Alias: ", host);
	    input = input.trim();
