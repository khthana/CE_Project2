/****************************************************************************
** icmpEchoReqForm meta object code from reading C++ file 'icmpechoreqform.h'
**
** Created: Thu Jan 27 19:35:47 2005
...
QMetaObject* icmpEchoReqForm::staticMetaObject()
{
    ...
    static const QUMethod slot_0 = {"GenerateICMPReq", 0, 0 };
    static const QUMethod slot_1 = {"progressecho", 0, 0 };
    static const QUMethod slot_2 = {"languageChange", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "GenerateICMPReq()", &slot_0, QMetaData::Public },
	{ "progressecho()", &slot_1, QMetaData::Public },
...
bool icmpEchoReqForm::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 0: GenerateICMPReq(); break;
    case 1: progressecho(); break;
