...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="eeeeee">
  <?
			...
			mysql_connect("$hostname","$user","$password") or die ("can't connect data base server");//ติดต่อ data base
			mysql_select_db("$dbname")or die("can't conected database");//เลือกฐานข้อมูล
			$sql2= "SELECT * FROM `la`  WHERE USER_NAME='$username' and TYPE='ลาพักผ่อน'";
 ...
 ?>
  <tr> 
    <td align="left" valign="top"><form action="g_from2.php?data_date=<?=$data_date;?>"  method="post" target="_blank">
	...
	<input type="hidden"  name="d19" value="<? echo "$re_yos $re_username $re_sername";?>" >
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="38" bgcolor="#990000">&nbsp;<img src="images/icon2/ico416.gif" width="16" height="21" align="absmiddle">&nbsp;<span class="style8"><strong>ใบลาพักผ่อน</strong></span></td>
          </tr>
        </table>
        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="eeeeee">
          <tr align="center" class="style4"> 
            <td height="43" class="title">ใบลาพักผ่อน</td>
          </tr>
          <tr align="center" class="style4"> 
            <td>ข้าพเจ้า<? echo "$re_yos $re_username $re_sername";?> ตำแหน่ง 
              <?=$re_positionuser;?>
              ระดับ 
              <?=$re_level;?>
          ...
          <tr align="left" class="style4"> 
            <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;มีวันลาพักผ่อนสะสม 
              <input name="d1" type="text" id="d1" size="3">
              วันทำการ ขอลาพักผ่อน</td>
          </tr>
          <tr align="left" class="style4"> 
            <td align="center">&nbsp;&nbsp;ตั้งแตวันที่ 
              <select  
          ...
          <tr align="left" class="style4"> 
            <td align="center">&nbsp;&nbsp;ถึงวันที่&nbsp;&nbsp;&nbsp; <select  
                        name=d7 id="d7">
                <option value=1>1</option>
                <option 
                          value=2>2</option>
          ...
          <tr align="left" class="style4"> 
            <td align="center">&nbsp;&nbsp;ในระหว่างลาจะติดต่อข้าพเจ้าได้ที่ 
              <input name="d18" type="text" id="d18" size="10"></td>
          </tr>
          <tr align="center" class="style4"> 
            <td><input type="submit" name="Submit" value="ส่งแบบฟอร์ม"></td>
          </tr>
        </table>
      </form></td>
  </tr>
