...
$pdf->SetMargins(30,10,30);
						...
						$txt="มีวันลาพักผ่อนสะสม $d1 วันทำการ มีสิทธิลาพักผ่อนประจำปีนี้อีก 10 วันทำการ รวมเป็น $sum วันทำการ";
						$pdf->MultiCell(0,$InterLigne,$txt,0,'J',0,0); 
						$txt="ขอลาพักผ่อนตั้งแต่วันที่ $d4  เดือน $d5 พ.ศ.$d6  ถึงวันที่ $d7 เดือน $d8 พ.ศ. $d9 มีกำหนด $d10  วันทำการ";
						$pdf->MultiCell(0,$InterLigne,$txt,0,'J',0,10); 
						$txt="ในระหว่างลาจะติดต่อข้าพเจ้าได้ที่ $d18 ";
						$pdf->MultiCell(0,$InterLigne,$txt,0,'J',0,10); 		
