...
<body>
<form name="form1" method="post" action="index2.php?data=save3&username=<?=$username;?>&pwd=<?=$pwd;?>&data1=<?=$data1;?>">
  <table width="100%" border="0">
    ...
    <tr> 
      <td align="left" valign="top">ระยะเวลา</td>
    ...
    <tr> 
      <td rowspan="5" align="left" valign="top">ประเภท&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      </td>
      <td> <input name="type_order" type="radio" value="order" checked>
        ประกาศ(ไม่แจ้ง)</td>
    </tr>
    <tr> 
      <td><input type="radio" name="type_order" value="order_and_sent">
        ประกาศและแจ้งทุกuser</td>
    </tr>
    <tr>
      <td><input type="radio" name="type_order" value="sent_all">
        แจ้งทุกuser</td>
    </tr>
    <tr> 
      <td><input type="radio" name="type_order" value="order_to">
        ประกาศระบุuser&nbsp;&nbsp;&nbsp; </td>
    </tr>
    <tr> 
      <td> <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr align="center" valign="top" bgcolor="#999999"> 
            <td height="28" align="left"> <p><span class="style3"><span class="style1"> 
