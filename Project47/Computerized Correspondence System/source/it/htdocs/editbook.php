...
<?php
				...
				$data1=$re_ID_BOOKS;
		 	?>
<form action="index2.php?data=save2&username=<?=$username;?>&pwd=<?=$pwd;?>&data1=<?=$data1;?>" method="post" enctype="multipart/form-data" name="form1"  >
  <table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#33CCFF">
    <tr bgcolor="#009933"> 
      <td colspan="4" align="center">ข้อมูลการลงทะเบียนหนังสือรับ</td>
    </tr>
    <tr> 
      <td align="left" valign="top">เลขทีรับหนังสือ</td>
      <td colspan="3"><?=$re_ID_BOOKS;?></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td colspan="3"><input name="att" type="text" id="att" value="<?=$re_AT;?>"></td>
    </tr>
    <tr> 
      <td><p>วันที่</p></td>
      <td colspan="3"><p> 
          <input name="date_book"  type="text" id="date_book" value="<?=$re_DATE;?>"  >
        </p></td>
    </tr>
    <tr> 
