      ...
      <table width="550" border="1" cellpadding="0" cellspacing="0" bordercolor="#345487" bgcolor="#eef2f7">
        <tr>
          <td background="images/logo.gif">
            <div align="center"><strong>Error Page </strong></div></td>
        </tr>
        <tr>
          <td><div align="center">
              <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><p align="center" class="style1">Please Login before use recent pages </p>
                    <p align="center">*This page will return to Account Registeration in 5 Sec. </p></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
