...
<%
	...
	try {
		...
		pname = new String(pname.getBytes("ISO8859_1"), "TIS-620");
		address = new String(address.getBytes("ISO8859_1"), "TIS-620");
		tel = new String(tel.getBytes("ISO8859_1"), "TIS-620");
		detail = new String(detail.getBytes("ISO8859_1"), "TIS-620");
		
		call.setOperationName(new QName("http://161.246.5.68/axis/services/YellowPageServices", "setPersonDetail"));
		result = (String)call.invoke(new Object[] {user, password, name, surname, pid, pname, address, tel, detail});
	} catch (Exception e) {}
%>
        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  <p><font color="#0000CC" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::Add Person:: </strong></font></p>
                  <blockquote>
                    <table width="399" border="0">
                      <tr>
                        <td width="64">Person_Name</td>
                        <td><%=name%></td>
                      </tr>
                      <tr>
