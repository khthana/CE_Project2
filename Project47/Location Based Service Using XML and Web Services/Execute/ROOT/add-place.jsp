        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  ...
                  <blockquote>
					<form method="post" action="add-place2.jsp">
                    <table width="0" border="0">
                      ...
                      <tr>
                        <td>Website</td>
                        <td><input name="website" type="text" size="50" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td>OpenTime</td>
                        <td><input name="opentime" type="text" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Lat</td>
                        <td><input name="lat" type="text" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Lon</td>
                        <td><input name="lon" type="text" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Detail</td>
