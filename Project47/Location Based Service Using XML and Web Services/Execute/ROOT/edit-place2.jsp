...
<%
	...
	try {
		...
		result = (String [])call.invoke(new Object[] {user, password, pid, name, type});

		pid = result[0];
		name = new String(result[1].getBytes("ISO8859_1"), "TIS-620");
		type = new String(result[2].getBytes("ISO8859_1"), "TIS-620");
		tel = new String(result[3].getBytes("ISO8859_1"), "TIS-620");
		website = new String(result[4].getBytes("ISO8859_1"), "TIS-620");
		opentime = new String(result[5].getBytes("ISO8859_1"), "TIS-620");
		lat = result[6];
		lon = result[7];
		detail = new String(result[8].getBytes("ISO8859_1"), "TIS-620");
	} catch (Exception e) {}
%>
        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  <p><font color="#0000CC" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::Edit Place:: </strong></font></p>
                  <blockquote>
                      <table width="399" border="0">
                        <tr>
                          <td width="64">Place_ID</td>
                          <td><%=pid%></td>
                        </tr>
                        <tr>
                          <td>Name</td>
                  ...
                  <p>Edit your information below then push 'Submit' button. </p>
                  <blockquote>
					<form method="post" action="edit-place3.jsp">
                    <table width="0" border="0">
                      ...
                      <tr>
                        <td>Name</td>
                        <td><input name="name" type="text" value="<%=name%>" size="50" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td>Type</td>
                        <td><select name="type">
                          ...
                          <option>Restaurant</option>
                          <option>Tourpoint</option>
                        </select></td>
                      </tr>
                      <tr>
                        <td>Tel</td>
                        <td><input name="tel" type="text" value="<%=tel%>" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Website</td>
                        <td><input name="website" type="text" value="<%=website%>" size="50" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td>OpenTime</td>
                        <td><input name="opentime" type="text" value="<%=opentime%>" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Lat</td>
                        <td><input name="lat" type="text" value="<%=lat%>" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Lon</td>
                        <td><input name="lon" type="text" value="<%=lon%>" size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Detail</td>
                        <td><textarea name="detail" cols="50" rows="4"><%=detail%></textarea></td>
                      </tr>
                      <tr>
