...
<%
	...
	try {
		...
		surname = new String(surname.getBytes("ISO8859_1"), "TIS-620");

		call.setOperationName(new QName("http://161.246.5.68/axis/services/YellowPageServices", "getPersonDetail"));
		result = (String [])call.invoke(new Object[] {user, password, id, name, surname});

		id = result[0];
		name = new String(result[1].getBytes("ISO8859_1"), "TIS-620");
		surname = new String(result[2].getBytes("ISO8859_1"), "TIS-620");
		pid = result[3];
		pname = new String(result[4].getBytes("ISO8859_1"), "TIS-620");
		address = new String(result[5].getBytes("ISO8859_1"), "TIS-620");
		tel = new String(result[6].getBytes("ISO8859_1"), "TIS-620");
		detail = new String(result[7].getBytes("ISO8859_1"), "TIS-620");
	} catch (Exception e) {}
%>
        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  ...
                  <p>Edit your information below then push 'Sumbit' button.</p>
                  <blockquote>
                    <table width="399" border="0">
                      <tr>
                        <td width="64">Person_ID</td>
                        <td><input name="id" type="text" value=" " size="10" maxlength="10"></td>
                      </tr>
                      <tr>
                        <td>Person_Name</td>
                        <td><input name="name" type="text" value=" " size="50" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td>Person_Surname</td>
                        <td><input name="surname" type="text" value=" " size="50" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td>Place_ID</td>
                        <td><input name="pid" type="text" value=" " size="10" maxlength="10"></td>
                      </tr>
                      <tr>
                        <td>Place_Name</td>
                        <td><input name="pname" type="text" value=" " size="50" maxlength="50"></td>
                      </tr>
                      <tr>
                        <td>Address</td>
                      ...
                      <tr>
                        <td>Tel</td>
                        <td><input name="tel" type="text" value=" " size="20" maxlength="20"></td>
                      </tr>
                      <tr>
                        <td>Detail</td>
