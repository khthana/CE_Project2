...
<%
	...
	try {
		...
		call.setOperationName(new QName("http://161.246.5.68/axis/services/MapServices", "searchPlace"));
		result = (String)call.invoke(new Object[] {user, password, name, type});
        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  <p><font color="#0000CC" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::Search Place:: </strong></font></p>
                  <blockquote>
