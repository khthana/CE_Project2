...
<%
	...
	try {
		...
		call.setOperationName(new QName("http://161.246.5.68/axis/services/YellowPageServices", "searchPerson"));
		result = (String)call.invoke(new Object[] {user, password, name, surname});

		result = new String(result.getBytes("ISO8859_1"), "TIS-620");
	} catch (Exception e) {}
%>
        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  <p><font color="#0000CC" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::Search Person:: </strong></font></p>
                  <blockquote>
