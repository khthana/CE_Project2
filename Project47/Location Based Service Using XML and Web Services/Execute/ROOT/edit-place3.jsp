...
<%
	...
	try {
		...
		call.setOperationName(new QName("http://161.246.5.68/axis/services/MapServices", "editPlaceDetail"));
		result = (String)call.invoke(new Object[] {user, password, pid, name, type, tel, website, opentime, lat, lon, detail});
	} catch (Exception e) {}
%>
