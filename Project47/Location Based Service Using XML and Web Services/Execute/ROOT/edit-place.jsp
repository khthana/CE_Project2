        ...
        <td width="881"><table width="884" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
                <td valign="top"><blockquote>
                  ...
                  <p>Choose your location that you want to edit by entering your location's information below. </p>
                  <blockquote>
					  <form method="post" action="edit-place2.jsp">
                      <table width="399" border="0">
                        <tr>
                          <td width="64">Place_ID</td>
                          <td><input name="pid" type="text" size="10" maxlength="10"></td>
                        </tr>
                        <tr>
                          <td>Name</td>
