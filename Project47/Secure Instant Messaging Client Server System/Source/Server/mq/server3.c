	...
	//fprintf(stdout,"------------------> %#x\n",channel);	
        ...
        switch(channel)
        {
            ...
            case 0x2: 
							...
							request_info(ssl,buffer_read,user_id,list);
							/*free buffer of the channel*/
							for(i = 0;i < MAX_MESSAGE;i++)
								buffer_read[i] = '\0';
                     		break;
