<%@ Page Language="C#" MasterPageFile="~/WebRest/MasterPage.master" AutoEventWireup="true" CodeFile="Booked.aspx.cs" Inherits="WebRest_Booked" Title="WebRest MCL Project" %>
            ...
            <div id="timesheet">
                ...
                <legend>Booked</legend>
                    ...
                    <table style="width: 300px; height: 33px">
                        <tr>
                            <td style="width: 100px">
                            <asp:GridView ID="GridViewbooked" runat="server" BackColor="White" BorderColor="#E7E7FF"
                            BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Horizontal" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
