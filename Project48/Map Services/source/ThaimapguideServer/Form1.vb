...
#Region "Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(544, 400)
        ...
        'exitButton
        '
        Me.exitButton.Location = New System.Drawing.Point(544, 432)
        ...
        Me.Text = "ThaiMapGuide Server by MCL 2005"
...
#End Region 
        ...
        Try
            While True
                ...
                If clientdata.Chars(0) = "A" Then
                    ...
                    Dim tmp As String = CType(mapName(curMapIndex), String)
                    If tmp.Equals("Bangkok Full") Then
                        TmgX1.SetScale(0)
                    Else
                        TmgX1.SetScale(2)
                    End If
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        'TmgX1.SetCenter(myLat, myLon)
        Dim l1, l2 As Double
        TmgX1.GetCenter(l1, l2)
        TmgX1.AddWaypoint(" ", l1, l2, 1, 1, "")
    End Sub
