...
PAM_EXTERN int pam_sm_authenticate(pam_handle_t * pamh, int flags, int argc, const char **argv)
{
	...
	const char * username;
//	const char * uid;
	char result_file[20]="/tmp/anubis.lock";
//	char * passwd;
	int retval;
	pid_t pid;
...
//	fprintf(stdout, "Hello %s\n", uid);
	...
	char face_gaborrg[100] = "/root/gaborrg_jet.xml";
	char face_jets[100] = "/root/face_jet.xml";
/*
...
*/
	...
	switch(pid)
	{
		...
		case 0:
			...
			execl("anubisrecog", "anubisrecog", "-j", face_gaborrg, "-f", face_jets,0);
			break;
		default:
			sleep(3);
