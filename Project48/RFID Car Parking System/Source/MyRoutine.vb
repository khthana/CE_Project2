...
Module MyRoutine
	...
	Public rHandle As Short
	Public retcode As Short
	Public SID As Byte
	Public Sec As Short
	...
	Public Function ErrDef(ByVal ErrCode As Short) As String
	...
	Public Function KeyVerify(ByVal key As Short) As Short
	...
	Public Function StrHEX_Dec(ByVal StrHex As String) As Short
	...
	Public Function Hex_Dec(ByRef val_Renamed As System.Windows.Forms.TextBox, ByVal start As Byte) As Byte
		Dim MSB As Byte
		Dim LSB As Byte
		Dim Fbyte As Byte
		...
		MSB = StrHEX_Dec(Mid(val_Renamed.Text, start, 1))
		LSB = StrHEX_Dec(Mid(val_Renamed.Text, start + 1, 1))
		Fbyte = (MSB * 16) + LSB
