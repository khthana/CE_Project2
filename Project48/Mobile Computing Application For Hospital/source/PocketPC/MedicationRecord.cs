...
{
	/// <summary>
	/// Summary description for MedicationRecord.
	/// </summary>
	public class MedicationRecord : System.Windows.Forms.Form
	{
		...
		{
			MedicationRecord2 st = new MedicationRecord2();
			st.Show();
		}
	}
}
