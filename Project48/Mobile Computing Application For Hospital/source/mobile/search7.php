<?
		...
		check_session();
		header_officer("สืบค้นข้อมูลผู้ป่วย");
...
<TR bgColor="99FFFF">
    ...
    <TD  width="10%"><font face = "MS Sans Serif" color="#000000" size="1">$id_card</font></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$name</FONT></TD>
    <TD  width="7%"><font face = "MS Sans Serif" color="#000000" size="1">$bg</FONT></TD>
    <TD  width="8%"><font face = "MS Sans Serif" color="#000000" size="1">$h</FONT></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$w</FONT></TD>
	<TD  width="13%"><font face = "MS Sans Serif" color="#000000" size="1">$o</FONT></TD>
	<TD  width="13%"><font face = "MS Sans Serif" color="#000000" size="1">$mp</FONT></TD>
	<TD  width="10%"><font face = "MS Sans Serif" color="#000000" size="1">$p</FONT></TD></TR>
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;<A Href="."form_search7.php".">กลับไปค้นหาใหม่ </A></tr><br>";
