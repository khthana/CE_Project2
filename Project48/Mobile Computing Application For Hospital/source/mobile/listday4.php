...
//เเสดงก่อนคลิก
		  ...
		  $sql = "select tbltestrecord.ListID,Name,RoomTypeName,RoomNo,Bed  from tbltestrecord,tblpatientbasicdata,tblroom where tbltestrecord.PatientID= tblpatientbasicdata.PatientID and tblroom.RoomTypeID = tbltestrecord.RoomTypeID  and tbltestrecord.status = 0";
		  ...
		  $sql = "select  *  from tbltestrecord,tblpatientbasicdata,tblroom where tbltestrecord.PatientID= tblpatientbasicdata.PatientID and tblroom.RoomTypeID = tbltestrecord.RoomTypeID  and tbltestrecord.status = 0 and ListID = ".$ListID." ";
