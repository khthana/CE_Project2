<?
		...
		$sql_search = "select * from $tblname where $type like '%$search%' order by DoctorID,DoctorName";	
...
?>
	...
	<TBODY>
		<TR bgColor=#CCCCCC>
			...
			<TD align=middle width="20%"><font face = "MS Sans Serif" color="#000000" size="1"><B>ที่อยู่</B></FONT></TD>
			<TD align=middle width="15%"><font face = "MS Sans Serif" color="#000000" size="1"><B>หมวดหมุ่ความเชี่ยวชาญ </B></FONT></TD>
			<TD align=middle width="13%"><font face = "MS Sans Serif" color="#000000" size="1"><B>เบอร์โทรศัพท์มือถือ</B></FONT></TD>
			<TD align=middle width="13%"><font face = "MS Sans Serif" color="#000000" size="1"><B>เบอร์โทรศัพท์บ้าน</B></FONT></TD>
			<TD align=middle width="4%"><font face = "MS Sans Serif" color="#000000" size="1"><B>อีเมล์</B></FONT></TD>
		</TR>
...
print <<<EOT
<TR bgColor="99FFFF">
    <TD width="7%"><font face = "MS Sans Serif" color="#000000" size="1">$doctorid </font></TD>
    <TD width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$doctorname</FONT></TD>
    <TD width="20%"><font face = "MS Sans Serif" color="#000000" size="1">$address</FONT></TD>
    <TD width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$catid</FONT></TD>
	<TD width="13%"><font face = "MS Sans Serif" color="#000000" size="1">$mobilephone</FONT></TD>
	<TD width="13%"><font face = "MS Sans Serif" color="#000000" size="1">$phone</FONT></TD>
	<TD width="10%"><font face = "MS Sans Serif" color="#000000" size="1">$email</FONT></TD></TR>
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;<A Href="."form_search6.php".">กลับไปค้นหาใหม่ </A></tr><br>";
