<?
		...
		check_session();
		header_officer("สืบค้นประวัติการรักษา");

		$dbname = "hospital";	
		$tblname = "tbltreathistory";	
		mysql_select_db($dbname) or die("เลือกฐานข้อมูลไม่ได้");
		$sql_search = "select * from $tblname,tbldoctor,tblpatientbasicdata,tbldisease where $type like '%$search%' and tbldoctor.DoctorID=$tblname.DoctorID and tblpatientbasicdata.PatientID=$tblname.PatientID and $tblname.DiseaseID=tbldisease.DiseaseID order by ListID";	
...
?>
	...
	<TBODY>
		<TR bgColor=#FFCCFF>
			<TD align=middle width="4%"><font face = "MS Sans Serif" color="#000000" size="1"><B>ลำดับ</B></FONT></TD>
			<TD align=middle width="7%"><font face = "MS Sans Serif" color="#000000" size="1"><B>รหัสผู้ป่วย</B></FONT></TD>
			<TD align=middle width="15%"><font face = "MS Sans Serif" color="#000000" size="1"><B>ชื่อผู้ป่วย</B></FONT></TD>
			<TD align=middle width="15%"><font face = "MS Sans Serif" color="#000000" size="1"><B>ชื่อเเพทย์</B></FONT></TD>
			<TD align=middle width="15%"><font face = "MS Sans Serif" color="#000000" size="1"><B>โรคที่ป่วย</B></FONT></TD>
			<TD align=middle width="15%"><font face = "MS Sans Serif" color="#000000" size="1"><B>เข้ารับการรักษา</B></FONT></TD>
			<TD align=middle width="15%"><font face = "MS Sans Serif" color="#000000" size="1"><B>ออก </B></FONT></TD>
		</TR>
...
print <<<EOT
<TR bgColor="99FFFF">
    <TD  width="4%"><font face = "MS Sans Serif" color="#000000" size="1">$list </font></TD>
    <TD  width="7%"><font face = "MS Sans Serif" color="#000000" size="1">$p_id</FONT></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$p_name</FONT></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$d_name</FONT></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$disease</FONT></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$date_admis</FONT></TD>
    <TD  width="15%"><font face = "MS Sans Serif" color="#000000" size="1">$date_ex</FONT></TD>
...
echo "&nbsp;&nbsp;&nbsp;&nbsp;<A Href="."form_search8.php".">กลับไปค้นหาใหม่ </A></tr><br>";
