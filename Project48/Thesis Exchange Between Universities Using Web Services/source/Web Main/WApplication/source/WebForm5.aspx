<%@ Page language="c#" Codebehind="WebForm5.aspx.cs" AutoEventWireup="false" Inherits="WApplication.WebForm5" %>
		...
		<FORM id="Form1" method="post" runat="server">
			...
			<td width="75%">
				<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="300" align="center" border="1">
					<tr>
						<asp:table id="Table1" runat="server" Width="100%" Height="44px"></asp:table></tr>
				</TABLE>
			</td>
			<tr>
			</tr>
