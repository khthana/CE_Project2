<%@ Page language="c#" Codebehind="WebForm6.aspx.cs" AutoEventWireup="false" Inherits="WApplication.WebForm6" %>
									...
									<DIV class="wpmd">
										<DIV><FONT face="Tahoma"><B>
													<DIV><FONT face="Tahoma"><B><A class="style1" href="index.aspx">หน้าหลัก</A></B></FONT><FONT face="Tahoma" color="#333333"><B>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
															...
															</B></FONT><FONT face="Tahoma" color="#333333"><B>&nbsp;</B></FONT><FONT face="Tahoma" color="#333333"><B>&nbsp;&nbsp;<A class="style1" href="WebForm2.aspx">ค้นหาจากชื่อคน</A>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</B></FONT><FONT face="Tahoma" color="#333333"><B>&nbsp;&nbsp;&nbsp;</B></FONT><FONT face="Tahoma" color="#333333"><B>&nbsp;&nbsp;</B></FONT><FONT face="Tahoma" color="#333333"><B class="style1"><FONT color="#800080"><FONT face="Tahoma" color="#333333"><B class="style1"><FONT color="#800080"><A class="style1" href="WebQuset.aspx"><FONT color="purple">ถาม-ตอบ</FONT></A></FONT></B></FONT></FONT>
															</B></FONT>
													</DIV>
												</B></FONT>
										</DIV>
			...
			<TD width="75%">
				<P>
					<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="1">
						<TR>
							<TD style="HEIGHT: 3px" width="5"></TD>
							<TD style="HEIGHT: 3px">
								<P align="center"><asp:label id="Label1" runat="server" Font-Size="16pt" ForeColor="Blue">Label</asp:label><BR>
									<asp:Label id="Label2" runat="server" ForeColor="Teal" Font-Size="14pt" Visible="False">Label</asp:Label>&nbsp;
									<asp:Label id="Label3" runat="server" ForeColor="Teal" Font-Size="14pt" Visible="False">Label</asp:Label><BR>
									&nbsp;
									<asp:Label id="Label4" runat="server" ForeColor="Teal" Font-Size="14pt" Visible="False">Label</asp:Label></P>
							</TD>
							<TD style="HEIGHT: 3px" width="5"></TD>
						</TR>
						<TR>
							<TD colSpan="3">
								<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="1">
									<TR>
										<TD align="center"><asp:datagrid id="DataGrid1" runat="server" Font-Size="Smaller" CellPadding="0" AllowPaging="True"
												Width="504px" ShowFooter="True" Visible="False">
