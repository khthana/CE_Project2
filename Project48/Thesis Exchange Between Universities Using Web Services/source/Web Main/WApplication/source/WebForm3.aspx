<%@ Page language="c#" Codebehind="WebForm3.aspx.cs" AutoEventWireup="false" Inherits="WApplication.WebForm3" %>
...
<HTML>
	...
	<body>
		<FORM id="Form1" method="post" runat="server">
				...
				<P>
					<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
						<tr>
							...
							<td style="WIDTH: 531px" align="center" bgColor="#cccccc"><asp:label id="Label1" runat="server" Font-Size="16pt" ForeColor="#C00000">ผลการค้นหา</asp:label></td>
							<td></td>
						</tr>
						<tr>
							<td style="WIDTH: 20px"></td>
							<td style="WIDTH: 531px" bgColor="#99ffcc">
								<P>
									<asp:hyperlink id="HyperLink1" runat="server" Font-Size="Smaller">HyperLink</asp:hyperlink><BR>
									<asp:hyperlink id="HyperLink2" runat="server" Visible="False" Font-Size="Medium">HyperLink</asp:hyperlink><BR>
									<asp:hyperlink id="HyperLink3" runat="server" Visible="False" Font-Size="Medium">HyperLink</asp:hyperlink></P>
							</td>
							<td></td>
						</tr>
						<tr>
						...
						<TR>
							<TD style="WIDTH: 20px"></TD>
							<TD style="WIDTH: 531px" align="center" borderColor="#339966"></TD>
							<TD></TD>
						</TR>
						<TR>
							<TD style="WIDTH: 20px; HEIGHT: 36px"></TD>
							<TD style="WIDTH: 531px; HEIGHT: 31px" align="center" borderColor="#339966">
								<P align="left">&nbsp;</P>
							</TD>
						...
						<TR>
							<TD style="WIDTH: 20px"></TD>
							<TD style="WIDTH: 531px" align="center"></TD>
							<TD></TD>
						</TR>
					</TABLE>
				</P>
			...
			<tr>
				<td colSpan="2">
					<P><IMG alt="" src="/WApplication/image/bot1.gif"><IMG height="47" src="/WApplication/image/bot2.gif" width="28"><IMG height="47" src="http://localhost/WApplication/image/botmenu_bg.gif" width="539"></P>
				</td>
			</tr>
			<tr bgColor="#94a8b4">
