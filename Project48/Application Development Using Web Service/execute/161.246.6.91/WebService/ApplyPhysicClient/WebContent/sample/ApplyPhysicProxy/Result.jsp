...
<jsp:useBean id="ApplyPhysicProxyid" scope="session" class="WS.ApplyPhysicProxy" />
...
case 2:
        ...
        ApplyPhysicProxyid.useJNDI(useJNDI_0idTemp);
break;
case 7:
        gotMethod = true;
        java.lang.String getEndpoint7mtemp = ApplyPhysicProxyid.getEndpoint();
...
case 10:
        ...
        ApplyPhysicProxyid.setEndpoint(endpoint_1idTemp);
break;
case 15:
        gotMethod = true;
        WS.ApplyPhysic getApplyPhysic15mtemp = ApplyPhysicProxyid.getApplyPhysic();
if(getApplyPhysic15mtemp == null){
%>
<%=getApplyPhysic15mtemp %>
<%
}else{
%>
<TABLE>
...
<%
if(getApplyPhysic15mtemp != null){
java.lang.String typecourseAll18 = getApplyPhysic15mtemp.getCourseAll();
...
case 20:
        gotMethod = true;
        java.lang.String getCourseAll20mtemp = ApplyPhysicProxyid.getCourseAll();
...
case 23:
        ...
        boolean buyClass23mtemp = ApplyPhysicProxyid.buyClass(classID_2idTemp,email_3idTemp,receiveID_4idTemp);
...
case 32:
        ...
        boolean reservation32mtemp = ApplyPhysicProxyid.reservation(classID_5idTemp,email_6idTemp,name_7idTemp,surname_8idTemp,phoneNo_9idTemp);
...
case 45:
        ...
        java.lang.String getCourse45mtemp = ApplyPhysicProxyid.getCourse(subject_10idTemp,period_11idTemp);
...
case 52:
        ...
        java.lang.String getCourseFromEmail52mtemp = ApplyPhysicProxyid.getCourseFromEmail(email_12idTemp);
...
case 57:
        ...
        boolean cancel57mtemp = ApplyPhysicProxyid.cancel(classID_13idTemp,email_14idTemp);
