'*****************************************************************************************
'Class AccountHisDA  : Definition Class for Database connection to account history table *
'*****************************************************************************************
Imports System.Data
Imports Oracle.DataAccess.Client
Public Class AccountHisDA
    '*************************************************************
    'AccountHisInsert : insert new account history to thw system *
    '*************************************************************
    ...
    End Function
    '****************************************************
    'SelectDataset : select a group of account history  *
    '****************************************************
