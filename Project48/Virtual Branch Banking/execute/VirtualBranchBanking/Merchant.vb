'**********************************************************************************
'Class Merchant  : Definition Class for Merchant who join in the payment service  *
'**********************************************************************************
Public Class Merchant
    ...
    Public Function Check(ByVal mer As Merchant) As Merchant
        ...
        Return merChecked
    End Function
    Public Function CheckByMerchantName(ByVal mer As Merchant) As Merchant
        Dim merDA As New MerchantDA
        Dim merChecked As New Merchant
        merChecked = merDA.MerchantSelectByMerchantName(mer)
        Return merChecked
    End Function
End Class
