<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PayHistoryPage.aspx.vb" Inherits="VirtualBranchBanking.PayHistoryPage"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:label id="Label6" style="Z-INDEX: 135; LEFT: 56px; POSITION: absolute; TOP: 32px" runat="server"
				Font-Size="Medium" Font-Names="Arial" Font-Bold="True" ForeColor="Black" Height="24px">Virtual Branch Banking</asp:label><asp:imagebutton id="quickPayButton" style="Z-INDEX: 144; LEFT: 232px; POSITION: absolute; TOP: 96px"
			...
			<TABLE id="Table2" style="Z-INDEX: 136; LEFT: 216px; WIDTH: 520px; POSITION: absolute; TOP: 56px; HEIGHT: 21px"
			...
			<TABLE id="Table4" style="Z-INDEX: 137; LEFT: 56px; WIDTH: 656px; POSITION: absolute; TOP: 112px; HEIGHT: 288px"
							...
							<TABLE id="Table1" style="WIDTH: 656px; HEIGHT: 232px" cellSpacing="0" cellPadding="0"
								...
								<TR>
									...
									<TD><FONT face="Tahoma"></FONT><FONT face="Tahoma">
											<DIV style="WIDTH: 481px; POSITION: relative; HEIGHT: 232px" ms_positioning="GridLayout">
												...
												<asp:label id="Label1" style="Z-INDEX: 144; LEFT: 16px; POSITION: absolute; TOP: 8px" runat="server"
													Font-Size="X-Small" Font-Names="Tahoma" Font-Bold="True" ForeColor="#404040">Payment History</asp:label><asp:label id="Label3" style="Z-INDEX: 144; LEFT: 16px; POSITION: absolute; TOP: 24px" runat="server"
													Font-Size="XX-Small" Font-Names="Tahoma" Font-Bold="True" ForeColor="#404040">Customer Name</asp:label><asp:label id="cusNameLabel" style="Z-INDEX: 144; LEFT: 96px; POSITION: absolute; TOP: 24px"
													runat="server" Font-Size="XX-Small" Font-Names="Tahoma" ForeColor="Blue"></asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 144; LEFT: 0px; POSITION: absolute; TOP: 48px" runat="server"
			...
			<TABLE id="Table3" style="Z-INDEX: 138; LEFT: 56px; WIDTH: 167px; POSITION: absolute; TOP: 56px; HEIGHT: 34px"
			...
			<asp:label id="noOfUser" style="Z-INDEX: 139; LEFT: 696px; POSITION: absolute; TOP: 416px"
				runat="server" Font-Size="XX-Small" Font-Names="Microsoft Sans Serif" ForeColor="#0000C0"></asp:label><asp:label id="Label2" style="Z-INDEX: 140; LEFT: 640px; POSITION: absolute; TOP: 416px" runat="server"
				Font-Size="XX-Small" Font-Names="Microsoft Sans Serif">Now online</asp:label><asp:label id="Label5" style="Z-INDEX: 141; LEFT: 624px; POSITION: absolute; TOP: 80px" runat="server"
				Font-Size="XX-Small" Font-Names="Microsoft Sans Serif">Hello</asp:label><asp:label id="userLabel" style="Z-INDEX: 142; LEFT: 648px; POSITION: absolute; TOP: 80px"
				runat="server" Font-Size="XX-Small" Font-Names="Arial" ForeColor="Maroon" Height="8px"></asp:label><asp:label id="Label4" style="Z-INDEX: 143; LEFT: 56px; POSITION: absolute; TOP: 96px" runat="server"
				BackColor="Black" Width="176px" Font-Size="X-Small" Font-Names="Arial"></asp:label></form>
	</body>
</HTML>
