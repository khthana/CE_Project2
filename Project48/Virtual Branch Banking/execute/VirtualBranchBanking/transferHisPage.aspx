<%@ Page Language="vb" AutoEventWireup="false" Codebehind="transferHisPage.aspx.vb" Inherits="VirtualBranchBanking.transferHisPage"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label3" style="Z-INDEX: 105; LEFT: 56px; POSITION: absolute; TOP: 32px" runat="server"
				...
				runat="server" Width="60px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\depositMenuButton.jpg"></asp:imagebutton><asp:imagebutton id="transferMenuButton" style="Z-INDEX: 106; LEFT: 416px; POSITION: absolute; TOP: 96px"
				runat="server" Width="100px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\transferMenuButton.jpg"></asp:imagebutton><asp:imagebutton id="updatePassButton" style="Z-INDEX: 108; LEFT: 512px; POSITION: absolute; TOP: 96px"
				runat="server" Width="100px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\updateBookMenuButton.jpg"></asp:imagebutton><asp:imagebutton id="transferHisButton" style="Z-INDEX: 110; LEFT: 608px; POSITION: absolute; TOP: 96px"
				runat="server" Width="100px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\transferHisMenuButton.jpg"></asp:imagebutton>
			<TABLE id="Table2" style="Z-INDEX: 107; LEFT: 216px; WIDTH: 520px; POSITION: absolute; TOP: 56px; HEIGHT: 21px"
			...
			<TABLE id="Table4" style="Z-INDEX: 109; LEFT: 56px; WIDTH: 656px; POSITION: absolute; TOP: 112px; HEIGHT: 288px"
								...
								<TR>
									...
									<TD><FONT face="Tahoma"></FONT><FONT face="Tahoma">
											<DIV style="WIDTH: 473px; POSITION: relative; HEIGHT: 232px" ms_positioning="GridLayout">
												...
												<asp:label id="Label1" style="Z-INDEX: 122; LEFT: 16px; POSITION: absolute; TOP: 8px" runat="server"
													Font-Size="X-Small" Font-Names="Tahoma" Font-Bold="True" ForeColor="#404040">Transfer History</asp:label><asp:label id="Label2" style="Z-INDEX: 122; LEFT: 16px; POSITION: absolute; TOP: 24px" runat="server"
													Font-Size="XX-Small" Font-Names="Tahoma" Font-Bold="True" ForeColor="#404040">Customer Name :</asp:label><asp:label id="cusNameLabel" style="Z-INDEX: 122; LEFT: 104px; POSITION: absolute; TOP: 24px"
													runat="server" Font-Size="XX-Small" Font-Names="Tahoma" ForeColor="Blue"></asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 122; LEFT: 0px; POSITION: absolute; TOP: 40px" runat="server"
													...
													<Columns>
														...
														<asp:BoundColumn DataField="FROM_ACCOUNT" ReadOnly="True" HeaderText="From Account"></asp:BoundColumn>
														<asp:BoundColumn DataField="FROM_ACCOUNT_TYPE" ReadOnly="True" HeaderText="Type"></asp:BoundColumn>
														<asp:BoundColumn DataField="TO_ACCOUNT" ReadOnly="True" HeaderText="To Account"></asp:BoundColumn>
														<asp:BoundColumn DataField="TO_ACCOUNT_TYPE" ReadOnly="True" HeaderText="Type"></asp:BoundColumn>
