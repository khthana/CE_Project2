<%@ Page Language="vb" AutoEventWireup="false" Codebehind="depositPage.aspx.vb" Inherits="VirtualBranchBanking.depositPage"%>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label3" style="Z-INDEX: 106; LEFT: 56px; POSITION: absolute; TOP: 32px" runat="server"
				Font-Names="Arial" Font-Bold="True" Font-Size="Medium" Height="24px" ForeColor="Black">Virtual Branch Banking</asp:label><asp:label id="Label5" style="Z-INDEX: 116; LEFT: 56px; POSITION: absolute; TOP: 96px" runat="server"
				Font-Names="Arial" Font-Size="X-Small" Width="57px" BackColor="Black"></asp:label><asp:imagebutton id="accSumButton" style="Z-INDEX: 101; LEFT: 112px; POSITION: absolute; TOP: 96px"
									...
									<TD><FONT face="Tahoma"></FONT><FONT face="Tahoma">
											<DIV style="WIDTH: 472px; POSITION: relative; HEIGHT: 232px" ms_positioning="GridLayout">
												<TABLE id="Table5" style="Z-INDEX: 100; LEFT: 0px; WIDTH: 472px; POSITION: absolute; TOP: 0px; HEIGHT: 232px"
													...
													<TR>
														<TD id="gridLayout1">
															<asp:Image id="cashCounterImage" style="Z-INDEX: 101; LEFT: 392px; POSITION: absolute; TOP: 16px"
																runat="server" Height="56px" Width="57px" ImageUrl="\VirtualBranchBanking\picture\cashCounter.jpg"
																Visible="False"></asp:Image></TD>
													</TR>
												</TABLE>
												<asp:label id="Label1" style="Z-INDEX: 102; LEFT: 16px; POSITION: absolute; TOP: 8px" runat="server"
													Font-Names="Tahoma" Font-Bold="True" Font-Size="X-Small" ForeColor="#404040">Deposit Money</asp:label><asp:label id="Label2" style="Z-INDEX: 103; LEFT: 136px; POSITION: absolute; TOP: 48px" runat="server"
													Font-Names="Tahoma" Font-Size="X-Small" ForeColor="#404040">To Account</asp:label><asp:dropdownlist id="toAccountList" style="Z-INDEX: 104; LEFT: 208px; POSITION: absolute; TOP: 48px"
													runat="server" Width="128px" Height="22px" AutoPostBack="True"></asp:dropdownlist><asp:textbox id="amountTextBox" style="Z-INDEX: 105; LEFT: 208px; POSITION: absolute; TOP: 72px"
													runat="server" Width="128px" Height="22px"></asp:textbox><asp:label id="Label4" style="Z-INDEX: 106; LEFT: 160px; POSITION: absolute; TOP: 72px" runat="server"
													Font-Names="Tahoma" Font-Size="X-Small" ForeColor="#404040">Amount</asp:label><asp:imagebutton id="depositButton" style="Z-INDEX: 107; LEFT: 200px; POSITION: absolute; TOP: 128px"
													runat="server" Width="80px" Height="22px" ImageUrl="\VirtualBranchBanking\picture\depositButton.jpg"></asp:imagebutton>
												<asp:Image id="recieptImage" style="Z-INDEX: 108; LEFT: 320px; POSITION: absolute; TOP: 112px"
													runat="server" Height="96px" Width="48px" ImageUrl="\VirtualBranchBanking\picture\reciept.jpg"
													BorderWidth="1px" BorderColor="Gray" Visible="False"></asp:Image></DIV>
			...
			<asp:label id="noOfUser" style="Z-INDEX: 112; LEFT: 696px; POSITION: absolute; TOP: 416px"
				runat="server" Font-Names="Microsoft Sans Serif" Font-Size="XX-Small" ForeColor="#0000C0"></asp:label><asp:label id="Label7" style="Z-INDEX: 113; LEFT: 640px; POSITION: absolute; TOP: 416px" runat="server"
				Font-Names="Microsoft Sans Serif" Font-Size="XX-Small">Now online</asp:label><asp:label id="Label6" style="Z-INDEX: 114; LEFT: 624px; POSITION: absolute; TOP: 80px" runat="server"
				Font-Names="Microsoft Sans Serif" Font-Size="XX-Small">Hello</asp:label><asp:label id="userLabel" style="Z-INDEX: 115; LEFT: 648px; POSITION: absolute; TOP: 80px"
				runat="server" Font-Names="Arial" Font-Size="XX-Small" Height="8px" ForeColor="Maroon"></asp:label></form>
	</body>
</HTML>
