<%@ Page Language="vb" AutoEventWireup="false" Codebehind="timeOuterrorPage.aspx.vb" Inherits="VirtualBranchBanking.timeOuterrorPage"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>timeOuterrorPage</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:Label id="Label1" style="Z-INDEX: 100; LEFT: 56px; POSITION: absolute; TOP: 40px" runat="server"
				ForeColor="Black" Font-Bold="True" Font-Size="Smaller" Font-Names="Arial">Application time out, Please log in again...</asp:Label>
