<%@ Page Language="vb" AutoEventWireup="false" Codebehind="outOfServicePage.aspx.vb" Inherits="VirtualBranchBanking.outOfServicePage"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>outOfServicePage</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:Label id="Label1" style="Z-INDEX: 115; LEFT: 56px; POSITION: absolute; TOP: 32px" runat="server"
				Font-Bold="True" Font-Names="Tahoma" Font-Size="X-Small" ForeColor="#404040">Out of Service, Please contact another ATM</asp:Label>
			<TABLE id="Table2" style="Z-INDEX: 117; LEFT: 216px; WIDTH: 520px; POSITION: absolute; TOP: 56px; HEIGHT: 21px"
			...
			<TABLE id="Table3" style="Z-INDEX: 118; LEFT: 56px; WIDTH: 167px; POSITION: absolute; TOP: 56px; HEIGHT: 34px"
