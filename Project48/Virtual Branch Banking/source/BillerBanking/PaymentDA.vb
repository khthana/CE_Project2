...
Public Class PaymentDA
    ...
    End Function
    '*******************************************************************
    Public Function MerPaySelectDataset(ByVal mer As Merchant) As DataSet
        ...
        Dim sqlPayHisSelectDataset As String = "SELECT * FROM PAYMENT WHERE MERCHANT_NAME LIKE '" & mer.GetMerchantName & "' ORDER BY DUE_DATE "
