'*******************************************************************************
'Class timeOuterrorPage  : Definition Class for wrapping the error when that   * 
'                           user discontinue in use with in system define time *                       *                                *
'*******************************************************************************
Public Class timeOuterrorPage
