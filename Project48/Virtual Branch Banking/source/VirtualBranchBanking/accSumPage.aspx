<%@ Page Language="vb" AutoEventWireup="false" Codebehind="accSumPage.aspx.vb" Inherits="VirtualBranchBanking.accSumPage"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<asp:label id="Label9" style="Z-INDEX: 101; LEFT: 56px; POSITION: absolute; TOP: 32px" runat="server"
				Font-Size="Medium" Font-Names="Arial" Font-Bold="True" ForeColor="Black" Height="24px">Virtual Branch Banking</asp:label>
							...
							<TABLE id="Table1" style="WIDTH: 656px; HEIGHT: 232px" cellSpacing="0" cellPadding="0"
								...
								<TR>
									...
									<TD><FONT face="Tahoma"></FONT><FONT face="Tahoma">
											<DIV style="WIDTH: 473px; POSITION: relative; HEIGHT: 234px" ms_positioning="GridLayout">
												<TABLE id="Table5" style="Z-INDEX: 101; LEFT: 0px; WIDTH: 472px; POSITION: absolute; TOP: 0px; HEIGHT: 234px"
													cellSpacing="0" cellPadding="0" width="472" bgColor="#ffffff" border="0">
													<TR>
														<TD id="gridLayout1"></TD>
													</TR>
												</TABLE>
												<asp:label id="Label1" style="Z-INDEX: 105; LEFT: 184px; POSITION: absolute; TOP: 0px" runat="server"
													Font-Size="X-Small" Font-Names="Tahoma" Font-Bold="True" ForeColor="#404040">Account Summary</asp:label><asp:datagrid id="DataGrid1" style="Z-INDEX: 110; LEFT: 0px; POSITION: absolute; TOP: 16px" runat="server"
													...
													<ItemStyle Font-Size="Smaller" Font-Names="Tahoma" HorizontalAlign="Center" ForeColor="#404040"
														VerticalAlign="Middle" BackColor="White"></ItemStyle>
													<HeaderStyle Font-Size="Smaller" Font-Names="Tahoma" Font-Bold="True" HorizontalAlign="Center"
												...
												</asp:datagrid><asp:label id="Label2" style="Z-INDEX: 106; LEFT: 192px; POSITION: absolute; TOP: 136px" runat="server"
													Font-Size="Smaller" Font-Names="Tahoma" Font-Bold="True" ForeColor="#404040">Quick Transfer</asp:label><asp:label id="Label3" style="Z-INDEX: 104; LEFT: 104px; POSITION: absolute; TOP: 160px" runat="server"
													Width="85px" Font-Size="X-Small" Font-Names="Tahoma" ForeColor="DimGray">From Account</asp:label><asp:dropdownlist id="fromAccountList" style="Z-INDEX: 102; LEFT: 192px; POSITION: absolute; TOP: 160px"
													runat="server" Width="120px" AutoPostBack="True" Height="16px"></asp:dropdownlist><asp:label id="Label4" style="Z-INDEX: 103; LEFT: 120px; POSITION: absolute; TOP: 184px" runat="server"
													Width="73px" Font-Size="X-Small" Font-Names="Tahoma" ForeColor="DimGray">To Account</asp:label><asp:dropdownlist id="toAccountList" style="Z-INDEX: 107; LEFT: 192px; POSITION: absolute; TOP: 184px"
													runat="server" Width="120px" AutoPostBack="True"></asp:dropdownlist><asp:label id="Label5" style="Z-INDEX: 108; LEFT: 136px; POSITION: absolute; TOP: 208px" runat="server"
													Width="48px" Font-Size="X-Small" Font-Names="Tahoma" ForeColor="DimGray">Amount</asp:label><asp:textbox id="amountTextBox" style="Z-INDEX: 109; LEFT: 192px; POSITION: absolute; TOP: 208px"
													runat="server" Width="104px" Height="20px"></asp:textbox><asp:imagebutton id="transferButton" style="Z-INDEX: 111; LEFT: 344px; POSITION: absolute; TOP: 208px"
													runat="server" Width="80px" Height="22px" ImageUrl="\VirtualBranchBanking\picture\transferButton.jpg"></asp:imagebutton></DIV>
										</FONT>
									</TD>
								</TR>
							</TABLE>
			...
			<asp:label id="noOfUser" style="Z-INDEX: 105; LEFT: 696px; POSITION: absolute; TOP: 416px"
				runat="server" Font-Size="XX-Small" Font-Names="Microsoft Sans Serif" ForeColor="#0000C0"></asp:label><asp:label id="Label8" style="Z-INDEX: 106; LEFT: 640px; POSITION: absolute; TOP: 416px" runat="server"
				Font-Size="XX-Small" Font-Names="Microsoft Sans Serif">Now online</asp:label><asp:label id="Label7" style="Z-INDEX: 107; LEFT: 624px; POSITION: absolute; TOP: 80px" runat="server"
				...
				runat="server" Font-Size="XX-Small" Font-Names="Arial" ForeColor="Maroon" Height="8px"></asp:label><asp:label id="Label6" style="Z-INDEX: 109; LEFT: 56px; POSITION: absolute; TOP: 96px" runat="server"
				BackColor="Black" Width="57px" Font-Size="X-Small" Font-Names="Arial"></asp:label><asp:imagebutton id="accSumButton" style="Z-INDEX: 110; LEFT: 112px; POSITION: absolute; TOP: 96px"
				...
				runat="server" Width="60px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\depositMenuButton.jpg"></asp:imagebutton><asp:imagebutton id="tranferMenuButton" style="Z-INDEX: 114; LEFT: 416px; POSITION: absolute; TOP: 96px"
				...
				runat="server" Width="100px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\updateBookMenuButton.jpg"></asp:imagebutton><asp:imagebutton id="tranferHisButton" style="Z-INDEX: 116; LEFT: 608px; POSITION: absolute; TOP: 96px"
				runat="server" Width="100px" Height="16px" ImageUrl="\VirtualBranchBanking\picture\transferHisMenuButton.jpg"></asp:imagebutton></form>
	</body>
</HTML>
