'*************************************************************************
'Class openAccPage  : Definition Class for open new account transaction  * 
'                           show as web page                             *
'*************************************************************************
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents newAccTypeList As System.Web.UI.WebControls.DropDownList
    Protected WithEvents Label6 As System.Web.UI.WebControls.Label
    Protected WithEvents newAccNoTextBox As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Public Sub clearAllData()
        ...
        newAccNoTextBox.Text = ""
        newAccTypeList.SelectedIndex = 0
        amountTextBox.Text = ""
    End Sub
    '*************************************************************
    ...
    End Sub
    '********************************************************
    'เหตูการเมื่อกดปุ่ม submit เพื่อทำการ เปิดบัญชีเพิ่ม
    '********************************************************
    Private Sub submitButton_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles submitButton.Click
        ...
        If amountTextBox.Text = "" And newAccNoTextBox.Text = "" Then
            Response.Redirect("errorPage.aspx?reason=Please insert amount or account No...")
            Exit Sub
        Else
            Select Case systemUsed
                Case "CapitalSystem"
                    ...
                    system1.openNewAccService(Session("cusID"), newAccNoTextBox.Text, newAccTypeList.SelectedItem.Value, amountTextBox.Text, atm1)
                Case "ProvinceSystem"
