'************************************************************
'Class Customer  : Definition Class for bank's customer     *
'************************************************************
Public Class Customer
    ...
    'Class Method
    '**************************************
    Public Function Save(ByVal cus As Customer) As Integer
        ...
        End If
    End Function
    Public Function Check(ByVal cus As Customer) As Customer
        Dim cusDA As New CustomerDA
