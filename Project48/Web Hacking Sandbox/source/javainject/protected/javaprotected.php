...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td colspan="2" valign="middle" class="style0"><br>
              <br>
               <div align="center">เลือกประเภทการป้องกัน</div><br>
              <br>
            
            <table width="100%" border="1" bordercolor="#3399CC">
              <tr> 
                <td class="style0"><div align="center"><a href="formedit/javaformp.php">Form 
                    Editing</a> </div></td>
                <td class="style0"><div align="center"><a href="cookieedit/cookieprotect.php">Cookie 
                    Editing </a><br>
                  </div></td>
              </tr>
            </table>
        ...
        <tr> 
          <td colspan="2"><table width="100%" border="0">
              <tr> 
                ...
                <td width="9%"><form name="form2" method="post" action="../test/javainjecttest.php">
    ...
    <TD COLSPAN=3 class="style0"><div align="center">:: Java injection Protected 
        :: </div></TD>
		<TD>
...
<map name="Map">
  <area shape="rect" coords="-38,1,414,113" href="../../index1.html">
</map>
</BODY>
</HTML>