...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td colspan="2" valign="top" class="style0"> <br> <font color="#DE5208">ข้อมูลเบื้องต้น </font><br>
            <iframe src="jinfo.html"  width="100%" height="205" frameborder="0"></iframe></td>
        ...
        <tr> 
          <td colspan="2"><table width="100%" border="0">
              <tr> 
                ...
                <td width="8%"><form name="form_test" method="post" action="test/javainjecttest.php">
                    <input type="submit" name="Submit" value="ทำการทดลอง">
                  </form></td>
                <td width="9%"><form name="form2" method="post" action="protected/javaprotected.php">
...
<map name="Map">
  <area shape="rect" coords="-21,4,412,123" href="../index1.html">
</map>
</BODY>
</HTML>