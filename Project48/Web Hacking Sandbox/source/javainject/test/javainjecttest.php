    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td colspan="2" valign="middle" class="style0"> <br>
              <br>
              <div align="center">เลือกการทดลอง</div> <br>
            
            <table width="100%" border="1" bordercolor="#3399CC">
              <tr> 
                <td class="style0"><div align="center"><a href="formedit/javaformtest.php">Form 
                    Editing</a> </div></td>
                <td class="style0"><div align="center"><a href="cookieedit/setcookie.php">Cookie 
                    Editing </a><br>
                  </div></td>
              </tr>
            </table>
...
<map name="Map">
  <area shape="rect" coords="-16,1,416,119" href="../../index1.html">
</map>
</BODY>
</HTML>