...
if ($_SESSION['hintsql']=='0'){echo '';}
	...
	?>
				 <font color="#FF0000">วิธีการ</font><br>
                  ...
                  <div align="center"><a href="../hidden/test/hintdel.php">back</a></div>
	<?php			  }
	...
	?>
			 <font color="#FF0000">1.</font> ทำการ save หน้านี้เก็บไว้<br>
                  จากนั้นเปิดดู source code ดูที่ FORM tag<br>
<font color="#FF0000">2.</font> ทำการแก ้MAXLENGTH=value และ SIZE=value ให้เป็นค่าที่ต้องการ<br>
                  <font color="#FF0000">3.</font> ส่งกลับไปยัง server โดยเปลี่ยน<br>
&lt;FORM name=form2 action=&quot;<font color="#FF0000">check.php</font>&quot; 
<br>
                  ให้เป็น url ของ server เช่น<br>
&lt;FORM name=form2 action=&quot;<font color="#FF0000">http://server/check.php</font>&quot; 
