          ...
          function checkIsNum()
           {
                ...
                if((document.formSubmit.order.value=="")||(isNaN(document.formSubmit.order.value)))
				     {
                      alert ("กรุณากรอกจำนวนที่ต้องการสั่งซื้อ");
                     document.formSubmit.order.focus();
                     return;
					  }
    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td colspan="2" valign="top" class="style0"><br><br><div align="center"><img src="../../images/Boom_Box_4.jpg" width="225" height="111"><br>
              <font color="#003366">ราคา 
              5000 บาท</font><br>
              <form name="formSubmit" action="hiddenchk1.php" method="post" >
          ...
          <td width="37%" valign="top"> 
		  			<!-- ------------- iframe -------------------------------------------------------------------------------------------------------------------- -->
				  <iframe src="hint.php" width="100%" height="250"  frameborder="0"></iframe>
				   <!-- ------------- iframe -------------------------------------------------------------------------------------------------------------------- --> </td>
          <td width="2%">&nbsp;</td>
        </tr>
      </table> </TD>
...
<map name="Map">
  <area shape="rect" coords="-24,2,416,118" href="../../index1.html">
</map>
</BODY>
</HTML>