...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          <td width="19%">&nbsp;</td>
          <td colspan="2" valign="top" class="style0"><font color="#DE5208">ข้อมูลเบื้องต้น 
            </font><br> 
            <!-- ------------- iframe -------------------------------------------------------------------------------------------------------------------- -->
            <iframe src="info.html" width="550" height="220" class="style1"  frameborder="0"></iframe> 
            <!-- ------------- iframe -------------------------------------------------------------------------------------------------------------------- -->
            <table width="100%" height="100%" border="0">
              <tr> 
                <td width="83%"><div align="right"> </div></td>
                <td width="8%"><form action="test/hiddentest1.php" method="post" name="form_test" target="_blank">
                    <input type="submit" name="Submit" value="ทำการทดลอง">
                  </form></td>
                <td width="9%"><form action="protected/hiddenprotected.php" method="post" name="form2" target="_blank">
...
<map name="Map">
  <area shape="rect" coords="-12,1,414,115" href="../index1.html">
</map>
</BODY>
</HTML>