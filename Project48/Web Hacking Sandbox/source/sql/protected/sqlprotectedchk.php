...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td width="34%" height="63">&nbsp;</td>
          <td width="4%" rowspan="2">&nbsp;</td>
          <td width="22%" rowspan="3" valign="top" class="style0">&nbsp;ทำการป้องกัน sql injection 
            แล้ว</td>
...
$lenpwd=strlen($Pwd);
 if(($user=='')&&($Pwd=='')){
	...
	print"   <br><br>";
	print"    <a href='sqlprotected.php'>ทดลองใหม่</a> </div>";
 }
else if(($lenname<=20)&&($lenpwd<=20)){
	$queryuser=@mysql_query("SELECT * FROM profile WHERE UserName='$user' AND Password ='$Pwd' ");
	$count=@mysql_num_rows($queryuser);
	if($count !=0){
	...
	print"   <br><br>";
	print"    <a href='sqlinject.php'>ทดลองใหม่</a> </div>";
}
...
<map name="Map">
  <area shape="rect" coords="2,2,417,111" href="../../index1.html">
</map>
</BODY>
</HTML>