    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td width="27%" rowspan="3" valign="top" class="style0"><br>
            &nbsp;<strong><u>ภารกิจ</u></strong><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เข้าสู่ระบบโดยใช้วิธีการตามทฤษฎี 
            SQL injection</td>
          <td width="26%">&nbsp;</td>
          <td width="1%" rowspan="2">&nbsp;</td>
          <td width="43%" rowspan="3" valign="top">&nbsp;
            <iframe src="hint.php" width="100%" height="200"  frameborder="0"></iframe></td>
          <td width="2%" rowspan="3">&nbsp;</td>
        </tr>
        <tr> 
          <td height="57"><table width="100%" border="1" cellspacing="0" bordercolor="#006699">
              <tr> 
                <td class="style0"> <form action="sqlcheck.php" method="post" name="form" >
