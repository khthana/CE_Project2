...
$lenpwd=strlen($Pwd);
 if(($user=='')&&($Pwd=='')){
	...
	$temp= stripslashes($Pwd); 
	$queryuser=@mysql_query("SELECT * FROM profile WHERE UserName='$user' AND Password ='$temp' ");
...
?>
        ...
        <tr> 
          <td width="34%"><table width="100%" border="0">
              <tr> 
                <td width="80%"><form name="form_inside_goto_protected" method="post" action="../protected/sqlprotected.php">
                    <div align="right"> 
...
<map name="Map">
  <area shape="rect" coords="0,2,420,116" href="../../index1.html">
</map>
</BODY>
</HTML>