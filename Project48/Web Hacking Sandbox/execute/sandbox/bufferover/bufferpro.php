...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    ...
    <TD COLSPAN=4><table width="100%" border="0">
        <tr> 
          ...
          <td width="27%" rowspan="3" valign="top" class="style0"><br>
            &nbsp;<strong><u>ได้รับการป้องกันแล้ว</u></strong></td>
          <td width="26%">&nbsp;</td>
          <td width="1%" rowspan="2">&nbsp;</td>
          <td width="43%" rowspan="3" valign="top" class="style0"><font color="#FF0000">วิธีป้องกัน</font><br>
            สาเหตุที่ทำให้เกิด Buffer Overflow นั้นก็มาจากข้อมูลที่รับเข้ามาจากผู้ใช้งานมีลักษณะไม่ตรงตามที่ต้องการ 
            ดังนั้นสิ่งที่ทำได้คือ<br>
            1. กำหนดลักษณะของข้อมูลที่ต้องการ<br>
            2. ตรวจสอบความยาวของข้อมูล ไม่ให้ยาวเกินกว่าพื้นที่ที่ได้เตรียมไว้<br>
            3. ตรวจสอบรูปแบบของข้อมูลให้ตรงความต้องการ<br>
            4. ทำการ encode สัญลักษณ์ต่าง ๆ ก่อนที่จะนำไปประมวลผล เช่น &gt; เปลี่ยนเป็น 
            &amp;gt; เพื่อให้เครื่องคิดว่าเป็นตัวอักษรตัวหนึ่งเท่านั้น<br> </td>
          <td width="2%" rowspan="3">&nbsp;</td>
        </tr>
        <tr> 
          <td height="57"><table width="100%" border="1" cellspacing="0" bordercolor="#006699">
              <tr> 
                <td class="style0"> <form action="bufferprock.php" method="post" name="form" >
        ...
        <tr> 
          <td width="26%"><table width="100%" border="0">
              <tr> 
                <td width="80%"><form name="form_inside_goto_protected" method="post" action="buffer.php">
                    <div align="right"> 
                      <input type="submit" name="Submit2" value="การทดลอง">
                    </div>
                  </form></td>
                <td width="20%"><form name="form_to_info" method="post" action="bufferindex.php">
                    <div align="right"> 
    ...
    <TD COLSPAN=3 class="style0"> <div align="center"><font face="Microsoft Sans Serif, MS Sans Serif, sans-serif">:: 
        Application Buffer Overflows Protect::</font></div></TD>
		<TD>
...
<map name="Map">
  <area shape="rect" coords="1,0,415,111" href="../index1.html">
</map>
</BODY>
</HTML>