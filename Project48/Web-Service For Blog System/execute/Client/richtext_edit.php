...
<div class=\"center_content\">
	Title name&nbsp;:&nbsp;<input name=\"title_entry\" type=\"text\" size=\"30\" maxlength=\"100\" value='".$old_title."'>
	&nbsp;&nbsp;&nbsp;&nbsp;<input name='crecommend' type='checkbox' value='yes'";
	($crecommend == 'yes') ? print "checked" : "";
print ">&nbsp;Recommend<br><br>
	Category : 	<select  style=\"width:100px;\"name=\"cat_entry\" size=\"1\" >";
	$i = 0;
	while ($add_blog_category[$i]) { 
		print "<option value=\"".$add_blog_category_id[$i]."\"";
		($category==$add_blog_category_id[$i]) ? print "selected" : "";
		print ">".$add_blog_category[$i]."</option>";
		$i++;
	}
print "			</select>
...
print "
writeRichText('contents', '$contents', '100%', 300, true, false);
//-->
</script>
...
<tr>
	...
	<td ><input name='permission' type='radio' value='show' ";
	($permission == 'show') ? print "checked" : "";
	print ">&nbsp;Show</td>
	<td ><input name='permission' type='radio' value='hide'";
	($permission == 'hide') ? print "checked" : "";
	print ">&nbsp;Hide</td>
</tr>
<tr>
	<td>การอนุญาตให้Comment &nbsp;:</td>
	<td colspan='2'><select name='comment_allow' size='1'  style='width:250px;'>
							<option value='allow-show'";
							($comment_allow == 'allow-show') ? print "selected" : "";
							print ">อนุญาตให้ comment + แสดง comment</option>
							<option value='allow-hide'";
							($comment_allow == 'allow-hide') ? print "selected" : "";
							print ">อนุญาตให้ comment + ไม่แสดง comment</option>
							<option value='notallow'";
							($comment_allow == 'notallow') ? print "selected" : "";
							print ">ไม่อนุญาตให้ comment</option></td>
</tr>
</table></div>
...
<tr>
<td>
<input type='submit' name='submit' class='button' value='Edit Entry'>&nbsp;
</td>
<td>
...
/*
<form action='preview_entry.php?userid=".$_COOKIE['user_id']."&action=editentry' method='POST' target='_blank' name='preview'>
<td>
