...
<jsp:useBean id="NeoProxyid" scope="session" class="WS.NeoProxy" />
...
case 2:
        ...
        NeoProxyid.useJNDI(useJNDI_0idTemp);
break;
case 7:
        gotMethod = true;
        java.lang.String getEndpoint7mtemp = NeoProxyid.getEndpoint();
...
case 10:
        ...
        NeoProxyid.setEndpoint(endpoint_1idTemp);
break;
case 15:
        gotMethod = true;
        WS.Neo getNeo15mtemp = NeoProxyid.getNeo();
if(getNeo15mtemp == null){
%>
<%=getNeo15mtemp %>
<%
}else{
...
<%
if(getNeo15mtemp != null){
java.lang.String typecourseAll18 = getNeo15mtemp.getCourseAll();
...
case 20:
        gotMethod = true;
        java.lang.String getCourseAll20mtemp = NeoProxyid.getCourseAll();
...
case 23:
        ...
        boolean buyClass23mtemp = NeoProxyid.buyClass(classID_2idTemp,email_3idTemp,receiveID_4idTemp);
...
case 32:
        ...
        boolean reservation32mtemp = NeoProxyid.reservation(classID_5idTemp,email_6idTemp,name_7idTemp,surname_8idTemp,phoneNo_9idTemp);
...
case 45:
        ...
        java.lang.String getCourse45mtemp = NeoProxyid.getCourse(subject_10idTemp,period_11idTemp);
...
case 52:
        ...
        java.lang.String getCourseFromEmail52mtemp = NeoProxyid.getCourseFromEmail(email_12idTemp);
...
case 57:
        ...
        boolean cancel57mtemp = NeoProxyid.cancel(classID_13idTemp,email_14idTemp);
