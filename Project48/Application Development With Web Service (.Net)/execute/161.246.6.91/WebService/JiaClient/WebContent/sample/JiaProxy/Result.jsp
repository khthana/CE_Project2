...
<jsp:useBean id="JiaProxyid" scope="session" class="WS.JiaProxy" />
...
case 2:
        ...
        JiaProxyid.useJNDI(useJNDI_0idTemp);
break;
case 7:
        gotMethod = true;
        java.lang.String getEndpoint7mtemp = JiaProxyid.getEndpoint();
...
case 10:
        ...
        JiaProxyid.setEndpoint(endpoint_1idTemp);
break;
case 15:
        gotMethod = true;
        WS.Jia getJia15mtemp = JiaProxyid.getJia();
if(getJia15mtemp == null){
%>
<%=getJia15mtemp %>
<%
}else{
...
<%
if(getJia15mtemp != null){
java.lang.String typecourseAll18 = getJia15mtemp.getCourseAll();
...
case 20:
        gotMethod = true;
        java.lang.String getCourseAll20mtemp = JiaProxyid.getCourseAll();
...
case 23:
        ...
        boolean buyClass23mtemp = JiaProxyid.buyClass(classID_2idTemp,email_3idTemp,receiveID_4idTemp);
...
case 32:
        ...
        boolean reservation32mtemp = JiaProxyid.reservation(classID_5idTemp,email_6idTemp,name_7idTemp,surname_8idTemp,phoneNo_9idTemp);
...
case 45:
        ...
        java.lang.String getCourse45mtemp = JiaProxyid.getCourse(subject_10idTemp,period_11idTemp);
...
case 52:
        ...
        java.lang.String getCourseFromEmail52mtemp = JiaProxyid.getCourseFromEmail(email_12idTemp);
...
case 57:
        ...
        boolean cancel57mtemp = JiaProxyid.cancel(classID_13idTemp,email_14idTemp);
