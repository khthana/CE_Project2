...
<table width="239" border="0" align="center" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
  <tr> 
    <td width="233" height="18" bgcolor="#CC0033"><font color="#FFFFFF" size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>หน้าจอเข้าระบบของพนักงาน...</strong></font></td>
  </tr>
  <tr>
  <td height="78" valign="top" bgcolor="#CC0000">
        ...
        <form name="form1" method="post" action="?file2=formloginuser.php" >
          <tr> 
...
$sql="select u.*, s.sta_province from user u, station s where u.id_station=s.id_station and binary u.id_user='$username' and binary u.password='$password1' ";
...
if($result){
	...
	print"<meta http-equiv=\"refresh\" content=\"0;url=index.php\">";       //exit();
	}
}
}
?>
