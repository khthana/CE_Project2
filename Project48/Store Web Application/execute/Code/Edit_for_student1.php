...
// ถ้าช่องใส่รหัสใหม่ไม่ตรงกับรหัสที่ยืนยัน *** ถ้าไม่ใส่ทั้ง 2 ช่องก็ให้ถือว่าไม่ต้องการแก้ไข
		...
		echo "<div align=center> [ <a href=Edit_for_student.php> กลับหน้าแก้ไขข้อมูลนักศึกษา  </a>] </div>";
		}
...
// รหัส  newpass ตรงกันกับ newpass 2 หรือไม่ 
		{ 
			...
			$result=mysql_db_query($dbname,$sql);
							...
							if  ($result) {
								...
								echo "<center>	[ <a href=Edit_for_student.php> กลับแก้ไขข้อมูลนักศึกษา </a> ] </center>";
								} 
							mysql_close();
					}		
						else // กรณีที่ Update ค่าของ ที่อยู่,เบอร์โทร,Email เท่านั้น
					{
	...
	$dbquery = mysql_db_query("store",$ordersresult);
				...
				echo "<br><b>&nbsp; &nbsp; E-Mail</b> $Email ";
				echo "<br><b>&nbsp; &nbsp; ระดับผู้ใช้งาน</b> $level_regis ";
				echo "<br><br><center> [ <a href=Edit_for_student.php> กลับหน้าแก้ไขข้อมูลนักศึกษา  </a> ] </center></font>";
				mysql_close();
				}
		}
