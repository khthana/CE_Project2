...
echo "<form name='Edit_for_teacher' method='post' action='Edit_for_Teacher1.php'>
<div align='center'>  <h2><font color=#999900>:: แก้ไขข้อมูลอาจารย์ :: </font> </h2></div>  
<br>
...
<input type='hidden' name='level_regis' value='teacher'>
