...
echo" <table width='100%' border='2' bordercolor='#3366FF'>
	...
	echo"<br><br><strong><font size=3 color=#996600> <b>ข้อมูลเครื่องมือ</b></font></strong> ";
	...
	{ 
		while ( $record = mysql_fetch_row($result))
		{
			...
			if($record[6] == 'no'){
			   echo"<TD bgcolor=#FFCC99><font color=red><b>&nbsp;&nbsp;Borrow</b></font></TD>";
			}else{
