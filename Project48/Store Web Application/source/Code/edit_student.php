...
if($number!=0){
echo "<form name='Edit_Student' method='post' action='edit_student1.php'>
<div align='center'>  <h2><font color=#993366>:: แก้ไขข้อมูลนักศึกษา :: </font> </h2></div>  
<br>
<table width='50%' height='30' border='1' align='center' cellpadding='0' cellspacing='0' bordercolor='#3399FF'>

<tr> 
<td bgcolor=#CCFFCC> <font color=#6633FF><b>&nbsp; รหัสนักศึกษา*</b></font> </td>
...
<td> <input name='Class' type='text' maxlength='10' value='$record[11]'></td>
</tr>

<tr> 
<td bgcolor=#FFCCCC> <font color=#6633FF><b>&nbsp; Status </b></font></td>
<td> <input name='Status' type='text' maxlength='10' value='$record[7]'></td>
</tr>

<tr> 
<td bgcolor=#CCFFCC> <font color=#6633FF><b>&nbsp; Username* </b></font></td>
<td> <input name='User' type='text' maxlength='15'  value='$record[8]'> </td>
</tr>

<tr>
<td bgcolor=#FFCCCC> <font color=#6633FF><b>&nbsp; Password* </b></font></td>
<td> <input name='Password' type='password' maxlength='32'  value='$Password'></td>
</tr>
<tr>
  <td bgcolor=#CCFFCC> <font color=#6633FF><b>&nbsp; Re-Password*</b></font></td>
  <td> <input name='Repwd' type='password' maxlength='32'  value='$Repwd'></td>
</tr>

<tr>
<td bgcolor=#FFCCCC><font color=#6633FF><b> &nbsp; ระดับ* </b></font></td>
<td> <select name='level_regis'>
 <option value='student'> นักศึกษา </option> </td>
</tr>

<tr>
<td bgcolor=#CCFFCC><font color=#6633FF><b> &nbsp; Black List </b></font></td>
<td><input name='BlackList' type='text' maxlength='15'  value='$record[12]'></td>
</tr>
