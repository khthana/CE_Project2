...
<?php
	...
	$sql="SELECT * FROM accessory WHERE Acces_ID = '$ID'";
	$result=mysql_query($sql);
	$number=mysql_num_rows($result);
	$record = mysql_fetch_row($result);

if($number != 0){
echo "<form name='Edit_Accessory' method='post' action='edit_accessory1.php'>
<div align='center'>  <h2><font color=#993366>:: แก้ไขข้อมูลอุปกรณ์  :: </font> </h2></div>  
<br>
...
<td> <input name='ID_acces' type='text' maxlength='20' value='$record[0]'></td></tr>

<tr>
<td bgcolor=#FFCCCC><font color=#6633FF><b>&nbsp; ชื่ออุปกรณ์</b></font></td>
<td> <input name='Name_acces' type='text' maxlength='30' value='$record[1]'></td>
</tr>

<tr>
<td bgcolor=#CCFFCC><font color=#6633FF><b>&nbsp; จำนวนทั้งหมด</b></font> </td>
<td> <input name='Amount_acces' type='text' maxlength='30' value='$record[2]'></td>
</tr>

<tr>
<td bgcolor=#FFCCCC><font color=#6633FF><b>&nbsp; จำนวนคงเหลือ</b></font> </td>
<td> <input name='remain_acces' type='text' maxlength='30' value='$record[3]'></td>
</tr>
