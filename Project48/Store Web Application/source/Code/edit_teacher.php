...
if($number!=0){
echo "<form name='Edit_teacher' method='post' action='edit_teacher1.php'>
<div align='center'>  <h2><font color=#993366>:: แก้ไขข้อมูลอาจารย์  :: </font> </h2></div>  
<br>
...
<td> <select name='level_regis'>
 <option value='teacher'> อาจารย์ </option> </td>
</tr>
<tr>
  <td> </td>
  <td>
...
//editdata
echo"
<form name='EditTeacher' method='post' action='edit_teacher.php'>
<div align='center'> <font color=#996666>:: แก้ไขข้อมูลอาจารย์   :: </font> </div>  
...
//editdata
	...
	$result=mysql_query($sql);
	$number=mysql_num_rows($result);
		echo"<br><strong><font size=3 color=#996600> <b>ข้อมูลอาจารย์</b></font></strong> ";
		echo " <TABLE  border='1' >
			<TR>
