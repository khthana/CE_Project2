...
echo "<form name='Edit_for_Staff' method='post' action='Edit_for_staff1.php'>
<div align='center'>  <h2><font color=#999900>:: แก้ไขข้อมูลเจ้าหน้าที่ :: </font> </h2></div>  
<br>
...
<input type='hidden' name='level_regis' value='staff'>
