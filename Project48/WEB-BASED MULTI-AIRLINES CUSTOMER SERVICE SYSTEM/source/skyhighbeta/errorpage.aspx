<%@ Page Language="vb" AutoEventWireup="false" Codebehind="errorpage.aspx.vb" Inherits="skyhighbeta.errorpage"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>SkyHigh :: Error Page</title>
							...
							<TR>
								<td>
									<table style="FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Tahoma" width="100%">
										...
										<tr height="10">
											<td>
												<asp:Label id="lblReason" runat="server" ForeColor="OrangeRed" Font-Names="Tahoma" Font-Size="8pt"></asp:Label></td>
										</tr>
										<tr height="30">
											<td></td>
										</tr>
