<%@ Page Language="vb" AutoEventWireup="false" Codebehind="registerresult.aspx.vb" Inherits="skyhighbeta.registerresult"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>SkyHigh :: Registeration Result</title>
									...
									<table style="FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Tahoma" width="100%" cellpadding="4"
										...
										<tr height="10" style="COLOR: orangered">
											<td style="HEIGHT: 20px">
												<asp:Label id="lblFail" runat="server" Visible="False" ForeColor="Firebrick">
													<b>Registration has failed !!!</b></asp:Label><BR>
												<asp:Label id="lblSuccess" runat="server" ForeColor="OrangeRed" Visible="False">Your registration is successful.</asp:Label></td>
										</tr>
										<tr height="10">
											<td></td>
										</tr>
										<tr style="COLOR: orangered">
											<td>
												<asp:Label id="lblFailReason" runat="server" Visible="False" ForeColor="Firebrick"></asp:Label>
											</td>
										</tr>
										<tr height="10">
											<td></td>
									...
									<table style="FONT-SIZE: 8pt; FONT-FAMILY: Tahoma" width="100%">
										<tr vAlign="middle" height="30">
											...
											<td align="right" width="50%">
												<asp:button id="btnHome" runat="server" Font-Bold="True" Font-Size="8pt" Text="Home" ForeColor="White"
													BorderColor="MistyRose" BackColor="Firebrick" Font-Names="Tahoma"></asp:button></td>
										</tr>
									</table>
								</td>
							</tr>
