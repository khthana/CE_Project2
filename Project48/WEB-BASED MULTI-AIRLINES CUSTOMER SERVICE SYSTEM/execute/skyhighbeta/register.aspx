<%@ Page Language="vb" AutoEventWireup="false" Codebehind="register.aspx.vb" Inherits="skyhighbeta.register"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>SkyHigh :: Register to be SkyHigh member</title>
					...
					<td>
						<table cellSpacing="0" cellPadding="0" width="96%" align="center">
							...
							<tr style="FONT-WEIGHT: bold; FONT-SIZE: 16pt; COLOR: #cc6633; FONT-FAMILY: Tahoma; HEIGHT: 35px"
								vAlign="middle">
								<td>REGISTER&nbsp;&nbsp;<asp:label id="lblStatus" runat="server" Font-Size="8pt" Font-Bold="True" Font-Names="Tahoma"
										...
										<tr>
											<td>
												<table style="FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Tahoma" cellSpacing="0" cellPadding="4"
													width="100%" align="center" bgcolor="#ffffee">
													...
													<tr bgColor="#ffffc1">
														<td width="20%"><asp:textbox id="txtUser" tabIndex="1" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="98%"></asp:textbox></td>
														<td width="25%"><asp:textbox id="txtPwd" tabIndex="2" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="98%"
																TextMode="Password"></asp:textbox></td>
														<td width="25%" colSpan="2"><asp:textbox id="txtConFirmPwd" tabIndex="3" runat="server" Font-Size="8pt" Font-Names="Tahoma"
																Width="98%" TextMode="Password"></asp:textbox></td>
														<td width="30%" colSpan="2"><asp:radiobuttonlist id="radMember" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="124px"
													...
													<tr bgColor="#ffffc1">
														<td><asp:textbox id="txtFirstName" tabIndex="5" runat="server" Font-Size="8pt" Font-Names="Tahoma"
																Width="98%"></asp:textbox></td>
														<td><asp:textbox id="txtLastName" tabIndex="6" runat="server" Font-Size="8pt" Font-Names="Tahoma"
																Width="98%"></asp:textbox></td>
														<td width="10%"><asp:textbox id="txtAge" tabIndex="7" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="98%"
																MaxLength="3"></asp:textbox></td>
														<td width="15%"><asp:radiobuttonlist id="radSex" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="100%" RepeatDirection="Horizontal"
																tabIndex="8">
																<asp:ListItem Value="M" Selected="True">Male</asp:ListItem>
																<asp:ListItem Value="F">Female</asp:ListItem>
															</asp:radiobuttonlist></td>
														<td align="center"><asp:dropdownlist id="cboCountry" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="95%" tabIndex="9">
														...
														<td align="center"><asp:dropdownlist id="cboMeal" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="95%" tabIndex="10">
												...
												<table style="FONT-WEIGHT: bold; FONT-SIZE: 8pt; COLOR: black; FONT-FAMILY: Tahoma" cellSpacing="0"
													...
													<TBODY>
														...
														<tr style="FONT-WEIGHT: normal" bgColor="#ffffc1">
															...
															<td width="25%"><asp:dropdownlist id="cboCodeHome" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="95%"
																	tabIndex="11">
																	<asp:ListItem Value="61">Australia</asp:ListItem>
																	<asp:ListItem Value="86">Chaina</asp:ListItem>
																	<asp:ListItem Value="44">England</asp:ListItem>
															...
															<td width="30%"><asp:textbox id="txtTelHome" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="98%" tabIndex="13"></asp:textbox></td>
															<td width="30%"></td>
														</tr>
														<tr style="FONT-WEIGHT: normal" bgColor="#ffffc1">
															<td style="HEIGHT: 28px" align="right" width="15%">Business Number:
															</td>
															<td style="HEIGHT: 28px" width="20%"><asp:dropdownlist id="cboCodeBiz" runat="server" Width="95%" Font-Size="8pt" Font-Names="Tahoma" tabIndex="14">
																	<asp:ListItem Value="61">Australia</asp:ListItem>
																	<asp:ListItem Value="86">Chaina</asp:ListItem>
																	<asp:ListItem Value="44">England</asp:ListItem>
																	<asp:ListItem Value="39">Italy</asp:ListItem>
															...
															<td style="HEIGHT: 28px" width="20%"><asp:textbox id="txtTelBiz" runat="server" Width="98%" Font-Size="8pt" Font-Names="Tahoma" tabIndex="16"></asp:textbox></td>
															<td style="HEIGHT: 28px" width="300%"><asp:textbox id="txtExt" runat="server" Width="98%" Font-Size="8pt" Font-Names="Tahoma" tabIndex="17"></asp:textbox></td>
														</tr>
														<tr style="FONT-WEIGHT: normal" bgColor="#ffffc1">
															<td align="right" width="15%">Fax Number:
															</td>
															<td width="25%"><asp:dropdownlist id="cboCodeFax" runat="server" Width="95%" Font-Size="8pt" Font-Names="Tahoma" tabIndex="18">
																	<asp:ListItem Value="61">Australia</asp:ListItem>
																	<asp:ListItem Value="86">Chaina</asp:ListItem>
																	<asp:ListItem Value="44">England</asp:ListItem>
																	<asp:ListItem Value="39">Italy</asp:ListItem>
															...
															<td width="30%"><asp:textbox id="txtTelFax" runat="server" Width="98%" Font-Size="8pt" Font-Names="Tahoma" tabIndex="20"></asp:textbox></td>
															<td width="30%"></td>
														</tr>
														...
														<tr style="FONT-WEIGHT: normal" bgColor="#ffffc1">
															...
															<td><asp:textbox id="txtEmail" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="100%" tabIndex="21"></asp:textbox></td>
															<td align="right">ID Card Number:
															</td>
															<td><asp:textbox id="txtIDCard" tabIndex="22" runat="server" Font-Size="8pt" Font-Names="Tahoma"
																	Width="98%"></asp:textbox></td>
														</tr>
														<tr style="FONT-WEIGHT: normal" bgColor="#ffffc1">
															<td align="right">Adress:
															</td>
															<td colSpan="4"><asp:textbox id="txtAddress" runat="server" Font-Size="8pt" Font-Names="Tahoma" Width="100%"
							...
							<tr>
								<td>
									<table style="FONT-SIZE: 8pt; FONT-FAMILY: Tahoma" cellSpacing="4" width="100%">
										<tr vAlign="middle">
											<td width="50%"><asp:button id="btnHome" runat="server" Font-Size="8pt" Font-Bold="True" Font-Names="Tahoma"
													BackColor="Firebrick" BorderColor="MistyRose" ForeColor="White" Text="Home" tabIndex="24"></asp:button></td>
											<td align="right" width="50%"><asp:button id="btnSubmit" runat="server" Font-Size="8pt" Font-Bold="True" Font-Names="Tahoma"
													BackColor="Firebrick" BorderColor="MistyRose" ForeColor="White" Text="Submit" tabIndex="25"></asp:button>&nbsp;
											</td>
										</tr>
									</table>
								</td>
