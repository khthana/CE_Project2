...
#End Region
    ...
    Private Sub prnDoc_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles prnDoc.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("การค้นข้อมูล รายการชื้ออาหาร", myHeadFont, Brushes.Black, 300, YPosition)
            ...
            e.Graphics.DrawString("ชื่อนักศึกษา", myFont, Brushes.Black, LeftMargin + 100, yp)
            e.Graphics.DrawString("นามสกุล", myFont, Brushes.Black, LeftMargin + 200, yp)
            e.Graphics.DrawString("รหัสอาหาร", myFont, Brushes.Black, LeftMargin + 300, yp)
            e.Graphics.DrawString("ชื่ออาหาร", myFont, Brushes.Black, LeftMargin + 370, yp)
            e.Graphics.DrawString("ราคา", myFont, Brushes.Black, LeftMargin + 570, yp)
            e.Graphics.DrawString("วันที่ชื้อ (ว/ด/ป)", myFont, Brushes.Black, LeftMargin + 610, yp)
            ...
            While (CountLine < LinesInPage) And (dbCursor < dbSet.Tables("Query").Rows.Count)
                ...
                strData4 = dbSet.Tables("Query").Rows(dbCursor).Item("FoodID")
                strData5 = dbSet.Tables("Query").Rows(dbCursor).Item("FoodName")
                strData6 = dbSet.Tables("Query").Rows(dbCursor).Item("FoodCost")
                strData7 = dbSet.Tables("Query").Rows(dbCursor).Item("DateCurrent")

                SumList = SumList + strData6

                e.Graphics.DrawString(strData1, myFont, Brushes.Black, LeftMargin, YPosition)
                e.Graphics.DrawString(strData2, myFont, Brushes.Black, LeftMargin + 100, YPosition)
                e.Graphics.DrawString(strData3, myFont, Brushes.Black, LeftMargin + 200, YPosition)
                e.Graphics.DrawString(strData4, myFont, Brushes.Black, LeftMargin + 300, YPosition)
                e.Graphics.DrawString(strData5, myFont, Brushes.Black, LeftMargin + 370, YPosition)
                e.Graphics.DrawString(strData6, myFont, Brushes.Black, LeftMargin + 570, YPosition)
                e.Graphics.DrawString(strData7, myFont, Brushes.Black, LeftMargin + 610, YPosition)
            ...
            If dbCursor = dbSet.Tables("Query").Rows.Count Then '----------End of Data and Has Sum
                ...
                e.Graphics.DrawString("รวมเป็นเงินทั้งสิ้น ", myFont, Brushes.Black, LeftMargin + 370, YPosition + 5)
                e.Graphics.DrawString(CStr(SumList), myFont, Brushes.Black, LeftMargin + 570, YPosition + 5)
