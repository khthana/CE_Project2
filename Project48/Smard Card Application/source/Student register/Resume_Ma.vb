...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'Bcancel
        '
        Me.Bcancel.BackColor = System.Drawing.SystemColors.AppWorkspace
        Me.Bcancel.Font = New System.Drawing.Font("Microsoft Sans Serif", 11.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Bcancel.ForeColor = System.Drawing.SystemColors.ActiveCaptionText
        Me.Bcancel.Location = New System.Drawing.Point(528, 272)
        ...
        'Bedit
        '
        Me.Bedit.BackColor = System.Drawing.Color.FromArgb(CType(255, Byte), CType(224, Byte), CType(192, Byte))
        Me.Bedit.Location = New System.Drawing.Point(432, 272)
        Me.Bedit.Name = "Bedit"
        ...
        Me.Bsave.Location = New System.Drawing.Point(320, 272)
        Me.Bsave.Name = "Bsave"
        ...
        Me.GroupBox1.Text = "ส่วน ข้อมูล มารดา"
        '
        'TelWK
        '
...
#End Region
    ...
    Private Sub Resume_Ma_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Function IsFoundId() As Boolean 'ตรวจสอบการมีIDในฐานข้อมูล
        ...
        ds.Tables.Clear()
        da.Fill(ds, "Count")
        If ds.Tables("Count").Rows.Count >= 2 Then
            ShowData()
            Bedit.Enabled = True
            Bsave.Enabled = False
        Else
    ...
    Private Function ShowData() As Boolean
        ...
        da = New SqlDataAdapter(sql, Conn)
        ds.Tables.Clear()
        da.Fill(ds, "Query1") 'แก้ไขตรงนี้ No Record
        If ds.Tables("Query1").Rows.Count >= 2 Then

            Id1 = CStr(ds.Tables("Query1").Rows(1).Item("Fa_NUM"))
    ...
    Private Sub Bsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bsave.Click
        If checkItem() Then
            If MessageBox.Show("ต้องเพิ่มข้อมูลของมารดานักศึกษา รหัส  " + Student_ID + "  ลงในฐานข้อมูล", "คำยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                RegisterSTD = True
                InsertNew()
                Me.Close()
            End If
    ...
    Private Function InsertNew() As Boolean
        ...
        MsgBox("การบันทึกข้อมูลเสร็จเรียบร้อยแล้ว")
    ...
    Private Sub Bedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bedit.Click
        If checkItem() Then
            If MessageBox.Show("ต้องแก้ไขข้อมูลของมารดานักศึกษา รหัส  " + Student_ID + "  ลงในฐานข้อมูล", "คำยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                Dim sql As String = ""
                ...
                sql = sql + " Where Fa_NUM = " + Id1 + " and Fa_Status ='2' "
