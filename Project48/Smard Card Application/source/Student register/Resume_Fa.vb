...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Text = "ส่วน ข้อมูล บิดา"
        '
        'TelWK
        '
        ...
        'Bsave
        '
        Me.Bsave.BackColor = System.Drawing.Color.Gainsboro
        Me.Bsave.Location = New System.Drawing.Point(328, 272)
        Me.Bsave.Name = "Bsave"
        ...
        Me.Bedit.Location = New System.Drawing.Point(440, 272)
        Me.Bedit.Name = "Bedit"
        ...
        Me.Bcancel.Location = New System.Drawing.Point(536, 272)
...
#End Region
    ...
    Private Sub Resume_Fa_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Function ShowData() As Boolean
        ...
        ds.Tables.Clear()
        da.Fill(ds, "Query1")
        Id1 = CStr(ds.Tables("Query1").Rows(0).Item("Fa_NUM"))
        ' Dim Id2 As String = CStr(ds.Tables("Query1").Rows(1).Item("Fa_NUM"))
    ...
    Private Sub Bsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bsave.Click
        If checkItem() Then
            If MessageBox.Show("ต้องเพิ่มข้อมูลของบิดานักศึกษา รหัส  " + Student_ID + "  ลงในฐานข้อมูล", "คำยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                RegisterSTD = True
                InsertNew()
                Me.Close()
            End If
    ...
    Private Sub Bedit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Bedit.Click
        If checkItem() Then
            If MessageBox.Show("ต้องแก้ไขข้อมูลของบิดานักศึกษา รหัส  " + Student_ID + "  ลงในฐานข้อมูล", "คำยืนยัน", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                Dim sql As String = ""
                ...
                sql = sql + " Where Fa_NUM = " + Id1 + " and Fa_Status ='1' "
