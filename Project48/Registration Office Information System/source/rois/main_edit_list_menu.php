		...
		<tr>
			<td>			
				<table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#FF5C0F" bordercolor="#000000">
					<tr>
						<td><p  align="center" class="headTable">แก้ไขรายงาน</p></td>
					</tr>
				</table>
			</td>
		</tr>
		<tr>
			<td>		
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td>	
							<form method="post" action="report_estimate_expense.php?mode=edit">					
								<table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
									...
									<tr>
										...
										<td bgcolor="#F3F3F3"><?php list_box("side",database_query("select * from side where department_id = '08'")); ?></td>
									</tr>
									<tr>
		...
		<tr>
			<td>		
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td>	
							<form method="post" action="report_estimate_receipt.php?mode=edit">					
								<table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
									<tr>
										<td bgcolor="#F3F3F3" align="right" width="30%">ปีงบประมาณ : </td>
										<td bgcolor="#F3F3F3" width="70%"><?php year_list_box(); ?></td>
		...
		<tr>
			<td>		
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td>	
							<form method="post" action="report_real_expense.php?mode=edit">					
								<table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
									<tr>
										<td bgcolor="#F3F3F3" align="right" width="30%">ปีงบประมาณ : </td>
										<td bgcolor="#F3F3F3" width="70%"><?php year_list_box(); ?></td>
		...
		<tr>
			<td>		
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td>	
							<form method="post" action="report_real_receipt.php?mode=edit">					
								<table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
									<tr>
										<td bgcolor="#F3F3F3" align="right" width="30%">ปีงบประมาณ : </td>
										<td bgcolor="#F3F3F3" width="70%"><?php year_list_box(); ?></td>
