...
<html>
<head>
<title> เพิ่มรายการรายจ่ายจริง </title>
                ...
                <tr>
                        <td>
                                <table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#FF5C0F" bordercolor="#000000">
                                        <tr>
                                                <td><p  align="center" class="headTable">เพิ่มรายการรายจ่ายจริง</p></td>
                                        </tr>
                                </table>
                        </td>
                </tr>
                <tr>
                        <td>
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr>
                                                <td>
                                                        <form method="post" action="process_add_data_to_database.php?mode=real_expense" name="form">
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td bgcolor="#F3F3F3" width="70%"><?php list_box("activity_sub",database_query("select * from activity_sub")); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td bgcolor="#F3F3F3" width="70%"><?php list_box_date(); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td bgcolor="#F3F3F3" width="70%"><input type="text" name="ref"></td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right" width="30%">&nbsp;</td>
                                                                                <td bgcolor="#F3F3F3" width="70%">&nbsp;</td>
