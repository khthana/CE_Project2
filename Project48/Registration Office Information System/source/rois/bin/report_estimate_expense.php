         ...
         <td>
		 		<table width="100%" border="0" cellspacing="1" class="font1">
        			...
        			<tr>
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#FF8B3E" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			<tr>
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#FF8B00" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			<tr>
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#FF9F2B" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			<tr>
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#FFB559" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			<tr>
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#FFC782" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			<tr>
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#FFE3C1" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			<tr>
        				...
        				<td bgcolor="#D8D8D8">  
							<p align="right">
        					<?php
        						$amount1 = sum("select sum(amount) from estimate_expense where expense_sub_id = any (select id from expense_sub where expense_type_sub_id = any (select id from expense_type_sub where expense_type_id = any (select id from expense_type where account_id = '".$object_account[0]."'))) and side_id = '".$side."' and project_id = '".$object_project[0]."' and fund_id = '".$object_fund[0]."' and year = '".$year."' and money_type_id = '1'");
        						print $amount1;        						
        					?>
        					</p>      					
        				</td>
        				<td bgcolor="#D8D8D8">
        					<p align="right">
        					<?php
        						$amount2 = sum("select sum(amount) from estimate_expense where expense_sub_id = any (select id from expense_sub where expense_type_sub_id = any (select id from expense_type_sub where expense_type_id = any (select id from expense_type where account_id = '".$object_account[0]."'))) and side_id = '".$side."' and project_id = '".$object_project[0]."' and fund_id = '".$object_fund[0]."' and year = '".$year."' and money_type_id = '2'");
        						print $amount2;        					
        					?>
        					</p>
        				</td>
					...
					$str_expense_type = "select * from expense_type where id = any".
																"(select expense_type_id from expense_type_sub where id = any".
																	"(select expense_type_sub_id from expense_sub where id = any".
																		"(select expense_sub_id from estimate_expense where side_id = '".$side."' and year = '".$year."')))".
																			" and account_id = '".$object_account[0]."'";
					...
					while($object_expense_type = mysql_fetch_array($ret_expense_type)) {
						$ret_temp = database_query("select * from estimate_expense where expense_sub_id = any".
										"(select id from expense_sub where expense_type_sub_id = any".
											"(select id from expense_type_sub where expense_type_id ='".$object_expense_type[0]."'))".
												" and side_id = '".$side."' and fund_id = '".$object_fund[0]."'");
						if(mysql_num_rows($ret_temp)) {
						//print $object_expense_type[0];
						if($object_expense_type[0] != "00000" && $object_expense_type[0] != "00001" && $object_expense_type[0] != "00002") {
					?>
        			<tr>
        				<td bgcolor="#E6E6E6">        					
        				...
        				<td bgcolor="#E6E6E6">
        					<p align="right">
        					<?php
        						$amount1 = sum("select sum(amount) from estimate_expense where expense_sub_id = any ".
        															"(select id from expense_sub where expense_type_sub_id = any".
        																"(select id from expense_type_sub where expense_type_id = '".$object_expense_type[0]."'))".
        																	" and side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project[0]."' and activity_id = '".$object_activity[0]."' and fund_id = '".$object_fund[0]."' and money_type_id = '1'");
        						print $amount1;        						
        					?>
        					</p>
        				</td>
        				<td bgcolor="#E6E6E6">
        					<p align="right">
        					<?php
        						$amount2 = sum("select sum(amount) from estimate_expense where expense_sub_id = any ".
        															"(select id from expense_sub where expense_type_sub_id = any".
        																"(select id from expense_type_sub where expense_type_id = '".$object_expense_type[0]."'))".
        																	" and side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project[0]."' and activity_id = '".$object_activity[0]."' and fund_id = '".$object_fund[0]."' and money_type_id = '2'");
        						print $amount2;        						
        					?>
        					</p>
        				</td>
					...
					$str_expense_type_sub = "(select * from expense_type_sub where id = any".
																			"(select expense_type_sub_id from expense_sub where id = any".
																				"(select expense_sub_id from estimate_expense where side_id = '".$side."' and year = '".$year."' and fund_id = '".$object_fund["ID"]."'))".
					...
					while($object_expense_type_sub = mysql_fetch_array($ret_expense_type_sub)) {
						$ret_temp_sub = database_query("select * from estimate_expense where expense_sub_id = any".
																							"(select id from expense_sub where expense_type_sub_id = any".
																								"(select id from expense_type_sub where expense_type_id ='".$object_expense_type[0]."' and id = '".$object_expense_type_sub["ID"]."'))".
																									" and side_id = '".$side."' and fund_id = '".$object_fund[0]."'");
					if($object_expense_type_sub[0] != "00000" && $object_expense_type_sub[0] != "00001" && $object_expense_type_sub[0] != "00002"
						&& $object_expense_type_sub[0] != "00003" && $object_expense_type_sub[0] != "00004" && $object_expense_type_sub[0] != "00005" &&
						$object_expense_type_sub[0] != "00006" ) {
					?>
					<tr>
        				<td bgcolor="#E6E6E0">        					
        						<?php print "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $object_expense_type_sub[1]; ?>
        				</td>
        				<td bgcolor="#E6E6E0">
        				</td>
        				<td bgcolor="#E6E6E0">
        				...
        				<? if(isset($mode)) { ?>
						<td bgcolor="#E6E6E0" align="center">&nbsp;</td>
						<? } ?>
        			</tr>
        			...
        			// expense sub
        			$temp;        			
					$str_expense_sub = "select expense_sub_id , expand , id from estimate_expense where side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project[0]."' and activity_id = '".$object_activity[0]."' and fund_id = '".$object_fund[0]."' and expense_sub_id = any "."(select id from expense_sub where expense_type_sub_id = any (select id from expense_type_sub where expense_type_id = '".$object_expense_type[0]."') and expense_type_sub_id = '".$object_expense_type_sub["ID"]."') order by expense_sub_id";
					//print $str_expense_sub;
        			...
        			<tr>
						...
						<td bgcolor="#F2F2F2" align="center">
							<? print "<a href='form_edit_list_estimate_expense.php?id=".$object_expense_sub[2]."'>"; ?>
								<img src="picture/b_edit.gif" width="16" height="16" border="0" alt="แก้ไข้ข้อมูล">
							</a>
							<? print "<a href='process_edit_delete_list.php?mode=delete&table_name=estimate_expense&year=".$year."&side=".$side."&id=".$object_expense_sub[2]."'>"; ?>
