...
<?
		...
		if($side == '00000') {
			header('Location: report_all_real_expense.php?year=' . $year);
			exit;	
		}
?>
...
<tr>
			<td>
					<? print "<a href='report_real_expense_pdf.php?year=".$year."&side=".$side."' target='_blank'>"; ?>
					<img src="picture/pdf.gif" width="16" height="16" border="0" alt="รายงาน PDF"></a>
					<? print "<a href='report_real_expense_excel.php?year=".$year."&side=".$side."' target='_blank'>"; ?>
         ...
         <td>
		 		<table width="100%" border="1" cellspacing="0" bordercolor="#000000">
        			<tr> 
          				<td bgcolor="#FF6600"> 
						  <div align="center"> 
						  	<p class="headTable">รายงานรายจ่ายจริง ประจำปีงบประมาณ <?php print $year ?> <br>สำนัทะเบียนและประมวลผล</p>
						  </div>
						</td>
        			</tr>
      			</table>
         ...
         <td>
         	<!-- **********************************  Label ****************************************  -->
		 		<table width="100%" border="0" cellspacing="1" class="font1">		 			
        			...
        			<tr>
        				<!-- column1 -->
        				<td bgcolor="#FF8B3E" class="normalFont">
        					<? 
        						$object_side = mysql_fetch_array(database_query("select * from side where id = '".$side."'")); 
        						print "<b>" . $object_side["SIDE"] . "</b>";
        					?>
        				</td>
        				<!-- column3 -->
        				<td  align="right" bgcolor="#FF8B3E" class="normalFont">
        					<?
        						$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1'"));	
								if($amount_gov[0] > 0)
        				...
        				<td  align="right" bgcolor="#FF8B3E" class="normalFont">
        					<?
        						$amount_ins = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '2'"));	
								if($amount_ins[0] > 0)
								print "<b>" . number_format($amount_ins[0]) . "</b>";
        					?>
        				</td>
        				<!-- column5 -->
        				<td bgcolor="#FF8B3E"  align="right" class="normalFont">
        					<?
					...
					?>        			
        					...
        					<tr>
        						<!-- column1 -->
        						<td bgcolor="#FF8B00" class="normalFont">
        							<?         								
        								print "<b>" . $object_sector["SECTOR"] . "</b>";
        							?>
        						</td>
        						<!-- column3 -->
        						<td  align="right" bgcolor="#FF8B00" class="normalFont">
        							<?
        								$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and project_id = any". 
        						...
        						<td  align="right" bgcolor="#FF8B00" class="normalFont">
        							<?
        								$amount_ins = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '2' and project_id = any". 
																																				"(select id from project where program_id = any".
																																						"(select id from program where sector_id = '".$object_sector["ID"]."'))"));	
										if($amount_ins[0] > 0)
										print "<b>" . number_format($amount_ins[0]) . "</b>";
        						...
        						<!-- column5 -->
        						<td bgcolor="#FF8B00"  align="right" class="normalFont">
        							<?
        								print "<b>" . number_format(($amount_gov[0] + $amount_ins[0])) . "</b>";
        							?>
        						</td>
							...
							?>        			
        							...
        							<tr>
        								<!-- column1 -->
        								<td bgcolor="#FF9F2B" class="normalFont">
        									<?         								
        										print "<b>" . $object_program["PROGRAM"] . "</b>";
        									?>
        								</td>
        								<!-- column3 -->
        								<td bgcolor="#FF9F2B"  align="right" class="normalFont">
        									<?
        										$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and project_id = any". 
																																				"(select id from project where program_id = any".
									...
									?>        			
        									...
        									<tr>
        										<!-- column1 -->
        										<td bgcolor="#FFB559" class="normalFont">
        											<?         								
        												print "<b>" . $object_project["PROJECT"] . "</b>";
        											?>
        										</td>
        										<!-- column3 -->
        										<td bgcolor="#FFB559"  align="right" class="normalFont">
        											<?
        												$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and project_id = any". 
																																								"(select id from project where program_id = any".
												...
												<?
													$str_activity = "select * from activity where id = any".
																						"(select activity_id from real_expense where side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project["ID"]."')";
												...
												?>        			
        												...
        												<tr>
        													<!-- column1 -->
        													<td bgcolor="#FFC782" class="normalFont">
        													<?         								
        														print "<b>" . $object_activity["ACTIVITY"] . "</b>";
        													?>
        													</td>
        													<!-- column3 -->
        													<td bgcolor="#FFC782"  align="right" class="normalFont">
        														<?
        															$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and activity_id = '".$object_activity["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."')"));	
																	if($amount_gov[0] > 0)
																	print "<b>" . number_format($amount_gov[0]) . "</b>";
        													...
        													<td bgcolor="#FFC782"  align="right" class="normalFont">
        														<?
        															$amount_ins = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '2' and activity_id = '".$object_activity["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."')"));	
																	if($amount_ins[0] > 0)
																	print "<b>" . number_format($amount_ins[0]) . "</b>";
														...
														<?
															$str_activity_sub = "select * from activity_sub where id = any".
																								"(select activity_sub_id from real_expense where side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project["ID"]."')";
														...
														?>        			
        														...
        														<tr>
        															<!-- column1 -->
        															<td bgcolor="#FFD7A6" class="normalFont">
        															<?         								
        																print "<b>" . $object_activity_sub["ACTIVITY_SUB"] . "</b>";
        															?>
        															</td>
        															<!-- column3 -->
        															<td bgcolor="#FFD7A6"  align="right" class="normalFont">
        																<?
        																	$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and activity_id = '".$object_activity["ID"]."' and activity_sub_id = '".$object_activity_sub["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."')"));	
																			if($amount_gov[0] > 0)
																			print "<b>" . number_format($amount_gov[0]) . "</b>";
        															...
        															<td bgcolor="#FFD7A6"  align="right" class="normalFont">
        																<?
        																	$amount_ins = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '2' and activity_id = '".$object_activity["ID"]."' and activity_sub_id = '".$object_activity_sub["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."')"));	
																			if($amount_ins[0] > 0)
																			print "<b>" . number_format($amount_ins[0]) . "</b>";
														...
														<?
															$str_fund = "select * from fund where id = any".
																						"(select fund_id from real_expense where side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project["ID"]."' and activity_id = '".$object_activity["ID"]."')";
														...
														?>        			
        														...
        														<tr>
        															<!-- column1 -->
        															<td bgcolor="#FFE3C1" class="normalFont">
        															<?         								
        																print "<b>" . $object_fund["FUND"] . "</b>";
        															?>
        															</td>
        															<!-- column3 -->
        															<td bgcolor="#FFE3C1"  align="right" class="normalFont">
        																<?
        																	$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."')"));
																			if($amount_gov[0] > 0)	
																			print "<b>" . number_format($amount_gov[0]) . "</b>";
        															...
        															<td bgcolor="#FFE3C1"  align="right" class="normalFont">
        																<?
        																	$amount_ins = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '2' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."')"));	
																			if($amount_ins[0] > 0)
																			print "<b>" . number_format($amount_ins[0]) . "</b>";
																										...
																										"(select account_id from expense_type where id = any".
																												"(select expense_type_id from expense_type_sub where id = any".
																														"(select expense_type_sub_id from expense_sub where id = any".
																																"(select expense_sub_id from real_expense where side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project["ID"]."' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."'))))";
																	//print $str_account;
																...
																?>        			
        																...
        																<tr>
        																	<!-- column1 -->
        																	<td bgcolor="#D8D8D8" class="normalFont">
        																	<?         								
        																		print "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . "<b>" . $object_account["ACCOUNT"] . "</b>";
        																	?>
        																	</td>
        																	<!-- column3 -->
        																	<td bgcolor="#D8D8D8"  align="right" class="normalFont">
        																		<?
        																			$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																		...
																		?>        			
        																		...
        																		<tr>
        																			<!-- column1 -->
        																			<td bgcolor="#E6E6E6" class="normalFont">
        																			<?         								
        																				print "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $object_expense_type["EXPENSE_TYPE"];
        																			?>
        																			</td>
        																			<!-- column3 -->
        																			<td bgcolor="#E6E6E6"  align="right" class="normalFont">
        																				<?
        																					$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."') and expense_sub_id = any".
        																...
        																?>
																				...
																				?>        			
        																				...
        																				<tr>
        																					<!-- column1 -->
        																					<td bgcolor="#E6E6E0" class="normalFont">
        																					<?         								
        																						print "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . $object_expense_type_sub["EXPENSE_TYPE_SUB"];
        																					?>
        																					</td>
        																					<!-- column3 -->
        																					<td bgcolor="#E6E6E0"  align="right" class="normalFont">
        																						<?
        																							$amount_gov = mysql_fetch_array(database_query("select sum(amount) from real_expense where year = '".$year."' and side_id = '".$side."' and money_type_id = '1' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."' and project_id = any". 
																																								"(select id from project where program_id = any".
																																										"(select id from program where sector_id = '".$object_sector["ID"]."' and id = '".$object_program["ID"]."') and id = '".$object_project["ID"]."') and expense_sub_id = any".
        																		...
        																		?>	
        																				...
        																				<!-- ************************************ Expense Sub ****************************************** -->
																						<?
																							$str_expense_sub ="select * from real_expense where side_id = '".$side."' and year = '".$year."' and project_id = '".$object_project["ID"]."' and activity_id = '".$object_activity["ID"]."' and fund_id = '".$object_fund["ID"]."' and expense_sub_id = any".
																																		"(select id from expense_sub where expense_type_sub_id = any".
																						...
																						?>        			
        																						...
        																						<tr>
        																							...
        																							<!-- column3 -->
        																							<td bgcolor="#F2F2F2"  align="right" class="normalFont">
        																								<?
        																									$int;
        																							...
        																							<!-- column6 -->
        																							<td bgcolor="#F2F2F2"  align="center" class="normalFont">
