         ...
         <td>
		 		<table width="100%" border="1" cellspacing="0" bordercolor="#000000">
        			<tr> 
          				<td bgcolor="#FF6600"> 
						  <div align="center"> 
						  	<p align="center" class="headTable">รายการรายรับจริง ประจำปี <? print $year ?></ p>
						</td>
        			</tr>
      			</table>
		 </td>
      ...
      <td>
		<table width="100%" border="0" cellspacing="1" class="font1">
        	<tr> 
				...
				<td width="11%" align="center" class="normalFont"><b>อ้างอิง</b></td>
				<? if(isset($mode)) { ?>
				<td width="5%">&nbsp;</td>						
				<? } ?>
        	</tr>
        	...
        	?>
        			<tr>
        				...
        				<td  align="center" bgcolor="#FFC184" class="normalFont"><? print $object_money_gov_txt["REF_DOCUMENT"]; ?></td>
        				<? if(isset($mode)) { ?>
        				<!-- column 5 -->
        	...
        	?>
          		...
          		<!-- ************************************ ประจำเดือน ***************************************************** -->
          		<?
          				$str_receipt_month = "select * from real_receipt where money_type_receipt_id = '43000' group by date order by date";
          				$ret_receipt_month = database_query($str_receipt_month);
          				while($object_receipt_month = mysql_fetch_array($ret_receipt_month)) {
          						
          						$m = substr($object_receipt_month["DATE"],5,2);  
          						$y = substr($object_receipt_month["DATE"],0,4);            						      						          						
          		...
          		?>
          							...
          							<tr>
          								<td bgcolor="#FFD5AA" class="normalFont"><? print "<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ประจำเดือน " . $month[(int)$m]. "&nbsp;".$y."</b>"; ?></td>
          								<td bgcolor="#FFD5AA" class="normalFont"></td>
          								<td bgcolor="#FFD5AA"  align="right" class="normalFont">
          								<?
          								...
          								<td bgcolor="#FFD5AA"  align="right" class="normalFont"><? print "<b>" . number_format($amount_receipt_month[0]) . "</b>"; ?></td>
          		 				...
          		 				?>
          		 								...
          		 								?>
          		 													<tr>
          		 															...
          		 															<td  align="center" bgcolor="#F2F2F2" class="normalFont"><? print $object_receipt_temp["REF_DOCUMENT"]; ?></td>
          		 															<? if(isset($mode)) { ?>
        																		<!-- column 5 -->
        	  																	<td bgcolor="#F2F2F2">
        	  																			<? 
