...
<tr>
        ...
        <tr> 
          <td width="46%">&nbsp; </td>
          <td  width="12%"> <div align="center">เงินงบประมาณ</div></td>
      ...
      <?php  
	    ...
	    <?php
	    // sub money3
		$str_money3_sub = "select * from estimate_receipt where receipt_sub_id = any (select id from receipt_sub where receipt_type_id = '".$object_money3_type[0]."')";
