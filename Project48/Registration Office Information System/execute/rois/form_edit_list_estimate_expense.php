...
<?php       
			head_html("แก้ไขรายงานประมาณการรายจ่าย");
        database_connect();
         java_script();
         
         //print "select * from real_expense where id = ".$id."";
         $db = database_query("select * from estimate_expense where id = ".$id."");	
                ...
                <tr>
                        <td>
                                <table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#FF5C0F" bordercolor="#000000">
                                        <tr>
                                                <td><p  align="center" class="headTable">แก้ไขรายการประมาณการรายจ่าย</p></td>
                                        </tr>
                                </table>
                        </td>
                </tr>
                <tr>
                        <td>
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr>
                                                <td>
                                                        <form method="post" <? print "action='process_edit_delete_list.php?mode=edit&select=estimate_expense&id=".$id."'" ?> name="form">
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                        <tr>
