...
$fname = tempnam("/tmp", "all_real_expense.xls");
...
# Title
#
$worksheet1->write('B1', "รายงานสรุปรายจ่ายจริง ประจำปี ". $year, $main_head);
...
header("Content-Type: application/x-msexcel; name=\"report_all_real_receipt.xls\"");
header("Content-Disposition: inline; filename=\"report_real_all_receipt.xls\"");
$fh=fopen($fname, "rb");
fpassthru($fh);
unlink($fname);
