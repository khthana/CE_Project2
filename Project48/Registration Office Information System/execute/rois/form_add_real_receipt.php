                ...
                <tr>
                        <td>
                                <table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#FF5C0F" bordercolor="#000000">
                                        <tr>
                                                <td><p  align="center" class="headTable">เพิ่มรายการรายรับจริง</p></td>
                                        </tr>
                                </table>
                        </td>
                </tr>
                <tr>
                        <td>
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr>
                                                <td>
                                                        <form method="post" action="process_add_data_to_database.php?mode=real_receipt1" name="form">
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
                                                                        ...
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">เอกสารอ้างอิง : </td>
                                                                                <td bgcolor="#F3F3F3"><input type="text" name="ref"></td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">&nbsp;</td>
                                                                                <td bgcolor="#F3F3F3">&nbsp;</td>
                			...
                			<td>
                					<table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
		                                   ...
		                                   <tr>
                                                <td>
                                                        <form method="post" action="process_add_data_to_database.php?mode=real_receipt2" name="form2">
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0" class="normalFont">
                                                                			<tr>
                                                                        ...
                                                                        <tr>
                                                                                ...
                                                                                <td bgcolor="#F3F3F3"><input type="text" name="expand"></td>
                                                                        </tr>                                                                     
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right" width="30%">ประจำเดือน : </td>
                                                                                <td bgcolor="#F3F3F3" width="70%"><?php list_box_month(); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">&nbsp;</td>
                                                                                <td bgcolor="#F3F3F3">&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3"></td>
                                                                                <td bgcolor="#F3F3F3"><input type="submit" value="Submit" onClick="checkYearMoney(document.form2.month,document.form2.dyear)"><input type="reset"></td>
                                                                        </tr>
                                                                </table>
                                                        </form>
                                                </td>
