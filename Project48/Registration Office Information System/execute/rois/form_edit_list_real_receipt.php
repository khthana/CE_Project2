...
<?php       
			head_html("แก้ไขรายงานรายรับจริง");
        database_connect();
         java_script();
         
         $db = database_query("select * from real_receipt where id = ".$id."");	
			$row = mysql_fetch_array($db);
			//print $row["MONEY_TYPE_RECEIPT_ID"];		
?>
       ...
       <table width="75%" border="0" cellspacing="10" cellpadding="0" align="center">
                <tr>
                        <td>
                                <table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#FF5C0F" bordercolor="#000000">
                                        <tr>
                                                <td><p  align="center" class="headTable">แก้ไขรายการรายรับจริง</p></td>
                                        </tr>
                                </table>
                        </td>
                </tr>
                ...
                <tr>
                        <td>
                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        ...
                                        <tr>
                                                <td>
                                                        <? print "<form method='post' action='process_edit_delete_list.php?mode=edit&select=real_receipt&money_type_receipt=42000&id=".$id."' name='form'>"; ?>
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                			<tr>
                ...
                <? } 
               		...
               		$row_receipt_type = mysql_fetch_array(database_query("select * from receipt_type where id = (select receipt_type_id from receipt_sub where id = ".$row["RECEIPT_SUB_ID"].")")); // ประเภทรายรับ			
							$row_receipt_sub = mysql_fetch_array(database_query("select * from receipt_sub where id = (select receipt_sub_id from real_receipt where id = ".$id.")"));
                 ?>
                <tr>
                			<td>
                					<table width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tr>
		                                   ...
		                                   <tr>
                                                <td>
                                                        <? print "<form method='post' action='process_edit_delete_list.php?mode=edit&select=real_receipt&money_type_receipt=43000&id=".$id."' name='form2'>"; ?>
                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                			<tr>
                                                                        ...
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">วันที่ : </td>
                                                                                <td bgcolor="#F3F3F3"><? edit_month_box($row["DATE"]); ?></td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">&nbsp;</td>
                                                                                <td bgcolor="#F3F3F3">&nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">อ้างอิง : </td>
                                                                                <td bgcolor="#F3F3F3"><input type="text" name="ref" <? print "value='".$row["REF_DOCUMENT"]."'"; ?>></td>
                                                                        </tr>
                                                                        <tr>
                                                                                <td bgcolor="#F3F3F3" align="right">&nbsp;</td>
                                                                                <td bgcolor="#F3F3F3">&nbsp;</td>
