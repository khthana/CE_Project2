...
void CBluetoothPMPExampleEngine::HandleListenerDataReceivedL(TDesC& aData)
	...
	TBuf<80> command1;
	command1.Format(_L("Bedroom_TV_On"));

	TBuf<80> command2;
	command2.Format(_L("Bedroom_TV_Off"));

	TBuf<80> command3;
	command3.Format(_L("Bedroom_Stereo_On"));

	TBuf<80> command4;
	command4.Format(_L("Bedroom_Stereo_Off"));

	TBuf<80> command5;
	command5.Format(_L("Bedroom_Light_On"));

	TBuf<80> command6;
	command6.Format(_L("Bedroom_Light_Off"));

	TBuf<80> command7;
	command7.Format(_L("Bedroom_Computer_On"));

	TBuf<80> command8;
	command8.Format(_L("Bedroom_Computer_Off"));

	TBuf<80> command9;
	command9.Format(_L("Bedroom_Fan_On"));

	TBuf<80> command10;
	command10.Format(_L("Bedroom_Fan_Off"));

	TBuf<80> command11;
	command11.Format(_L("Bedroom_Air_On"));

	TBuf<80> command12;
	command12.Format(_L("Bedroom_Air_Off"));

	TBuf<80> command13;
	command13.Format(_L("Bedroom_Play_On"));

	TBuf<80> command14;
	command14.Format(_L("Bedroom_Play_Off"));

	TBuf<80> command15;
	command15.Format(_L("Bedroom_Radio_On"));

	TBuf<80> command16;
	command16.Format(_L("Bedroom_Radio_Off"));
