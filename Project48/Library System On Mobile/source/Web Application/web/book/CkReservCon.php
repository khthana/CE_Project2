...
$sqlClearStatus4 ="update book set status4= 0  where status4=1";
	$resultsqlClearStatus4 = mysql_db_query($dbname, $sqlClearStatus4);	
...
//{
	...
	@$sql="update book set status4 =1 where id='$value[$i]'";
	...
	if (!$result)
	...
	else
		{
			...
			print "<meta http-equiv=\"refresh\" content=\"0;URL=UpdateTimeBorrow.php\">\n";
		}
}
else{
...
<center>
          <b>ต้องทำการเลือกตัว 
          Checkbox ระบบถึงจะสามารถทำงานต่อได้ครับ</b>
          <br>[ <A  href= list_addmin.php >ย้อนกลับไปค้นหาใหม่</A>] 
        </center>
<BR><br>
      </TD></TR></td><TR>
