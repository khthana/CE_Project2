...
border=1>
  <TBODY>
  <TR>
    <TD bgColor=#f0f0f0><FONT face=Verdana size=2><B>โปรแกรมห้องสมุด version 1.0 -
     ยินดีต้อนรับคุณ <?
	 if($login_name==""){
	 echo"gest";
	 }
	 ...
	 echo"[$login_name]";
	  ...
	  ครับผม ..</B></FONT><DIV align=right><!-- <b>วันนี้วันที่:</b>  --><?  
...
?>  <!-- <b>เวลา:</b><?echo"$d";?><b>น.</b> --></DIV></TD></TR>
 ...
 <DIV align=right>จำนวนหนังสือที่แสดง ต่อหน้า <SELECT onchange="MM_jumpMenu('parent',this,0)" name=menu>
  <OPTION value=list2.php?menu=5>ไม่กำหนด!!</OPTION>
 <OPTION value=list2.php?menu=10>10</OPTION> 
 <OPTION  value=list2.php?menu=25>25</OPTION> 
 <OPTION  value=list2.php?menu=50>50</OPTION>
 <OPTION  value=list2.php?menu=100>100</OPTION></SELECT></form></TD></TR></TBODY></TABLE><IMG 
