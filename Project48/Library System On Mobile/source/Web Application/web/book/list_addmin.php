...
<OPTION  value=isbn>ISBN</OPTION></SELECT>
 <INPUT type=submit value=ok!>
      ...
      [ <A href="index.php" target=_parent>Home</A> ] [ <A 
      href="formaddbook.htm?login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>">เพิ่มหนังสือใหม่</A>] 
      [ <A  href="book_borrow_admin.htm">ยืมหนังสือ</A>] [ <A  href="return.htm">คืนหนังสือ</A>] [ <A  href="book_reserv.htm">จองหนังสือ</A>]
