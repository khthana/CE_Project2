...
include("upload_pic.inc");
	...
	@$sql = "insert into book  (id, catalog, code, name_book, writer, company,  year_print, isbn, price, detail,name_borrow,return_book,datetime,pic,total_borrow,status,status1,status2,status3,filetype,filesize,filename) values  (' ','$catalog','$code','$name_book','$writer','$company','$year_print','$isbn','$price','$detail','$name_borrow','$return_book','$datetime','$picture','total_borrow','$status','$status1','$status2','$status3','$picture_type','$picture_size','$picture_name')";
...
//			print "<meta http-equiv=\"refresh\" content=\"0;URL=list_addmin.php\">\n";
			?>
			  ...
			  <TR><td><center><IMG  src="picture/images.jpg"> - </center></td>
			    <TD bgColor=#ffffff><br>
			<center><b>บันทึกข้อมูลเรียบร้อยแล้ว</b> </center>
			<BR><br>
			      </TD></TR></td><TR>
				  <TD><center><BR></center></TD></TR></TBODY></TABLE></TD></TR>
			 </TBODY></TABLE>
