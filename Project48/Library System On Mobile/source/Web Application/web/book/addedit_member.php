...
include("phpConfig.php");
	...
	//# EMOTION ICON
		$address=str_replace (":D", "<img src=\"webboard/icon_biggrin.gif\">", $address);
		$address=str_replace (":)", "<img src=\"webboard/icon_smile.gif\">", $address);
		$address=str_replace (":(", "<img src=\"webboard/icon_sad.gif\">", $address);
		$address=str_replace (":o:", "<img src=\"webboard/icon_surprised.gif\">", $address);

		$address=str_replace (":shock:", "<img src=\"webboard/icon_eek.gif\">", $address);
		$address=str_replace (":~", "<img src=\"webboard/icon_confused.gif\">", $address);
		$address=str_replace ("8)", "<img src=\"webboard/icon_cool.gif\">", $address);
		$address=str_replace (":lol:", "<img src=\"webboard/icon_lol.gif\">", $address);

		$address=str_replace (":x", "<img src=\"webboard/icon_mad.gif\">", $address);
		$address=str_replace (":P", "<img src=\"webboard/icon_razz.gif\">", $address);
		$address=str_replace (":oops:", "<img src=\"webboard/icon_redface.gif\">", $address);
		$address=str_replace (":cry:", "<img src=\"webboard/icon_cry.gif\">", $address);

		$address=str_replace (":evil:", "<img src=\"webboard/icon_evil.gif\">", $address);
		$address=str_replace (":twisted:", "<img src=\"webboard/icon_twisted.gif\">", $address);
		$address=str_replace (":roll:", "<img src=\"webboard/icon_rolleyes.gif\">", $address);
		$address=str_replace (":wink:", "<img src=\"webboard/icon_wink.gif\">", $address);

		$address=str_replace (":!:", "<img src=\"webboard/icon_exclaim.gif\">", $address);
		$address=str_replace (":?:", "<img src=\"webboard/icon_question.gif\">", $address);
		$address=str_replace (":idea:", "<img src=\"webboard/icon_idea.gif\">", $address);
		$address=str_replace (":arrow:", "<img src=\"webboard/icon_arrow.gif\">", $address);
		//#address=eregi_replace ("\[img\]([[:alnum:]]+)://([^[:space:]]*)([[:alnum:]])\[/img\]", "<img src=\"\\1://\\2\\3\">",address ) ;
		$address=eregi_replace("([[:alnum:]]+)://([^[:space:]]*)([[:alnum:]#?/&=])","<a href=\"\\1://\\2\\3\" target=\"\\2\\3\">\\1://\\2\\3</a>",$address);
		$address=eregi_replace("([[:alnum:]]+)@([^[:space:]]*)([[:alnum:]])","<a href=mailto:\\1@\\2\\3>\\1@\\2\\3</a>",$address); 
