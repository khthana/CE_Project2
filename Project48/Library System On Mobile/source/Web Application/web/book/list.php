...
?>
<HTML><HEAD><TITLE>:: ระบบห้องสมุดงมือถือ ::</TITLE>
<META 
		...
		<TBODY>
			<TR>
				<TD>
					...
					<FORM  action=search.php method=post><IMG  src="webboard/icon_mini_search.gif"> 
			  ค้นหาหนังสือ :	<INPUT size=30 name=search>
				...
				จาก :		<SELECT  name=type>
					...
					<FORM action=list2.php method=post > 
							<DIV >จำนวนหนังสือที่แสดง ต่อหน้า <SELECT name=menu>
							...
							<BR>
							<DIV >เรียงลำดับโดย <SELECT name=sort>
				...
				<TD>
					<FORM  name=addcomment onsubmit="return check()" action=checkmember.php
							method=post encType=multipart/form-data>
							<TABLE width="" align="right" border=0>
								 <TBODY>
									 <TR>
										<TD align="right">username :</TD>
											<TD><INPUT maxLength=200 size=20 name=login_name> * </TD>
									</TR>
									<TR>
										<TD align="right">password :</TD>
											<TD><INPUT type= Password maxLength=50 size=20 name=login_password> * </TD>
									</TR>
								 
									<TR >	
									<TD colspan="2" align="center"><INPUT type=submit value="Login" name=submit1> * <INPUT type=reset value=Clear name=B2> [ <A 
										href="formmember.htm" >สมัครสมาชิกใหม่</A> ]</TD></TBODY></TABLE></TD>
									</TR></TBODY>
					 </FORM>
				</TD>
			</TR>
