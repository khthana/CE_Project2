...
<!-- 	  <OPTION  value = return_book>วันที่ส่งคืนหนังสือ!!</OPTION> -->
          ...
          <TD>
    <FORM action=list_addmin2.php method=post > 
...
<OPTION  value=isbn>ISBN</OPTION></SELECT>
 <INPUT type=submit value=ok!>
      ...
      <A href="list_addmin.php" target=_parent>Home</A> ] [ <A 
      href="formaddbook.htm?login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>">เพิ่มหนังสือใหม่</A>] [ <A  href="borrow.htm">ยืมหนังสือ</A>] [ <A  href="return.htm">คืนหนังสือ</A>] [ <A  href="book_reserv.htm">จองหนังสือ</A>] [ <A  href="veiw_return_admin.php">ดูหนังสือที่ถูกยืมไปแล้ว</A>]
 [ <A  href="formmember.htm">สมัครสมาชิกใหม่</A>]  [ <A  href="list_guestbook.php">แสดงข้อมูลเสนอแนะ</A>] [ <A  href="logout.php">ออกจากระบบ</A>]
      &nbsp; 
     <BR>
