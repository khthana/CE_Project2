...
<center><b>ขณะนี้คุณยังไม่ได้ Login เข้าสู้ระบบ.............</b>
		  [ <A  href="login.htm" >กลับไปหน้าแรก</A> ]</center>
<BR><br>
      </TD></TR></td><TR>
...
?>  <!-- <b>เวลา:</b><?echo"$d";?><b>น.</b> --></DIV></TD></TR>
 ...
 <DIV align=right>จำนวนคำแนะนำที่แสดง ต่อหน้า <SELECT name=menu>
 ...
 <OPTION value=g_id>ลำดับทีี่</OPTION> 
 ...
 <INPUT type=submit value=ok!>
      ...
      [ <A href="list_addmin.php" target=_parent>Home</A> ]
...
$q_sql = "select * from guestbook";
	...
	$sql = "select * from guestbook order by g_id ASC limit $goto,$pagesize";
...
?>
          <TD>จำนวนหนังสือที่แสดง : <B><FONT color=#3399cc><?echo"$pagesize\n";?></FONT></B> 
			...
			echo"$borrow \n";?></B>  เล่ม  - คำแนะนำทั้งหมดมี : <b><? echo"$num_rows ";  ?></b> หัวข้อ<BR>
   <?php
