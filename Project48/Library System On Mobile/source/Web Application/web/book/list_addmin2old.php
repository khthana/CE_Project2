...
?>  <!-- <b>เวลา:</b><?echo"$d";?><b>น.</b> --></DIV></TD></TR>
 ...
 <DIV align=right>จำนวนหนังสือที่แสดง ต่อหน้า <SELECT onchange="MM_jumpMenu('parent',this,0)" name=menu>
  <OPTION value=list_addmin2.php?menu=5&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>ไม่กำหนด!!</OPTION>
 <OPTION value=list_addmin2.php?menu=10&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>10</OPTION> 
 <OPTION  value=list_addmin2.php?menu=25&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>25</OPTION> 
 <OPTION  value=list_addmin2.php?menu=50&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>50</OPTION>
 <OPTION  value=list_addmin2.php?menu=100&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>100</OPTION></SELECT></form></TD></TR></TBODY></TABLE><IMG 
      src="webboard/line1.gif"> <BR>[ 
      <A href="list.php" target=_blank>Home</A> ] [ <A 
      href="formaddbook.htm?login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>">เพิ่มหนังสือใหม่</A>] [ <A  href="borrow.htm">ยืมหนังสือ</A>] [ <A  href="return.htm">คืนหนังสือ</A>] [ <A  href="veiw_return_admin.php">ดูหนังสือที่ถูกยืมไปแล้ว</A>]
