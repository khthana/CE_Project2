...
?>  <!-- <b>เวลา:</b><?echo"$d";?><b>น.</b> --></DIV></TD></TR>
      ...
      <TABLE width="100%" align=center border=0>
        ...
        <TR>
		 ...
		 <OPTION  value = name_book>ชื่อหนังสือ!!</OPTION>
          ...
          <TD>
  <FORM name=limit > 
 <DIV align=right>จำนวนหนังสือที่แสดง ต่อหน้า <SELECT onchange="MM_jumpMenu('parent',this,0)" name=menu>
 ...
 <OPTION  value=list2.php?menu=100&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>100</OPTION></SELECT>


 <DIV align=right>เรียงลำดับโดย <SELECT onchange="MM_jumpMenu('parent',this,0)" name=menu1>
  <OPTION value=list2.php?menu=id&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>ไม่กำหนด!!</OPTION>
 <OPTION value=list2.php?menu=catalog&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>หมู่</OPTION> 
 <OPTION  value=list2.php?menu=code&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>รหัส</OPTION> 
 <OPTION  value=list2.php?menu=name_book&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>ชื่อหนังสือ</OPTION>
 <OPTION  value=list2.php?menu=writer&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>ชื่อผู้แต่ง</OPTION>
<OPTION  value=list2.php?menu=company&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>สำนักพิมพ์</OPTION>
<OPTION  value=list2.php?menu=year&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>วัน/เดือน/ปี</OPTION>
<OPTION  value=list2.php?menu=name_borrow&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>ผู้ยืม</OPTION>
<OPTION  value=list2.php?menu=isbn&login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>>ISBN</OPTION></SELECT></form>


</TD></TR></TBODY></TABLE><IMG 
      src="webboard/line1.gif"> <BR>[ 
      <A href="list.php" target=_blank>Home</A> ][ <A href="veiw_return.php" target=_blank>ดูหนังสือที่ถูกยืมแล้ว</A> ]
