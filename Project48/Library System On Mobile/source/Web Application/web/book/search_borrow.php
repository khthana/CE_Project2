...
<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=2 width="100%" border=1>
  <TBODY>
  <TR bgColor=#cce9fd>
    <TD align=middle width="2%"><FONT color=#000000 size=1><B>ck</B></FONT></TD>
...
<TD align=middle width="10%"><FONT color=#000000 size=1><B>ยืมโดย</B></FONT></TD>
 ...
 <form name = "edit" action = "CkReservCon.php" method="post">
<?php	
...
<TD align=middle width="3%"><FONT color=#000000 size=1><input type="checkbox" name="name[]" value="$id"><input type ="hidden" name="id" value="$id">  </FONT></TD>
    ...
    <TD align=middle width="10%"><FONT color=#000000 size=1>$return_book</FONT></TD>
...
echo"<input type = submit value = ยืมต่อ>";
echo"<input type = reset value = ยกเลิก>";
echo"</form>";

//end While

echo "<Font color=blue> แสดงผลการค้นหาข้อมูลงผู้ยืมหนังสือ </Font><Font color=black>[".$search."] </Font>";

echo "&nbsp;&nbsp;&nbsp;&nbsp;<Font color=blue> ค้นพบหนังสือที่ยืมจำนวน </font><Font color=black><b>". $i."</b></font><Font color=blue> เล่ม</font>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;<A Href="."search_borrow.htm".">กลับไปค้นหาใหม่ </A><br><br>";
