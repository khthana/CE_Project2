...
border=1>
  ...
  <TR>
    <TD bgColor=#f0f0f0><FONT face=Verdana size=2><DIV align=right><!-- <b>วันนี้วันที่:</b> -->
    <?
  ...
  <!--  <OPTION  value = name_borrow>ชื่อผู้ยืม!!</OPTION> -->
   <OPTION  value = company>สัมนักพิมพ์!!</OPTION>
	...
	<!--   <OPTION  value = return_book>วันที่ส่งคืนหนังสือ!!</OPTION> -->
      ...
      <A href="index.htm" target=_blank>Home</A> ]  <A 
      href="formaddbook.htm?login_name=<?echo"$login_name";?>&login_password=<?echo"$login_password";?>"></A> <A  href="borrow.htm"></A><A  href="return.htm"></A>  
...
$q_sql = "select name_borrow from book  where name_borrow !=''";
	...
	$sql = "select name_borrow from book  order by id ASC limit $goto,$pagesize";
...
<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=2 width="100%" border=1>
  ...
  <TR bgColor=#cce9fd>
	...
	<TD align=middle width="10%"><FONT color=#000000 size=1><B>กำหนดการคืน</B></FONT></TD>
