...
echo "<td width=\"24%\" class=\"Tahoma11\"><b><font color=\"#CCFF00\">::ข้อมูลของ คุณ $login_name เป็นดังนี้้ ::</font></b></td>\n";
...
echo "</tr>\n";
echo "<tr>\n";
echo "<td valign=\"top\" class=\"Tahoma13\"><img src=\"viewpic_member.php?login_name=$login_name \" border=\"1\" hspace=\"1\"><font color=\"#fafafa\" size=\"4\"><br><b>$address</b><br>&nbsp;</font></td>";
echo "</tr>\n";
echo "<tr>\n";
...
echo "</a>";
echo "<a href=\"edit_member_addmin.php?\">";
