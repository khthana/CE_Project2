...
<title>Microprofessor interfacing</title>
<style type="text/css">
<!--
body {
 ...
 <table width="860" cellspacing="0">
   ...
   <tr>
     <td width="476"><table border="0" cellspacing="0" cellpadding="2">
       <tr>
         <td colspan="2"><table width="415" border="0">
             ...
             <tr>
               ...
               <td width="318"><div align="left"><FONT face=Tahoma size=2>8088/8086 Microprocessors and Supporting Chips<BR>
               </FONT></div></td>
             </tr>
             <tr>
               <td><strong>Chapter 2</strong></td>
               <td><div align="left"> <FONT face=Tahoma size=2>80286 Microprocessors ans Supporting Chips<BR>
               </FONT></div></td>
             </tr>
             <tr>
               <td><strong>Chapter 3</strong></td>
               <td>Memeory and Memory Interfacing</td>
             </tr>
             <tr>
               <td><strong>Chapter 4</strong></td>
               <td>I/O 8255 and Device Interfacing</td>
             </tr>
             <tr>
               <td><strong>Chapter 5</strong></td>
               <td>825/53/54 Timer and Music</td>
             </tr>
             <tr>
               <td><strong>Chapter 6</strong></td>
               <td>Interrupts and the 8259 Chip</td>
             </tr>
             <tr>
               <td><strong>Chapter 7</strong></td>
               <td>Direct Memrory Accessing; The 8237 DMA Chip </td>
             </tr>
             <tr>
               <td><strong>Chapter 8</strong></td>
               <td>Video and VideoAdapters</td>
             </tr>
             <tr>
               <td><strong>Chapter 9</strong></td>
               <td>Serial Data Communication and the 16450/8250/8251 Chips</td>
             </tr>
             <tr>
               <td><strong>Chapter 10</strong></td>
               <td><p> Keyboard and Printer Interfacing<BR>
               </p></td>
             </tr>
             <tr>
               <td><strong>Chapter 11</strong></td>
               <td>Floppy Disks, Hard Disks, and Files</td>
             </tr>
             <tr>
               <td><strong>Chapter 12</strong></td>
               <td>IC Technology and System Design Considerations</td>
             </tr>
             <tr>
               <td><strong>Chapter 13</strong></td>
               <td>ISA, EISA, MCA, Local and PCI bus</td>
             </tr>
         </table></td>
       </tr>
       <tr>
       ...
       <tr>
         <td colspan="2"><strong>หลักสูตร</strong> 60 ชั่วโมง เีรียนทั้งสิ้น 20&nbsp;ครั้ง ครั้งละ 3 ชั่วโมง</td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td><strong>•</strong>&nbsp;&nbsp;&nbsp;ผู้จบหลักสูตรสามารถออกแบบวงจรทางดิจิตอลได้ <br>
           <strong>•</strong>&nbsp;&nbsp;&nbsp;ผู้จบหลักสูตรจะได้รับประกาศนียบัตรจากทางสถาบันเทคโนโลยีพระจอมเกล้า<br>
           เจ้่่าคุณทหารลาดกระบัง <br>
