 ...
 <table width="860" cellspacing="0">
   ...
   <tr>
     <td width="476"><table border="0" cellspacing="0" cellpadding="2">
       ...
       <tr>
         <td colspan="2"><strong>หลักสูตร</strong> 48 ชั่วโมง เีรียนทั้งสิ้น 16 &nbsp;ครั้ง ครั้งละ 3 ชั่วโมง</td>
       </tr>
       <tr>
...
เลขที่บัญชี xxx-x-xxxxx-x</td>
     ...
     <td width="349"><table width="300" border="0" cellpadding="2" cellspacing="0">
       ...
       <tr>
         <td width="326"><form name="form1" method="post" action="../register_check.php">
           <div align="center">
