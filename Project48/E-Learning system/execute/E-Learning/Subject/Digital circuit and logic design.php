 ...
 <table width="860" cellspacing="0">
   ...
   <tr>
     <td width="476"><table border="0" cellspacing="0" cellpadding="2">
       <tr>
         <td colspan="2"><table width="415" border="0">
             ...
             <tr>
               ...
               <td width="318"><div align="left">Number Systems<FONT size=2></FONT><FONT face=Tahoma size=2><BR>
               </FONT></div></td>
             </tr>
             <tr>
               <td><strong>Chapter 2</strong></td>
               <td><div align="left"> Logic Gates<FONT size=2></FONT><FONT face=Tahoma size=2><BR>
               </FONT></div></td>
             </tr>
             <tr>
               <td><strong>Chapter 3</strong></td>
               <td>Waveforms and Boolean Algebra</td>
             </tr>
             <tr>
               <td><strong>Chapter 4</strong></td>
               <td>Exclusive-OR Gates</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td> Master-Slave D and JK Flip-Flops</td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td><p> Schmitt-Trigger Input and Clock One-Shots<BR>
               </p></td>
             </tr>
             <tr>
               <td>&nbsp;</td>
               <td>Digital-to-analog and Analog to Digital Conversions</td>
             </tr>
             <tr>
               <td><strong>Chapter 11</strong></td>
               <td>Decodes,Multiplexers,Demultiplexers and Display</td>
             </tr>
             <tr>
               <td><strong>Chapter 12</strong></td>
               <td>Memories and Introduction to Microcomputers </td>
             </tr>
         </table></td>
       </tr>
       <tr>
       ...
       <tr>
         <td colspan="2"><strong>หลักสูตร</strong> 63 ชั่วโมง เีรียนทั้งสิ้น 21&nbsp;ครั้ง ครั้งละ 3 ชั่วโมง</td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td><strong>•</strong>&nbsp;&nbsp;&nbsp;ผู้จบหลักสูตรสามารถออกแบบวงจรทางดิจิตอลได้ <br>
               <strong>•</strong>&nbsp;&nbsp;&nbsp;ผู้จบหลักสูตรจะได้รับประกาศนียบัตรจากทางสถาบันเทคโนโลยีพระจอมเกล้า<br>เจ้่่าคุณทหารลาดกระบัง <br>
             <strong>•</strong>&nbsp;&nbsp;&nbsp;ประกาศนียบัตรที่ได้รับสามารถนำไปเป็นเอกสาร&nbsp;เพื่อศึกษาต่อปริญญาโทที่<br>           
          สถาบันเทคโนโลยีพระจอมเกล้าเจ้่าคุณทหารลาดกระบังได้ </td>
       </tr>
       <tr>
         <td colspan="2">&nbsp;</td>
       </tr>
...
1. ชำระเงินด้วยตนเองที่สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง
<br>โดยชำระเงินที่สำนักทะเบียนภาควิชาวิศวกรรมคอมพิวเตอร์
<br>
...
เลขที่บัญชี xxx-x-xxxxx-x </td>
     ...
     <td width="349"><table width="300" border="0" cellpadding="2" cellspacing="0">
       ...
       <tr>
         <td colspan="2"><img src="../Images/pm.jpg" width="293" height="196"></td>
       </tr>
       <tr>
         <td colspan="2">&nbsp;</td>
       </tr>
...
&nbsp;&nbsp;  <input type="submit" name="Submit" value="ลงทะเบียนเรียน">
       ...
       <tr>
         <td colspan="2"><img src="../Images/fig3.gif" width="321" height="226"></td>
       </tr>
       <tr>
         <td colspan="2">&nbsp;</td>
       </tr>
