...
mysql_select_db($database_conn, $conn);
$query_student_rs = "SELECT * FROM student where user_ID ='$id' ";
...
<table width="770" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>&nbsp;</td>
    <td><img src="../Images/student_edit_form.gif" width="510" height="72"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td width="30">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="629"><form action="student_edit.php" method="post" name="form1">
      <table width="511" border="1" cellpadding="0" cellspacing="0" bordercolor="#0099FF" background="Images/bg.gif" bgcolor="#FFFFFF">
        <tr>
          ...
          <td><input name="name" type="text" id="name" value="<?php echo $row_student_rs['name']; ?>" maxlength="30"></td>
        </tr>
        <tr>
          <td width="138" bgcolor="#66CCFF">&#3609;&#3634;&#3617;&#3626;&#3585;&#3640;&#3621;</td>
          <td width="367"><input name="surname" type="text" id="surname" value="<?php echo $row_student_rs['surname']; ?>" maxlength="30"></td>
        </tr>
        <tr>
