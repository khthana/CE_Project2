<?php include("../javascript/teacher_edit_check.htm"); ?>
<html>
<head>
...
<?php //if submit update users table and teacher table
	...
	{	
		...
		if($file1!=""){
		$query ="UPDATE teacher SET title='$title',name='$name',surname='$surname',
		...
		teacher_pic='$Name1' where user_ID='$id' ";
		}else{
		$query ="UPDATE teacher SET title='$title',name='$name',surname='$surname',
		position='$position',email='$email',telnum='$telnum',teach_degree='$teach_degree',personal_link='$personal_link',education='$education',
		research1='$research1',research2='$research2',research3='$research3',research4='$research4',research5='$research5',
		book1='$book1',book2='$book2',book3='$book3',book4='$book4',book5='$book5' where user_ID='$id' ";
		}
		$result = mysql_query($query,$conn) or die(mysql_error());
...
mysql_select_db($database_conn, $conn);
$query_teacher_rs = "SELECT * FROM teacher where user_ID='$id' ";
...
<table width="770" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="30">&nbsp;</td>
    <td width="668"><form action="teacher_edit.php" method="post" enctype="multipart/form-data" name="form1">
      <table width="650" border="1" cellpadding="0" cellspacing="0" bordercolor="#0099FF" background="Images/bg.gif" bgcolor="#FFFFFF">
        <tr>
          ...
          <td width="348"><input name="title" type="text" id="title" value="<?php echo $row_teacher_rs['title']; ?>" maxlength="30"></td>
        <td width="149" rowspan="4"><img src="../Images/teacher_pic/<?php echo $row_teacher_rs['teacher_pic']; ?>" width="135" height="145"></td>
        </tr>
        <tr>
          <td width="145" bgcolor="#66CCFF">ชื่อ<span class="style6">*</span></td>
          <td><input name="name" type="text" id="name" value="<?php echo $row_teacher_rs['name']; ?>" maxlength="30"></td>
        </tr>
        <tr>
          <td bgcolor="#66CCFF">นามสกุล<span class="style6">*</span></td>
          <td><input name="surname" type="text" id="surname" value="<?php echo $row_teacher_rs['surname']; ?>" maxlength="30"></td>
        </tr>
        <tr>
          <td bgcolor="#66CCFF">Username<span class="style6">*</span></td>
        ...
        <tr>
          <td bgcolor="#66CCFF">Password<span class="style6">*</span></td>
          <td colspan="2"><input name="password" type="text" id="password" value="<?php echo $row_user_rs['password']; ?>" maxlength="12">            
...
<input <?php if (!(strcmp($professor,1))) {echo "checked";} ?> name="professor" type="checkbox" id="professor" value="1">
        ...
        <tr>
          ...
          <td colspan="2"><input name="personal_link" type="text" id="personal_link" value="<?php echo $row_teacher_rs['personal_link']; ?>"></td>
        </tr>
        <tr>
		...
		<tr>
          <td height="28" colspan="3" bgcolor="#66CCFF"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
