...
namespace W
{
    namespace Circle
    {
        public class CircleSetting : IDrawSetting
        {
            ...
            public bool Circle
            {
                set
                {
                    ...
                    if (drawAble != null)
                    {
                        W.Circle.CircleDraw cd = (CircleDraw)drawAble;
                        cd.Clear();
                    }
                }
                get
            ...
            public void initializeSettingForm(IMenu menu)
            {
                ...
                this.GB_basicprop.Controls.Add(this.CB_ellipse);
                //
                // GB_linemode
                //
                ...
                this.CB_ellipse.AutoSize = true;
                this.CB_ellipse.Location = new System.Drawing.Point(21, 72);
                this.CB_ellipse.Name = "RB_Ellipse";
                this.CB_ellipse.Size = new System.Drawing.Size(20, 20);
                this.CB_ellipse.TabIndex = 7;
                this.CB_ellipse.Text = "Ellisp";
                this.CB_ellipse.CheckedChanged += new System.EventHandler(this.CB_CheckedChanged);
                ...
                this.GB_linemode.Location = new System.Drawing.Point(11, 109);
        ...
        public class CircleDraw : DrawAble
        {
            private Circle.CircleSetting setting;
            ...
            #region Construtor
            public CircleDraw(B b, Circle.CircleSetting s)
                : base(b)
            {
                setting = s;
                State = States.First;
                ...
                set
                {
                    switch (value)
                    {
                        case States.First:
                            {
                                color = board.Color;
                                setting = (Circle.CircleSetting)board.ObjectsSetting.settings[(int)Basic2DObjects.Circle];
            ...
            protected override void FillFrame()
            {
                ...
                drawableFrame.cmd = CMD.Circle;
                drawableFrame.para = new string[8];
                ...
                if (setting.Circle)
                {
                    drawableFrame.para[7] = "t";
                    drawableFrame.para[5] = c.ToString();
                    drawableFrame.para[6] = "t";
                }
                else
                {
                    drawableFrame.para[7] = "f";
                ...
                drawableFrame.paraSize = 10 + drawableFrame.para[1].Length;//(10 = 2+8)
            ...
            protected override void Draw()
            {
                ...
                if ((Possition2.X - Possition.X) * (Possition2.X - Possition.X) > ((possition2.Y - Possition.Y)) * (possition2.Y - Possition.Y))
                {
                    c = (float)possition2.X - (float)Possition.X;
                }
                else
                {
                    c = (float)possition2.Y - (float)Possition.Y;
                }
                switch (setting.Mode)
                {
                   case DrawModes.Draw:
                        {
                            if (setting.Circle == true)
                            {
                                g.DrawEllipse(new Pen(color, setting.Size), (float)Possition.X, (float)possition.Y, c, c);  
                            }
                            else
                            {
                                g.DrawEllipse(new Pen(color, setting.Size), (float)Possition.X, (float)possition.Y, (float)Possition2.X - (float)Possition.X, (float)possition2.Y - (float)Possition.Y);
                            }
                        } break;
                    case DrawModes.Fill:
                        {
                            if (setting.Circle == false)
                            {
                                g.FillEllipse(new SolidBrush(color), (float)Possition.X, (float)possition.Y, (float)Possition2.X - (float)Possition.X, (float)possition2.Y - (float)Possition.Y);    
                            }
                            else
                            {
                                g.FillEllipse(new SolidBrush(color), (float)Possition.X, (float)possition.Y, c, c);
                            }
                        } break;
                }
                g.Dispose();
