...
<body bgcolor="#FFCCFF">
<form enctype="multipart/form-data" name="frmUploadFile" action="infofile.php" method="post">
...
<p style="margin-left: 10"><font face="Verdana" size="2"> File Thumnail Location:</font></td> 
...
{ 
	echo "<center><b>Please Login Before <font color=\"#FF6600\"><a href=\"login.php\">LOGIN !</a></font></b></center>";
}
?>
