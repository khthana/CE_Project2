...
get_lang($module_name);
 ...
 $user=$HTTP_SESSION_VARS[user];
	...
	$dbQuery .="WHERE User='$user' AND Status='1'";
	...
	echo"</table></center>";
	echo "<center>";
	echo"<a href=../nuke/modules.php?name=showfile&&file=showowner>SHOW OWNER</a>";
	echo "&nbsp;&nbsp;";
	echo"<a href=../nuke/modules.php?name=showfile&&file=editprivate>EDIT PRIVATE</a>";
	echo "</center>";
CloseTable();
 include("footer.php");
