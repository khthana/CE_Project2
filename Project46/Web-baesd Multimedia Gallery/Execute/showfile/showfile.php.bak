...
function download1(id){
				window.open('login2.php?id='+id,'', 'scrollbars=no,width=260,height=160,status=no,Left=450  Top=300')
...
$user=$HTTP_SESSION_VARS["user"];
	...
	echo "<br>";
	echo "<center><a href><img src=\"downloadfile.php?ImageId=$rs[Id]\">\n</a>";
	echo "<br>";
...
<?
	...
	//$dbQuery.="WHERE Type Like ('%image%' ) AND Status='0'";
