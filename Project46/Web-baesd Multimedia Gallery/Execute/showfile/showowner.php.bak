...
//-----------------------------------------------------------------------------
  //####################################
	...
	for($k=0;$k<$perpage;$k++){	
		$k_p=$k+1;
		echo "<a href=../nuke/modules.php?name=showfile file=showowner&&page=$page_arr[$k]>$k_p</a>";
		echo "&nbsp;&nbsp;";
	}
echo "</center>";
	...
	echo "&nbsp;&nbsp;";
	echo"<a href=../nuke/modules.php?name=showfile&&file=editowner>Edit All Owner File</a>";
	echo "</center>";
CloseTable();
 include("footer.php");
?>
