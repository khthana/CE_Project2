<%@ Page language="c#" Codebehind="register.aspx.cs" AutoEventWireup="false" Inherits="Hospital.register" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<font color="#ff5000">
			<h3>สมัครลงทะเบียนประกันสุขภาพถ้วนหน้า</h3>
			<br>
		</font>&nbsp; &nbsp; &nbsp; &nbsp; หมายเลขประจำตัวประชาชนผู้ที่ต้องการลงทะเบียน <FONT face="Tahoma">
			<br>
			<br>
			<DIV ms_positioning="FlowLayout" align="center" style="WIDTH: 612px; POSITION: relative; HEIGHT: 23px">
				<FORM id="Form1" action="registerHealthy/register.aspx" method="post" name=InputForm>
