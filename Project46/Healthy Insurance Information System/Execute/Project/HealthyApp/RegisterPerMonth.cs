...
{
	/// <summary>
	/// Summary description for RegisterPerMonth.
	/// </summary>
	public class RegisterPerMonth : System.Windows.Forms.Form
	{
		/// <summary>
		...
		public RegisterPerMonth(Form mainForm)
		{
			//
			// Required for Windows Form Designer support
			//
		...
		private void InitializeComponent()
		{
			...
			this.crystalReportViewer1.ReportSource = "C:\\Documents and Settings\\Soowit\\My Documents\\Visual Studio Projects\\HealthyApp\\R" +
				"egisterMonth.rpt";
			...
			this.Name = "RegisterPerMonth";
			this.Text = "Register For A Month";
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			String MMYYYY = YY + "-"+ MM;
			String inputparam="{LogfileRegister.DATE_REGIS} in '"+MMYYYY+"-01' to '"+MMYYYY+"-31'";
