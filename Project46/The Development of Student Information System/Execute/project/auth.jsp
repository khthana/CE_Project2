...
<% 	if(!session.isNew()) session.setAttribute("auth","0"); %>
...
<table width="100%"  height="100%" border=0   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG">
  ...
  <tr>
    <td width="264" height="113" rowspan="4" valign="middle" >ขอต้อนรับสู่ระบบทะเบียนนักศึกษา<br>
     สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง 
	 </td>
    <td height="50" colspan="2"  valign="middle" align="center"><h1> USER LOGIN </h1></td>
  </tr>
  <tr>
    <td width="48" height="30">user :      </td>
    <td width="154"  align="right"><input type="text" name="user"></td>
  </tr>
  <tr>
    <td height="30"  width="48">pass :      </td>
    <td height="30" align="right"  width="154" ><input type="password" name="pass"></td>
  </tr>
  <tr>
