...
<form name="form1" method="post" action="editfacre.jsp">
 <input name="fac" type="hidden" value="<%=viewf.getFac()%>">
  <tr>
    <td height="30" bgcolor="#99FF99">&#3627;&#3609;&#3656;&#3623;&#3618;&#3591;&#3634;&#3609; / &#3588;&#3603;&#3632; <a href="addfac.jsp">add</a> <a href="viewfac.jsp">view</a></td>
  </tr>
  <tr>
    <td height="356" bgcolor="#CCFFCC"><table width="697" border="0">
      ...
      <tr>
        ...
        <td width="275" height="35"><input name="tname" type="text" value="<%= viewf.getTname() %>" size="40" maxlength="50"></td>
        <td width="108" height="35">&#3594;&#3639;&#3656;&#3629;&#3618;&#3656;&#3629;(&#3652;&#3607;&#3618;)</td>
        <td width="188" height="35"><input name="tabb" type="text" value="<%= viewf.getTabb() %>"size="17" maxlength="15"></td>
      </tr>
      <tr>
  ...
  <tr>
    <td height="30" bgcolor="#CCFFCC" ><div align="right">
      ...
      <input type="button" name="del" value="delete" onclick="del()">
    </div></td>
  </tr>
  </form>   
</table>
