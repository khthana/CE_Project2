...
<table width="100%"  height="100%" border="0"   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG" >
  ...
  &#3648;&#3585;&#3655;&#3610;&#3588;&#3656;&#3634;&#3626;&#3629;&#3610;&#3616;&#3634;&#3625;&#3634;&#3605;&#3656;&#3634;&#3591;&#3611;&#3619;&#3632;&#3648;&#3607;&#3624;</label>
        ...
        <tr>
		  ...
		  ทฤษฏี 
		    <input name="lecture" type="text" size="5" maxlength="2" onKeyPress="nochar()"> :
		  ปฏิบัติ <input name="lab" type="text" size="5" maxlength="2" onKeyPress="nochar()">		  </td>
		...
		<tr>
			<td colspan="4">
				<input type="checkbox" name="term1" value="y" onClick="active2(document.form1)"><a href="javascript:void(0)" onClick="showd(dm1)">ภาคต้น</a>
				<input type="checkbox" name="term2" value="y" onClick="active2(document.form1)"><a href="javascript:void(0)" onClick="showd(dm2)">ภาคปลาย</a>
				<input type="checkbox" name="term3" value="y" onClick="active2(document.form1)"><a href="javascript:void(0)" onClick="showd(dm3)">ภาคฤดูร้อน</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
			...
			<select name="note1_1" size="1" style="visibility: hidden "><option></option></select><select name="note2_1" size="1" style="visibility: hidden "><option></option></select>
		</table>
				</div>
        ...
        <tr>
			<select name="note1_2" size="1" style="visibility: hidden "><option></option></select> <select name="note2_2" size="1" style="visibility: hidden "><option></option></select>
		</table>
		</div>
		...
		<select name="note1_3" size="1" style="visibility:hidden "><option></option></select><select name="note2_3" size="1" style="visibility:hidden" ><option></option></select>
		</table>
		</div>
			</td>
		</tr>		
