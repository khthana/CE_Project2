...
function adds(val) {
	opener.form1.sec2.length = opener.form1.sec2.length +1;
	opener.form1.maxstd2.length = opener.form1.maxstd2.length +1;
	opener.form1.note1[1].value = val.n1.value;
	opener.form1.note2[1].value = val.n2.value;	
	opener.form1.sec2[opener.form1.sec2.length - 1].value = opener.form1.sec2.length - 1;
	opener.form1.sec2[opener.form1.sec2.length - 1].text = opener.form1.sec2.length - 1;
	opener.form1.maxstd2[opener.form1.sec2.length - 1].value = val.maxstd.value;
	opener.form1.maxstd2[opener.form1.sec2.length - 1].text = val.maxstd.value;
	opener.form1.s2[opener.form1.sec2.length - 1].value = opener.form1.sec2.length - 1;
	opener.form1.m2[opener.form1.sec2.length - 1].value = val.maxstd.value;	
	self.close();
}
function writes() {
	document.write(opener.form1.sec2.length);
}
</script>
</HEAD>
...
<table width="640"  height="100%" border="0"   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG" >
  ...
  <tr valign="top">
      ...
      <form name="form1">
       	<table  border="0">
  <tr>
    <td colspan="2">เทอมปลาย : เซ็กชั่น <script language="javascript">writes()</script> : จำนวนนักศึกษาที่ต้องการรับ <input type="text" name="maxstd" size="4" maxlength="3" onKeyPress="nochar()"></td>
  </tr>
  <tr>
