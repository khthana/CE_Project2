...
<table width="100%"  height="100%" border="0"   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG" >
  ...
  <tr valign="top">
  	<td colspan="2">
      <table width="100%"  border="0"><form name="form1" method="post" action="addstdre.jsp">
        <tr>
          <td width="7%" align="right">คำนำหน้า(ท) :<br>
			<select name="tpren">
			<option value="1">นาย</option>
			<option value="2">นาง</option>
			<option value="3">นางสาว</option>										
			</select>			</td>
          <td  width="12%"align="left">ชื่อ(ท) : <br> <input name="tfname" type="text" size="20" maxlength="40"></td>
          <td width="15%" align="left">นามสกุล(ท) : <br> <input name="tlname" type="text" size="30" maxlength="40"></td>
          <td rowspan="5" valign="top"><table border="0">
            <tr valign="top">
              <td width="80">ประเภท<br>
			  	<label><input type="radio" name="type" value="1">สามัญ</label><br>
				<label><input type="radio" name="type" value="1">ทดลองเรียน</label><br>  
			  </td>
              <td width="100">นักศึกษา<br>
			  	<label><input type="radio" name="" value="1">ในประเทศ</label><br>
				<label><input type="radio" name="degree" value="1">ต่างประเทศ</label><br>			  
			  </td>
              <td rowspan="2" width="120">สถานภาพ<br>
			  	<label><input type="radio" name="status" value="1">กำลังศึกษา</label><br>
				<label><input type="radio" name="status" value="1">จบการศึกษา</label><br>
			  	<label><input type="radio" name="status" value="1">พ้นสภาพ</label><br>
				<label><input type="radio" name="status" value="1">ปรับสภาพนักศึกษา</label><br>
			  	<label><input type="radio" name="status" value="1">ลาออก</label><br>
				<label><input type="radio" name="status" value="1">ไม่มารายงานตัว</label><br>
			  	<label><input type="radio" name="status" value="1">คัดชื่อออก</label><br>			  
			  </td>
            </tr>
            <tr valign="top">
              <td>ระดับ<br>
        ...
        <tr>
          <td align="right">คำนำหน้า(ท) :<br>
			<select name="epren">
			<option value="1">นาย</option>
			<option value="2">นาง</option>
			<option value="3">นางสาว</option>										
			</select>		  </td>
          <td align="left">ชื่อ(อ) : <br> <input name="efname" type="text" size="20" maxlength="40"></td>
          <td align="left">นามสกุล(อ) : <br> <input name="elname" type="text" size="30" maxlength="40"></td>        </tr>
        <tr>
          <td colspan="3"  align="left">สาขา : 
			<select name="major">
			...
			|  ห้อง : 
          <input name="room" type="text" size="2" maxlength="2"> | ชั้นปี : <input name="class" type="text" size="2" maxlength="2">		  </td>
        </tr>
        <tr>
          <td colspan="3"  align="left">หลักสูตร : 
			<select name="cur">
			<option value="1">sdf</option>
			<option value="2">asdf</option>
			<option value="3">fasd</option>										
        ...
        <tr>
          <td colspan="3" >
		  	<input name="chk" type="checkbox" value="1">เป็นข้าราชการในสถาบันฯ |  ประเทภรับเข้า/เวลาเรียน
			<select name="cur">
			<option value="1">sdf</option>
			<option value="2">asdf</option>
			<option value="3">fasd</option>										
