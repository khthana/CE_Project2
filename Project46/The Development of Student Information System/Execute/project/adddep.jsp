...
<table width="100%"  height="100%" border=0   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG">
  ...
  <tr valign="top">
    <td colspan="2">ภาควิชา</td>
  </tr>
  <tr valign="top">
    <td colspan="2">ชื่อ(ท) <input name="tname" type="text" size="40" maxlength="50"></td>
  </tr>
  <tr valign="top">
    <td colspan="2">ชื่อ(อ) <input name="ename" type="text" size="40" maxlength="50"></td>
  </tr>
  <tr valign="top">
    <td colspan="2">สังกัดหน่วยงาน 
		<select name="fac">
		<%
		String str; int id;
		VarDB v = new VarDB();
