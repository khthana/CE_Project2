...
<table width="702" border="0" >
  <tr>
    <td height="55" bgcolor="#99FF99">ภาควิชา  <a href="adddep.jsp">add </a> <a href="viewdep.jsp">view</a></td>
  </tr>
  <tr>
    <td height="184" bgcolor="#CCFFCC"  valign="top">&nbsp;<jsp:getProperty name="addd" property="add" /></td>
  </tr>
</table>   
</body>
</html>
