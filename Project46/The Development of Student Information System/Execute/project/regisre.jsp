...
<%
	reg.setSubid(request.getParameterValues("subid")); 
	reg.setSec(request.getParameterValues("sec")); 
	reg.check();
%>	
...
<table width="100%"  height="100%" border="0"   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG" >
  ...
  <tr valign="top" height="30">
  	<td colspan="2">
		...
		<% 
			if( reg.getFlag() == 1 )  out.print("regisconf.jsp");
			else out.print("");
		%>
		">
		...
		<%
		String [] tmp1 = reg.getSubid(); String [] tmp2 = reg.getSname(); String  [] tmp3 = reg.getResult();
		...
		<tr>
			...
			<%
				if( reg.getFlag() == 1 )  out.print("<input type=\"submit\" name=\"Submit\" value=\"confirm\">");
