...
<table width="100%"  height="100%" border=0   cellspacing="0" cellpadding="0"  background="pic/shadow.JPG">
  ...
  <tr valign="top" height="40">
  	<td colspan="2" height="40"><jsp:include page="popup.jsp" flush="false"></jsp:include></td>
  </tr>
  <tr valign="top"  height="30">
    <td colspan="2">ข้อมูลภาควิชา  <a href="adddep.jsp">add </a>  |  <a href="viewdep.jsp">view</a></td>
  </tr>
  <tr valign="top">  
    <td colspan="2"><jsp:getProperty name="addd" property="add" /> การเพิ่มข้อมูลภาควิชาเรียบร้อย</td>
  </tr>
  <tr valign="bottom">
