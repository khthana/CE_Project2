...
?>
        <tr> 
          <td class="warning"><div align="center">กรุณาใส่ Username กับ Password 
              ใหม่ </div></td>
        </tr>
<?php
}
...
?>
        <tr> 
          <td class="warning"><div align="center">ไม่มี Username นี้ในระบบ กรุณาตรวจสอบ 
              หรือ <a href="register.php">Register</a> ใหม่ </div></td>
        </tr>
<?php
}
if ($error==3)
...
?>
        <tr> 
          <td class="warning"><div align="center">Password ของคุณผิดกรุณาใส่ใหม่<br>
              ลืม Password คลิก <a href="forget.php">ที่นี่</a></div></td>
        </tr>
<?php
}
?>
