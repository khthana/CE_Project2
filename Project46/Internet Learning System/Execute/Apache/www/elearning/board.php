...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="550" bgcolor="#FF9900" class="headmenu">รายชื่อ Webboard</td>
...
<?php
	...
	$sql = "select subid,enname,thname from subject";	
...
?>
        <tr> 
          <td height="23"><a href="webboard.php?Category=<? print $rsubid; ?>&page=1" target="_blank"><? print "$rthname ( $renname )"; ?></a></td>
        </tr>
        <?php
	}
?>
        <tr> 
          <td><a href="webboard.php?Category=&page=1" target="_blank">ทั่วไป ฯลฯ</a></td>
        </tr>
      </table></td>
    <td width="28">&nbsp;</td>
  </tr>
