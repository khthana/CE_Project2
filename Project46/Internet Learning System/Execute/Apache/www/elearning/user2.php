...
<html>
<head>
<title>เกี่ยวกับข้อมูลส่วนตัว</title>
...
if(isset($_SESSION['user']) && ($rstatus==2 || $rstatus==1))
{
?>
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="544" bgcolor="#FF9900" class="headmenu"><font size="2">&nbsp;เกี่ยวกับข้อมูลส่วนตัว</font></td>
    ...
    <td colspan="3"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF9900">
        <tr> 
          <td colspan="2"><table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td>&nbsp;</td>
                <td class="defaultfont">ข้อมูลส่วนตัวที่ได้กรอกลงไปก่อนทำการ register 
                  สามารถทำการแก้ไขได้ โดยหลังจากเช้าสู่ระบบแล้ว เข้า menu Edit 
                  Phofile แล้วทำการเปลี่ยนแปลงข้อมูลได้</td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
                    <tr> 
                      <td width="50%"><img src="logo/user2-1.jpg" width="135" height="131"></td>
                      <td width="50%" class="defaultfont">กรอก Password เพื่อทำการยืนยันการเปลี่ยนแปลง</td>
                    </tr>
                  </table></td>
                <td>&nbsp;</td>
              </tr>
