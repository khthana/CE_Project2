          ...
          <td><table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr> 
                <td><div align="left"></div>
                  <div align="right"><a href="editebook.php?sort=1">เรียงตามรหัสวิชา</a></div></td>
                <td width="100" class="defaultfont"><div align="right">|&nbsp;&nbsp;&nbsp;<a href="editebook.php?sort=2">เรียงตามตัวอักษร</a></div></td>
                <td width="100" class="defaultfont"><div align="right">|&nbsp;&nbsp;&nbsp;<a href="editebook.php?sort=3">เรียงตามระดับขั้น</a></div></td>
              </tr>
            </table></td>
        </tr>
<?php
...
for ($i=0; $i<$count; $i++)
{
	...
	$sql1 =  "select * from ebooksubject where subid='$rsubid';";
...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr bgcolor="#FFEECC"> 
                ...
                <td width="60" class="warning"><?php print $count1; ?> <a href="editsbook.php?subid=<?php print $rsubid; ?>">lesson</a></td>
