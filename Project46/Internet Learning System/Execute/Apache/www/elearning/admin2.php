    ...
    <td colspan="3"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF9900">
        <tr> 
          <td colspan="2"><table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td>&nbsp;</td>
                <td class="defaultfont">ใน menu แก้ไข user นั้นจะแสดงถึง user 
                  ที่เป็นบุคลากรทั้งหมดและ user ที่เป็นผู้เรียนที่หมด ในหน้านี้ 
                  admin สามารถที่จะ สร้าง ลบ และเปลี่ยนแปลงข้อมูลของ user ได้</td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
                    <tr>
                      <td class="defaultfont">user ที่เป็นบุคลากร</td>
                    </tr>
                    <tr>
                      <td><img src="logo/admin2-1.jpg" width="480" height="74"></td>
                    </tr>
                    <tr>
                      <td class="defaultfont">user ที่เป็นผู้เรียน</td>
                    </tr>
                    <tr>
                      <td><img src="logo/admin2-2.jpg" width="482" height="64"></td>
                    </tr>
                  </table></td>
                <td>&nbsp;</td>
              </tr>
