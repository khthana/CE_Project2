...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="550" bgcolor="#FF9900" class="headmenu">แบบทดสอบทั้งหมดของวิชา</td>
...
?>
        <tr> 
          <td> <table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr> 
                <td class="defaultfont"><a href="createtest.php?subid=<?php print $subid; ?>">create</a></td>
              </tr>
            </table></td>
        </tr>
        <?php
...
?>
        <tr> 
          <td> <table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr> 
                <td colspan="4" class="warning">lv.5</td>
              </tr>
<?php
	$sql = "select * from testsubject where subid='$subid' and level=5;";
	$result=mysql_query($sql);
	$count=mysql_num_rows($result);
	for($i=0; $i<$count; $i++)
	{
		$rquestion=mysql_result($result,$i,"question");
		$rnumid=mysql_result($result,$i,"numid");
?>
              <tr bgcolor="#FFCCBB"> 
                <td width="70" class="defaultfont"><?php print $i+1; ?></td>
                <td width="270" class="defaultfont"><?php print $rquestion; ?></td>
                <td width="70"><a href="edittes.php?subid=<?php print $subid; ?>&numid=<?php print $rnumid; ?>">edit</a></td>
                <td width="70"><a href="adtdelete.php?subid=<?php print $subid; ?>&numid=<?php print $rnumid; ?>">delete</a></td>
              </tr>
<?php
	}
?>
              <tr> 
                <td colspan="4" class="warning">lv.4</td>
              </tr>
<?php
	$sql = "select * from testsubject where subid='$subid' and level=4;";
	$result=mysql_query($sql);
	$count=mysql_num_rows($result);
	for($i=0; $i<$count; $i++)
	{
...
?>
              <tr> 
                <td colspan="4" class="warning">lv.3</td>
              </tr>
<?php
	$sql = "select * from testsubject where subid='$subid' and level=3;";
	$result=mysql_query($sql);
	$count=mysql_num_rows($result);
	for($i=0; $i<$count; $i++)
	{
...
?>
              <tr> 
                <td colspan="4" class="warning">lv.2</td>
              </tr>
<?php
	$sql = "select * from testsubject where subid='$subid' and level=2;";
	$result=mysql_query($sql);
	$count=mysql_num_rows($result);
	for($i=0; $i<$count; $i++)
	{
...
?>
              <tr> 
                <td colspan="4" class="warning">lv.1</td>
              </tr>
<?php
	$sql = "select * from testsubject where subid='$subid' and level=1;";
	$result=mysql_query($sql);
	$count=mysql_num_rows($result);
	for($i=0; $i<$count; $i++)
	{
