...
<html>
<head>
<title>รายชื่อวิชาทั้งหมดที่เปิด</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="550" bgcolor="#FF9900" class="headmenu">รายชื่อวิชา ทั้งหมด</td>
...
?>
        <tr>
          <td><table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr> 
                <td><div align="left">
				<a href="createsub.php">create</a>
				</div></td>
                <td width="100"><div align="right"><a href="editsubject.php?sort=1">เรียงตามรหัสวิชา</a></div></td>
                <td width="100" class="defaultfont"><div align="right">|&nbsp;&nbsp;&nbsp;<a href="editsubject.php?sort=2">เรียงตามตัวอักษร</a></div></td>
                <td width="100" class="defaultfont"><div align="right">|&nbsp;&nbsp;&nbsp;<a href="editsubject.php?sort=3">เรียงตามระดับขั้น</a></div></td>
              </tr>
            </table></td>
        </tr>
<?php
...
<table width="100%" border="0" cellpadding="1" cellspacing="1">
              <tr bgcolor="#FFEECC"> 
                ...
                <td width="60" class="defaultfont"><a href="editsub.php?subid=<?php print $rsubid; ?>">edit</a></td>
<?php
if($rstatus==0)
{
?>
                <td width="65" class="defaultfont"><a href="adsdelete.php?subid=<?php print $rsubid; ?>">delete</a></td>
<?php
}
?>
              </tr>
