...
?>
        <tr> 
          <td class="warning"><div align="center">*คุณยังไม่ได้ใส่ ชื่อ กรุณาใส่ด้วย</div></td>
        </tr>
<?php
}
else
...
?>
        <tr> 
          <td class="warning"><div align="center">*คุณยังไม่ได้ใส่ นามสกุล กรุณาใส่ด้วย</div></td>
        </tr>
<?php
	}
	else
...
?>
        <tr> 
          <td class="warning"><div align="center">*คุณยังไม่ได้ใส่ ชื่อเล่น กรุณาใส่ด้วย</div></td>
        </tr>
<?php
		}
		else
...
?>
        <tr> 
          <td class="warning"><div align="center">*คุณยังไม่ได้ใส่ email กรุณาใส่ด้วย</div></td>
        </tr>
<?php
			}
			else
...
?>
        <tr> 
          <td class="warning"><div align="center">*คุณยังไม่ได้ใส่ username กรุณาใส่ด้วย</div></td>
        </tr>
<?php
				}
				else
...
?>
        <tr> 
          <td class="warning"><div align="center">*คุณยังไม่ได้ใส่ password กรุณาใส่ด้วย</div></td>
        </tr>
<?php
					}
					else
...
?>
        <tr> 
          <td class="warning"><div align="center">*password ของคุณไม่ถูกต้อง กรุณาใส่ใหม่</div></td>
        </tr>
<?php
						}
						else
...
?>
        <tr> 
          <td class="warning"><div align="center">*username มีคนใช้แล้ว กรุณาเปลี่ยน</div></td>
        </tr>
<?php
							}
							else
