...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="550" bgcolor="#FF9900" class="headmenu">ขอรหัสผ่านใหม่</td>
  ...
  <tr> 
    ...
    <td>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td><form name="form1" method="post" action="getpass.php">
              <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                <tr> 
                  <td width="24%" bgcolor="#FFCC99" class="headfont">user *</td>
                  <td width="76%" bgcolor="#FFEECC"><input name="user" type="password" id="user" size="20" maxlength="20"></td>
                </tr>
                <tr> 
                  <td bgcolor="#FFCC99" class="headfont">E-mail *</td>
                  <td bgcolor="#FFEECC"><input name="email" type="password" id="email" size="30" maxlength="30"></td>
                </tr>
                <tr> 
