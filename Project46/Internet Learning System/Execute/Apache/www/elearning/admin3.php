...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="544" bgcolor="#FF9900" class="headmenu"><font size="2">&nbsp;บริหารรายวิชา 
      </font></td>
    ...
    <td colspan="3"><table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FF9900">
        <tr> 
          <td colspan="2"><table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td>&nbsp;</td>
                <td class="defaultfont">ใน menu แก้ไขรายวิชา admin จะสามารถสร้าง 
                  ลบ และแก้ไขรายวิชาต่างๆ ได้ทั้งหมด </td>
                <td>&nbsp;</td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
                <td><table width="100%" border="0" cellspacing="2" cellpadding="1">
                    <tr> 
                      <td><img src="logo/admin3-1.jpg" width="481" height="71"></td>
                    </tr>
                  </table></td>
                <td>&nbsp;</td>
              </tr>
