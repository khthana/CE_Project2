...
<html>
<head>
<title>รายวิชาที่สามารถเข้าสอบเพื่อเพิ่มระดับ</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="550" bgcolor="#FF9900" class="headmenu">แบบทดสอบ</td>
...
?>
              <tr> 
                <td width="50" class="defaultfont"><a href="JavaScript:openwin('prompt.php?subid=<?php print $rsubid; ?>&ok=','','scrollbars=yes,resizable=no,width=700,height=600')"><?php print $rsubcode; ?></a></td>
                <td class="defaultfont"><a href="JavaScript:openwin('prompt.php?subid=<?php print $rsubid; ?>&ok=','','scrollbars=yes,resizable=no,width=700,height=600')"><?php print $renname; ?></a></td>
                <td class="defaultfont"><a href="JavaScript:openwin('prompt.php?subid=<?php print $rsubid; ?>&ok=','','scrollbars=yes,resizable=no,width=700,height=600')"><?php print $rthname; ?></a></td>
