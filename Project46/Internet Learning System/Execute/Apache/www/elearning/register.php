...
<html>
<head>
<title>กรอกรายละเอียดข้อมูลส่วนตัว เพื่อสมัครเป็นสมาชิก</title>
...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td class="headmenu" width="550" bgcolor="#FF9900">ลงทะเบียนเป็นสมาชิก</td>
    ...
    <td> 
      <form name="form1" method="post" action="reg.php">
        <table width="100%" border="0" cellpadding="1" cellspacing="1">
          <tr> 
            <td width="20%" bgcolor="#FFCC99" class="headfont"> &nbsp;ชื่อ *</td>
            <td width="30%" bgcolor="#FFEECC" class="defaultfont"><input name="fristname" type="text" id="fristname" maxlength="30"></td>
            <td width="20%" bgcolor="#FFCC99" class="headfont">&nbsp;นามสกุล *</td>
          ...
          <tr> 
            ...
            <td colspan="3" bgcolor="#FFEECC" class="defaultfont"><input name="email" type="text" id="email" maxlength="30">
              &nbsp;(เพื่อใช้ในการติดต่อ และลืมรหัสผ่าน)</td>
          </tr>
          <tr> 
            <td bgcolor="#FFCC99" class="headfont"><p>&nbsp;UserID *</p>
              </td>
            <td colspan="3" bgcolor="#FFEECC" class="defaultfont"><input name="user" type="text" id="user" maxlength="20"></td>
          </tr>
          <tr> 
          ...
          <tr> 
            ...
            <td colspan="3" bgcolor="#FFEECC" class="defaultfont"><input name="pass2" type="password" id="pass2" maxlength="40">
              &nbsp;(กรุณาใส่อีกครั้งเพื่อยืนยัน)</td>
          </tr>
          <tr> 
