		...
		if(login!=null)
		{
			...
			if(rs!=null)
			{
				while(rs.next())
				{
					...
					{
						out.println("<strong><center>ดูรายละเอียดของการลงทะเบียน</center></strong><hr>");
						...
						out.println("<tr  align='right' ><td height='30' background='images/greenbg.gif'>|<a href='removemember.jsp'>ลบสมาชิก</a>");
						out.println("|<a href='createroom.jsp'>สร้างห้องเรียนออนไลน์</a>");
						out.println("|<a href='addsubject.jsp'>เพิ่มรายวิชา</a>");
						out.println("|<a href='removesubject.jsp'>ลบรายวิชา</a>");
						out.println("|<a href='addteacher.jsp'>เพิ่มรายชื่ออาจารย์</a>");
						out.println("|<a href='removeteacher.jsp'>ลบรายชื่ออาจารย์</a>");
						out.println("|<a href='addtutorial.jsp'>เพิ่มบทเรียน</a>|<a href='removetutorial.jsp'>ลบบทเรียน</a>");
						out.println("|<a href='upload.jsp'>อัปโหลดไฟล์</a>");
						out.println("|<a href='/jchatbox/admin/index.jsp'>สร้างห้องแชท</a>");
						...
						{	
							out.println("<table width=100% cellSpacing=0 cellPadding=0 align=center border=0  >");
						    String teach = new String(rs3.getString("teacher").getBytes("ISO8859_1"),"MS874");
						    String coteach = new String(rs3.getString("co_teacher").getBytes("ISO8859_1"),"MS874");
							out.println("<tr align=left><td width='13%' ><font size=2 color='blue'>"+rs3.getString("original_id")+"&nbsp;</font></td><td width='40%'><font size=2 color='blue'>"+rs3.getString("subject")+"</font></td><td width='30%' ><font size=2 color='blue'>"+teach+"</font></td><td width='25%' ><font size=2 color='blue'>"+coteach+"</font></td></tr>");
						}
						out.println("</table><br><br>");	
						}
						rs3.close();
						...
						String sql4 = "SELECT * FROM subject_detail ";
						ResultSet rs4=stmt4.executeQuery(sql4);
						if (rs4!=null)
						{
							out.println("<strong><center>รายชื่อวิชาที่เปิดสอน</center></strong><hr>");
							while(rs4.next())
							{	
								out.println("<table width=100% cellSpacing=0 cellPadding=0 align=center border=0  >");
							   String time = new String(rs4.getString("time").getBytes("ISO8859_1"),"MS874");
								...
								out.println("<tr align=left><td width='30%' ><font size=2 color='blue'>"+rs4.getString("subjectid")+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+rs4.getString("subjectname")+"</font></td><td width='11%' ><font size=2 color='blue'>"+time+"</font></td><td width='10%' ><font size=2 color='blue' width='20%'>"+teach+"</font></td><td width='10%' ><font size=2 color='blue' align='right'>"+coteach+"</font></td></tr>");
							}
							out.println("</table>");	
						}
						rs4.close();
...
<form name="login" method="post" action="adminlogin.jsp">
       <td width="28%" rowspan="2" align="center" valign="top"  bgcolor="#00CC00"> <font color="#066618"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Administrator Login</font> <br> 
