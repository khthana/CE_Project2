...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  border="0">
	...
	<%
	String sid=request.getParameter("original_id");
	...
	while(rs.next())
	{
     	out.println(" <table width='100%' border='0' cellspacing='0' cellpadding='5' bordercolor='#CCCCCC' align = 'center'>");
       	out.println(" <tr> ");
        out.println("<td colspan='2' height='30' width='600' bgcolor='#336699'> ");
        ...
        out.println(" </td>");
         ...
         out.println("<div align='center'><font face='Tahoma' size='2' color='#FFFFFF'>รหัสรายวิชา</font></div>");
       	out.println("</td>");
      	out.println("<td width='75%' height='25' bgcolor='#F4F4F4'><font face='Tahoma' size='2'>"+rs.getString("subjectid")+"&nbsp;</font> ");
        out.println("</td>");
  	    out.println("</tr>");
        out.println("<tr>");
        out.println("<td width='23%' height='25' bgcolor='#336699'> ");
        ...
        out.println("</td>");
        out.println(" <td width='75%' height='25' bgcolor='#F4F4F4'><font face='Tahoma' size='2'>"+rs.getString("subjectname")+"&nbsp;</font> ");
        out.println("</td>");
        out.println("</tr>");
        out.println(" <tr>"); 
         out.println(" <td width='23%' height='25' bgcolor='#336699'> ");
		 ...
		 out.println("<td width='75%' height='25' bgcolor='#F4F4F4'><font face='Tahoma' size='2'>"+teach+"&nbsp;</font></td>");
         out.println("</tr>");
         out.println("<tr> ");
         out.println("<td width='23%' height='25' bgcolor='#336699'>"); 
		 ...
		 out.println("<td width='75%' height='25' bgcolor='#F4F4F4'><font face='Tahoma' size='2'>"+coteach+"&nbsp;</font>");
         out.println("</td>");
         out.println("</tr>");
         out.println("<tr > ");
		 ...
		 out.println("<td bgcolor='#F4F4F4' height='25' width='75%'><font face='Tahoma' size='2'>-"+detail+detail2+detail3+detail4+"&nbsp;</font></td>");
         out.println("</tr>");
         out.println("<tr> ");
         out.println("  <td bgcolor='#336699' height='25'>"); 
		 ...
		 out.println("<td bgcolor='#F4F4F4' height='25' width='75%'><font face='Tahoma' size='2'>"+time+"&nbsp;</font></td>");
        out.println(" </tr>");
        out.println("</table>");
	}	
