...
<body background="images/bg.gif">
    ...
    <tr> 
      <td height="13" background="images/coner.gif" colspan="1"><b>
...
<%
	...
	out.println("<tr><td height='30' background='images/greenbg.gif'><center>ยินดีต้อนรับท่านอาจารย์ "+session.getAttribute("teacher")+"&nbsp;แก้ไข้ข้อมูลสมาชิกได้ที่นี่</center></td></tr></table>");
	...
	String sql2 = "SELECT * FROM infoteach WHERE username='"+session.getAttribute("teacher")+"'";
	ResultSet rs = stmt.executeQuery(sql2);
	while(rs.next())
	{
		out.println("<form action='updateinfoteach.jsp' method='post'>");
		out.println("<table cellpadding=2 cellspacing=1 width='800' border='0' align=left>");
		
	%>
	<tr> 
                  <td width="100"  bgcolor="#00CC00"><font color="#FFFFFF" size="2" face="MS Sans Serif, Tahoma, sans-serif"><strong>แก้ไขข้อมูลของอาจารย์</strong></font></td>
                </tr>
	<%
