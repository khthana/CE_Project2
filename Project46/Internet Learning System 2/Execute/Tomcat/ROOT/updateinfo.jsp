	...
	if (error==0)
	{
		...
		{	
			...
			{*/
				...
				String sql2 = "UPDATE login SET username='"+username+"',password='"+password+"' WHERE username='"+session.getAttribute("auth")+"'";

				int myresult2 = stmt2.executeUpdate(sql2);
				if (myresult2!=0)
				{  out.println("<center><b>เปลี่ยนแปลงข้อมูลเรียบร้อยแล้ว<br><br>");
					out.println("<a href = 'membersection.jsp'>คลิ้กที่นี่เพื่อกลับไปยังหน้าแรก</a></b></center>");
				}
			//} 
