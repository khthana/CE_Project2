...
On Error GoTo s_er:
    ...
    For c = 0 To (f_l_data.list_l.ListCount - 1)
        f_l_data.list_l.ListIndex = c
        Print #1, f_l_data.list_l.Text
    Next
    Close #1
    f_l_data.list_l.ListIndex = -1
    Unload Me
Exit Sub
s_er:
