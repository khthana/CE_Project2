...
Begin VB.Form f_e_data 
   ...
   Begin VB.ComboBox c_type 
      ...
      EndProperty
      Height          =   420
      ItemData        =   "Form3.frx":1332DA
      Left            =   6480
      List            =   "Form3.frx":1332EA
   ...
   Begin VB.ComboBox c_status_b 
      ...
      EndProperty
      Height          =   420
      ItemData        =   "Form3.frx":13330F
      Left            =   6480
      List            =   "Form3.frx":133322
      Style           =   2  'Dropdown List
      TabIndex        =   8
      Top             =   3480
      Width           =   2535
   ...
   Begin VB.ComboBox type_s 
      ...
      EndProperty
      Height          =   420
      ItemData        =   "Form3.frx":133344
      Left            =   480
      List            =   "Form3.frx":133351
      Style           =   2  'Dropdown List
      TabIndex        =   14
      Top             =   7200
      Width           =   2415
...
Private Sub edit_cancel_Click()
    ...
    Author.Text = Empty
    Location.Text = Empty
    Location2.Text = Empty
    Detail.Text = Empty
    c_type.ListIndex = -1
    c_status_b.ListIndex = -1
    edit_ok.Enabled = False
    edit_cancel.Enabled = False
End Sub

Private Sub edit_ok_Click()
If MsgBox("ต้องการแก้ไขข้อมูลกด OK" + vbCrLf + "     ยกเลิกกด Cancel", vbOKCancel + vbExclamation, "ยืนยันการแก้ไขข้อมูล") = vbOK Then
    If I_D.Text <> Empty And ISBN.Text <> Empty And N_ame.Text <> Empty And Author.Text <> Empty And Detail.Text <> Empty Then
        ...
        db_rs!Location_Book = Location2.Text
...
Private Sub display()
    ...
    c_type.ListIndex = (db_rs!Type_Book) - 1
    c_status_b.ListIndex = (db_rs!Status_Book) - 1
    ...
    End If
    Location2.Text = db_rs!Location_Book
