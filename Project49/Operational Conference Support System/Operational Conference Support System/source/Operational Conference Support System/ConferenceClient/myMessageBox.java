...
public class myMessageBox extends JFrame {
	...
	private void Init() throws Exception {
		...
		icob1 = new ImageIcon(myMessageBox.class.getResource("ok.png"));
		ico = new ImageIcon(myMessageBox.class.getResource("mhead.png"));
		icox = new ImageIcon(myMessageBox.class.getResource("mbot.png"));
		b1 = new JLabel(icob1);
