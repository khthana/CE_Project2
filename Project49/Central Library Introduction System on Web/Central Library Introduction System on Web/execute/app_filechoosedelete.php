...
function startElement($parser, $name, $attrs) 
{
   ...
   if ($name == "SUBJECT")
   {
   		echo "<tr><td align='center'><form action='app_deletenode.php' method='post' target='_self' >";
   }
   if ($name == "NAME")
   {
...
echo "<table width='580' border='0' cellspacing='10' cellpadding='0'>
	<tr><td align='center'>
		<p>&nbsp;</p>
		<strong>โปรดเลือกหัวข้อเอกสารที่ต้องการ <font color='#DE4B11'>ลบ</font></strong>
		<p>&nbsp;</p>
	</td></tr>";
