...
<table width="580" border="0" cellspacing="20" cellpadding="0">
  <tr>
	...
	โปรดเลือกหมวด ที่ต้องการ <font color="#DE4B11">เพิ่มข้อมูลใหม่</font> </td>
  </tr>
  <tr>
    <td align="center"  valign="middle" height="250" >
	<table width="100%" border="0" cellspacing="20" cellpadding="0">
    <tr><td align="center">
	        <form id="form1" name="form1" method="post" action="app_addnewdata.php" target="_self" >
	...
	<tr><td align="center">
		<form id="form2" name="form2" method="post" action="app_addnewdata.php" target="_self" >
	...
	<tr><td align="center">
		<form id="form3" name="form3" method="post" action="app_addnewdata.php" target="_self" >
	...
	<tr><td align="center">
		<form id="form4" name="form4" method="post" action="app_addnewdata.php" target="_self" >
	...
	<tr><td align="center">
		<form id="form5" name="form5" method="post" action="app_addnewdata.php" target="_self" >
