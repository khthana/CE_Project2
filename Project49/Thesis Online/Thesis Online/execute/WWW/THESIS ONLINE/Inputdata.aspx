...
<head runat="server">
    ...
    <title>KMITL Library Public Access Catalog CENTRAL LIBRARY, King Mongkut's Institute of Technology Ladkrabang 
</title>
        ...
        <form id="form1" runat="server">
            <div style="text-align: center">
                <table align=center style="table-layout: fixed; font-size: 16pt; width: 730px; color: #6666cc;
                    font-family: 'Angsana New', Sans-Serif; text-align: left" bgcolor="#ffffff">
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" style="height: 103px; text-align: center">
                            <img border="0" height="101" src="./Picture_Files/Head.jpg" style="width: 801px" /></td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#ff3300" style="width: 164px; height: 21px">
                                        ...
                                        <asp:HyperLink ID="HyperLink2" runat="server" Font-Bold="True" Font-Size="Smaller"
                                            Font-Strikeout="False" ForeColor="Black" NavigateUrl="~/MainManu.aspx" Width="140px">[ Data Option ]</asp:HyperLink></td>
                    ...
                    <tr style="font-size: 16pt; color: #6666cc;">
                        ...
                        <td height="15" style="width: 133px">
                            <span>Title</span></td>
                        <td height="15" style="width: 241px; color: #6666cc;">
                        </td>
                    ...
                    <tr style="font-size: 16pt; color: #6666cc">
                        ...
                        <td style="width: 133px">
                            Thai Creator<strong><span style="font-size: 15pt; color: #ff0000"> </span></strong>
                        ...
                        <td style="width: 241px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Thai_Creator"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="AddCreator" Width="1px"></asp:RequiredFieldValidator>
                        </td>
                        <td style="width: 134px; font-size: 16pt; color: #6666cc;">
                            English Creator :</td>
                        <td style="width: 261px; font-size: 16pt;">
                            <asp:TextBox ID="English_Creator" runat="server" Columns="35" ToolTip="ชื่อผู้ทำวิทยานิพนธ์ภาษา English"
                                Width="170px"></asp:TextBox>&nbsp;<strong><span style="font-size: 15pt; color: #ff0000">
                                </span></strong>
                        </td>
                    </tr>
                    <tr style="font-size: 16pt; color: #6666cc">
                        ...
                        <td style="width: 134px; height: 31px; font-size: 16pt; color: #6666cc;">
                            E-Mail :</td>
                        <td style="width: 261px; height: 31px; font-size: 16pt;">
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td colspan="2" style="height: 50px">
                            <asp:Button ID="AddCreator" runat="server" Text="Add" ToolTip="บันทึก" Width="40px" />
                            &nbsp;&nbsp;
                            <asp:Button ID="ClearCreator" runat="server" Text="Clear" ToolTip="ลบทั้งหมด" Width="40px" />&nbsp;
                            &nbsp;<asp:Button ID="EditCreator" runat="server" Text="Edit" ToolTip="แก้ไข" Width="40px" />
                            &nbsp;&nbsp;
                            <asp:Button ID="BackCreator" runat="server" Text="Back" ToolTip="ย้อนหลัง" Width="40px" />&nbsp;
                            &nbsp;<asp:Button ID="NextCreator" runat="server" Text="Next" ToolTip="ไปข้างหน้า"
                                Width="40px" /></td>
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 241px; height: 11px; color: #6666cc;">
                        </td>
                        <td style="width: 134px; height: 11px; color: #6666cc;">
                        </td>
                        <td style="width: 261px; height: 11px; color: #6666cc;">
                        </td>
                    </tr>
                    <tr style="font-size: 16pt; color: #6666cc">
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 133px; height: 31px">
                            Roles :</td>
                        <td style="width: 241px; height: 31px">
                            <asp:TextBox ID="Roles_Adviser" runat="server" Enabled="False" Width="174px"></asp:TextBox></td>
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 241px; font-size: 16pt; color: #6666cc;">
                        </td>
                        <td style="width: 134px; font-size: 16pt; color: #6666cc;">
                        </td>
                        <td style="width: 261px; font-size: 16pt; color: #6666cc;">
                        </td>
                    </tr>
                    <tr style="font-size: 16pt; color: #6666cc;">
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 261px; height: 19px;">
                            <asp:TextBox ID="FacultyEng" runat="server" Width="200px" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="font-size: 16pt">
                        <td style="width: 18px">
                        ...
                        <td style="width: 261px">
                            <asp:TextBox ID="DepartmentEnglish" runat="server" Width="200px" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="font-size: 16pt">
                        <td style="width: 18px">
                        ...
                        <td style="width: 261px">
                            <asp:TextBox ID="DesciptionEng" runat="server" Width="200px" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="font-size: 16pt">
                        ...
                        <td colspan="3" style="height: 26px; text-align: left;">
                            <asp:TextBox ID="DegreeGrantor" runat="server" Width="563px" ToolTip="ชื่อสถาบัน (สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง)">สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง</asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="DegreeGrantor"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="Savedata" Width="2px"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr style="font-size: 16pt">
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 241px">
                            <asp:TextBox ID="Publisher_Name" runat="server" Columns="30" ToolTip="ชื่อหน่วยงานที่จัดทำ(สำนักหอสมุดกลาง)"
                                Width="180px">สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง สำนักหอสมุดกลาง</asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Publisher_Name"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="Savedata" Width="2px"></asp:RequiredFieldValidator>
                        ...
                        <td style="width: 261px">
                            <asp:TextBox ID="URL" runat="server" Columns="30" ToolTip="เว็บ ของ สำนักหอสมุด"
                                Width="180px">http://lib.kmitl.ac.th</asp:TextBox>&nbsp;
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 133px">
                            Place :</td>
                        <td style="width: 241px">
                            <asp:TextBox ID="Place" runat="server" Columns="30" ToolTip="ชื่อจังหวัด" Width="160px">กรุงเทพมหานคร (Bangkok)</asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="Place"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="Savedata" Width="2px"></asp:RequiredFieldValidator>
                        ...
                        <td style="width: 134px">
                            E-Mail :</td>
                        <td style="width: 261px">
                            <asp:TextBox ID="E_mail_Publisher" runat="server" Columns="30" Width="204px" ToolTip="e-mail ของหน่วยงานที่ทำ">kswipara@kmitl.ac.th</asp:TextBox>&nbsp;
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 241px">
                            <asp:TextBox ID="Created" runat="server" Columns="30" ToolTip="ปี พ.ศ. ของวิทยานิพนธ์"
                                Width="100px" MaxLength="4" AutoPostBack="True"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="Created"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="Savedata" Width="1px"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="Created"
                                ...
                                ValidationGroup="Savedata" Width="86px"></asp:RegularExpressionValidator></td>
                        <td style="width: 134px">
                        ...
                        <td style="width: 261px">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="CreatedYEnglish"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="Savedata" Width="1px"></asp:RequiredFieldValidator>
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 241px; height: 35px;">
                            <asp:TextBox ID="Date_Issued" runat="server" Columns="11" ToolTip="บันทึกเมื่อ วัน / เดือน / ปี"
                                Width="116px" MaxLength="10" Enabled="False"></asp:TextBox>&nbsp;
                        </td>
                        ...
                        <td style="width: 261px; height: 35px;">
                            <asp:TextBox ID="Date_Modified" runat="server" Columns="11" ToolTip="แก้ไขเมื่อ วัน / เดือน / ปี"
                                Width="118px" MaxLength="10" ValidationGroup="Savedata" Enabled="False"></asp:TextBox>&nbsp;
                        </td>
                    </tr>
                    <tr style="font-size: 16pt">
                        <td style="width: 18px">
                        ...
                        <td style="width: 133px">
                            ISSN :</td>
                        <td style="width: 241px">
                            <asp:TextBox ID="ISSN" runat="server" Columns="30" ToolTip="เลข ISSN" Width="120px"
                        ...
                        <td style="width: 261px">
                            <asp:TextBox ID="ISBN" runat="server" Columns="30" ToolTip="เลข ISBN" Width="120px"
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 133px">
                            Rights :</td>
                        <td colspan="3">
                            <asp:TextBox ID="Rights" runat="server" Columns="70" Width="580px" ToolTip="ชื่อสถาบัน">สถาบันเทคโนโลยีพระจอมเกล้าเจ้าคุณทหารลาดกระบัง</asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="Rights"
                                ErrorMessage="*" Font-Bold="False" Font-Overline="False" SetFocusOnError="True"
                                ValidationExpression="\d{2}/\d{2}/\d{4}" ValidationGroup="Savedata" Width="2px"></asp:RequiredFieldValidator></td>
                    </tr>
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 133px">
                            Rights &nbsp;Access :</td>
                        <td colspan="3">
                            <asp:TextBox ID="Access" runat="server" Columns="40" Width="228px" ToolTip="สามารถเข้าใช้ได้เฉพาะสมาชิกในกลุ่ม">สามารถเข้าใช้ได้เฉพาะสมาชิก KMITL</asp:TextBox></td>
                    </tr>
                    <tr style="font-size: 16pt">
                        <td height="15" style="width: 18px">
                        </td>
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 133px">
                            Thai Eng :</td>
                        <td style="width: 241px">
                            <asp:RadioButton ID="LanguageThai" runat="server" Checked="False" GroupName="Language"
                    ...
                    <tr style="font-size: 16pt">
                        <td style="width: 18px; height: 1px;">
                        </td>
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 134px; height: 23px">
                        </td>
                    ...
                    <tr style="font-size: 16pt">
                        ...
                        <td style="width: 241px; text-align: center; height: 29px;">
                            <asp:Button ID="Savea" runat="server" Text="Save" ValidationGroup="Savedata" Width="67px" /></td>
                        <td style="width: 134px; text-align: center; height: 29px;">
