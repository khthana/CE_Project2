...
###############################################
   ...
   def __init__( self, semaphore, weight1 = 200 , weight2 = 50):
      """Initialize thread"""
      ...
      self.weight2 = weight2  #SemaphoreThread.maxImg 
   ...
   def running(self, puller, ids):
	...
	# out of 3 level
		...
		# limit number of link to maxwideSe
		...
		# limit number of image to maxImg
		if len(puller.getImageList()) > self.weight1:
