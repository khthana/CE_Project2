...
class Cthread(threading.Thread):
	...
	def run(self):
		...
		##############################################
				...
				DBobj.inserti("""INSERT INTO PORN_WEB(URL,IP_ADDRESS,DATE_TIME,TOTAL_WEIGHT,ISP_ID,CHILD) VALUES ('%s','%s',now(),%s,%d,%s) """ %(scheme+'://'+self.URL,ipad,str(cmd),int(ISP_ID),str(child)))
			...
			DBobj.inserti("""UPDATE PORN_WEB SET TOTAL_WEIGHT = %s , DATE_TIME =now(),CHILD = %s WHERE ID = %s"""%(str(cmd),str(child),str(oldURL)))
