<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TeacherViewNews.aspx.vb" Inherits="Teacher_TeacherViewNews" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Teacher View News</title>
    <style>
                    ...
                    <asp:DataList ID="DataList1" runat="server" DataKeyField="new_id" DataSourceID="NewsDTS" BackColor="PaleGoldenrod" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black">
                        <ItemTemplate>
                            <table width="750">
                                ...
                                <tr height="30">
                                    <td align="right" bgcolor="lightgoldenrodyellow">
                                ...
                                <tr height="30">
                                    <td align="right" bgcolor="lightgoldenrodyellow">ผู้ประกาศ : <asp:Label ID="new_writerLabel" runat="server" Text='<%# Eval("new_writer") %>'></asp:Label></td>
                                </tr>
                            </table>
                        </ItemTemplate>
