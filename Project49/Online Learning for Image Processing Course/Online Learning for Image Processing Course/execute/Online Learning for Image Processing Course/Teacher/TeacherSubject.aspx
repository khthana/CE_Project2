<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TeacherSubject.aspx.vb" Inherits="Teacher_TeacherSubject" %>
                    ...
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr>
                            <td colspan="2" style="font-weight:bold">
                                แบบฟอร์มสำหรับการเปลี่ยนแปลงรายละเอียดวิชาและหนังสืออ้างอิง</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr>
                            <td style="width: 180px">วิชา</td>
                            <td width="400"><asp:DropDownList ID="subjectDDL" runat="server" AutoPostBack="True" Width="355px"></asp:DropDownList></td>
                        </tr>
                        <tr height="100" align="center">
                            <td valign="top" style="width: 180px">รายละเอียด</td>
                            <td><asp:TextBox ID="description" runat="server" Text='<%# Eval("sub_description") %>' TextMode="MultiLine" height="100" Width="350" MaxLength="990"></asp:TextBox>
                            <asp:RequiredFieldValidator
                                    ID="descriptionRFV" runat="server" ControlToValidate="description" Display="Dynamic"
                                    ErrorMessage="กรุณาใส่รายละเอียด" ValidationGroup="subjectsystem"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator
                                ID="descriptionREV" runat="server" ControlToValidate="description" Display="Dynamic"
                                ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+" ValidationGroup="subjectsystem"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr align="center">
                            <td style="width: 180px">หนังสืออ้างอิง</td>
                            <td><asp:TextBox ID="reference" runat="server" Text='<%# Eval("sub_book") %>' Width="350" MaxLength="490"></asp:TextBox>
                            <asp:RequiredFieldValidator
                                    ID="referenceRFV" runat="server" ControlToValidate="reference" Display="Dynamic"
                                    ErrorMessage="กรุณาใส่หนังสืออ้างอิง" ValidationGroup="subjectsystem"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator
                                ID="referenceREV" runat="server" ControlToValidate="reference"
                                Display="Dynamic" ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+"
                                ValidationGroup="subjectsystem"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="update" runat="server" Text="อัพเดทข้อมูล" ValidationGroup="subjectsystem" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="90px" />
