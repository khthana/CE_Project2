<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentLearningLivePage.aspx.vb" Inherits="Student_StudentLearningLivePage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Student Learning Live Page</title>
<style>
    ...
    <div>
        <table width="800" align="center" bgcolor="white" border="0" cellpadding="0" cellspacing="0" style="border:0px;text-align:center;">
            ...
            <tr height="30" style="font-weight:bold">
                <td colspan="2">การเรียนแบบถ่ายทอดสดและการสนทนา</td>
            </tr>
                            ...
                            <table width="750" align="center">
                                <tr height="450" align="center">
                                    ...
                                    <td width="280" align="center">
                                        <%#"<iframe src=StudentChatRoom.aspx?sub_id=" & Container.DataItem("sub_id") & " width=280 height=450 />"%>
                                    </td>
                                </tr>
                            </table>
                        </ItemTemplate>
