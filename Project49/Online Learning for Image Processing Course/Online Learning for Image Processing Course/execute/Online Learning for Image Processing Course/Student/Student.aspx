<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Student.aspx.vb" Inherits="Student_Student" %>
            ...
            <tr height="580">
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Register</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการลงทะเบียน ซึ่งรวมถึงการเพิ่ม เปลี่ยน ถอนรายวิชา</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Schedule</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของตารางเรียนตารางสอบของวิชาที่ลงทะเบียน</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Lesson</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของรายละเอียดเกี่ยวกับบทเรียน</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Testing</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการทดสอบ ซึ่งแบ่งเป็นการทดสอบท้ายบทเรียน การมอบหมายงาน 
                                <br />
                                &nbsp;และการทดสอบวัดผล</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">PowerPoint On web</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการเรียนโดยใช้ Microsoft Power Point เป็นสื่อการเรียนรู้</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">VDO On web</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการเรียนโดยใช้ Clip VDO เป็นสื่อการเรียนรู้</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Simulation On Web</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของตัวอย่างการทดลองในแต่ละวิชา</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Learning Live</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการเรียนการสอนแบบถ่ายทอดสดกับอาจารย์ผู้สอนแต่ละวิชา</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Document Download</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของเอกสารสำหรับการดาวน์โหลด</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Learning Tracking</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการติดตามการเรียนของผู้เรียนแต่ละคน</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">Message Board</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของกระดานสนทนาสำหรับแต่ละวิชา</td>
                        </tr>
                    </table>
                </td>
            </tr>
