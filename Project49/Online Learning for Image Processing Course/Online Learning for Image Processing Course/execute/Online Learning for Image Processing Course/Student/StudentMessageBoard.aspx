<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentMessageBoard.aspx.vb" Inherits="Student_StudentMessageBoard" %>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold">
                            <td colspan="2">กระดานสนทนาตามรายวิชา</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr height="30" style="font-weight:bold">
                        ...
                        <tr>
                            <td>
                                <table visible="false" id="newtopictable" runat="server" align="center" width="550">
                                    ...
                                    <tr>
                                        <td colspan="2"><asp:Button ID="send" runat="server" Text="ส่งข้อความ" ValidationGroup="postsystem" Width="120" BackColor="#FF8000" Font-Names="Microsoft Sans Serif" ForeColor="White" Font-Bold="True" />
                                            <asp:Button ID="clear" runat="server" Text="เคลียร์" Width="120" BackColor="#FF8000" Font-Names="Microsoft Sans Serif" ForeColor="White" Font-Bold="True" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="warningmain" runat="server" ForeColor="Red"></asp:Label>
                                <asp:GridView Width="550px" ID="GridView1" runat="server" AllowPaging="True" PageSize="15" AutoGenerateColumns="False" CellPadding="4"
                                    DataKeyNames="top_id" DataSourceID="MBDTS" ForeColor="#333333" GridLines="None">
                                    <FooterStyle BackColor="GrayText" Font-Bold="True" ForeColor="White" />
                                    <Columns>
                                        <asp:ImageField HeaderImageUrl="~/Image/lamp3.jpg" DataImageUrlField="top_id" DataImageUrlFormatString="~/Image/lamp1.jpg">
                                            <ItemStyle Height="30px" />
                                        </asp:ImageField>
                                        <asp:HyperLinkField DataNavigateUrlFields="top_id,sub_id" DataNavigateUrlFormatString="StudentMessageBoardDetail.aspx?top_id={0}&sub_id={1}"
                                            DataTextField="top_name" HeaderText="หัวข้อ" SortExpression="top_name" Target="_blank" >
                                            <ItemStyle Width="250px" />
                                        </asp:HyperLinkField>
                                        <asp:BoundField DataField="top_writer" HeaderText="ผู้ประกาศ" SortExpression="top_writer" />
                                        <asp:BoundField DataField="top_nreplier" HeaderText="จำนวนผู้ตอบ" SortExpression="top_nreplier" />
                                        <asp:BoundField DataField="top_nreader" HeaderText="จำนวนผู้อ่าน" SortExpression="top_nreader" />
                                        <asp:BoundField DataField="top_name" HeaderText="top_name" SortExpression="top_name"
                                            Visible="False" />
                                        <asp:BoundField DataField="top_id" HeaderText="top_id" InsertVisible="False" ReadOnly="True"
                                            SortExpression="top_id" Visible="False" />
                                        <asp:BoundField DataField="sub_id" HeaderText="sub_id" SortExpression="sub_id" Visible="False" />
                                    </Columns>
                                    <SelectedRowStyle BackColor="#E2DED6" ForeColor="#333333" Font-Bold="True" />
                                    <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                    <HeaderStyle BackColor="GrayText" Font-Size="Small" ForeColor="White" Height="45px" Font-Bold="True" />
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                    <EditRowStyle BackColor="#999999" />
                                </asp:GridView>
                                <asp:SqlDataSource ID="MBDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>" 
                                    SelectCommand="SELECT [top_id], [sub_id], [top_name],[top_writer], [top_nreplier], [top_nreader], [top_date] FROM [TopicMB] WHERE ([sub_id] = @sub_id) ORDER BY [top_id] DESC">
                                    <SelectParameters>
