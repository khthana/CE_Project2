<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentDownload.aspx.vb" Inherits="Student_StudentDownload" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Student Document Download</title>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold">
                            <td colspan="2">เอกสารสำหรับการดาวน์โหลด</td>
                        </tr>
                        <tr height="30" style="font-weight:bold">
                            <td colspan="2">
                                เลือกวิชา
                        ...
                        <tr>
                            <td>
                                <asp:SqlDataSource ID="downloadDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>" 
                                    SelectCommand="select lrnc_id,sub_id,lrnc_topic,lrnc_dateshow from learningcontent where ([sub_id] = @sub_id) and lrnc_year = (select max(lrnc_year) from learningcontent) 
                                ...
                                <asp:DataList ID="DataList2" runat="server" DataKeyField="lrnc_id" DataSourceID="downloadDTS" CellPadding="4" ForeColor="#333333">
                                    <ItemTemplate>
                                        <table width="550">
                                            <tr>
                                                <td width="50" align="center"><img src="../Image/viewicon.gif" align="middle" /></td>
                                                <td width="500" align="left">
                                                    <%#"<a href=StudentDownloadDetail.aspx?lrnc_id=" & _
                                                    Container.DataItem("lrnc_id") & "&date=" & _
                                                    Container.DataItem("lrnc_dateshow") & "&sub_id=" & _
                                                    Container.DataItem("sub_id") & " target=_blank>" & _
                                                    Container.DataItem("lrnc_topic") & "</a>"%>
                                                </td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
