<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LogContrast.aspx.vb" Inherits="LogContrast" %>
...
<head runat="server">
    <title>Logarithm Contrast</title>
<style>
    ...
    <div>
        <table align="center" width="600" bgcolor="white" border="0">
            <tr align="center" height="50">
                ...
                <font style="font-family:Arial;font-weight:bolder;font-size:medium">Logarithm Contrast</font>
                <br />Y = ALog(1 + X) + B : B = 0</td>
            </tr>
            ...
            <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double">
                    ...
                    <cc1:SliderProperties TargetControlID="txtValue" EnableHandleAnimation="true" BoundControlID="lblValue" Minimum="30" Maximum="130" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue" runat="server" />
                </td>
           </tr>
           <tr align="center" height="30">
                <td colspan="3"><asp:Button ID="Log_Contrast" runat="server" Text="ประมวลผล" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="90px" /></td>
           </tr>
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="LogContrastChart" Visible="false" runat="server" BorderStyle="Outset" 
