<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ColorBalance.aspx.vb" Inherits="ColorBalance" %>
    ...
    <div>
        <table align="center" width="600" bgcolor="white" border="0">
            <tr align="center" height="50">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><font style="font-family:Arial;font-weight:bolder;font-size:medium">Color Balance</font></td>
            </tr>
            ...
            <tr align="center">
                <td  style="border-color:#ff9933;border-width:thin;border-style:double" colspan="3">
                    Value R (x0.1)<atlas:ScriptManager ID="sm1" runat="server" />
                    <asp:TextBox ID="txtValue1" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender1" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue1" EnableHandleAnimation="true" BoundControlID="lblValue1" Minimum="0" Maximum="20" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue1" runat="server" /><br />
                    Value G (x0.1)<asp:TextBox ID="txtValue2" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender2" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue2" EnableHandleAnimation="true" BoundControlID="lblValue2" Minimum="0" Maximum="20" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue2" runat="server" /><br />
                    Value B (x0.1)<asp:TextBox ID="txtValue3" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender3" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue3" EnableHandleAnimation="true" BoundControlID="lblValue3" Minimum="0" Maximum="20" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue3" runat="server" />
                </td>
           </tr>
           <tr align="center" height="30">
                <td colspan="3"><asp:Button ID="Linear_ContrastBrightness" runat="server" Text="ประมวลผล" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="90px" /></td>
           </tr>
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="RedColorBalanceChart" Visible="false" runat="server" BorderStyle="Outset" 
           ...
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="GreenColorBalanceChart" Visible="false" runat="server" BorderStyle="Outset" 
                            BorderWidth="5px" ChartFormat="Jpg" Height="250px" ShowXValues="False" 
                            ShowYValues="False" Width="550px" XTicksInterval="200" ChartPadding="10" 
                            LeftChartPadding="0" Padding="20" GridLines="None">
                        <YAxisFont StringFormat="Far,Near,Character,LineLimit" />
           ...
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="BlueColorBalanceChart" Visible="false" runat="server" BorderStyle="Outset" 
                            BorderWidth="5px" ChartFormat="Jpg" Height="250px" ShowXValues="False" 
                            ShowYValues="False" Width="550px" XTicksInterval="200" ChartPadding="10" 
                            LeftChartPadding="0" Padding="20" GridLines="None">
                        <YAxisFont StringFormat="Far,Near,Character,LineLimit" />
