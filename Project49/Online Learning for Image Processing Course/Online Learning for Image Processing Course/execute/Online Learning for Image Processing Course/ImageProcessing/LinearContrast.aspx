<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LinearContrast.aspx.vb" Inherits="_Default" %>
    ...
    <div>
        <table align="center" width="600" bgcolor="white" border="0">
            <tr align="center" height="50">
                ...
                <font style="font-family:Arial;font-weight:bolder;font-size:medium">Linear Contrast</font><br />Y = AX + B : B = 0</td>
            </tr>
            ...
            <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double">
                    ...
                    <cc1:SliderProperties TargetControlID="txtValue" EnableHandleAnimation="true" BoundControlID="lblValue" Minimum="-25" Maximum="25" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue" runat="server" />
                </td>
           </tr>
           <tr align="center" height="30">
                <td colspan="3"><asp:Button ID="LinearContrast" runat="server" Text="ประมวลผล" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="90px" /></td>
           </tr>
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="LinearContrastChart" Visible="false" runat="server" BorderStyle="Outset" 
