<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LinearContrastBrightness.aspx.vb" Inherits="LinearContrastBrightness" %>
...
<head runat="server">
    <title>Linear Contrast/Brightness</title>
<style>
    ...
    <div>
        <table align="center" width="600" bgcolor="white" border="0">
            <tr align="center" height="50">
                ...
                <font style="font-family:Arial;font-weight:bolder;font-size:medium">Linear Contrast / Brightness</font>
                <br />Y = AX + B</td>
            </tr>
            ...
            <tr align="center">
                <td style="border-color:#ff9933;border-width:thin;border-style:double">
                    Value A (x0.1)<atlas:ScriptManager ID="sm1" runat="server" />
                    <asp:TextBox ID="txtValue1" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender1" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue1" EnableHandleAnimation="true" BoundControlID="lblValue1" Length="200" Minimum="-50" Maximum="50" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue1" runat="server" />
                </td>
                <td></td>
                <td style="border-color:#ff9933;border-width:thin;border-style:double">
                    Value B<asp:TextBox ID="txtValue2" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender2" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue2" EnableHandleAnimation="true" BoundControlID="lblValue2" Length="200" Minimum="-100" Maximum="100" />
                    </cc1:SliderExtender>
           ...
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="LinearContrastBrightnessChart" Visible="false" runat="server" BorderStyle="Outset" 
