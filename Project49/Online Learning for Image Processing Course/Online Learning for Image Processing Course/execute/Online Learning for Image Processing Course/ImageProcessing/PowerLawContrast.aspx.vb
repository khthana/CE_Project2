...
Partial Class PowerLawContrast
    ...
    Protected Sub OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            Warning.Text = ""
            PowerLawContrastChart.Visible = False
    ...
    Protected Sub PowerLaw_Contrast_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles PowerLaw_Contrast.Click
        Try
            Warning.Text = ""
            ...
            Dim AValue As Integer = Val(txtValue1.Text)
            Dim YValue As Double = Val(txtValue2.Text)
            YValue = YValue * 0.1
            ...
            For i = 0 To 255
                If AValue > 0 Then
                    PixelTemp = AValue * (i ^ YValue)
                Else
                    PixelTemp = (AValue * (i ^ YValue)) + 255
                End If
            ...
            PowerLawContrastChart.Visible = True
            ...
            Else
                Warning.Text = "พบปัญหาที่ฟังก์ชัน PowerLaw_Contrast_Click"
                Exit Sub
            End If
    ...
    Private Sub CreateGraph(ByVal value() As Double)
        Try
            ...
            Else
                ...
                chart.DataBind()
                PowerLawContrastChart.Charts.Add(chart)
                ConfigureColors()
                PowerLawContrastChart.RedrawChart()
            End If
        Catch ex As Exception
            Warning.Text = ex.Message
            Exit Sub
    ...
    Private Sub ConfigureColors()
        Try
            PowerLawContrastChart.Background.Color = Color.GreenYellow
            PowerLawContrastChart.ChartTitle.Text = "Power Law Contrast Chart"
            PowerLawContrastChart.ChartTitle.ForeColor = Color.BlueViolet
            PowerLawContrastChart.Border.Color = Color.Brown
            PowerLawContrastChart.BorderStyle = BorderStyle.Solid
        Catch ex As Exception
            Warning.Text = ex.Message
            Exit Sub
        End Try
