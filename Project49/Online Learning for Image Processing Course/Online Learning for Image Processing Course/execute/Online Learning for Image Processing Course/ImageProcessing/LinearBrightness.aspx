<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LinearBrightness.aspx.vb" Inherits="LinearBrightness" %>
    ...
    <div>
        <table align="center" width="600" bgcolor="white" border="0">
            <tr align="center" height="50">
                ...
                <font style="font-family:Arial;font-weight:bolder;font-size:medium">Linear Brightness</font>
                <br />Y = AX + B : A = 1</td>
            </tr>
            <tr align="center">
                <td colspan="3" height="30"><asp:FileUpload ID="ImageFile" runat="server" EnableTheming="True" Width="450px" />
            ...
            <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double">
                    Value B<atlas:ScriptManager ID="sm1" runat="server" />
           ...
           <tr align="center" height="30">
                <td colspan="3"><asp:Button ID="Linear_Brightness" runat="server" Text="ประมวลผล" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="90px" /></td>
           </tr>
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="LinearBrightnessChart" Visible="false" runat="server" BorderStyle="Outset" 
