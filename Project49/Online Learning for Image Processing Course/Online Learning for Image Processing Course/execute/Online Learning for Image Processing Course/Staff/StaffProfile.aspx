<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StaffProfile.aspx.vb" Inherits="Staff_StaffProfile" %>
...
<head runat="server">
    ...
    <script src="../js/staffbtn.js" language="javascript" type="text/javascript"></script>
    <style type="text/css">
        ...
        <table width="800" align="center" bgcolor="white" border="0" cellpadding="0" cellspacing="0" style="border:0px;text-align:center;">
            ...
            <tr height="580">
                <td valign="top" width="200">
                    <table style="margin-top:10px;" cellpadding="0" cellspacing="0" border="0" bgcolor="#FF6300">
                        <tr>
                            <td>
                                <a href = "StaffProfile.aspx" onMouseOver="turnOn('profile');" onMouseOut="turnOff('profile');">
                                    <img name="profile" class="imgTrans" src="../Image/Button/staff/stfprofile1.jpg" border="0" align="middle" width="200" height="20">
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <a href = "../ImageProcessing/ImageProcessingPage.aspx" onMouseOver="turnOn('image');" onMouseOut="turnOff('image');">
                                    <img name="image" class="imgTrans" src="../Image/Button/staff/stfimage1.jpg" border="0" align="middle" width="200" height="20">
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <a href = "StaffSignOut.aspx" onMouseOver="turnOn('out');" onMouseOut="turnOff('out');">
                                    <img name="out" class="imgTrans" src="../Image/Button/staff/stfout1.jpg" border="0" align="middle" width="200" height="20">
                                </a>
                            </td>
                        </tr>
                        <tr bgcolor="white">
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        <tr height="30" bgcolor="#ff9933" style="font-weight:bold;color:White">
                            <td colspan="2">:: ระบบสมาชิกประเภทสมาชิกห้อง Image Processing ::</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr style="font-weight:bold">
                            <td colspan="2">
                                <asp:SqlDataSource ID="userDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>" SelectCommand="SELECT [stf_name] FROM [Staff] WHERE ([stf_id] = @stf_id)">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="stf_id" SessionField="user" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <asp:DataList ID="DataList1" runat="server" DataSourceID="userDTS">
                                    <ItemTemplate>
                                        คุณ 
                                        <asp:Label ID="stf_nameLabel" runat="server" Text='<%# Eval("stf_name") %>'></asp:Label><br />
                                        <br />
                                    </ItemTemplate>
                                </asp:DataList>
                            </td>
                        ...
                        <tr>
                            <td>เลือกรูปใหม่</td>
                            <td><asp:FileUpload ID="newpicture" runat="server" Width="350px" /></td>
                        </tr>
                        <tr>
                            <td>ชื่อ-นามสุกล</td>
                        ...
                        <tr>
                            ...
                            <asp:RegularExpressionValidator
                                ID="qualificationREV" runat="server" ControlToValidate="qualification" Display="Dynamic"
                                ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+" ValidationGroup="signupsystem"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            ...
                            <asp:RegularExpressionValidator
                                ID="performanceREV" runat="server" ControlToValidate="performance" Display="Dynamic"
                                ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+" ValidationGroup="signupsystem"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td>ความสนใจ</td>
                            ...
                            <asp:RegularExpressionValidator
                                ID="attentionREV" runat="server" ControlToValidate="attention" Display="Dynamic"
                                ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+" ValidationGroup="signupsystem"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
