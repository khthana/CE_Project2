<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TeacherDetail.aspx.vb" Inherits="TeacherDetail" %>
            ...
            <tr height="100">
                ...
                <td width="600" rowspan="2" valign="top">
                    <table style="margin-bottom:10px;margin-left:10px;margin-right:10px">
                        ...
                        <tr>
                            <td align="left">
                                <asp:SqlDataSource ID="TeacherDetailDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>"
                                    SelectCommand="SELECT * FROM [Teacher] WHERE ([tch_id] = @tch_id)">
                                    <SelectParameters>
                                        <asp:QueryStringParameter Name="tch_id" QueryStringField="tch_id" Type="Int64" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                                <asp:DataList Width="550" ID="DataList1" runat="server" DataKeyField="tch_id" DataSourceID="TeacherDetailDTS" CellPadding="4" ForeColor="#333333">
                                    <ItemTemplate>
                                        <table border="0px" width="550">
                                            <tr align="left">
                                                <td width="150">ชื่อ-นามสกุล</td>
                                                <td width="200"><asp:Label ID="tch_nameLabel" runat="server" Text='<%# Eval("tch_name") %>'></asp:Label></td>
                                                <td rowspan="4" align="right" width="150"><img src='<%# Eval("tch_picture") %>' align="middle" width="150" height="150" /></td>       
                                            </tr>
                                            <tr align="left">
                                                <td width="150">ที่อยู่</td>
                                                <td><asp:Label ID="tch_addressLabel" runat="server" Text='<%# Eval("tch_address") %>'></asp:Label></td>
                                            </tr>
                                            <tr align="left">
                                                <td width="150">หมายเลขโทรศัพท์</td>
                                                <td><asp:Label ID="tch_phoneLabel" runat="server" Text='<%# Eval("tch_phone") %>'></asp:Label></td>
                                            </tr>
                                            <tr align="left">
                                                <td width="150">E - Mail</td>
                                                <td><asp:Label ID="tch_emailLabel" runat="server" Text='<%# Eval("tch_email") %>'></asp:Label></td>
                                            </tr>
                                            <tr align="left">
                                                <td width="150">คุณวุฒิ</td>
                                                <td colspan="2"><asp:Label ID="tch_qualificationLabel" runat="server" Text='<%# Eval("tch_qualification") %>'></asp:Label></td>
                                            </tr>
                                            <tr align="left">
                                                <td width="150">ผลงานทางวิชาการ</td>
                                                <td colspan="2"><asp:Label ID="tch_performanceLabel" runat="server" Text='<%# Eval("tch_performance") %>'></asp:Label></td>
                                            </tr>
                                            <tr align="left">
                                                <td width="150">ความสนใจ</td>
                                                <td colspan="2"><asp:Label ID="tch_attentionLabel" runat="server" Text='<%# Eval("tch_attention") %>'></asp:Label></td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
