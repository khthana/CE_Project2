<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdministratorProfile.aspx.vb" Inherits="Administrator_AdministratorProfile" %>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="birthRFV" runat="server" ControlToValidate="txt"
                                    ...
                                    <%--<asp:DropDownList ID="dayDDL" runat="server" Width="99px" AutoPostBack="True">
                                ...
                                <asp:DropDownList ID="monthDDL" runat="server" Width="175px" AutoPostBack="True">
                                    <asp:ListItem Value="Select">- - - เลือก - - -</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="address" runat="server" Width="350" Height="50px" MaxLength="195"></asp:TextBox>
                            <asp:RequiredFieldValidator
