<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdministratorMSB.aspx.vb" Inherits="Administrator_AdministratorMSB" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Administrator Message Board for Delete</title>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold;">
                            <td colspan="2">
                                การลบข้อมูลของกระทู้สำหรับกระดานสนทนาตามรายวิชา</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr>
                            <td style="font-weight:bold">
                                ...
                                <asp:DropDownList ID="subjectDDL" runat="server" AutoPostBack="True" DataSourceID="subjectDTS"
                                    DataTextField="sub_name" DataValueField="sub_id" Width="150px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr>
                            <td>
                                <asp:SqlDataSource ID="MSBDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>" 
                                    DeleteCommand="DELETE FROM [TopicMB] WHERE [top_id] = @top_id" 
                                    InsertCommand="INSERT INTO [TopicMB] ([top_name], [top_writer], [top_date]) VALUES (@top_name, @top_writer, @top_date)" 
                                    SelectCommand="SELECT [top_id], [top_name], [top_writer], [top_date] FROM [TopicMB] WHERE ([sub_id] = @sub_id) ORDER BY [top_id] DESC" 
                                    UpdateCommand="UPDATE [TopicMB] SET [top_name] = @top_name, [top_writer] = @top_writer, [top_date] = @top_date WHERE [top_id] = @top_id">
                                    <DeleteParameters>
                                    ...
                                    <UpdateParameters>
                                        ...
                                        <asp:Parameter Name="top_date" Type="String" />
                                        <asp:Parameter Name="top_id" Type="Int64" />
                                    </UpdateParameters>
                                    <SelectParameters>
                                ...
                                <asp:GridView ID="GridView1" Width="550" runat="server" AllowPaging="True" PageSize="20" AutoGenerateColumns="False"
                                    CellPadding="4" DataKeyNames="top_id" DataSourceID="MSBDTS" ForeColor="#333333"
                                    GridLines="None" OnRowDeleting="GridView1_DeleteRow" OnRowDataBound="GridView1_RowDataBound" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="top_id" DataNavigateUrlFormatString="AdministratorViewReplyMB.aspx?top_id={0}"
