<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdministratorViewReplyBoard.aspx.vb" Inherits="Administrator_AdministratorViewReplyBoard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Administrator View Reply Board For Delete</title>
    <style>
    ...
    <div>
        <table width="800" align="center" bgcolor="white" border="0" cellpadding="0" cellspacing="0" style="border:0px;text-align:center;">
            ...
            <tr height="30" style="font-weight:bold;">
                <td colspan="2">การลบข้อมูลในส่วนของการตอบกระทู้ทั่วไปและของสมาชิก</td>
            </tr>
            <tr height="10"><td colspan="2"></td></tr>
            <tr height="580">
                <td valign="top">
                    <asp:SqlDataSource ID="replyDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>"
                        DeleteCommand="DELETE FROM [ReplyWB] WHERE [rep_id] = @rep_id" InsertCommand="INSERT INTO [ReplyWB] ([top_id], [rep_content], [rep_writer], [rep_date]) VALUES (@top_id, @rep_content, @rep_writer, @rep_date)"
                        SelectCommand="SELECT [top_id], [rep_id], [rep_content], [rep_writer], [rep_date] FROM [ReplyWB] WHERE ([top_id] = @top_id) ORDER BY [rep_id] DESC"
                        UpdateCommand="UPDATE [ReplyWB] SET [top_id] = @top_id, [rep_content] = @rep_content, [rep_writer] = @rep_writer, [rep_date] = @rep_date WHERE [rep_id] = @rep_id">
                        <DeleteParameters>
                    ...
                    <asp:GridView ID="GridView1" Width="750px" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        DataKeyNames="rep_id" DataSourceID="replyDTS" ForeColor="#333333" GridLines="None" PageSize="20" AllowPaging="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="rep_content" itemStyle-Width="400px" HeaderText="ข้อความ" SortExpression="rep_content" >
