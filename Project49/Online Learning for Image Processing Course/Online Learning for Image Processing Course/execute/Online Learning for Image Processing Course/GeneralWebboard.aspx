<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GeneralWebboard.aspx.vb" Inherits="GeneralWebboard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>General Webboard</title>
    <style>
    ...
    <div>
        <table width="800" align="center" bgcolor="white" border="0" cellpadding="0" cellspacing="0" style="border:0px;text-align:center;">
            ...
            <tr bgcolor="#00cc00" style="font-weight:bold;color:White" valign="top" height="20">
                <td valign="middle">:: กระดานสนทนาทั่วไป ::</td>
            </tr>
            <tr height="10">
                <td></td>
            </tr>
            <tr>
                <td><asp:LinkButton ID="LinkButton1" runat="server"><img src="Image/newtopic.jpg" align="middle" border="0" /></asp:LinkButton>
                    &nbsp;&nbsp;&nbsp;ค้นหาตามชื่อกระทู้ &nbsp;
                    <asp:TextBox ID="keyword" runat="server"></asp:TextBox>
                    <asp:Button ID="search" runat="server" Text="ค้นหา" BackColor="#FF8000" ValidationGroup="searchsystem" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="100px" Font-Bold="True" />
                ...
                <td>
                    <table visible="false" id="newtopictable" runat="server" align="center" width="550">
                        <tr>
                            ...
                            <td width="400"><asp:TextBox ID="name" MaxLength="45" runat="server" Width="400"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="posterRFV" runat="server" ControlToValidate="name" Display="Dynamic"
                                    ErrorMessage="กรุณาใส่ชื่อผู้ตอบกระทู้" ValidationGroup="postsystem"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="posterREV" runat="server" ControlToValidate="name"
                                Display="Dynamic" ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+"
                                ValidationGroup="postsystem" Width="140px"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td>E - Mail</td>
                            <td><asp:TextBox ID="email" MaxLength="45" runat="server" Width="400"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td><asp:TextBox ID="topic" runat="server" MaxLength="45" Width="400"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="topicRFV" runat="server" ControlToValidate="topic" Display="Dynamic"
                                    ErrorMessage="กรุณาใส่ชื่อหัวข้อกระทู้" ValidationGroup="postsystem"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="topicREV" runat="server" ControlToValidate="topic"
                                Display="Dynamic" ErrorMessage="กรุณาใช้เครื่องหมายอื่นแทน(')" ValidationExpression="[^']+"
                                ValidationGroup="postsystem" Width="140px"></asp:RegularExpressionValidator></td>
                        </tr>                            
                        <tr>
                            ...
                            <asp:RequiredFieldValidator ID="contentRFV" runat="server" ControlToValidate="content" Display="Dynamic"
                                    ErrorMessage="กรุณาใส่ข้อความ" ValidationGroup="postsystem"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="contentREV" runat="server" ControlToValidate="content" Display="Dynamic"
                        ...
                        <tr>
                            <td colspan="2"><asp:Button ID="send" runat="server" Text="ส่งข้อความ" ValidationGroup="postsystem" Width="100px" BackColor="#FF8000" Font-Names="Microsoft Sans Serif" ForeColor="White" Font-Bold="True" />
                                <asp:Button ID="clear" runat="server" Text="เคลียร์" Width="100px" BackColor="#FF8000" Font-Names="Microsoft Sans Serif" ForeColor="White" Font-Bold="True" />
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr valign="top">
                <td>
                    <asp:SqlDataSource ID="TopicWebboardDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>"
                        ...
                        <SelectParameters>
                            <asp:QueryStringParameter Name="top_type" QueryStringField="wbtype" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:GridView ID="GridView1" Width="800px" runat="server" AllowPaging="True" PageSize="20" AutoGenerateColumns="False"
                        CellPadding="4" DataKeyNames="top_id" DataSourceID="TopicWebboardDTS" ForeColor="#333333"
                        GridLines="None">
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="top_id" DataNavigateUrlFormatString="GeneralDetailWebboard.aspx?top_id={0}"
