<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdministratorMemberWB.aspx.vb" Inherits="Administrator_AdministratorMemberWB" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Administrator Member Webboard for Delete</title>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold;">
                            <td colspan="2">
                                การลบข้อมูลของกระทู้สำหรับกระดานสนทนาของสมาชิก</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr>
                            <td>
                                <asp:SqlDataSource ID="memberboardDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>"
                                    ...
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="member" Name="top_type" Type="String" />
                                    </SelectParameters>
                                    <InsertParameters>
                                        <asp:Parameter Name="top_name" Type="String" />
                                        <asp:Parameter Name="top_writer" Type="String" />
                                ...
                                <asp:GridView ID="GridView1" Width="550" runat="server" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" CellPadding="4" 
                                    ...
                                    DataKeyNames="top_id" DataSourceID="memberboardDTS" ForeColor="#333333" GridLines="None">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="top_id" DataNavigateUrlFormatString="AdministratorViewReplyBoard.aspx?top_id={0}&top_type=member"
                                            DataTextField="top_name" ControlStyle-Width="250" HeaderText="หัวข้อกระทู้" SortExpression="top_name"
                                            Target="_blank" />
                                        <asp:BoundField DataField="top_writer" HeaderText="ผู้ต้งกระทู้" SortExpression="top_writer" />
