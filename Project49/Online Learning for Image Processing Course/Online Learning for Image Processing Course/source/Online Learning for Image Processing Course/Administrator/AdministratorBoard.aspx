<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdministratorBoard.aspx.vb" Inherits="Administrator_AdministratorBoard" %>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold;">
                            <td colspan="2">
                                การลบข้อมูลของกระดานสนทนาต่างๆ</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr>
                            <td>
                                <asp:Button ID="gwb" runat="server" Text="การจัดการกระดานสนทนาทั่วไป" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="220px" /><br />
                                <br />
                                <asp:Button ID="mwb" runat="server" Text="การจัดการกระดานสนทนาของสมาชิก" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="220px" /><br />
                                <br />
                                <asp:Button ID="msb" runat="server" Text="การจัดการกระดานสนทนารายวิชา" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="220px" />
                            </td>
                        </tr>
                    </table>
                </td>
