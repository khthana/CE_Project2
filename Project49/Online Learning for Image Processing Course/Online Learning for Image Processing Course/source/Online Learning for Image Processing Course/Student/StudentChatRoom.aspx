<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentChatRoom.aspx.vb" Inherits="Student_StudentChatRoom" %>
...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" background="../Image/bg.jpg" style="font-family:MS Sans Serif;font-size:10pt">
    ...
    <div>
        ...
        <asp:DataList ID="DataList1" runat="server" DataKeyField="sub_id" DataSourceID="chatDTS">
            <ItemTemplate>
                <%#"<iframe src=DisplayChatting.aspx?sub_id=" & Container.DataItem("sub_id") & " width=274 height=374 /><br />" & _
                   "<iframe src=StudentSendMessageChatting.aspx?sub_id=" & Container.DataItem("sub_id") & " width=274 height=70 />"%>
            </ItemTemplate>
        </asp:DataList>
    </div>
    </form>
