<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentLesson.aspx.vb" Inherits="Student_StudentLesson" %>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold">
                            <td>บทเรียนที่มีในรายวิชานั้นๆ</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr height="30" style="font-weight:bold">
                            <td>เลือกวิชา <asp:DropDownList ID="subjectDDL" runat="server" AutoPostBack="True" DataSourceID="subjectDTS" DataTextField="sub_name" DataValueField="sub_id">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:DataList ID="DataList2" runat="server" DataKeyField="les_id" DataSourceID="LessonDTS" CellPadding="4" ForeColor="#333333">
                                    <ItemTemplate>
                                        <table align="center" border="0" width="550">
                                            <tr>
                                                <td rowspan="2" width="150">
                                                    บทที่ <asp:Label ID="les_numberLabel" runat="server" Text='<%# Eval("les_number") %>'></asp:Label>
                                                </td>
                                                <td align="left" width="400">
                                                    <font color="black">หัวข้อ : 
                                                    <asp:Label ID="les_topicLabel" runat="server" Text='<%# Eval("les_topic") %>' ForeColor="Blue"></asp:Label>
                                                    <br /><br />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">รายละเอียด : 
                                                    <asp:Label ID="les_descriptionLabel" runat="server" Text='<%# Eval("les_description") %>' ForeColor="Blue"></asp:Label></td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
