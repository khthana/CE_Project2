<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentSimulation.aspx.vb" Inherits="Student_StudentSimulation" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Student Simulation</title>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold">
                            <td colspan="2">ตัวอย่างการทดลองของวิชาต่างๆ</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr height="30">
                            <td colspan="2">
                                <asp:SqlDataSource ID="subjectDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>"
                                    SelectCommand="select sub_id, sub_name, sub_sim from subject 
                                                    where sub_id in (select sub_id from subjectsection where sec_id in (select sec_id 
                                        ...
                                        <table width="550">
                                            <tr align="center" height="30">
                                                ...
                                                <td width="500" align="left">
                                                    <%#"<a href=Simulation.aspx?sub_id=" & Container.DataItem("sub_id") & _
                                                       "&sim=" & Container.DataItem("sub_sim") & " target=_blank>" & Container.DataItem("sub_name") & "</a>"%>
                                                </td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
