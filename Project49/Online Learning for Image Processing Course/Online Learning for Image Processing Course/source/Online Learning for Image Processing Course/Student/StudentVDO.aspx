<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StudentVDO.aspx.vb" Inherits="Student_StudentVDO" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Student VDO On Web</title>
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30" style="font-weight:bold">
                            <td colspan="2">การเรียนโดยใช้ Clip VDO เป็นสื่อการสอน</td>
                        </tr>
                        <tr height="10"><td colspan="2"></td></tr>
                        <tr height="30" style="font-weight:bold">
                            <td colspan="2">
                        ...
                        <tr>
                            <td>
                                <asp:SqlDataSource ID="vdoDTS" runat="server" ConnectionString="<%$ ConnectionStrings:ProjectDBConnectionString %>" 
                                    SelectCommand="select lowvdo_id,sub_id,lowvdo_topic,lowvdo_dateshow from learningonwebvdo where ([sub_id] = @sub_id) and lowvdo_year = (select max(lowvdo_year) from learningonwebvdo) 
                                ...
                                <asp:DataList ID="DataList2" runat="server" DataKeyField="lowvdo_id" DataSourceID="vdoDTS" CellPadding="4" ForeColor="#333333">
                                    <ItemTemplate>
                                        <table width="550">
                                            <tr>
                                                <td width="50" align="center"><img src="../Image/viewicon.gif" align="middle" /></td>
                                                <td width="500" align="left">
                                                    <%#"<a href=StudentVDODetail.aspx?lowvdo_id=" & _
                                                         Container.DataItem("lowvdo_id") & "&date=" & _
                                                         Container.DataItem("lowvdo_dateshow") & "&sub_id=" & _
                                                         Container.DataItem("sub_id") & " target=_blank>" & _
                                                         Container.DataItem("lowvdo_topic") & "</a>"%>
                                                </td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
