<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PowerLawContrast.aspx.vb" Inherits="PowerLawContrast" %>
...
<head runat="server">
    <title>Power Law Contrast</title>
<style>
    ...
    <div>
        <table align="center" width="600" bgcolor="white" border="0">
            <tr align="center" height="50">
                ...
                <font style="font-family:Arial;font-weight:bolder;font-size:medium">Power Law Contrast</font>
                <br />Y = AX^y + B : B = 0 : y = Gamma Value</td>
            </tr>
            ...
            <tr align="center">
                <td style="border-color:#ff9933;border-width:thin;border-style:double">
                    Value A<atlas:ScriptManager ID="sm1" runat="server" />
                    <asp:TextBox ID="txtValue1" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender1" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue1" EnableHandleAnimation="true" BoundControlID="lblValue1" Length="200" Minimum="-100" Maximum="100" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue1" runat="server" />
                </td>
                <td></td>
                <td style="border-color:#ff9933;border-width:thin;border-style:double">
                    Value y (x0.1)<asp:TextBox ID="txtValue2" runat="server" />
                    <cc1:SliderExtender ID="SliderExtender2" runat="server">
                    <cc1:SliderProperties TargetControlID="txtValue2" EnableHandleAnimation="true" BoundControlID="lblValue2" Length="200" Minimum="0" Maximum="20" />
                    </cc1:SliderExtender>
                    <asp:Label ID="lblValue2" runat="server" />
                </td>
           </tr>
           <tr align="center" height="30">
                <td colspan="3"><asp:Button ID="PowerLaw_Contrast" runat="server" Text="ประมวลผล" BackColor="#FF8000" Font-Bold="True" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="90px" /></td>
           </tr>
           <tr align="center">
                <td colspan="3" style="border-color:#ff9933;border-width:thin;border-style:double"><Web:ChartControl ID="PowerLawContrastChart" Visible="false" runat="server" BorderStyle="Outset" 
