...
Partial Class LogContrast
    ...
    Protected Sub OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            Warning.Text = ""
            LogContrastChart.Visible = False
    ...
    Protected Sub Log_Contrast_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Log_Contrast.Click
        Try
            Warning.Text = ""
            ...
            Dim AValue As Double = Val(txtValue.Text)
            ...
            For i = 0 To 255
                If AValue > 0 Then
                    PixelTemp = (AValue * Math.Log10(1 + i))
                End If
            ...
            Else
                Warning.Text = "พบปัญหาที่ฟังก์ชัน Log_Contrast_Click"
                Exit Sub
            End If
    ...
    Private Sub CreateGraph(ByVal value() As Double)
        Try
            ...
            Else
                ...
                chart.DataBind()
                LogContrastChart.Charts.Add(chart)
                ConfigureColors()
                LogContrastChart.RedrawChart()
            End If
        Catch ex As Exception
            Warning.Text = ex.Message
            Exit Sub
    ...
    Private Sub ConfigureColors()
        Try
            LogContrastChart.Background.Color = Color.GreenYellow
            LogContrastChart.ChartTitle.Text = "Log Contrast Chart"
            LogContrastChart.ChartTitle.ForeColor = Color.BlueViolet
            LogContrastChart.Border.Color = Color.Brown
            LogContrastChart.BorderStyle = BorderStyle.Solid
        Catch ex As Exception
            Warning.Text = ex.Message
            Exit Sub
        End Try
