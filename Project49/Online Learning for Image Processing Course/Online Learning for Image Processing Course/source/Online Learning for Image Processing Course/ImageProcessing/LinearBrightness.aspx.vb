...
Partial Class LinearBrightness
    ...
    Protected Sub OK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            Warning.Text = ""
            LinearBrightnessChart.Visible = False
    ...
    Protected Sub Linear_Brightness_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Linear_Brightness.Click
        Try
            Warning.Text = ""
            ...
            Dim BValue As Double = Val(txtValue1.Text)
            ...
            LinearBrightnessChart.Visible = True
            ...
            Else
                Warning.Text = "พบปัญหาที่ฟังก์ชัน Linear_Brightness_Click"
                Exit Sub
            End If
    ...
    Private Sub CreateGraph(ByVal value() As Double)
        Try
            ...
            Else
                ...
                chart.DataBind()
                LinearBrightnessChart.Charts.Add(chart)
                ConfigureColors()
                LinearBrightnessChart.RedrawChart()
            End If
        Catch ex As Exception
            Warning.Text = ex.Message
            Exit Sub
    ...
    Private Sub ConfigureColors()
        Try
            LinearBrightnessChart.Background.Color = Color.GreenYellow
            LinearBrightnessChart.ChartTitle.Text = "Linear Brightness Chart"
            LinearBrightnessChart.ChartTitle.ForeColor = Color.BlueViolet
            LinearBrightnessChart.Border.Color = Color.Brown
            LinearBrightnessChart.BorderStyle = BorderStyle.Solid
        Catch ex As Exception
            Warning.Text = ex.Message
            Exit Sub
        End Try
