<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GeneralDetailWebboard.aspx.vb" Inherits="GeneralDetailWebboard" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>General Detail Webboard</title>
    <style>
...
<body topmargin="0" bottommargin="0" background="Image/bg.jpg" style="font-family:MS Sans Serif;font-size:10pt">
    ...
    <div>
        <table width="800" align="center" bgcolor="white" border="0" cellpadding="0" cellspacing="0" style="border:0px;text-align:center;">
            ...
            <tr bgcolor="#00cc00" style="font-weight:bold;color:White">
                <td>:: กระดานสนทนาทั่วไป ::</td>
            </tr>
            <tr height="10">
                <td></td>
            </tr>
