<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SearchThesis.aspx.vb" Inherits="SearchThesis" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Result Thesis Searching</title>
            ...
            <tr height="100">
                ...
                <td width="600" rowspan="2" valign="top">
                    <table style="margin-bottom:10px;margin-left:10px;margin-right:10px">
                        <tr bgcolor="#00cc00" style="font-weight:bold;color:White" height="20">
                            <td colspan="4">:: ผลการค้นหาวิทยานิพนธ์ ::</td>
                        </tr>
                        <tr height="10">
                            <td colspan="4"></td>
                        </tr>
                        <tr>
                            ...
                            <td><asp:Button ID="search" runat="server" Text="ค้นหา" ValidationGroup="searchsystem" BackColor="#FF8000" Font-Names="Microsoft Sans Serif" ForeColor="White" Width="120px" Font-Bold="True" /></td>
                        </tr>
                        <tr height="10">
                            <td colspan="4">
                        ...
                        <tr>
                            <td colspan="4">
                                <asp:Label ID="Warning" runat="server" ForeColor="Red"></asp:Label><br />
                                <asp:DataList ID="DataList1" runat="server" DataKeyField="tsis_id" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" ForeColor="Black">
                                    <HeaderTemplate>
