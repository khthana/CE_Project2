...
Partial Class GeneralWebboard
    ...
    Protected Sub send_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles send.Click
        ...
        QueryStr = "insert into TopicWB(top_type,top_name,top_writer,top_date,top_email,top_content,top_ip,top_nreplier,top_nreader) values('general','" & _
    ...
    Protected Sub search_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles search.Click
        Response.Redirect("SearchTopicWB.aspx?type=general&key=" & keyword.Text)
    End Sub
