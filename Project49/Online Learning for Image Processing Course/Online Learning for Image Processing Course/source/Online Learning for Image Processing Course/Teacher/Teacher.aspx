<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Teacher.aspx.vb" Inherits="Teacher_Teacher" %>
                    ...
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">
                                Learning File</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการอัพโหลดสื่อการสอนต่างๆ เช่น ไฟล์ Power Point, Clip VDO 
                                <br />
                                &nbsp;และเอกสารสำหรับการดาวน์โหลด</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">
                                Subject</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการกำหนดรายละเอียดของวิชาที่สอน</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">
                                Lesson</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการกำหนดบทเรียนที่จะสอนในภาคการศึกษานั้นๆ</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">
                                Assessment</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการกำหนดการประเมินการเรียนในวิชาที่สอน ซึ่งก็คือการกำหนดค่าของ<br />
                                &nbsp;คะแนนในการสอบแต่ละประเภท</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">
                                Testing</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการสร้างและเปลี่ยนแปลงแก้ไขข้อสอบแต่ละประเภท</td>
                        </tr>
                        <tr height="30">
                            <td bgcolor="PaleGoldenrod">
                                Student Tracking</td>
                            <td align="left" bgcolor="LightGoldenrodYellow">
                                &nbsp;เป็นส่วนของการติดตามการเรียนผู้เรียนแต่ละคนที่ได้ลงวิชาที่สอน</td>
                        </tr>
                    </table>
                </td>
            </tr>
