<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TeacherAssessmentResult.aspx.vb" Inherits="Teacher_TeacherAssessmentResult" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Teacher Assessment Result</title>
            ...
            <tr height="580">
                ...
                <td valign="top" width="600">
                    <table style="margin-top:10px;margin-bottom:10px;margin-left:10px;margin-right:10px" width="550">
                        ...
                        <tr>
                            <td style="font-weight:bold">ผลการประเมินผู้สอน</td>
                        </tr>
                        <tr height="10"><td></td></tr>
                        <tr>
                            <td style="font-weight:bold">
                                ...
                                เลือกวิชา &nbsp;<asp:DropDownList ID="subjectDDL" runat="server" AutoPostBack="True" Width="149px">
                                </asp:DropDownList>
                                <br />
                                <asp:Label ID="warning" runat="server" ForeColor="Red"></asp:Label></td>
                        </tr>
                        <tr height="10"><td></td></tr>
                        <tr>
                            <td align="left">
