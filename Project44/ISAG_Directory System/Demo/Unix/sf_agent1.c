...
#define LOCAL_IP  "161.246.5.31"
#define RDN "AgentID=SF1"
...
int main(int argc, char *argv[])
{
   ...
   strcat(str,asctime(area));
   str[strlen(str)-1] = 0;
   strcat(str,"|IPCap$161.246.5.x,161.246.6.x|PortCap$21,23,139");
