...
//    char *RDN = "AgentID=FW1";
   ...
   strcat(str,asctime(area));
   str[strlen(str)-1] = 0;
   strcat(str,"|Source$any|Destination$161.246.4.*|Service$ftp|Action$Accept");
