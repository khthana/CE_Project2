...
function mouseDown() {
	...
	if (window.event.srcElement.className == "Member") {
	  ...
	  }else{alert("you already select this dimension for X-Axis")}
	}	
}
...
function cmdOK() {
	...
	window.close()
	OldWhereValue = window.opener.document.queryForm.elements("columns").value;
	dimension = document.queryForm.elements("dimension").value;
	if (OldWhereValue != "") 
	{	if (OldWhereValue.indexOf("["+dimension+"]") != -1)
		{	 
		}
		else{ window.opener.document.queryForm.elements("columns").value="{"+ selectedMember2 +"}";	window.opener.document.queryForm.elements("column dimension").value =  "["+ dimension + "]";
		 window.opener.document.queryForm.elements("customdimX").value="1"
	...
	else{window.opener.document.queryForm.elements("columns").value ="{"+ selectedMember2 +"}"
	window.opener.document.queryForm.elements("column dimension").value =  "["+ dimension + "]";
	window.opener.document.queryForm.elements("customdimX").value="1"
	chkWhere=window.opener.document.queryForm.elements("where").value
	if (chkWhere.indexOf("["+dimension+"]",0)!=-1){ window.opener.document.queryForm.elements("where").value=""}
	}
...
<form CLASS=invisibleForm name="queryForm" action="AxisXBrowser.asp" method="get">
