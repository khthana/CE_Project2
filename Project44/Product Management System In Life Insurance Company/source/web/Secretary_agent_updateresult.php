...
if($update)
{
updateagent($Aid,$Aname,$Asurname,$Anick,$Apasswd,$Arange,$AregDate,$Aaddress,$Asoi,$Asubsoi,$Aroad,	$Adistrict,$Asubd,$Aprovince,$Apostcode,$Atel,$Asubh);
}
elseif ($del)
{
Remove_Agent($Aid);
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">อัพเดทข้อมูลตัวแทน คุณ <?echo $Aname?></font></b></td>
          </tr>
          <tr> 
...
<?	if($update){
        echo"<div align=\"center\"><b><a href=\"Secretary_agent_update.php?Agent_Id= $Aid\">กลับไปดูข้อมูลตัวแทนที่อัพเดทแล้ว </a></b> </div>";}
		elseif($del){
        echo"<div align=\"center\"><b><a href=\"Secretary_agent.php\">ลบข้อมูลแล้วกลับไปดูข้อมูลตัวแทน </a></b> </div>";}
?>
