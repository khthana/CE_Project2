<? 	include("phpFunctionDB.php"); 
 Add_Competition($Com_Name,$Detail_Con,$Detail_Rew,$Detail_O,$Start_date,$End_Date,$FYP_OverAll,	 $NewCode,$FYP_Newcode,$Persistency,$Claim_Ratio,$Amount_Of_In);
?>
  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <div align="center"><b><a href="Secretary_competition.php">Competition 
          Page </a></b> </div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <div align="center"> </div>
