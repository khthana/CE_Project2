...
?>
<html>
<!-- #BeginTemplate "/Templates/Secretary_Template.dwt" --> 
<head>
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">INBOX</font></b></td>
          </tr>
        </table>
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#FFFFFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366"><a href="Secretary_message.php">INBOX</a> 
              | <a href="Secretary_message_outbox.php">OUTBOX</a> | <a href="Secretary_message_compose.php">COMPOSE</a> 
              | <a href="Secretary_Address%20book.php">ADDRESS BOOK</a></font></b> 
            </td>
          </tr>
        </table>
        <table width="100%" border="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
          <tr> 
            <td bordercolor="#FFFFFF"> 
              <div align="center">คุณมีข้อความใน<b> INBOX</b> ทั้งหมด <b>
			   <?echo$count?></b>ข้อความ</div>
            </td>
          </tr>
        </table>
        <table width="100%" border="0">
          <tr> 
            ...
            <td width="21%" bgcolor="#ffffe4"><b>DATE</b></td>
            <td width="26%" bgcolor="#ffffe4"><b>Sender</b></td>
            <td width="48%" bgcolor="#ffffe4"><b>Subject</b></td>
          </tr>
<? $n = 0;
   while ($count>$n)
   {
            ...
            echo"<td width=\"24%\" bgcolor=\"#ffffff\" valign=\"center\">$From[$n]</td>";
            echo"<td width=\"48%\" height=\"27\"><a href=\"Secretary_message_detail.php?inbox_id=$Mid[$n]\">$Topic[$n]</a></td>";
			echo"</tr>";
			$n++;
   }
 ?>
