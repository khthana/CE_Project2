...
<body bgcolor="#FFFFFF">
  <form name="form1" method="post" action="list_search_customer.php">
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td height="16" width="250" align="left" valign="top"><!-- #BeginEditable "sub_menu" --><img src="Pic/Pic_Agent/Search_customer.gif" width="250" height="28"><!-- #EndEditable --></td>
    ...
    <tr> 
      <td height="201" width="256" valign="top" align="left"><img src="Pic/Pic_Agent/Sub_Agent.gif" width="256" height="196" usemap="#Map" border="0"> 
        <map name="Map"> 
          ...
          <area shape="rect" coords="2,59,249,86" href="Agent_Statistic.php">
          <area shape="rect" coords="1,142,249,168" href="Agent_logout.php">
          <area shape="rect" coords="2,87,249,114" href="Agent_message.php">
        </map>
      </td>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"> 
              <div align="center"> <b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">ค้นหาลูกค้า</font></b></div>
            </td>
          </tr>
        </table>
