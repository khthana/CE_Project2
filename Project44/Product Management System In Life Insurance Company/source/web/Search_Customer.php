...
<body bgcolor="#FFFFFF">
  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td height="16" width="250" align="left" valign="top"><!-- #BeginEditable "sub_menu" --><img src="Pic/Pic_Manager/Search_customer.gif" width="250" height="28"> 
        <!-- #EndEditable --></td>
