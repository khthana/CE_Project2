<? 	include("phpFunctionDB.php"); 
		$Noinsurance = $why;
		Search_Insurance_Policy($Noinsurance,$agent,$customer,&$sql);
?>
...
<body bgcolor="#FFFFFF">
  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td height="16" width="250" align="left" valign="top"><!-- #BeginEditable "sub_menu" --><img src="Pic/Pic_Agent/Search_insurance.gif" width="250" height="28"><!-- #EndEditable --></td>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"> 
              <div align="center"> <b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">ค้นหากรมธรรม์</font></b></div>
            </td>
          </tr>
          <tr>
            <td valign="top" align="center" bgcolor="#FFFFFF">
              <div align="left">รายละเอียดผลการค้นหามีดัวนี้... </div>
            </td>
          </tr>
        </table>
        <div align="center">
          <table width="100%" border="0">
            <tr bgcolor="#FFFFCC"> 
              ...
              <td width="22%"> 
                <div align="center">เลขที่กรมธรรม์</div>
              </td>
              <td width="34%"> 
                <div align="center">ชื่อลูกค้า </div>
              </td>
              <td width="34%"> 
                <div align="center">ชื่อตัวแทน</div>
              </td>
            </tr>																																	  
<?
	global $conn;
	Conn2DB(); //$insurance_id =1;
$result =mysql_query($sql,$conn);	$n = 1;
while($row=mysql_fetch_array($result))
{
		echo"<tr> ";
		 echo"<td width=\"9%\">";
         echo"<div align=\"center\">$n</div>";
         echo"</td>";
         echo"<td width=\"20%\">";
         echo"<div align=\"center\"><a href=\"Manager_customer_insurance.php?insurance_id=$row[insurance_id]\">$row[insurance_id]</a></div>";
         echo"</td>";
         echo"<td width=\"35%\">";
         echo"<div align=\"center\">คุณ $row[customer_name]  -  $row[customer_surname]</div>";
         echo"</td>";
         echo"<td width=\"36%\">";
         echo"<div align=\"center\">คุณ $row[agent_name]  -  $row[agent_surname]</div>";
          echo"</td>";
         echo"</tr>";
		 $n++;
}
