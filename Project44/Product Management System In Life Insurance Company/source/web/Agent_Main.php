    ...
    <tr> 
      <td height="201" width="256" valign="top" align="left"><img src="Pic/Pic_Agent/Sub_Agent.gif" width="256" height="196" usemap="#Map" border="0"> 
        <map name="Map"> 
          ...
          <area shape="rect" coords="244,33,245,59" href="Templates/Search_Customer.php">
          <area shape="rect" coords="-1,60,246,87" href="Agent_Statistic.php">
          <area shape="rect" coords="-2,88,245,115" href="Agent_message.php">
          <area shape="rect" coords="1,143,248,168" href="Agent_logout.php">
        </map>
      </td>
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <table width="100%" border="0" bordercolor="#FFFFFF" cellspacing="1" cellpadding="2">
              <tr bgcolor="#FFFFCC"> 
            <td width="15%"> 
              <div align="left"><font color="#003366"><b>Date</b></font></div>
            </td>
            <td> 
              <div align="left"><font color="#003366"><b>Header</b></font></div>
            </td>
          </tr>
			<?
			...
			echo"<tr> ";
            echo"<td width=\"15%\">";
            echo"<div align=\"left\"><font color=\"#000000\">$Announce[$n]</font></div>";
            echo"</td>";
            echo"<td width=\"75%\">"; 
            echo"<div align=\"left\"><a href=\"Agent_news.php?News_id=$News_id[$n]\">$Header[$n]</a></div>";
            echo"</td>";
            echo"</tr>";
				$n++;
			}
