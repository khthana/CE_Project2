  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td height="24" colspan="2" align="left" valign="top"> 
        <div align="right"><font color="#003366"><!-- #BeginEditable "name" --><b> 
          ยินดีต้อนร ับ 
          <?echo$CK[Login]?>
          </b><!-- #EndEditable --></font></div>
      </td>
    </tr>
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="1" bordercolor="#99CCFF">
          <tr> 
                    ...
                    <table width="100%" border="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
                      <tr> 
                        <td bordercolor="#FFFFFF"> 
                          <div align="center">คุณมีข้อความใน<b> OUTBOX </b>ทั้งหมด 
                            <b> 
                            <?echo  $count?>
                            </b>ข้อความ</div>
                        </td>
            ...
            echo"<td width=\"48%\" height=\"27\"><a href=\"Secretary_message_detail_outbox.php?outbox_id=$Oid[$n]\">$Topic[$n]</a></td>";
			echo"</tr>";
			$n++;
			}
		?>
