...
<body bgcolor="#FFFFFF">
  <form name="form" method="post" action="Secretary_customer_add.php">
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"> 
              <div align="center"> <b><font face="MS Sans Serif, Microsoft Sans Serif" 				  color="#003366">Customer</font></b></div>
            </td>
          </tr>
          <tr> 
        ...
        <table width="100%" border="0">
          <tr bgcolor="#FFFFCC"> 
            <td width="9%">&nbsp;</td>
            <td width="22%"> 
              <div align="left"><b>Customer ID</b></div>
            </td>
...
<?	
		...
		$result =mysql_query($sql,$conn);
					while ($row=mysql_fetch_array($result))
					{
						echo"<tr>";
						echo"<td width=\"9%\">";
						echo"<input type=\"checkbox\" name=\"checkbox\" value=\"$row[Customer_Id]\">";
						echo"</td>";
						echo"<td width=\"22%\">$row[Customer_Id]</td>";
						echo"<td width=\"69%\"><a href=\"Secretary_customer_update.php?Customer_Id=$row[Customer_Id]\">$row[Customer_PreN]   $row[Customer_Name]  $row[Customer_Surname] </a> </td>";
						echo"</tr>";
					}
?>
            <tr> 
