<? 	include("phpFunctionDB.php"); 
 addagent($Aname,$Asurname,$Anick,$Apasswd,$Arange,$Aaddress,$Asoi,$Asubsoi,$Aroad,	$Adistrict,$Asubd,$Aprovince,$Apostcode,$Atel,$Asubh);
?>
  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <p align="center"><b><a href="Secretary_agent.php">Agent Page</a></b></p>
        <p>&nbsp;</p>
        <div align="center"> </div>
        <!-- #EndEditable --></td>
    </tr>
