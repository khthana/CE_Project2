...
addcustomer($Cpren,$Cname,$Csurname,$CAddress,$Crange,$Csoi,$Csubsoi,$Croad,$Cdistrict,$Csubd,$Cprovince,	$Cpostcode,$Ctel1,$Ctel2,$Csubh,$Ausername);
?>
  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <div align="center">
<p><a href="Secretary_customer.php"><b>Customer Page</b></a> </p>
        </div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <div align="center"> </div>
