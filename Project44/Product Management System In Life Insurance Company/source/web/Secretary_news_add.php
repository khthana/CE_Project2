...
<body bgcolor="#FFFFFF">
  <form name="form1" method="post" action="Secretary_news_addresult.php">
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <table width="100%" border="1" bordercolor="#FFFFFF">
          <tr bordercolor="#99CCFF"> 
            ...
            <td width="65%" bordercolor="#FFFFFF"> 
          ...
          <tr bordercolor="#99CCFF"> 
            ...
            <td width="65%" bordercolor="#FFFFFF"> 
              <textarea name="News_Detail"  rows="10" cols="50"></textarea>
            </td>
          </tr>
          <tr bordercolor="#99CCFF"> 
            <td width="35%" height="31" bgcolor="#FFFFCC"> 
              <div align="right"><b>วันหมดอายุข่าว :</b></div>
            </td>
            <td width="65%" height="31" bordercolor="#FFFFFF"> 
              <input type="text" name="News_ExpireDate" >
            </td>
          </tr>
        </table>
