...
<body bgcolor="#FFFFFF">
  <form name="form1" method="post" action="Secretary_agentstatistic_update.php">
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td valign="top" align="center" bgcolor="#FFFFFF"><b></b></td>
          </tr>
        </table>
        <div align="center">
          <table width="100%" border="1">
            <tr> 
              <td width="24%"> 
                <div align="right"><b>Username Agent :</b></div>
              </td>
              <td colspan="4">
                <select name="agent">
				  <?
				...
				$sql = "select * from agent";
					...
					{	echo"<option value =\"$row[Agent_Id]\">$row[Agent_Username]</option>";
					}
				?>
                </select>
