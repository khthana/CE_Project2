...
<body bgcolor="#FFFFFF">
  <form name="form1" method="post" action="Secretary_news_add.php">
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <table width="100%" border="0">
          <tr bgcolor="#FFFFCC"> 
            <td width="9%">&nbsp;</td>
            <td width="22%"> 
              <div align="left"><b>News ID</b></div>
            </td>
            <td width="69%"> 
              <div align="left"><b>News Header</b></div>
            </td>
          </tr>
         <?
global $conn;
...
while($count >$n)
{
            ...
            echo"</td>";
            echo"<td width=\"22%\">$News_id[$n]</td>";
            echo"<td width=\"69%\"><a href=\"Secretary_news_update.php?News_id=$News_id[$n]\">$Header[$n]</a></td>";
			echo"<td> $Announce[$n]</td>";
			echo"</tr>";
			$n++;
}	
         ?>
