...
<body bgcolor="#FFFFFF">
  <form name="form1" method="post" action="Secretary_news_updateresult.php">
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        ...
        <table width="100%" border="1" bordercolor="#FFFFFF">
          <tr> 
            <td width="35%" bgcolor="#FFFFCC" bordercolor="#99CCFF"> 
              <div align="right"><b>หัวข้อข่าว :</b></div>
            </td>
            <td width="65%"> 
			<INPUT TYPE="hidden" NAME="News_id" value = "<?echo $News_id?>">
              <input type="text" name="News_Header"  value = "<?echo $News_Header?>">
            </td>
          </tr>
          <tr> 
            <td width="35%" bgcolor="#FFFFCC" bordercolor="#99CCFF"> 
              <div align="right"><b>รายละเอียด :</b></div>
            </td>
            <td width="65%"> 
              <textarea  name="News_Detail"  rows="10" cols="50"><?echo $News_Detail?></textarea>
            </td>
          </tr>
          <tr> 
            <td width="35%" height="31" bgcolor="#FFFFCC" bordercolor="#99CCFF"> 
              <div align="right"><b>วันหมดอายุข่าว :</b></div>
            </td>
            <td width="65%" height="31"> 
              <input type="text" name="News_Expire" value="<?echo $News_ExpireDate?>">
            </td>
          </tr>
        </table>
