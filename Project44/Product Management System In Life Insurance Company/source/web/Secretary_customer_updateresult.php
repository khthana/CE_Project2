...
if($update)
{
updatecustomer($Cid,$CPreN,$Cname,$Csurname,$Crange,$Cprovince,$Cdistrict,$Csubd,$Croad,$Csoi,$Csubsoi,$Csubh,	$Caddr,$Ctel1,$Ctel2,$Ausername,$Cpostcode);
}
elseif ($del)
{
 Remove_customer($Cid);
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">อัพเดทข้อมูลลูกค้า คุณ <?echo $Cname?></font></b></td>
          </tr>
          <tr> 
...
<?	if($update){
        echo"<div align=\"center\"><b><a href=\"Secretary_customer_update.php?Customer_Id= <?echo $Cid\">กลับไปดูข้อมูลลูกค้าที่อัพเดทแล้ว </a></b> </div>";}
		elseif($del){
        echo"<div align=\"center\"><b><a href=\"Secretary_customer.php\">ลบข้อมูลแล้วกลับไปดูข้อมูลลูกค้า </a></b> </div>";}
?>
