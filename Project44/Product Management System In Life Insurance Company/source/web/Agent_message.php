...
<body bgcolor="#FFFFFF">
  ...
  <table width="750" border="0" bgcolor="#FFFFFF">
        ...
        <table width="100%" border="0" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
          <tr>
            <td bordercolor="#FFFFFF">
              <div align="center">คุณมีข้อความใน<b> INBOX</b> ทั้งหมด <b> <?echo$count?></b>ข้อความ</div>
            </td>
          </tr>
        </table>
   ...
   while ($count>$n)
   {
            ...
            echo"<td width=\"48%\" height=\"27\"><a href=\"Agent_message_detail.php?inbox_id=$Mid[$n]\">$Topic[$n]</a></td>";
			echo"</tr>";
			$n++;
   }
 ?>
