    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">สถิติทั้งหมด</font></b></td>
          </tr>
        </table>
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr bgcolor="#FFFFFF"> 
            <td valign="top" align="center" height="2" colspan="6"> 
        ...
        <table width="100%" border="0">
          <tr bordercolor="#FFFFFF"> 
            <td width="15%" height="14" bgcolor="#FFFFCC"> 
            ...
            <td width="35%" height="14" bgcolor="#FFFFCC"> 
        	...
        	<?
				global $conn;
				Conn2DB();
				$sql = "select * from overall_statistics where (Year>=$startyear and Year<=$endyear)and (Month >=$startmonth and Month<=$endmonth)";
				...
				while ($row=mysql_fetch_array($result))
{
			...
			echo Month($row[Month]);echo"</font></div>";
			echo"</td>";
			echo"<td width=\"15%\" bordercolor=\"#FFFFFF\">"; 
			echo"<div align=\"center\">";echo $row[Year]+543,"</div>";
			echo"</td>";
            echo"<td bordercolor=\"#FFFFFF\">";
            echo"<div align=\"center\">$row[FYP] </div>";
            echo"</td><td>";
            echo"<div align=\"center\">$row[NewCode]</div>";
            echo"</td><td>";
            echo"<div align=\"center\">$row[Persistency]</div>";
            echo"</td><td> ";
            echo"<div align=\"center\">$row[Claim_Ratio]</div>";
            echo"</td><td>";
            echo"<div align=\"center\">$row[Amount_Of_Insurance]</div>";
            echo"</td></tr>";
				}
//			 Index_Id  Year  Month  FYP  NewCode  Persistency  Claim_Ratio  Amount_Of_Insurance 
				$sql = "select sum(FYP),sum(NewCode),sum(Persistency),sum(Claim_Ratio),sum(Amount_Of_Insurance) from overall_statistics where (Year>=$startyear and Year<=$endyear)and (Month >=$startmonth and Month<=$endmonth)";
				$result=mysql_query($sql,$conn);
				$row=mysql_fetch_array($result);
				CloseDB();
?>
          <tr> 
            <td colspan="2" bordercolor="#FFFFFF" bgcolor="#cfe6fc"> 
              <div align="center"><font color="#993333"><b>รวม </b> </font> </div>
            </td>
            <td bordercolor="#FFFFFF" bgcolor="#cfe6fc"> 
            ...
            <td bgcolor="#cfe6fc"> 
              <div align="center"><b><font color="#993333"><?echo $row[4]?></font></b></div>
            </td>
          </tr>
        </table>
        <p>&nbsp;</p>
