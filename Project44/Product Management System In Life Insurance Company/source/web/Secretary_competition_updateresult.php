...
if($update)
{
Update_Competition($Competition_Id,$Com_Name,$Detail_Con,$Detail_Rew,$Detail_O,$Start_date,$End_Date,$FYP_OverAll,$NewCode,$FYP_Newcode,$Persistency,$Claim_Ratio,$Amount_Of_In);
}
elseif ($del)
{
del_competition($Competition_Id);
}
?>
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">อัพเดทข้อมูลการแข่งขัน</font></b></td>
          </tr>
          <tr> 
            <td valign="top" align="center" bgcolor="#FFFFFF"><b><font color="#990000">ระบบได้ทำการอัพเดทข้อมูลเรียบร้อยแล้ว</font></b></td>
          </tr>
        </table>
<?	if($update){
        echo"<div align=\"center\"><b><a href=\"Secretary_competition_update.php?Com_Id= $Competition_Id\">กลับไปดูข้อมูลการแข่งขันที่อัพเดทแล้ว </a></b> </div>";}
		elseif($del){
        echo"<div align=\"center\"><b><a href=\"Secretary_competition.php\">ลบข้อมูลการแข่งขันแล้วกลับไปดูข้อมูลการแข่งขัน </a></b> </div>";}
?>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <div align="center"> </div>
