...
if($update)
{
Updatenews($News_id,$News_Header,$News_Detail,$News_ExpireDate);
}
elseif ($del)
{
Deletenews($News_id);
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td valign="top" align="center" bgcolor="#FFFFFF"><b><font color="#990000">ระบบได้ทำการเปลี่ยนแปลงข้อมูลเรียบร้อยแล้ว</font></b></td>
          </tr>
        </table>
       
<?	if($update){
        echo"<div align=\"center\"><b><a href=\"Secretary_news_update.php?News_id= $News_id\">News Page </a></b> </div>";}
		elseif($del){
        echo"<div align=\"center\"><b><a href=\"Secretary_news.php\">ลบข้อมูลแล้วกลับไปดูข้อมูล </a></b> </div>";}
?>
