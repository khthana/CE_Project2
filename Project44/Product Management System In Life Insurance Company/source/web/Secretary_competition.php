...
<body bgcolor="#FFFFFF">
  <form name="form1" method="post" action="Secretary_competition_add.php">
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          <tr> 
            <td valign="top" align="center" bgcolor="#99CCFF"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#003366">การแข่งขัน</font></b> 
              <div align="center"></div>
            </td>
          </tr>
          <tr> 
        ...
        <table width="100%" border="0">
          <tr bgcolor="#FFFFCC"> 
            <td width="9%">&nbsp;</td>
            <td width="22%"> 
              <div align="left"><b>Post Date</b></div>
            </td>
            <td width="69%" bgcolor="#FFFFCC"> 
              <div align="left"><b>Competition Name</b></div>
            </td>
          </tr>
<?global $conn;
	Conn2DB();
	$sql = "select * from competition order by Post_Date desc";
	...
	while( $row = mysql_fetch_array($result))
	{
        ...
        echo"</td>";
		$tem = mysql2unix($row[Post_Date]);
		$time = date("d/m/Y ",$tem); 
        echo"<td width=\"22%\">$time</td>";
        echo"<td width=\"69%\"><a href=\"Secretary_competition_update.php?Com_Id=$row[Competition_Id]\">$row[Competition_Name]</a></td>";
        echo"</tr>";
	}
?>
			  <tr> 
            ...
            <td width="69%"><font color="#990000">ทั้งหมด <b>50 </b>เรคคอร์ด<b> 
