            ...
            <td>
              <table width="100%" border="0">
                ...
                <tr> 
                  <td width="20%"> 
                    <div align="right"><b> 
<form name="forward" method="post" action="agent_main.php">
	<input type="submit" name="forward" value="Forword">
</form>
					  </b></div>
                  </td>
                  <td width="80%"> 
<form name="forward" method="post" action="delete_inbox.php?inbox_id=<?echo $inbox_id?>">
