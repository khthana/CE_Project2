...
//echo "  -----------     $index_id,$Persistency,$Claim_Ratio,$FYP,$Amount_Of_Insurance";
Update_Agent_Statistics($index_id,$Persistency,$Claim_Ratio,$FYP,$Amount_Of_Insurance);
?>
    ...
    <tr> 
      ...
      <td height="184" colspan="3" align="left" valign="top"><!-- #BeginEditable "content" --> 
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td valign="top" align="center" bgcolor="#FFFFFF"><b><font color="#990000">ระบบได้ทำการ 
              Update สถิติตัวแทนเรียบร้อยแล้ว </font></b></td>
          </tr>
        </table>
        <div align="center"><b><a href="Secretary_agentstatistic.php">Agents 
          Statistic Page </a></b></div>
        <div align="center"> </div>
        <!-- #EndEditable --></td>
    </tr>
  </table>   
