...
Update_Overall_Statistics($index_id,$Persistency,$Claim_Ratio,$Newcode);
?>
        ...
        <table width="100%" border="0" bgcolor="#FFFFFF">
          ...
          <tr> 
            <td valign="top" align="center" bgcolor="#FFFFFF"><b><font color="#990000">ระบบได้ทำการ 
              Update สถิติทั้งหมดเรียบร้อยแล้ว </font></b></td>
          </tr>
        </table>
        <div align="center"><b><a href="Secretary_allstatistic.php">Overal Statisticl 
          Page </a></b> </div>
        <div align="center"> </div>
        <!-- #EndEditable --></td>
    </tr>
