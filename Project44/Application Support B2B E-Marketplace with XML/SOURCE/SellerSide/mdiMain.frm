...
Begin VB.MDIForm mdiMain 
   ...
   Begin MSComctlLib.Toolbar ToolbarMain 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button9 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "VerPO"
            Object.ToolTipText     =   "Accept Or Reject P.O."
            ImageIndex      =   6
         EndProperty
         ...
         BeginProperty Button11 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "GenIV"
            Object.ToolTipText     =   "Generate Invoice from P.O."
            ImageIndex      =   7
         EndProperty
      EndProperty
      MousePointer    =   99
   ...
   Begin VB.Menu mnuPR 
      ...
      Begin VB.Menu mnuPRAccept 
         Caption         =   "Accep P.R. && Generate P.O."
      End
   ...
   Begin VB.Menu mnuPO 
      Caption         =   "P.O."
      Begin VB.Menu mnuPORecv 
         Caption         =   "Receive P.O. && Generate Order No."
      End
      Begin VB.Menu mnuPOVer 
         Caption         =   "Verify P.O."
      End
...
Private Sub MDIForm_Load()
        ...
        DBconString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & App.Path & "\Seller.mdb;Persist Security Info=False"
                ...
                If EofFile = Right$(strNew, Len(EofFile)) Then
                        ...
                        If (fileTp = ftPO) Or (fileTp = ftPR) Or (fileTp = ftInvoice) Then
                                ...
                                If mdlRecvXML.RecvXMLAll(SrcFile) Then
                                    ...
                                    '------------------ add log ----------------------
                                    datestr = Format$(Now, "dd/mm/yy  hh:nn:ss")
                                    frmEvent.AddEvent datestr & vbTab & "Receive File Complete"
                                    LogFile.AddLog datestr & vbTab & "Receive File Complete"
                                    '------------------------------------------------------
                        ...
                        ElseIf fileTp = ftTS Then
                                           If mdlRecvXML.DecryptFileOnly(SrcFile) Then
                                                        ...
                                                        If (xmldoc.documentElement.firstChild.nodeName = "TransactionPayment") And _
                                                                ((tsStatus = SReject) Or (tsStatus = SPaid)) Then
                                                                 ...
                                                                 valFile = Left$(SrcFile, Len(SrcFile) - 4) & "Valid" & Right$(decFile, 4)
                                                                        If ValidateFile(decFile, valFile) Then
                                                                                ...
                                                                                If mdlXML.RecvTSPaid_Reject(SrcFile) Then
                        ...
                        ElseIf fileTp = ftMP Then
                                        If mdlRecvXML.RecvXMLAll(SrcFile) Then
                                                ...
                                                If objxml.GetRootName = "MonthlyPayment" And objxml.GetStatus = "Seller" Then
                                                        dest = App.Path & "\MonthlyPayment\" & GetFileName(decFile)
                                                        delFile dest
                                                        fso.MoveFile decFile, dest
                                                        decFile = dest
                                                        
                                                        dest = App.Path & "\MonthlyPayment\" & GetFileName(SrcFile)
                                                        delFile dest
                                                        fso.MoveFile SrcFile, dest
                                                        SrcFile = dest
                                                        
                                                        dest = App.Path & "\MonthlyPayment\" & GetFileName(valFile)
                                                        delFile dest
                                                        ...
                                                        rcs.AddNew
                                                                ...
                                                                rcs!Startdate = objxml.query("StartDate", SrcFile)
                                                                rcs!EndDate = objxml.query("EndDate", SrcFile)
                                                                rcs!Createdate = Now
                                                        rcs.Update
                                                        rcs.Close
                                                        conn.Close
                                                ...
                                                ElseIf objxml.GetRootName = "MonthlyPayment" And objxml.GetStatus = "Partner" Then
                                                        ...
                                                        rcs.AddNew
                                                                ...
                                                                rcs!Startdate = objxml.query("StartDate", SrcFile)
                                                                rcs!EndDate = objxml.query("EndDate", SrcFile)
                                                                rcs!Partner = objxml.query("Partner", SrcFile)
                                                                rcs!Createdate = Now
                                                        rcs.Update
                                                        rcs.Close
                                                        conn.Close
