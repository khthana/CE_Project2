...
Public Function SendXMLAll(ByVal SrcFile As String) As String
        ...
        ElseIf Userid = "" Then
                        MsgBox "Please Set UserID Before Send XML file", vbExclamation + vbOKOnly
        Else
                        ...
                        'If optSha1.value Then
                                Sha1SignFile MarketID, MarketID, datestr, SrcFile, dest(1), UseKey, N
...
Public Function EncryptFileOnly(ByVal SrcFile As String) As String
        If PrivateKeyFile = "" Then
                        MsgBox "Please Select Private Key File in Setting Key Ring Beffore Send XML file", vbExclamation + vbOKOnly
        ElseIf Userid = "" Then
                        MsgBox "Please Set UserID Before Send XML file", vbExclamation + vbOKOnly
        Else
                        ...
                        On Error GoTo msgerr:
                         ...
                         If fso.FileExists(SrcFile) Then
                                ...
                                'FileName = dest
                                flag = True
                                EncryptFileOnly = dest
                        End If
                        Set fso = Nothing
        End If
Exit Function
msgerr:
        Message "Encrypt Transaction File Error"
        EncryptFileOnly = ""
End Function
