...
<br>
<br>
</font> <img src="images/BuyerRegistration.gif" width="1003" height="110" usemap="#Map" border="0"> 
<map name="Map">
  <area shape="rect" coords="880,88,987,113" href="home.asp">
</map>
...
จำเป็นต้องใส่ </font></font> <font color="#FF0000"><br>
</font></font> 
<form name="form1" method="post" action="AddMember.asp" enctype="multipart/form-data"  >
