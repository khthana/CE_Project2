...
<p>&nbsp;</p>
<img src="images/POStatusForSeller.gif" width="1003" height="110" usemap="#Map" border="0"> 
<map name="Map">
  <area shape="rect" coords="710,89,777,117" href="sellerInvoiceStatus.asp">
  <area shape="rect" coords="800,86,886,121" href="MainMenu.asp">
  <area shape="rect" coords="917,88,1023,126" href="Signout.asp">
</map>
<br>
<br>
<%
...
sql="Select  * From PO,PR  Where   PO.PRID=PR.PRID  AND PONo Like '%"&PONO&"%'  AND SellerID="&session("BuyerID")
...
rsPO.moveFirst
%>
<form name="PO" method="post" action="SellerPOStatus.asp" >
  <table width="864" border="0" cellspacing="0" cellpadding="0" height="55" >
    <tr> 
      <td width="53">&nbsp;</td>
      <td width="417">
<table width="94%" border="0" height="100%" align="center">
          <tr> 
            <td height="135"><font face="MS Sans Serif, Microsoft Sans Serif"><b></b></font> 
              <table width="85%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td> 
                    <div align="left"><font face="MS Sans Serif, Microsoft Sans Serif"><b><font color="993366"><%=session("BizName")%></font></b></font></div>
                  </td>
                </tr>
              </table>
              <font face="MS Sans Serif, Microsoft Sans Serif"><b><br>
              </b></font><b>มี P.O. เข้ามาทั้งสิ้นจำนวน 
              <%
		sql="Select  count(*) From PO,PR  Where  PO.PRID=PR.PRID AND  SellerID="&session("BuyerID")
		Set rs=conn.Execute(sql,,CmdText)
		response.write(rs(0))
		rs.close
		
		%>
              ใบ<font face="m"> มีสถานะดังนี้</font><font face="MS Sans Serif, Microsoft Sans Serif"><font face="m"><br>
              <br>
              </font> </font> </b>
              <table width="99%" border="0" cellspacing="0" cellpadding="0" align="left">
                <tr> 
                  <td width="32%" height="30"><b>Received 
                    <%
		sql="Select  count(*) From PO,PR  Where  PR.PRID=PO.PRID AND   POStatus='received' AND SellerID="&session("BuyerID")
		Set rs=conn.Execute(sql,,CmdText)
		response.write(rs(0))
		rs.close
		%>
                    </b></td>
                  <td width="34%" height="30"><b>Accepted 
                    <%
		sql="Select  count(*) From PO,PR  Where  PR.PRID=PO.PRID AND   POStatus='accepted' AND SellerID="&session("BuyerID")
		Set rs=conn.Execute(sql,,CmdText)
		response.write(rs(0))
		rs.close
		%>
                    </b></td>
                  <td width="34%" height="30"><b>Rejected 
                    <%
		sql="Select  count(*) From PO,PR  Where  PR.PRID=PO.PRID AND   POStatus='rejected' AND SellerID="&session("BuyerID")
		Set rs=conn.Execute(sql,,CmdText)
		response.write(rs(0))
		rs.close
		%>
                ...
                <tr> 
                  <td width="32%" height="30"><b>Delivered 
                    <%
		sql="Select  count(*) From PO,PR  Where  PR.PRID=PO.PRID AND   POStatus='delivered' AND SellerID="&session("BuyerID")
		Set rs=conn.Execute(sql,,CmdText)
		response.write(rs(0))
		rs.close
		%>
                    </b></td>
                  <td colspan="2" height="30"><b>Partially Delivered 
                    <%
		sql="Select  count(*) From PO,PR  Where  PR.PRID=PO.PRID AND   POStatus='partially delivered' AND SellerID="&session("BuyerID")
		Set rs=conn.Execute(sql,,CmdText)
		response.write(rs(0))
		rs.close
		%>
      ...
      <td bgcolor="#FFFAEC" width="394"> 
        <table width="100%" border="1" height="159" bordercolor="#FFFAEC">
          <tr> 
            <td height="17"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="DF0070">Purchase 
              Order Search </font></b></td>
          </tr>
          <tr>
            <td height="117" bordercolor="#0000CC" bgcolor="#D5ECFD"> 
              <table width="100%" border="0" cellpadding="0" cellspacing="1" dwcopytype="CopyTableRow" align="center" height="43%" bordercolor="#0000CC">
                <tr bordercolor="#FFFFFF" bgcolor="#D5ECFD"> 
                  <td width="91" height="30"><font size="-1" face="MS Sans Serif, Microsoft Sans Serif">&nbsp;&nbsp;&nbsp;<b>P.O. 
                    No.</b></font></td>
                  <td width="227" height="30"> <font size="-1" face="MS Sans Serif, Microsoft Sans Serif"> 
                ...
                <tr bordercolor="#FFFFFF" bgcolor="#D5ECFD"> 
                  <td width="91" height="30"><font face="MS Sans Serif, Microsoft Sans Serif" size="-1"></font></td>
                  <td width="227" height="30"><font size="-1" face="MS Sans Serif, Microsoft Sans Serif"> 
  ...
  <br>
  <table width="859" border="0" cellpadding="1" cellspacing="0">
    <tr> 
      <td width="63" height="4"><font face="MS Sans Serif, Microsoft Sans Serif"></font></td>
      <td width="512" height="35"><font face="MS Sans Serif, Microsoft Sans Serif"><b><font color="993366">Purchase 
        Order</font> <font color="#0000CC">
        <%response.write "<br>"&SearchResult%>
        </font></b></font></td>
      <td height="4" width="278"> 
      ...
      <td height="69" colspan="2"> 
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
          <tr bgcolor="#6601C8"> 
            ...
            <td width="212"> 
              <div align="center"><font size="-1"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#FFFFFF">ชื่อผู้สั่งของ<br>
                <font size="-2">SOLD TO</font></font></b></font></div>
            </td>
            <td width="83" height="26"> 
              <div align="center"><font face="Microsoft Sans Serif" size="-1"><b><font color="#FFFFFF">จำนวนบรรทััด<br>
                <font size="-2">LINE</font></font></b></font></div>
            </td>
            ...
            <td width="66"> 
              <div align="center"><font size="-1"><b><font face="MS Sans Serif, Microsoft Sans Serif" color="#FFFFFF">Order 
                No. </font></b></font></div>
            </td>
            <td width="85"> 
	...
	'	  end if
          ...
          <tr> 
            <td width="57" height="28"> 
			  ...
			  if rsPO("POStatus")="received" then%>
            ...
            <td width="66" height="28"> 
              <div align="center"><font face="Microsoft Sans Serif" size="-1"><%=rsPO("SellerOrderNo")%></font></div>
            </td>
...
function Arrange(){
	...
	case "1" :	location.href ="SellerPOStatus.asp?order=POFullDate&PONo=<%=PONo%>&POStatus=<%=POStatus%>&PODate=<%=PODate%>&POMonth=<%=POMonth%>&POYear=<%=POYear%>";  
	case "2":	location.href ="SellerPOStatus.asp?order=SellerOrderNo&PONo=<%=PONo%>&POStatus=<%=POStatus%>&PODate=<%=PODate%>&POMonth=<%=POMonth%>&POYear=<%=POYear%>";  
	case "3":	location.href ="SellerPOStatus.asp?order=PONo&PONo=<%=PONo%>&POStatus=<%=POStatus%>&PODate=<%=PODate%>&POMonth=<%=POMonth%>&POYear=<%=POYear%>"; 
	case "4":	location.href ="SellerPOStatus.asp?order=POID&PONo=<%=PONo%>&POStatus=<%=POStatus%>&PODate=<%=PODate%>&POMonth=<%=POMonth%>&POYear=<%=POYear%>";  
	case "6":	location.href ="SellerPOStatus.asp?order=POStatus&PONo=<%=PONo%>&POStatus=<%=POStatus%>&PODate=<%=PODate%>&POMonth=<%=POMonth%>&POYear=<%=POYear%>";  
	case "7":	location.href ="SellerPOStatus.asp?order=PRTotal Desc&PONo=<%=PONo%>&POStatus=<%=POStatus%>&PODate=<%=PODate%>&POMonth=<%=POMonth%>&POYear=<%=POYear%>";  
		}
	}
