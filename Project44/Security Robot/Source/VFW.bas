...
Public Const CONTROLCALLBACK_PREROLL   As Long = 1      '/* Waiting to start capture */
Public Const CONTROLCALLBACK_CAPTURING As Long = 2      '/* Now capturing */
...
End Function
Function capGetVideoFormat(ByVal hCapWnd As Long, ByRef BmpFormat As BITMAPINFO) As Long
   capGetVideoFormat = SendMessageAsAny(hCapWnd, WM_CAP_GET_VIDEOFORMAT, Len(BmpFormat), BmpFormat)
End Function
...
End Function
Function capSetVideoFormat(ByVal hCapWnd As Long, ByRef BmpFormat As BITMAPINFO) As Boolean
   capSetVideoFormat = SendMessageAsAny(hCapWnd, WM_CAP_SET_VIDEOFORMAT, Len(BmpFormat), BmpFormat)
End Function
