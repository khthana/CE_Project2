...
begin
  ...
  begin
    {if (not FMouseInControl)and DEFAULTINTERFACE then
    begin
      Canvas.Brush.Color := NewColor(Canvas, clHighLight, 68);;//Color;
    ...
    begin
      ...
      begin
        ...
        Canvas.RoundRect(PaintRect.Left,PaintRect.Top,PaintRect.Right,PaintRect.Bottom,5,5);
        Canvas.Brush.Color := NewColor(Canvas, clHighLight, 68);
        Canvas.Brush.Style := bsSolid;
        Canvas.FillRect(Rect(PaintRect.Left+2,PaintRect.Top+2,PaintRect.Right-2,PaintRect.Bottom-2));
      end
      else
      begin
    ...
    begin
      Canvas.Brush.Color := clHighlight;//Color;
//      Canvas.RoundRect(PaintRect.Left,PaintRect.Top,PaintRect.Right,PaintRect.Bottom,5,5);
//      Canvas.FillRect(PaintRect);
  ...
  begin
    ...
    begin
      ...
      if not DEFAULTINTERFACE then
      begin
        Canvas.Brush.Style := bsSolid;
        Canvas.Brush.Color := NewColor(Canvas, clBlue, 50);;//Color;
        Canvas.FillRect(PaintRect);
      end
      else
      begin
        Canvas.Brush.Style := bsClear;
        Canvas.RoundRect(PaintRect.Left,PaintRect.Top,PaintRect.Right,PaintRect.Bottom,5,5);
        Canvas.Brush.Color := NewColor(Canvas, clHighLight, 50);
        Canvas.Brush.Style := bsSolid;
        Canvas.FillRect(Rect(PaintRect.Left+2,PaintRect.Top+2,PaintRect.Right-2,PaintRect.Bottom-2));
      end;
      InflateRect(PaintRect, -1, -1);
