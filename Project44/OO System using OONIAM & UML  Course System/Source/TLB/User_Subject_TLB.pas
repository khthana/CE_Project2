...
// File generated on 26/2/2002 23:00:36 from Type Library described below.

// ************************************************************************  //
// Type Lib: E:\Projects\Program\TLB\User_Subject.tlb (1)
// LIBID: {EF710C36-DBC6-4DC1-9B26-2C859C394B2A}
// LCID: 0
// Helpfile: 
// DepndLst: 
...
// Errors:
//   Error creating palette bitmap of (TSubject) : Registry key CLSID\{A7379133-8300-4668-A69A-847061B10E87}\ToolboxBitmap32 not found
// ************************************************************************ //
// *************************************************************************//
// NOTE:                                                                      
...
const
  ...
  User_SubjectMajorVersion = 1;
  User_SubjectMinorVersion = 0;

  LIBID_User_Subject: TGUID = '{EF710C36-DBC6-4DC1-9B26-2C859C394B2A}';

  DIID_CSubject: TGUID = '{735A1928-FD61-4D05-B837-3CB5756EDE7F}';
  CLASS_Subject: TGUID = '{A7379133-8300-4668-A69A-847061B10E87}';
type

// *********************************************************************//
// Forward declaration of types defined in TypeLibrary                    
// *********************************************************************//
  CSubject = dispinterface;
...
// GUID:      {735A1928-FD61-4D05-B837-3CB5756EDE7F}
// *********************************************************************//
  CSubject = dispinterface
    ['{735A1928-FD61-4D05-B837-3CB5756EDE7F}']
      {735A1928-FD61-4D05-B837-3CB5756EDE7F}
...
// Control Name     : TSubject
// Help String      : Cache Object: User.Subject CoClass
// Default Interface: CSubject
// Def. Intf. DISP? : Yes
// Event   Interface: 
// TypeFlags        : (34) CanCreate Control
// *********************************************************************//
  TSubject = class(TOleControl)
  private
    FIntf: CSubject;
    function  GetControlInterface: CSubject;
  protected
  ...
  public
    ...
    property  ControlInterface: CSubject read GetControlInterface;
    property  DefaultInterface: CSubject read GetControlInterface;
...
procedure TSubject.InitControlData;
const
  CControlData: TControlData2 = (
    ClassID: '{A7379133-8300-4668-A69A-847061B10E87}';
    EventIID: '';
    EventCount: 0;
    EventDispIDs: nil;
...
procedure TSubject.CreateControl;

  procedure DoCreate;
  begin
    FIntf := IUnknown(OleObject) as CSubject;
  end;
...
function TSubject.GetControlInterface: CSubject;
begin
  CreateControl;
  Result := FIntf;
end;

function TSubject.Get_English: IDispatch;
begin
  Result := DefaultInterface.English;
end;

procedure TSubject.Set_English(const Value: IDispatch);
begin
  DefaultInterface.English := Value;
end;

function TSubject.Get_IsOf: IDispatch;
begin
  Result := DefaultInterface.IsOf;
end;

procedure TSubject.Set_IsOf(const Value: IDispatch);
begin
  DefaultInterface.IsOf := Value;
end;

function TSubject.Get_PossibleGrades: IDispatch;
begin
  Result := DefaultInterface.PossibleGrades;
end;

procedure TSubject.Set_PossibleGrades(const Value: IDispatch);
begin
  DefaultInterface.PossibleGrades := Value;
end;

function TSubject.Get_Prerequisites: IDispatch;
begin
  Result := DefaultInterface.Prerequisites;
end;

procedure TSubject.Set_Prerequisites(const Value: IDispatch);
begin
  DefaultInterface.Prerequisites := Value;
end;

function TSubject.Get_Status: OleVariant;
begin
  Result := DefaultInterface.Status;
end;

procedure TSubject.Set_Status(Value: OleVariant);
begin
  DefaultInterface.Status := Value;
end;

function TSubject.Get_SubCourses: IDispatch;
begin
  Result := DefaultInterface.SubCourses;
end;

procedure TSubject.Set_SubCourses(const Value: IDispatch);
begin
  DefaultInterface.SubCourses := Value;
end;

function TSubject.Get_Thai: IDispatch;
begin
  Result := DefaultInterface.Thai;
end;

procedure TSubject.Set_Thai(const Value: IDispatch);
begin
  DefaultInterface.Thai := Value;
end;

function TSubject.SYS_BuildIndices(const idxlist: IDispatch): OleVariant;
begin
  Result := DefaultInterface.SYS_BuildIndices(idxlist);
end;

function TSubject.SYS_CheckUnique(const idxlist: IDispatch): OleVariant;
begin
  Result := DefaultInterface.SYS_CheckUnique(idxlist);
end;

function TSubject.SYS_ClassName(fullname: OleVariant): WideString;
begin
  Result := DefaultInterface.SYS_ClassName(fullname);
end;

function TSubject.SYS_Close: OleVariant;
begin
  Result := DefaultInterface.SYS_Close;
end;

function TSubject.SYS_Delete(oid: OleVariant; concurrency: Integer): OleVariant;
begin
  Result := DefaultInterface.SYS_Delete(oid, concurrency);
end;

function TSubject.SYS_DeleteExtent(concurrency: Integer; var deletecount: WideString; 
                                   var instancecount: WideString): OleVariant;
begin
  Result := DefaultInterface.SYS_DeleteExtent(concurrency, deletecount, instancecount);
end;

function TSubject.SYS_DeleteId(const id: WideString; concurrency: Integer): OleVariant;
begin
  Result := DefaultInterface.SYS_DeleteId(id, concurrency);
end;

function TSubject.SYS_DowngradeConcurrency(const concurrency: WideString): OleVariant;
begin
  Result := DefaultInterface.SYS_DowngradeConcurrency(concurrency);
end;

function TSubject.SYS_Exists(oid: OleVariant): OleVariant;
begin
  Result := DefaultInterface.SYS_Exists(oid);
end;

function TSubject.SYS_ExistsId(const id: WideString): OleVariant;
begin
  Result := DefaultInterface.SYS_ExistsId(id);
end;

function TSubject.SYS_GetSwizzleObject(force: Integer; var oid: OleVariant): OleVariant;
begin
  Result := DefaultInterface.SYS_GetSwizzleObject(force, oid);
end;

function TSubject.SYS_Id: WideString;
begin
  Result := DefaultInterface.SYS_Id;
end;

procedure TSubject.SYS_IncrementCount;
begin
  DefaultInterface.SYS_IncrementCount;
end;

function TSubject.SYS_IsA(const isclass: WideString): Integer;
begin
  Result := DefaultInterface.SYS_IsA(isclass);
end;

function TSubject.SYS_IsModified: Integer;
begin
  Result := DefaultInterface.SYS_IsModified;
end;

function TSubject.SYS_KillExtent: OleVariant;
begin
  Result := DefaultInterface.SYS_KillExtent;
end;

function TSubject.SYS_New(const initvalue: WideString): IDispatch;
begin
  Result := DefaultInterface.SYS_New(initvalue);
end;

function TSubject.SYS_NormalizeObject: OleVariant;
begin
  Result := DefaultInterface.SYS_NormalizeObject;
end;

function TSubject.SYS_Oid: OleVariant;
begin
  Result := DefaultInterface.SYS_Oid;
end;

function TSubject.SYS_Open(oid: OleVariant; concurrency: Integer): WideString;
begin
  Result := DefaultInterface.SYS_Open(oid, concurrency);
end;

function TSubject.SYS_OpenId(const id: WideString; concurrency: Integer): WideString;
begin
  Result := DefaultInterface.SYS_OpenId(id, concurrency);
end;

function TSubject.SYS_PackageName: WideString;
begin
  Result := DefaultInterface.SYS_PackageName;
end;

function TSubject.SYS_PurgeIndices(const idxlist: IDispatch): OleVariant;
begin
  Result := DefaultInterface.SYS_PurgeIndices(idxlist);
end;

function TSubject.SYS_RollBack: OleVariant;
begin
  Result := DefaultInterface.SYS_RollBack;
end;

function TSubject.SYS_Save(related: Integer): OleVariant;
begin
  Result := DefaultInterface.SYS_Save(related);
end;

function TSubject.SYS_SortBegin(const idxlist: IDispatch; excludeunique: Integer): OleVariant;
begin
  Result := DefaultInterface.SYS_SortBegin(idxlist, excludeunique);
end;

function TSubject.SYS_SortEnd(const idxlist: IDispatch; commit: Integer): OleVariant;
begin
  Result := DefaultInterface.SYS_SortEnd(idxlist, commit);
end;

function TSubject.SYS_UpgradeConcurrency(const concurrency: WideString): OleVariant;
begin
  Result := DefaultInterface.SYS_UpgradeConcurrency(concurrency);
end;

function TSubject.SYS_ValidateObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.SYS_ValidateObject(force);
end;

function TSubject.CheckDependency: OleVariant;
begin
  Result := DefaultInterface.CheckDependency;
end;

function TSubject.Credit1DisplayToLogical(const SYS_val: WideString): Double;
begin
  Result := DefaultInterface.Credit1DisplayToLogical(SYS_val);
end;

function TSubject.Credit1Get: Double;
begin
  Result := DefaultInterface.Credit1Get;
end;

function TSubject.Credit1IsModified: Integer;
begin
  Result := DefaultInterface.Credit1IsModified;
end;

function TSubject.Credit1IsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.Credit1IsValid(value);
end;

function TSubject.Credit1IsValidDT(SYS_val: Double): Integer;
begin
  Result := DefaultInterface.Credit1IsValidDT(SYS_val);
end;

function TSubject.Credit1LogicalToDisplay(SYS_val: Double): WideString;
begin
  Result := DefaultInterface.Credit1LogicalToDisplay(SYS_val);
end;

function TSubject.Credit1Normalize(const SYS_val: WideString): Double;
begin
  Result := DefaultInterface.Credit1Normalize(SYS_val);
end;

function TSubject.Credit1Set(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.Credit1Set(newvalue);
end;

function TSubject.Credit1SetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.Credit1SetModified(newvalue);
end;

function TSubject.Credit2DisplayToLogical(const SYS_val: WideString): Double;
begin
  Result := DefaultInterface.Credit2DisplayToLogical(SYS_val);
end;

function TSubject.Credit2Get: Double;
begin
  Result := DefaultInterface.Credit2Get;
end;

function TSubject.Credit2IsModified: Integer;
begin
  Result := DefaultInterface.Credit2IsModified;
end;

function TSubject.Credit2IsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.Credit2IsValid(value);
end;

function TSubject.Credit2IsValidDT(SYS_val: Double): Integer;
begin
  Result := DefaultInterface.Credit2IsValidDT(SYS_val);
end;

function TSubject.Credit2LogicalToDisplay(SYS_val: Double): WideString;
begin
  Result := DefaultInterface.Credit2LogicalToDisplay(SYS_val);
end;

function TSubject.Credit2Normalize(const SYS_val: WideString): Double;
begin
  Result := DefaultInterface.Credit2Normalize(SYS_val);
end;

function TSubject.Credit2Set(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.Credit2Set(newvalue);
end;

function TSubject.Credit2SetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.Credit2SetModified(newvalue);
end;

function TSubject.CreditDisplayToLogical(const SYS_val: WideString): Double;
begin
  Result := DefaultInterface.CreditDisplayToLogical(SYS_val);
end;

function TSubject.CreditGet: Double;
begin
  Result := DefaultInterface.CreditGet;
end;

function TSubject.CreditIsModified: Integer;
begin
  Result := DefaultInterface.CreditIsModified;
end;

function TSubject.CreditIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.CreditIsValid(value);
end;

function TSubject.CreditIsValidDT(SYS_val: Double): Integer;
begin
  Result := DefaultInterface.CreditIsValidDT(SYS_val);
end;

function TSubject.CreditLogicalToDisplay(SYS_val: Double): WideString;
begin
  Result := DefaultInterface.CreditLogicalToDisplay(SYS_val);
end;

function TSubject.CreditNormalize(const SYS_val: WideString): Double;
begin
  Result := DefaultInterface.CreditNormalize(SYS_val);
end;

function TSubject.CreditSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.CreditSet(newvalue);
end;

function TSubject.CreditSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.CreditSetModified(newvalue);
end;

function TSubject.DeleteTagDisplayToLogical(const SYS_val: WideString): Integer;
begin
  Result := DefaultInterface.DeleteTagDisplayToLogical(SYS_val);
end;

function TSubject.DeleteTagGet: Integer;
begin
  Result := DefaultInterface.DeleteTagGet;
end;

function TSubject.DeleteTagIsModified: Integer;
begin
  Result := DefaultInterface.DeleteTagIsModified;
end;

function TSubject.DeleteTagIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.DeleteTagIsValid(value);
end;

function TSubject.DeleteTagIsValidDT(SYS_val: Integer): Integer;
begin
  Result := DefaultInterface.DeleteTagIsValidDT(SYS_val);
end;

function TSubject.DeleteTagLogicalToDisplay(SYS_val: Integer): WideString;
begin
  Result := DefaultInterface.DeleteTagLogicalToDisplay(SYS_val);
end;

function TSubject.DeleteTagNormalize(const SYS_val: WideString): Integer;
begin
  Result := DefaultInterface.DeleteTagNormalize(SYS_val);
end;

function TSubject.DeleteTagSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.DeleteTagSet(newvalue);
end;

function TSubject.DeleteTagSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.DeleteTagSetModified(newvalue);
end;

function TSubject.EnglishGet: IDispatch;
begin
  Result := DefaultInterface.EnglishGet;
end;

function TSubject.EnglishGetObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.EnglishGetObject(force);
end;

function TSubject.EnglishGetObjectId(force: Integer): WideString;
begin
  Result := DefaultInterface.EnglishGetObjectId(force);
end;

function TSubject.EnglishIsModified: Integer;
begin
  Result := DefaultInterface.EnglishIsModified;
end;

function TSubject.EnglishIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.EnglishIsValid(value);
end;

function TSubject.EnglishNewObject: IDispatch;
begin
  Result := DefaultInterface.EnglishNewObject;
end;

function TSubject.EnglishSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.EnglishSet(newvalue);
end;

function TSubject.EnglishSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.EnglishSetModified(newvalue);
end;

function TSubject.EnglishSetObject(newvalue: OleVariant): OleVariant;
begin
  Result := DefaultInterface.EnglishSetObject(newvalue);
end;

function TSubject.EnglishSetObjectId(const newid: WideString): OleVariant;
begin
  Result := DefaultInterface.EnglishSetObjectId(newid);
end;

function TSubject.ExtSubjectIDDisplayToLogical(const SYS_val: WideString): WideString;
begin
  Result := DefaultInterface.ExtSubjectIDDisplayToLogical(SYS_val);
end;

function TSubject.ExtSubjectIDGet: WideString;
begin
  Result := DefaultInterface.ExtSubjectIDGet;
end;

function TSubject.ExtSubjectIDIsModified: Integer;
begin
  Result := DefaultInterface.ExtSubjectIDIsModified;
end;

function TSubject.ExtSubjectIDIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.ExtSubjectIDIsValid(value);
end;

function TSubject.ExtSubjectIDIsValidDT(const SYS_val: WideString): Integer;
begin
  Result := DefaultInterface.ExtSubjectIDIsValidDT(SYS_val);
end;

function TSubject.ExtSubjectIDLogicalToDisplay(const SYS_val: WideString): WideString;
begin
  Result := DefaultInterface.ExtSubjectIDLogicalToDisplay(SYS_val);
end;

function TSubject.ExtSubjectIDNormalize(const SYS_val: WideString): WideString;
begin
  Result := DefaultInterface.ExtSubjectIDNormalize(SYS_val);
end;

function TSubject.ExtSubjectIDSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.ExtSubjectIDSet(newvalue);
end;

function TSubject.ExtSubjectIDSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.ExtSubjectIDSetModified(newvalue);
end;

function TSubject.ExtentClose(qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.ExtentClose(qHandle);
end;

function TSubject.ExtentExecute(var qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.ExtentExecute(qHandle);
end;

function TSubject.ExtentFetch(var qHandle: OleVariant; var Row: IDispatch; var AtEnd: Integer): OleVariant;
begin
  Result := DefaultInterface.ExtentFetch(qHandle, Row, AtEnd);
end;

function TSubject.ExtentFetchRows(var qHandle: OleVariant; FetchCount: Integer; 
                                  var RowSet: IDispatch; var ReturnCount: Integer; 
                                  var AtEnd: Integer): OleVariant;
begin
...
function TSubject.ExtentGetInfo(var colinfo: IDispatch; var parminfo: IDispatch; 
                                var idinfo: IDispatch; var qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.ExtentGetInfo(colinfo, parminfo, idinfo, qHandle);
end;

function TSubject.ExtentPrepare(var qHandle: OleVariant; const statement: WideString; 
                                containid: Integer; const optional: WideString): OleVariant;
begin
  Result := DefaultInterface.ExtentPrepare(qHandle, statement, containid, optional);
end;

function TSubject.GetClassName: WideString;
begin
  Result := DefaultInterface.GetClassName;
end;

function TSubject.GetParentClass: WideString;
begin
  Result := DefaultInterface.GetParentClass;
end;

function TSubject.IsOfGet: IDispatch;
begin
  Result := DefaultInterface.IsOfGet;
end;

function TSubject.IsOfGetObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.IsOfGetObject(force);
end;

function TSubject.IsOfGetObjectId(force: Integer): WideString;
begin
  Result := DefaultInterface.IsOfGetObjectId(force);
end;

function TSubject.IsOfIsModified: Integer;
begin
  Result := DefaultInterface.IsOfIsModified;
end;

function TSubject.IsOfIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.IsOfIsValid(value);
end;

function TSubject.IsOfNewObject: IDispatch;
begin
  Result := DefaultInterface.IsOfNewObject;
end;

function TSubject.IsOfSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.IsOfSet(newvalue);
end;

function TSubject.IsOfSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.IsOfSetModified(newvalue);
end;

function TSubject.IsOfSetObject(newvalue: OleVariant): OleVariant;
begin
  Result := DefaultInterface.IsOfSetObject(newvalue);
end;

function TSubject.IsOfSetObjectId(const newid: WideString): OleVariant;
begin
  Result := DefaultInterface.IsOfSetObjectId(newid);
end;

function TSubject.PossibleGradesGet: IDispatch;
begin
  Result := DefaultInterface.PossibleGradesGet;
end;

function TSubject.PossibleGradesGetObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.PossibleGradesGetObject(force);
end;

function TSubject.PossibleGradesGetObjectId(force: Integer): WideString;
begin
  Result := DefaultInterface.PossibleGradesGetObjectId(force);
end;

function TSubject.PossibleGradesIsModified: Integer;
begin
  Result := DefaultInterface.PossibleGradesIsModified;
end;

function TSubject.PossibleGradesNewObject: IDispatch;
begin
  Result := DefaultInterface.PossibleGradesNewObject;
end;

function TSubject.PossibleGradesSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.PossibleGradesSet(newvalue);
end;

function TSubject.PossibleGradesSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.PossibleGradesSetModified(newvalue);
end;

procedure TSubject.PrepareDeleting;
begin
  DefaultInterface.PrepareDeleting;
end;

function TSubject.PrerequisitesGet: IDispatch;
begin
  Result := DefaultInterface.PrerequisitesGet;
end;

function TSubject.PrerequisitesGetObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.PrerequisitesGetObject(force);
end;

function TSubject.PrerequisitesGetObjectId(force: Integer): WideString;
begin
  Result := DefaultInterface.PrerequisitesGetObjectId(force);
end;

function TSubject.PrerequisitesIsModified: Integer;
begin
  Result := DefaultInterface.PrerequisitesIsModified;
end;

function TSubject.PrerequisitesNewObject: IDispatch;
begin
  Result := DefaultInterface.PrerequisitesNewObject;
end;

function TSubject.PrerequisitesSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.PrerequisitesSet(newvalue);
end;

function TSubject.PrerequisitesSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.PrerequisitesSetModified(newvalue);
end;

function TSubject.QueryIsOfClose(qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.QueryIsOfClose(qHandle);
end;

function TSubject.QueryIsOfExecute(var qHandle: OleVariant; const deptid: IDispatch): OleVariant;
begin
  Result := DefaultInterface.QueryIsOfExecute(qHandle, deptid);
end;

function TSubject.QueryIsOfFetch(var qHandle: OleVariant; var Row: IDispatch; var AtEnd: Integer): OleVariant;
begin
  Result := DefaultInterface.QueryIsOfFetch(qHandle, Row, AtEnd);
end;

function TSubject.QueryIsOfFetchODBC(var qHandle: OleVariant; var SYS_d: WideString; 
                                     SYS_qacn: Integer; var AtEnd: Integer; var SQLCODE: Integer): OleVariant;
begin
  Result := DefaultInterface.QueryIsOfFetchODBC(qHandle, SYS_d, SYS_qacn, AtEnd, SQLCODE);
end;

function TSubject.QueryIsOfFetchRows(var qHandle: OleVariant; FetchCount: Integer; 
                                     var RowSet: IDispatch; var ReturnCount: Integer; 
                                     var AtEnd: Integer): OleVariant;
begin
...
function TSubject.QueryIsOfGetInfo(var colinfo: IDispatch; var parminfo: IDispatch; 
                                   var idinfo: IDispatch; var qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.QueryIsOfGetInfo(colinfo, parminfo, idinfo, qHandle);
end;

function TSubject.QueryIsOfPrepare(var qHandle: OleVariant; const statement: WideString; 
                                   containid: Integer; const optional: WideString): OleVariant;
begin
  Result := DefaultInterface.QueryIsOfPrepare(qHandle, statement, containid, optional);
end;

function TSubject.QuerySelectClose(qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.QuerySelectClose(qHandle);
end;

function TSubject.QuerySelectExecute(var qHandle: OleVariant; const x: WideString): OleVariant;
begin
  Result := DefaultInterface.QuerySelectExecute(qHandle, x);
end;

function TSubject.QuerySelectFetch(var qHandle: OleVariant; var Row: IDispatch; var AtEnd: Integer): OleVariant;
begin
  Result := DefaultInterface.QuerySelectFetch(qHandle, Row, AtEnd);
end;

function TSubject.QuerySelectFetchODBC(var qHandle: OleVariant; var SYS_d: WideString; 
                                       SYS_qacn: Integer; var AtEnd: Integer; var SQLCODE: Integer): OleVariant;
begin
  Result := DefaultInterface.QuerySelectFetchODBC(qHandle, SYS_d, SYS_qacn, AtEnd, SQLCODE);
end;

function TSubject.QuerySelectFetchRows(var qHandle: OleVariant; FetchCount: Integer; 
                                       var RowSet: IDispatch; var ReturnCount: Integer; 
                                       var AtEnd: Integer): OleVariant;
begin
...
function TSubject.QuerySelectGetInfo(var colinfo: IDispatch; var parminfo: IDispatch; 
                                     var idinfo: IDispatch; var qHandle: OleVariant): OleVariant;
begin
  Result := DefaultInterface.QuerySelectGetInfo(colinfo, parminfo, idinfo, qHandle);
end;

function TSubject.QuerySelectPrepare(var qHandle: OleVariant; const statement: WideString; 
                                     containid: Integer; const optional: WideString): OleVariant;
begin
  Result := DefaultInterface.QuerySelectPrepare(qHandle, statement, containid, optional);
end;

function TSubject.StatusDisplayToLogical(const SYS_val: WideString): OleVariant;
begin
  Result := DefaultInterface.StatusDisplayToLogical(SYS_val);
end;

function TSubject.StatusGet: OleVariant;
begin
  Result := DefaultInterface.StatusGet;
end;

function TSubject.StatusIsModified: Integer;
begin
  Result := DefaultInterface.StatusIsModified;
end;

function TSubject.StatusIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.StatusIsValid(value);
end;

function TSubject.StatusIsValidDT(SYS_val: OleVariant): Integer;
begin
  Result := DefaultInterface.StatusIsValidDT(SYS_val);
end;

function TSubject.StatusLogicalToDisplay(SYS_val: OleVariant): WideString;
begin
  Result := DefaultInterface.StatusLogicalToDisplay(SYS_val);
end;

function TSubject.StatusNormalize(const SYS_val: WideString): Integer;
begin
  Result := DefaultInterface.StatusNormalize(SYS_val);
end;

function TSubject.StatusSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.StatusSet(newvalue);
end;

function TSubject.StatusSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.StatusSetModified(newvalue);
end;

function TSubject.SubCoursesGet: IDispatch;
begin
  Result := DefaultInterface.SubCoursesGet;
end;

function TSubject.SubCoursesGetObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.SubCoursesGetObject(force);
end;

function TSubject.SubCoursesGetObjectId(force: Integer): WideString;
begin
  Result := DefaultInterface.SubCoursesGetObjectId(force);
end;

function TSubject.SubCoursesIsModified: Integer;
begin
  Result := DefaultInterface.SubCoursesIsModified;
end;

function TSubject.SubCoursesNewObject: IDispatch;
begin
  Result := DefaultInterface.SubCoursesNewObject;
end;

function TSubject.SubCoursesSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.SubCoursesSet(newvalue);
end;

function TSubject.SubCoursesSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.SubCoursesSetModified(newvalue);
end;

function TSubject.SubjectLevelDisplayToLogical(const SYS_val: WideString): Integer;
begin
  Result := DefaultInterface.SubjectLevelDisplayToLogical(SYS_val);
end;

function TSubject.SubjectLevelGet: Integer;
begin
  Result := DefaultInterface.SubjectLevelGet;
end;

function TSubject.SubjectLevelIsModified: Integer;
begin
  Result := DefaultInterface.SubjectLevelIsModified;
end;

function TSubject.SubjectLevelIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.SubjectLevelIsValid(value);
end;

function TSubject.SubjectLevelIsValidDT(SYS_val: Integer): Integer;
begin
  Result := DefaultInterface.SubjectLevelIsValidDT(SYS_val);
end;

function TSubject.SubjectLevelLogicalToDisplay(SYS_val: Integer): WideString;
begin
  Result := DefaultInterface.SubjectLevelLogicalToDisplay(SYS_val);
end;

function TSubject.SubjectLevelNormalize(const SYS_val: WideString): Integer;
begin
  Result := DefaultInterface.SubjectLevelNormalize(SYS_val);
end;

function TSubject.SubjectLevelSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.SubjectLevelSet(newvalue);
end;

function TSubject.SubjectLevelSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.SubjectLevelSetModified(newvalue);
end;

function TSubject.ThaiGet: IDispatch;
begin
  Result := DefaultInterface.ThaiGet;
end;

function TSubject.ThaiGetObject(force: Integer): OleVariant;
begin
  Result := DefaultInterface.ThaiGetObject(force);
end;

function TSubject.ThaiGetObjectId(force: Integer): WideString;
begin
  Result := DefaultInterface.ThaiGetObjectId(force);
end;

function TSubject.ThaiIsModified: Integer;
begin
  Result := DefaultInterface.ThaiIsModified;
end;

function TSubject.ThaiIsValid(const value: WideString): OleVariant;
begin
  Result := DefaultInterface.ThaiIsValid(value);
end;

function TSubject.ThaiNewObject: IDispatch;
begin
  Result := DefaultInterface.ThaiNewObject;
end;

function TSubject.ThaiSet(const newvalue: WideString): OleVariant;
begin
  Result := DefaultInterface.ThaiSet(newvalue);
end;

function TSubject.ThaiSetModified(newvalue: Integer): Integer;
begin
  Result := DefaultInterface.ThaiSetModified(newvalue);
end;

function TSubject.ThaiSetObject(newvalue: OleVariant): OleVariant;
begin
  Result := DefaultInterface.ThaiSetObject(newvalue);
end;

function TSubject.ThaiSetObjectId(const newid: WideString): OleVariant;
begin
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TSubject]);
end;
