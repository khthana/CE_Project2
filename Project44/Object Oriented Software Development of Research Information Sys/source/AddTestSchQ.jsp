...
String msgout = "";
	...
	if (!sid.equals("")) { 
		...
		String q2 = " INSERT INTO  TEST_SCHEDULE (STD_ID,TEST_TYPE, TEST_DATE,START_TEST_TIME,END_TEST_TIME,YEAR,SEM, ROOM,RESULT)  VALUES ('"+sid+"','Q','"+date+"','"+stime+"','"+etime+"',"+acadyear+",'"+sem+"','"+room+"','No information')";
