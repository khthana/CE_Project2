...
<%
	...
	String urldb = "jdbc:db2://161.246.6.135/EXAMPLE";
	...
	String qt = " SELECT THESIS_ID FROM THESIS_INFO "+
						" WHERE STD_ID =  '"+stdid+"'";
	...
	if ( !stdname.equals("")) { 
			...
			String q2 = " SELECT   YEAR , SEM , RESULT  FROM  TEST_SCHEDULE  WHERE STD_ID = '"+stdid+"'  AND TEST_TYPE = 'T' ";
	...
	if  (!thid.equals("") )  { 
			...
			String q3 = " SELECT  TOPIC_TH  FROM  THESIS_INFO WHERE THESIS_ID = "+thid;
...
<form name="TestKnowledgeQ" action="AddTestSchT.jsp">
  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#3399FF" bgcolor="#FFFFCC">
    <tr> 
      <td bgcolor="#FFCC66"> 
          <div align="center"><font size="4"><b><font color="#0000FF" size="5">บว.วป.13 ขอสอบวิทยานิพนธ์
            </font></b></font></div>
      </td>
    </tr>
  <tr>
      <td height="27">
          <table width="100%" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr> 
              <td width="4%" height="46"><font face="Cordia New, CordiaUPC" size="4"></font></td>
              <td width="96%" height="46"> 
                <table width="100%" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td width="18%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ชื่อวิทยานิพนธ์</font></td>
                    <td width="82%"><font face="Cordia New, CordiaUPC" size="4" color="#000000"><%=topicT%></font></td>
                  </tr>
                </table>
              </td>
            </tr>
            ...
            <tr> 
              <td width="4%"><font face="Cordia New, CordiaUPC" size="4"></font></td>
              <td width="96%"> <font face="Cordia New, CordiaUPC" size="4" color="#0000FF"><b>คณะกรรมการ</b></font></td>
            </tr>
            <tr> 
              <td width="4%"><font face="Cordia New, CordiaUPC" size="4"></font></td>
              <td width="96%"> 
                <table width="100%" cellspacing="0" cellpadding="1">
                  <tr> 
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">1.</font></td>
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ชื่อ</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Ncom1">
                      </font></td>
                    <td width="7%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">สกุล</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Scom1">
                      </font></td>
                    <td width="23%"> <font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ประธาน 
                      </font></td>
                  </tr>
                  <tr> 
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">2.</font></td>
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ชื่อ</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Ncom2">
                      </font></td>
                    <td width="7%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">สกุล</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Scom2">
                      </font></td>
                    <td width="23%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">คณะกรรมการ</font></td>
                  </tr>
                  <tr> 
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">3.</font></td>
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ชื่อ</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Ncom3">
                      </font></td>
                    <td width="7%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">สกุล</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Scom3">
                      </font></td>
                    <td width="23%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">คณะกรรมการ</font></td>
                  </tr>
                  <tr> 
                    ...
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ชื่อ</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Ncom4">
                      </font></td>
                    <td width="7%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">สกุล</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Scom4">
                      </font></td>
                    <td width="23%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">คณะกรรมการ</font></td>
                  </tr>
                  <tr> 
                    ...
                    <td width="5%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">ชื่อ</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Ncom5">
                      </font></td>
                    <td width="7%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">สกุล</font></td>
                    <td width="30%"> <font face="Cordia New, CordiaUPC" size="4" color="#000000"> 
                      <input type="text" name="Scom5">
                      </font></td>
                    <td width="23%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">คณะกรรมการ</font></td>
                  </tr>
                </table>
            ...
            <tr> 
              <td width="4%" height="124"><font face="Cordia New, CordiaUPC" size="4"></font></td>
              <td width="96%" height="124"> 
                <div align="center"> 
            ...
            <tr> 
              <td width="4%" height="62"><font face="Cordia New, CordiaUPC" size="4"></font></td>
              <td width="96%" height="62"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF"></font> 
              </td>
            </tr>
            <tr> 
              <td width="4%"><font face="Cordia New, CordiaUPC" size="4"></font></td>
