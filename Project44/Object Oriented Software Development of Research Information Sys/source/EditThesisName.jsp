...
String topth		= request.getParameter("NewTopTh");
String topen		= request.getParameter("NewTopEn");
...
String msgout = "";
	...
	String q2 = " UPDATE THESIS_INFO  SET (TOPIC_TH,TOPIC_EN) = ('"+topth+"','"+topen+"')  WHERE THESIS_ID = "+thid;
