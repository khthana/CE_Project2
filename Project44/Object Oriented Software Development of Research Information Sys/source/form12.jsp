...
//	String facid=null,facn=null;
	...
	if ( !stdname.equals("")) { 
			...
			String q2 = " SELECT   YEAR , SEM , RESULT  FROM  TEST_SCHEDULE  WHERE STD_ID = '"+stdid+"'  AND TEST_TYPE = 'Q' ";
...
<form name="TestKnowledgeQ" action="AddTestSchQ.jsp">
  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#3399FF" bgcolor="#FFFFCC">
    <tr> 
      <td bgcolor="#FFCC66"> 
          <div align="center"><font size="4"><b><font color="#0000FF" size="5">บว.วป.12 
            ขอสอบวัดคุณสมบัติ</font></b></font></div>
      </td>
    </tr>
    <tr>
      <td height="27">
