...
String q2 = " SELECT THESIS_ID FROM THESIS_INFO "+
	...
	if ( (!stdname. equals("")) && (!thid.equals("")) ){ 
		...
		} //else noteacher="ไม่มีอาจารย์คุมวิทยานิพนธ์";
		}
...
<form name = "chngT" action="ChngTcontrol.jsp" >
  <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#3399FF" bgcolor="#FFFFCC">
    <tr> 
      <td bgcolor="#FFCC66"> 
        <div align="center"><font size="4"><b><font color="#0000FF" size="5">บว.วป.3 
          คำร้องขอเปลี่ยนแปลงอาจารย์ผู้ควบคุมวิทยานิพนธ์</font></b></font></div>
      </td>
    </tr>
    <tr>
      <td height="27">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr> 
              ...
              <td width="30%"> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td width="47%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">รหัสนักศึกษา</font></td>
            ...
            <tr> 
              <td width="3%">&nbsp;</td>
              <td width="30%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">อาจารย์ควบคุมวิทยานิพนธ์เดิม</font></td>
              <td width="10%"> 
            ...
            <tr> 
              <td width="3%">&nbsp;</td>
              <td width="30%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">อาจารย์ควบคุมวิทยานิพนธ์ใหม่</font></td>
              <td width="10%"> 
                <div align="right"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF">อาจารย์</font></div>
              </td>
              <td width="2%"><font face="Cordia New, CordiaUPC" size="4" color="#0000FF"></font></td>
