...
$date=date("ymd");
	...
	$max_code=mysql_db_query($dbname,"select  MAX(code) from news_data");
...
$sql2="update news_data set detail='$detail',duration='$duration' where code='$code' ";
...
//ตาราง  news_data
	$sql2= "insert into news_data (code,detail,duration)		values('$code','$detail','$duration')";
//ตารางผู้ลงประกาศ
...
?>
	...
	<META HTTP-EQUIV="REFRESH" CONTENT="3; URL=../shownews.php?Code=<?echo $code?> ">
	</head>
...
<?/*
		...
		echo "<font size=2 face='MS Sans Serif'>";
		echo "[ <a href='postnews.html'>ลงประกาศใหม่</a> | ";
//	echo" <a href='javascript:window.close()'>ปิดหน้านี้</a> ]";
 echo" <a href='../shownews.php?Code=$code'>แสดงประกาศ</a> ]";
		echo "<font>";
		echo "</center>";
*/
	}
