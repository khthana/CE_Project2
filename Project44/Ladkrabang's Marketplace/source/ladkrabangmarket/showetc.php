...
$sql="select * from post,etc_data,poster  where post.code=etc_data.code and post.code =poster.code and post.code='$Code'";
...
<?
	...
	// ส่วนแสดงคำตอบ
	$sql = "select * from etc_ans where code='$Code'  order by no ";
...
<form method=post action="reply.php?Table=A&Code=<?echo $Code?>&dfile=showetc.php  " name="webForm" ENCTYPE="multipart/form-data" onsubmit="return check()"> 
