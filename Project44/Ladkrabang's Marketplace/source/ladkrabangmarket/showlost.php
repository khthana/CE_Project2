...
$sql="select * from post,lost_data,poster  where post.code=lost_data.code and post.code =poster.code and post.code='$Code'";
...
<?
	...
	// ส่วนแสดงคำตอบ
	$sql = "select * from lost_ans where code='$Code'  order by no ";
...
<form method=post action="reply.php?Table=L&Code=<?echo $Code?>&dfile=showlost.php  " name="webForm" ENCTYPE="multipart/form-data"  onsubmit="return check()"> 
