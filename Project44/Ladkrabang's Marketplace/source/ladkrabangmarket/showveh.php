...
$sql="select * from post ,vehicle_data,poster  where post.code=vehicle_data.code and post.code=poster.code and post.code='$Code'";
...
echo"  </tr>";
echo"  <tr> ";
echo"  <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ยี่ห้อ</font></td>";
echo"<td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Brand</td>";
echo"  </tr>";
echo"  <tr> ";
echo"    <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>รุ่น</font></td>";
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Model</td>";
echo"  </tr>";
echo"  <tr> ";
echo"    <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>สี</font></td>";
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Color</td>";
echo"  </tr>";
echo"  <tr> ";
echo"    <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ทะเบียน</font></td>";
  echo"  <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$License</td>";
echo"  </tr>";
echo"  <tr> ";
...
{ 
echo"  <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Condition";
 if($Percent==49){echo"สภาพ น้อยกว่า 50 %";}else if($Percent!=0){echo" สภาพ $Percent %";}else{echo "ไม่ระบุสภาพ";}
echo"</td>";
}else{
  echo"  <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Condition</td>";
}
echo"  </tr>";
echo"  <tr>"; 
...
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Howsend</td>";
echo"  </tr>";
echo"</table>";
echo"<table width=70% border=1 cellspacing=2 cellpadding=2 align=center bordercolor=#0000FF>";
echo"  <tr> ";
...
echo"          <td width=26% height=25 bgcolor=#EAF9FD><div align=center>";
			if($ICQ) {
			checkicq($ICQ);
		//		echo "\t\t<img src=\"http://online.mirabilis.com/scripts/online.dll?icq=$ICQ&img=$ICQ_Image_Type"."online.gif\" 
		//		alt='ICQ -$ICQ'>\n";
			}
echo"</td>";
...
<?
	// ส่วนแสดงคำตอบ
	$sql = "select * from vehicle_ans where code='$Code'  order by no ";
...
<form method=post action="reply.php?Table=V&Code=<?echo $Code?>&dfile=showveh.php  " name="webForm" ENCTYPE="multipart/form-data" onsubmit="return check()"> 
