...
$sql="select * from post,equipment_data,poster  where post.code=equipment_data.code and post.code =poster.code and post.code='$Code'";
...
<?
	...
	// ส่วนแสดงคำตอบ
	$sql = "select * from equipment_ans where code='$Code'  order by no ";
...
<form method=post action="reply.php?Table=E&Code=<?echo $Code?>&dfile=showequ.php  " name="webForm" ENCTYPE="multipart/form-data" onsubmit="return check()"> 
