...
$sql="select * from post ,vehicle_data,poster  where post.code=vehicle_data.code and post.code=poster.code and post.code='$codeedit'";
...
$row= mysql_fetch_array($result1);
		...
		//	$Date=showdate($Date);
			mysql_close();
			?>
<form name="formveh" enctype="multipart/form-data" method="post" action="../ladkrabangmarket/post/postvehicle.php"  onsubmit="return check()" >
<center>  
    <table width="648" border="0" cellspacing="0" cellpadding="2">
      <tr> 
    <td> 
        <div align="center"><font face="MS Sans Serif" size="4"><b><font color="#0000FF">ยานพาหนะ</font></b></font></div>
    </td>
  </tr>
  <tr> 
    <td> 
          <table width="641" border="1" cellspacing="0" cellpadding="2" height="542" bordercolor="#000080">
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="18"><font face="MS Sans Serif" size="2">ท่านต้องการ 
                <font color="#FF0000">* </font></font></td>
              <td width="504" height="18"><font face="MS Sans Serif" size="2"> 
                <select name=status>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="16"><font face="MS Sans Serif" size="2">หัวข้อประกาศ<font color="#FF0000"> 
                * </font></font></td>
              <td width="504" height="16"><font 
      face="MS Sans Serif, Microsoft Sans Serif" size=1> 
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="22"><font face="MS Sans Serif" size="2">ราคา</font></td>
              <td width="504" height="22"><font  face="MS Sans Serif, Microsoft Sans Serif" size="1"> 
                <?
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="25"><font face="MS Sans Serif" size="2">ระยะเวลาที่ลงประกาศ</font></td>
              <td width="504" height="25"><font face="MS Sans Serif" size="1"> 
                ...
                เดือน <font color="#FF0080"> </font></font></td>
            </tr>
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="14"><font face="MS Sans Serif" size="2">สภาพสินค้า</font></td>
              <td width="504" height="14"><font face="MS Sans Serif" size="2"> 
                <? 
...
echo"		<input  name=select1 type=radio value=2>";
	...
	?>
       ...
       echo"         <select name=usedmonth>";
		if($Usedmonth!='0'){
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="22"><font face="MS Sans Serif" size="2">ยี่ห้อ</font></td>
              <td width="504" height="22"><font 
      face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
          ...
          ?>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="14"><font face="MS Sans Serif" size="2">รุ่น</font></td>
              <td width="504" height="14"><font   face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="36"><font face="MS Sans Serif" size="2">สี</font></td>
              <td width="504" height="36"><font 
      face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
              echo"  <input maxlength=100  name=color size=16 value='$Color'>";
          ?>
                </font></td>
            </tr>
            <tr bgcolor="#c6e2ff"> 
              <td width="123" valign="top" height="18"><font face="MS Sans Serif" size="2">ทะเบียน</font></td>
              <td width="504" height="18"> <font face="MS Sans Serif" size="2"> 
                <?
                echo"<input type=text name=license size=16 maxlength=50 value='$License'>";
                ?>
                </font> </td>
            </tr>
            <tr bgcolor="#c6e2ff"> 
              <td width="123" valign="top" height="79"><font face="MS Sans Serif" size="2">รายละเอียด 
                <font color="#FF0000">* </font></font></td>
              <td width="504" height="79"> 
                <?
   ...
   echo"  <textarea class=Font1 cols=50 name=detail rows=5>$Detail</textarea> "; 
         ?>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="28"><font face="MS Sans Serif" size="2">การรับส่งสินค้า</font></td>
              <td width="504" height="28"><font face="MS Sans Serif, Microsoft Sans Serif" 
            size=1> 
                <?  			 
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="123" height="72" bgcolor="#c6e2ff"><font face="MS Sans Serif" size="2">ผู้ประกาศ 
                <font color="#FF0000">*</font> </font></td>
              <td width="504" height="72" valign="top"> 
                <table width="525" border="0" cellspacing="0" cellpadding="2" height="70" bordercolor="#000080">
                  <tr bgcolor="#c6e2ff"> 
                    <td height="43"><font 
...
function check()
{
	  var v1 = document.formveh.status.value;
      var v2 = document.formveh.topic.value;
      var v3 = document.formveh.detail.value;
	  // var v4 = document.formveh.username.value;
  	   
	  if (v1.length==0)
           {
           alert("กรุณาเลือกความต้องการ( ซื้อ,ขาย,ฯลฯ)");
           document.formveh.status.focus();           
		   return false;
           }
       else if ( v2.length==0)
           {
           alert("กรุณาป้อนหัวข้อครับ");
           document.formveh.topic.focus();           
           return false;
           }
        	else if (v3.length==0)
           {
           alert("กรุณาป้อนรายละเอียด");
           document.formveh.detail.focus();           
		   return false;
        }
	//	else if (v4.length==0)
    //       {
   //        alert("กรุณาป้อนชื่อผู้ประกาศ");
  //         document.formveh.username.focus();           
	//	   return false;
  //         }
