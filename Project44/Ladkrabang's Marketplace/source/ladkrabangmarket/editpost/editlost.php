...
$sql="select * from post,lost_data,poster  where post.code=lost_data.code and post.code =poster.code and post.code='$codeedit'";
...
mysql_close();
				?>
<form name="formlost" enctype="multipart/form-data" method="post" action="../ladkrabangmarket/post/postlost.php"   onsubmit="return check()">
  <div align="center">
    <table width="645" border="0" cellspacing="0" cellpadding="2">
      <tr> 
        <td height="29"> 
          <div align="center"> <font face="MS Sans Serif" size="4"><b>ประกาศของหาย</b></font></div>
        </td>
      </tr>
      <tr> 
        <td> 
      ...
      face="MS Sans Serif, Microsoft Sans Serif" size=1> 
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="120" valign="top"><font face="MS Sans Serif" size="2">ข้อความ 
                <font color="#FF0000">* </font></font></td>
              <td width="480" height="98" valign="top"><font 
      face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
   ...
   echo"  <textarea class=Font1 cols=50 name=detail rows=5>$Detail</textarea> "; 
         ?>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="120" height="70"><font face="MS Sans Serif" size="2">ผู้ประกาศ 
                <font color="#FF0000">* </font></font></td>
              <td width="480" height="70" valign="top"> 
...
function check()
{
      ...
      var v2 = document.formlost.topic.value;
      var v3 = document.formlost.detail.value;
	//   var v4 = document.formlost.username.value;
  	   
       if ( v2.length==0)
           {
           alert("กรุณาป้อนหัวข้อครับ");
           document.formlost.topic.focus();           
           return false;
           }
        	else if (v3.length==0)
           {
           alert("กรุณาป้อนรายละเอียด");
           document.formlost.detail.focus();           
		   return false;
        }
     /*   else if (v4.length==0)
           {
           alert("กรุณาป้อนชื่อผู้ประกาศ");
           document.formlost.username.focus();           
		   return false;
           }
      	*/
			else
