...
$sql="select * from post,equipment_data,poster  where post.code=equipment_data.code and post.code =poster.code and post.code='$codeedit'";
...
//			$Date=showdate($Date);
				...
				mysql_close();
				?>
<form name="formequ" enctype="multipart/form-data" method="post" action="../ladkrabangmarket/post/postequipment.php"  onsubmit="return check()">
  <div align="center">
    <table width="652" border="0" cellspacing="0" cellpadding="2">
      <tr> 
        <td> 
          <div align="center"><font face="MS Sans Serif" size="4" color="#0000FF"><b>อุปกรณ์การเรียน</b></font></div>
        </td>
      </tr>
      <tr> 
        <td> 
          <table width="636" border="1" cellspacing="0" cellpadding="2" height="470" bordercolor="#000080">
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="23"><font face="MS Sans Serif" size="2">ท่านต้องการ<font color="#FF0000"> 
                *</font> </font></td>
              <td width="517" height="23"> <font face="MS Sans Serif" size="2"> 
                <select name=status>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="24"><font face="MS Sans Serif" size="2">หัวข้อประกาศ 
                <font color="#FF0000">*</font> </font></td>
              <td width="517" height="24"><font 
    ...
    ?>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="17"><font face="MS Sans Serif" size="2">ราคา</font></td>
              <td width="517" height="17"><font    face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
		echo"		<input maxlength=50    name=price size=16 value='$Price'>";
    ?>
                บาท </font></td>
            </tr>
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="18"><font face="MS Sans Serif" size="1">ระยะเวลาที่ลงประกาศ</font></td>
              <td width="517" height="18"> <font face="MS Sans Serif" size="1"> 
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="21"><font face="MS Sans Serif" size="2">สภาพสินค้า</font></td>
              <td width="517" height="21"><font face="MS Sans Serif" size="2"> 
                <? 
...
echo"		<input  name=select1 type=radio value=2>";
	...
	?>
       ...
       echo"         <select name=usedmonth>";
		if($Usedmonth!='0'){
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="22"><font face="MS Sans Serif" size="2">ยี่ห้อ</font></td>
              <td width="517" height="22"><font    face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
				echo" <input maxlength=100    name=brand size=16 value='$Brand'> ";
               ?>
                </font></td>
            </tr>
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="17"><font face="MS Sans Serif" size="2">รุ่น</font></td>
              <td width="517" height="17"><font    face="MS Sans Serif, Microsoft Sans Serif" size=1> 
                <?
                echo"<input maxlength=50    name=model size=16 value='$Model' >";
                ?>
                </font></td>
            </tr>
            <tr bgcolor="#c6e2ff"> 
              <td width="105" valign="top" height="86"><font face="MS Sans Serif" size="2">รายละเอียด 
                <font color="#FF0000">*</font> </font></td>
              <td width="517" height="86"> 
                <? 
   ...
   ?>
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="38"><font face="MS Sans Serif" size="2">การรับส่งสินค้า</font></td>
              <td width="517" height="38"><font face="MS Sans Serif, Microsoft Sans Serif" 
            size=1> 
                <?  			 
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="76"><font face="MS Sans Serif" size="2">ผู้ประกาศ 
                <font color="#FF0000">* </font></font></td>
              <td width="517" height="76" valign="top"> 
            ...
            <tr bgcolor="#c6e2ff"> 
              <td width="105" height="30"><font face="MS Sans Serif" size="2">รูปภาพ 
                </font></td>
              <td width="517" height="30" valign="top">
            ...
            <tr bgcolor="#c6e2ff">
              <td width="105" height="30"><font face="MS Sans Serif" size="2"><font color="#FF0000">(สำหรับสมาชิก) 
                </font></font></td>
              <td width="517" height="30" valign="top"><font face="MS Sans Serif" size="2">ต้องการให้ส่งคำตอบของประกาศไปให้ทางเมล์หรือไม่ 
                <? if($Sendmail==1){
          ...
          <table width="644" border="0" cellspacing="0" cellpadding="2" height="27">
            <tr> 
              <td> 
                <div align="center"> 
...
function check()
{
	  var v1 = document.formequ.status.value;
      var v2 = document.formequ.topic.value;
      var v3 = document.formequ.detail.value;
//	   var v4 = document.formequ.username.value;
  	   
	    if (v1.length==0)
           {
           alert("กรุณาเลือกความต้องการ( ซื้อ,ขาย,ฯลฯ)");
           document.formequ.status.focus();           
		   return false;
           } 
        else if ( v2.length==0)
           {
           alert("กรุณาป้อนหัวข้อครับ");
           document.formequ.topic.focus();           
           return false;
           }
	else if (v3.length==0)
           {
           alert("กรุณาป้อนรายละเอียด");
           document.formequ.detail.focus();           
		   return false;
        }
	/*	else if (v4.length==0)
           {
           alert("กรุณาป้อนชื่อผู้ประกาศ");
           document.formequ.username.focus();           
		   return false;
           }
     	*/	
        else
