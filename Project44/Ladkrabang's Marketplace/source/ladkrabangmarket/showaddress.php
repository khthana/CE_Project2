...
$sql="select * from post,address_data,poster  where post.code=address_data.code and post.code =poster.code and post.code='$Code'";
...
echo"  <tr> ";
echo"    <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ต้องการ</font></td>";
echo"   <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD> $Status </td>";
echo"  </tr>";
echo"  <tr> ";
echo" <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ชื่อที่พักอาศัย</font></td>";
echo" <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Name</td>";
echo"  </tr>";
echo"  <tr> ";
echo"  <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ประเภท</font></td>";
echo"<td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Type</td>";
echo"  </tr>";
echo"  <tr> ";
echo"    <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ที่ตั้ง</font></td>";
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Address</td>";
echo"  </tr>";
echo"  <tr> ";
echo"    <td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>จำนวนห้อง</font></td>";
  echo"  <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$No_room</td>";
echo"  </tr>";
echo"  <tr>"; 
    echo"<td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ขนาดห้อง</font></td>";
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Size</td>";
echo"  </tr>";

echo"  <tr>"; 
    echo"<td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>ราคาต่อเดือน</font></td>";
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Price</td>";
echo"  </tr>";
echo"  <tr>"; 
    echo"<td width=19% bgcolor=#9DE6FD><font face=MS Sans Serif size=1>เบอร์โทรศัพท์</font></td>";
echo"    <td width=81% bordercolor=#0000FF bgcolor=#EAF9FD>$Tela</td>";
echo"  </tr>";
...
<?
	...
	// ส่วนแสดงคำตอบ
	$sql = "select * from address_ans where code='$Code'  order by no ";
...
<form method=post action="reply.php?Table=H&Code=<?echo $Code?>&dfile=showaddress.php  " name="webForm" ENCTYPE="multipart/form-data" onsubmit="return check()"> 
