...
while ($row = mysql_fetch_array($result)) 
{
  ...
  { 
	 ...
	 $sql1="delete from toadmin where no='$row[0]'";
...
echo"  <tr>";
echo"    <td>";
echo"      <p align=center><b><font face=MS Sans Serif size=3 color=#6600FF>ลบคำถามที่  $row[0] เรียบร้อยแล้ว        </font></b></p>";
echo"  <p align=center><font face=MS Sans Serif size=3 color=#330000><b> กรุณารอสักครู่จะกลับสู่หน้าอ่านคำถาม</b></font></p>";
echo"    </td>";
echo"  </tr>";
echo"</table>";
}else{
...
echo"  <tr>";
echo"    <td>";
 echo"  <p align=center><b><font face=MS Sans Serif size=3 color=#66CCFF>ไม่สามารถลบคำถาม $row[0] ได้ กรุณาตรวจสอบ</font></b></p>";
echo"      <p align=center><b><font face=MS Sans Serif size=3 color=#66CCFF>กรุณารอสักครู่จะกลับสู่หน้าอ่านคำถาม</font></b></p>";
echo"      </td>";
echo"  </tr>";
echo"</table> ";
}//else
...
?>
	...
	<META HTTP-EQUIV="REFRESH" CONTENT="3; URL=adminread.php ">
	</head>
	<style type="text/css">
	<!-- 
