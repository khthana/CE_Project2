...
$sql="select * from post,news_data,poster  where post.code=news_data.code and post.code =poster.code and post.code='$Code'";
...
<?
	...
	// ส่วนแสดงคำตอบ
	$sql = "select * from news_ans where code='$Code'  order by no ";
...
<form method=post action="reply.php?Table=N&Code=<?echo $Code?>&dfile=shownews.php  " name="webForm" ENCTYPE="multipart/form-data"  onsubmit="return check()"> 
