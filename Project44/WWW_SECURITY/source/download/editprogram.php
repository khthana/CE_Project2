...
?>
<table  border=1  cellpadding=5  cellspacing=0  width=100%  bordercolor="green">
		<tr>
<?
//*********************************************************
...
?>
			  ...
			  <table  border=1  width=400  height=280  cellpadding=5  cellspacing=0  bordercolor="blue">
...
<?
		...
		if ($submittedFile != "" && $size == 0 ) {  // กรอกที่อยู่ของไฟล์มาแต่ว่าไม่มีไฟล์นั้นจริง อาจกรอกที่อยู่ผิดก็ได้
...
//						$path2 = "C:/Inetpub/wwwroot/top/download/file/program/lwepfdeiowj";		 // directory ที่ใช้เก็บไฟล์ที่ upload โดยให้เฉพาะสต๊าฟ download ได้
						$path2 = "../file/filedownload/lwepfdeiowj";
...
?>
    									<table  border=1  cellpadding=2  cellspacing=0  width=400  height=100  bordercolor="yellow">
												<input  type="hidden"  name="group"  value="<?  echo $group;  ?>">  
												<tr>  <td  colspan=2  align=center><input  type="checkbox"  name="array[]"  value="<? echo "$id"; ?>">
																<? echo $name; ?>
														</td>
<!--														<td>		
																<? 
...
-->														
												...
												<tr>  <td><b>มีการดาวน์โหลด : </b></td>  <td><? echo "$download "; ?>ครั้ง</td>  </tr>
												<tr>  <td><b>วัน-เวลาที่อัพโหลด : </b></td>  <td><? echo $date_add; ?></td>  </tr>
		    									<tr>  <td><b>ขนาดไฟล์ : </b></td>  <td><? echo "$size  ไบต์"; ?></td>  </tr>
												<tr>  <td><b>รายละเอียด : </b></td>  <td><? echo $detail; ?></td>  </tr>
												<tr>  <td><b>โดย : </b></td>  <td><? echo $user_add; ?></td>  </tr>
												<br><br>
								    	</table>
...
?>
		<td  align="right"  valign="top">
			<table  border=1  cellpadding=5  cellspacing=0  bordercolor="red">
...
?>
					<tr>  <td  colspan=2><h3>โปรแกรม</h3></td>  </tr>
					<form  method="post"  action="<? echo $PHP_SELF; ?>">
<?
