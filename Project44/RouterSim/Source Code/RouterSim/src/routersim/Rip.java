...
/*
    Rip rrip = (Rip)this.getRIP();
    System.out.println("//Check router -> "+this.getName());
    if (!rrip.getRecieve()){
      rrip.setRecieve(true);
      System.out.println(this.getName()+" is recieve from "+oldRouter.getName());
      Interface iadj = null;
