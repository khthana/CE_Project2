			...
			while(resultset_show.next()){ 
				...
				if((author!=null)&&(author.length()>0)){
					...
					if(resultset_author.next()){%>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr><td>Title : <%=tmp_pname%></td></tr>
						<tr><td>Abstract : <%=tmp_description%></td></tr>
						<tr><td>Author : <%=resultset_author.getString("AuthorName")%> ,</td></tr>
						<%while(resultset_author.next()){%>
							<tr><td><%=resultset_author.getString("AuthorName")%> ,</td></tr>
						<%}%>
						<tr><td><a href=../upload/<%=tmp_location%>><font size="-2">Download</font></a><font size="-2">size : <%=tmp_size%></font></td></tr>
						<br>
					<%}
