...
//    System.out.println(s);
  ...
  public void showCmd1(){
    RouterConsole.output += "Exex Commands:\n";
    ...
    RouterConsole.output += "show history     \t\tShow running system information\n";
    RouterConsole.output += "traceroute       \t\tTrace route to destination\n\n";
  }
  public void showCmd2(){
    RouterConsole.output += "Exex Commands:\n";
    RouterConsole.output += "config           \t\tEnter configuration mode\n";
    RouterConsole.output += "copy             \t\tCopy configuration or image data\n";
    RouterConsole.output += "disable          \t\tTurn off privileged commands\n";
    RouterConsole.output += "erase            \t\tErase flash or configuration memory\n";
    RouterConsole.output += "ping             \t\tSend echo messages\n";
    RouterConsole.output += "show             \t\tShow running system information\n";
    RouterConsole.output += "terminal         \t\tShow running system information\n";
    RouterConsole.output += "traceroute       \t\tTrace route to destination\n\n";
  }
  public void showCmd3(){
    RouterConsole.output += "Configure commands:\n";
    ...
    RouterConsole.output += "no               \t\tNegate a command or set its defaults\n";
    RouterConsole.output += "router           \t\tSet protocol\n\n";
  }
  public void showCmd4(){
    RouterConsole.output += "Interface configuration commands:\n";
    RouterConsole.output += "bandwidth        \t\tSet bandwidth informational parameter\n";
    RouterConsole.output += "cdp              \t\tCDP interface subcommands\n";
    RouterConsole.output += "clock            \t\tConfigure serial interface clock\n";
    RouterConsole.output += "end              \t\tExit from configure mode\n";
    RouterConsole.output += "exit             \t\tExit from interface configuration mode\n";
    RouterConsole.output += "interface        \t\tSelect an interface to configure\n";
    RouterConsole.output += "ip               \t\tInterface Internet Protocol config commands\n";
    RouterConsole.output += "no               \t\tNegate a command or set its defaults\n";
    RouterConsole.output += "ring-speed       \t\tSet ring speed of token ring\n";
    RouterConsole.output += "shutdown         \t\tShutdown the selected interface\n\n";
  }
  public void showCmd5(){
    RouterConsole.output += "Router configuration commands:\n";
    RouterConsole.output += "network          \t\tEnable routing on an IP network\n\n";
  }
  public void showCmd6(){
    RouterConsole.output += "Line configuration commands:\n";
    RouterConsole.output += "login            \t\tEnable password checking\n";
    RouterConsole.output += "password         \t\tSet a password\n";
    RouterConsole.output += "no               \t\tNegate a command or set its defaults\n";
  }
  //----------------Traceroute-----------------//
  //Normal Trace
