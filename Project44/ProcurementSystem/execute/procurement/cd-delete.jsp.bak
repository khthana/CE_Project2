...
<%
	...
	java.sql.Time  time=new java.sql.Time(DateTime);
     ...
     // ส่วนจัดการ DB ของ Oracle
		 try {
				...
				String query="DELETE DATA_KEEPING_PRODUCTS WHERE CODE='"+code+"'";
	...
	%>
       <CENTER>ลบข้อมุลเสร็จสิ้น <A HREF="add-cd.html">เพิ่มเติมข้อมูล</A> หรือ <A HREF="show-cd-db.jsp">ดูข้อมูลในฐานข้อมูล</A> </CENTER>
