...
<%
				   ...
				   int lv=Integer.parseInt(level);
					...
					%>
	<P>&nbsp;<P>
	<FORM METHOD=POST ACTION="ct-edit2.jsp">
...
<TR>
	...
	<TD bgcolor="#FFF0E1" width="120"><FONT COLOR="#DF5F2D"><B><%=cat%></B></FONT></TD>	
<TR>
...
try{
		...
		while(res.next()){
			String wf_name=res.getString("WF_TYPE");
			System.out.println(wf_name);
			System.out.println("ok");
			%>
				<OPTION VALUE="<%=wf_name%>" ><%=wf_name%>
			<%															
		}
		    res.close();
		 stmt.close();
...
<TR>
<TD bgcolor="#FFF0E1" align="center" valign="middle" colspan="2"><INPUT TYPE="submit"  VALUE="ตกลง">&nbsp;&nbsp;<INPUT TYPE="reset" VALUE="ค่าเริ่มต้น"></TD>
</TR>
</TABLE>
</FORM></TD>
	</TR>
