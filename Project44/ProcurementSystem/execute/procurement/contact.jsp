      ...
      <TABLE width="100%" cellpadding="0" cellspacing="0" border="0">
        <TR>
		  ...
		  <TD bgColor="#ffffff" width="73%" valign="top"> 
			...
			<TABLE border="1" width="450" bordercolor="#66669A" cellspacing="0" cellpadding="3">
			<TR bgcolor="#66669A"  height="25">
				<TD colspan="2"><FONT  COLOR="#F1F0FF"><B>มีข้อสงสัย หรือสนใจสอบถามรายละเอียดเพิ่มเติม กรุณาติดต่อ</B></FONT></TD>
			</TR>
			<TR >
				<TD bgcolor="#FFFFFF" width="220">E-mail Address ของคุณ :</TD>
				<TD bgcolor="#F1F0FF"><INPUT TYPE="text" NAME="email" SIZE="30"></TD>
			</TR>
			<TR>
				<TD bgcolor="#FFFFFF" width="220" valign="top">ความคิดเห็น หรือ ข้อสงสัย : </TD>
				<TD bgcolor="#F1F0FF"><TEXTAREA NAME="suggestion" ROWS="5" COLS="40"></TEXTAREA></TD>
			</TR>
			<TR bgcolor="#F1F0FF" colspan="2" height="35">
				<TD colspan="2"><CENTER><INPUT TYPE="submit" value="ตกลง">&nbsp;&nbsp; <INPUT TYPE="reset" value="เริ่มใหม่"></CENTER>	</TD>
			</TR>
			</TABLE>
			</FORM>
			</CENTER></TD>
