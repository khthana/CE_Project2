...
<TABLE border=0 cellPadding=0 cellSpacing=0 width=760 align="center">
  ...
  <TR> 
   ...
   // กรณีพาสเวิร์ดผิดพลาด
				}	else  {out.println("<b><P>&nbsp;<P>&nbsp;<P><div align=\"center\">รหัสผ่านผิดพลาด กรุณาย้อน<A HREF=\"favorite.jsp\">กลับไป 1 หน้า</A>เพื่อตรวจสอบรหัสผ่านใหม่ หรือ<A HREF=\"forgetpw.jsp\"> ลืมรหัสผ่าน</A></div></b>");  }
				//END IF;  
