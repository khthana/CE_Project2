...
<TABLE border=0 cellPadding=0 cellSpacing=0 width=760 align="center">
 ...
 <TABLE>
	<TR>
		...
		<TABLE>
	<TR>
		              <TD width="182" colspan=2><IMG SRC="picture/file_head.gif" width="260" HEIGHT="24" BORDER=0 ALT="แฟ้มและอุปกรณ์จัดเก็บเอกสาร"></TD>
	</TR>
	<TR>
		              <TD width="182"><A HREF="file.jsp?type=แฟ้มสันกว้าง">แฟ้มสันกว้าง</A><BR>
			  <A HREF="file.jsp?type=แฟ้ม 3 ห่วง">แฟ้ม 3 ห่วง</A><BR>
			  <A HREF="file.jsp?type=แฟ้ม 4 ห่วง">แฟ้ม 4 ห่วง</A><BR>
			  <A HREF="file.jsp?type=แฟ้มหนีบ">แฟ้มหนีบ</A><BR>
			  <A HREF="file.jsp?type=แฟ้มคอมพิวเตอร์">แฟ้มคอมพิวเตอร์</A><BR>
			  <A HREF="file.jsp?type=แฟ้มแขวน">แฟ้มแขวน</A><BR>
			   <A HREF="file.jsp?type=แฟ้มซอง">แฟ้มซอง</A><BR>
			 
			  </TD>
			          <TD width="169"> <A HREF="file.jsp?type=แฟ้มโชว์เอกสาร">แฟ้มโชว์เอกสาร</A><BR>
			  <A HREF="file.jsp?type=ซองอเนกประสงค์">ซองอเนกประสงค์</A><BR>
			  <A HREF="file.jsp?type=แฟ้มเจาะ">แฟ้มเจาะ</A><BR>
			  <A HREF="file.jsp?type=ซองเอกสารพลาสติก">ซองเอกสารพลาสติก</A><BR>
			<A HREF="file.jsp?type=แฟ้มกระเป๋า">แฟ้มกระเป๋า</A><BR>
				<A HREF="file.jsp?type=แฟ้มหีบเพลง">แฟ้มหีบเพลง</A><BR>
				<A HREF="file.jsp?type=แฟ้มพับ">แฟ้มพับ</A><BR>
 			  </TD>
	</TR>
	</TABLE>
	</TD>
	<TD  align="center"><IMG SRC="picture/file.gif" WIDTH="150" HEIGHT="203" BORDER=0 ALT=""></TD>
</TR>
</TABLE>
<%
...
try{
		 ...
		 String query="SELECT COUNT(*) FROM FILING WHERE TYPE='"+type+"'";
		 ResultSet res=stmt.executeQuery(query);
		 res.next();
		 int num=res.getInt("COUNT(*)");
		 query="SELECT * FROM FILING WHERE TYPE='"+type+"'";
            ...
            <table align="left" width="495" >
              <tr> 
                <td width="157"><b>รหัสสินค้า &nbsp;: &nbsp;</b><%=code%><br>
                  <b>ตรา &nbsp;: &nbsp;</b><%=brand%><br>
                  <b>ขนาด &nbsp;: &nbsp;</b><%=paper_size%><br>
	<b>ใส่กระดาษหนา &nbsp;: &nbsp;</b><%=thick%><br>
		<b>สี &nbsp;: &nbsp;</b><%=color%><br>
                ...
                <td width="198" valign="bottom" align="right"> 
                  <form method=POST action="shoppingcart">
                   ...
                   <INPUT TYPE="hidden" NAME="type" VALUE="<%=type%>">
					...
					<INPUT TYPE="hidden" NAME="tablename" VALUE="FILING">
</form>
                </td>
              </tr>
            </table>
