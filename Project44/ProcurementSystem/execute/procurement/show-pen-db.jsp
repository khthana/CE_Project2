...
<HTML>
<HEAD>
<TITLE>  Show Db of WRITING_PRODUCTS </TITLE>
...
<table width="75%" border="1" bordercolor="#9E755F" frame="above" rules="rhs" cellspacing="0" cellpadding="3">
   <!--  <tr>
    ...
    --> <tr border="0" bgcolor="9E755F">
      ...
      <td width="80"><b><font color="#FFF7BE" ><div align="center">ขนาดหัว มม.</div></font></b></td>
...
<%try{
		 ...
		 String query="SELECT COUNT(*) FROM WRITING_PRODUCTS";
		 ResultSet res=stmt.executeQuery(query);
		 res.next();
		 int num=res.getInt("COUNT(*)");
		 query="SELECT * FROM WRITING_PRODUCTS ORDER BY CODE";
	 ...
	 <tr border="0" bgcolor="#FFF7BE">
      ...
      <td ><%=head_size%></td>
	   ...
	   <td align="center" valign="center">
		 <FORM METHOD=POST ACTION="p-edit.jsp?code=<%=code%>">
		       <INPUT TYPE="submit" VALUE="Edit">
		 </FORM></td>
		  <td align="center" valign="center">
		 <FORM METHOD=POST ACTION="p-delete.jsp?code=<%=code%>">
