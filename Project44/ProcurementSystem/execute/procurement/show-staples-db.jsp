...
<table width="75%" border="1" bordercolor="#9E755F" frame="above" rules="rhs" cellspacing="0" cellpadding="3">
   <!--  <tr>
    ...
    --> <tr border="0" bgcolor="9E755F">
      ...
      <td width="80"><b><font color="#FFF7BE" ><div align="center">รุ่นเทียบเท่า</div></font></b></td>
	  <td width="80"><b><font color="#FFF7BE" ><div align="center">ขนาดลวด</div></font></b></td>
	   <td width="80"><b><font color="#FFF7BE" ><div align="center">ใช้กับเครื่องเย็บรุ่น</div></font></b></td>
...
<%try{
		...
		while(i<=num){
		 ...
		 if ((ref_sub==null) || ref_sub.equals("null")){ ref_sub="-";}
		 String stap_size=rs.getString("STAP_SIZE");
		 if ((stap_size==null) || stap_size.equals("null")){ stap_size="-";}
		 String  sub=rs.getString("SUB");
		 if ((sub==null) || sub.equals("null")){ sub="-";}
		 String  stapler_sub=rs.getString("STAPLER_SUB");
		 if ((stapler_sub==null) || stapler_sub.equals("null")){ stapler_sub="-";}
	 ...
	 <tr border="0" bgcolor="#FFF7BE">
	  ...
	  <td ><%=detail%></td>
	   <td align="center" valign="center">
		 <FORM METHOD=POST ACTION="staples-edit.jsp?code=<%=code%>">
		       <INPUT TYPE="submit" VALUE="Edit">
		 </FORM></td>
		  <td align="center" valign="center">
		 <FORM METHOD=POST ACTION="staples-delete.jsp?code=<%=code%>">
