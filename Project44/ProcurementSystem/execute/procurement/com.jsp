...
<TABLE border=0 cellPadding=0 cellSpacing=0 width=760 align="center">
 ...
 <TABLE>
	...
	<TR>
	<TD width="200" align="center"><IMG SRC="picture/com.gif" WIDTH="150" HEIGHT="223" BORDER=0 ALT="อุปกรณ์การบรรจุภัณฑ์"></TD>
		<TD>
		<TABLE>
		<TR>
			<TD colspan="2"><IMG SRC="picture/com_head.gif" WIDTH="260" HEIGHT="24" BORDER=0 ALT="อุปกรณ์การบรรจุภัณฑ์"></TD>
		</TR>
		<TR>
			<TD><A HREF="com.jsp?type=แผ่นดิสเก็ต">แผ่นดิสเก็ต</A><BR>
			  <A HREF="com.jsp?type=แผ่น CD-R">แผ่น CD-R</A><BR>
			    <A HREF="com.jsp?type=แผ่น CD-RW">แผ่น CD-RW</A><BR>
			 <A HREF="com.jsp?type=เทปบันทึกข้อมูล">เทปบันทึกข้อมูล</A><BR>
			  <A HREF="com.jsp?type=อุปกรณ์จัดเก็บดิสเก็ต">อุปกรณ์จัดเก็บดิสเก็ต</A><BR>
			  <A HREF="com.jsp?type=อุปกรณ์จัดเก็บ CD">อุปกรณ์จัดเก็บ CD</A><BR>
			 <A HREF="com.jsp?type=ชุดทำความสะอาดแผ่น CD">ชุดทำความสะอาดแผ่น CD</A><BR>
			 <A HREF="com.jsp?type=เทปทำความสะอาด">เทปทำความสะอาด</A><BR>
			  </TD>
      </TD>
		</TR>
		</TABLE></TD>
...
try{
		 ...
		 String query="SELECT COUNT(*) FROM DATA_KEEPING_PRODUCTS WHERE TYPE='"+type+"'";
		 ResultSet res=stmt.executeQuery(query);
		 res.next();
		 int num=res.getInt("COUNT(*)");
		 query="SELECT * FROM DATA_KEEPING_PRODUCTS WHERE TYPE='"+type+"'";
              ...
              <tr> 
                ...
                <td width="198" valign="bottom" align="right"> 
                  <form method=POST action="shoppingcart">
					...
					<INPUT TYPE="hidden" NAME="catNo" VALUE="8">
					<INPUT TYPE="hidden" NAME="tablename" VALUE="DATA_KEEPING_PRODUCTS">
