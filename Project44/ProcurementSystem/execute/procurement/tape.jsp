...
<TABLE border=0 cellPadding=0 cellSpacing=0 width=760 align="center">
 ...
 <TABLE>
	<TR>
		...
		<TABLE>
		<TR>
			<TD colspan="2"><IMG SRC="picture/glue_head.gif" WIDTH="260" HEIGHT="24" BORDER=0 ALT="อุปกรณ์การบรรจุภัณฑ์"></TD>
		</TR>
		<TR>
			<TD><A HREF ="glue.jsp?type=กาวแท่ง">กาวแท่ง</A><BR>
			  <A HREF ="glue.jsp?type=กาวน้ำ">กาวน้ำ</A><BR>
			   <A HREF ="glue.jsp?type=กาวลาเท็กซ์">กาวลาเท็กซ์</A><BR>
			  <A HREF ="glue.jsp?type=กาวซูเปอร์กลู">กาวซูเปอร์กลู</A><BR>
			  <A HREF ="glue.jsp?type=กาวสารพัดประโยชน์">กาวสารพัดประโยชน์</A><BR>
	        <A HREF ="glue.jsp?type=กาวสเปรย์">กาวสเปรย์</A><BR>
			  <A HREF ="glue.jsp?type=กาวดินน้ำมัน">กาวดินน้ำมัน</A><BR>
			  <A HREF ="glue.jsp?type=กาวอุตสาหกรรม">กาวอุตสาหกรรม</A><BR>
			  
			  <TD>
			  <A HREF ="tape.jsp?type=เทปขุ่น">เทปขุ่น</A><BR>
			  <A HREF ="tape.jsp?type=เทปใส">เทปใส</A><BR>
			  <A HREF ="tape.jsp?type=แท่นตัดเทป">แท่นตัดเทป</A><BR>
			  <A HREF ="tape.jsp?type=เทปเยื่อกาวสองหน้า">เทปเยื่อกาวสองหน้า</A><BR>
			  <A HREF ="tape.jsp?type=เทปโฟม">เทปโฟม</A><BR>
			  <A HREF ="tape.jsp?type=เทปกระดาษกาวย่น">เทปกระดาษกาวย่น</A><BR>
			  <A HREF ="tape.jsp?type=เทปโอพีพี">เทปโอพีพี</A><BR>
			  <A HREF ="tape.jsp?type=เทปผ้า">เทปผ้า</A><BR>
			  <A HREF ="tape.jsp?type=เทปพลาสติกไวนิล">เทปพลาสติกไวนิล</A><BR>
			  </TD>
      </TD>
		</TR>
		</TABLE></TD>
		<TD width="200" align="center"><IMG SRC="picture/glue.gif" WIDTH="135" HEIGHT="240" BORDER=0 ></TD>
	</TR>
	</TABLE>
<%
...
try{
		 ...
		 String query="SELECT COUNT(*) FROM PACKING_PRODUCTS WHERE TYPE='"+type+"'";
		 ResultSet res=stmt.executeQuery(query);
		 res.next();
		 int num=res.getInt("COUNT(*)");
		 query="SELECT * FROM PACKING_PRODUCTS WHERE TYPE='"+type+"'";
              ...
              <tr> 
                ...
                <td width="198" valign="bottom" align="right"> 
                  <form method=POST action="servlet/AddToCartServlet">
                    ...
                    &nbsp; &nbsp; 
                    <input type="image" src="picture/shoppingcart.gif" name="image">
                    <input type="hidden" name="code" value="<%=code%>">
					<INPUT TYPE="hidden" NAME="type" VALUE="<%=type%>">
					<INPUT TYPE="hidden" NAME="catNo" VALUE="3">
					<INPUT TYPE="hidden" NAME="tablename" VALUE="PACKING_PRODUCTS">
