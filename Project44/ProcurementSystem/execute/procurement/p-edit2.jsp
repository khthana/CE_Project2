...
<% 
  ...
  <CENTER>
<FORM method="post"action="p-edit3.jsp?code=<%=code%>&type=<%=type%>&brand=<%=brand%>&color=<%=color%>&head_size=<%=head_size%>&detail=<%=detail%>&cat=<%=cat%>">
<TABLE cellpadding="3" bordercolor="#DF5F2D" border="1" frame="above" rules="rhs" width="300" cellspacing="0">
<TR bgcolor="#DF572D" height="24">
	<TD colspan="2" align="left"><FONT COLOR="#FFF0E1"><B>แก้ไขสินค้าประเภทปากกา</B></FONT></TD>
</TR>
<TR>
...
<TR>
	...
	<TD bgcolor="#FFF0E1" ><B><FONT COLOR="#DF572D"><%=cat%></FONT></B></TD>
</TR>
<TR>
...
<TR>
	...
	<TD bgcolor="#FFF0E1" ><B><FONT COLOR="#DF572D"><%=head_size%>&nbsp;มม.</FONT></B></TD>
</TR>
<TR>
