...
<%
	...
	java.sql.Time  time=new java.sql.Time(DateTime);
     ...
     // ส่วนจัดการ DB ของ Oracle
		 try {
				...
				String query="DELETE FILING WHERE CODE='"+code+"'";
	...
	%>
       <CENTER>ลบข้อมุลเสร็จสิ้น <A HREF="add-file.html">เพิ่มเติมข้อมูล</A> หรือ <A HREF="show-file-db.jsp">ดูข้อมูลในฐานข้อมูล</A> </CENTER>
