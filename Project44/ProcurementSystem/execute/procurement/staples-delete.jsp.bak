...
<%
	...
	java.sql.Time  time=new java.sql.Time(DateTime);
     ...
     // ส่วนจัดการ DB ของ Oracle
		 try {
				...
				String query="DELETE STAPLER WHERE CODE='"+code+"'";
	...
	%>
       <CENTER>ลบข้อมุลเสร็จสิ้น <A HREF="add-stapler.html">เพิ่มเติมข้อมูล</A> หรือ <A HREF="show-stapler-db.jsp">ดูข้อมูลในฐานข้อมูล</A> </CENTER>
