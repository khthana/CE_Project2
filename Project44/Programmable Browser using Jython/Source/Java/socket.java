...
public class socket extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$36 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\socket.py");
            funcTable = new _PyInner();
            c$0__gethostbyaddr = Py.newCode(1, new String[] {"name", "addrs", "names", "addresses", "addr"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "_gethostbyaddr", false, false, funcTable, 0, null, null, 0, 1);
            c$1_getfqdn = Py.newCode(1, new String[] {"name", "a", "addrs", "names"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "getfqdn", false, false, funcTable, 1, null, null, 0, 1);
            c$2_gethostname = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "gethostname", false, false, funcTable, 2, null, null, 0, 1);
            c$3_gethostbyname = Py.newCode(1, new String[] {"name"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "gethostbyname", false, false, funcTable, 3, null, null, 0, 1);
            c$4_gethostbyaddr = Py.newCode(1, new String[] {"name", "addrs", "names"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "gethostbyaddr", false, false, funcTable, 4, null, null, 0, 1);
            c$5_socket = Py.newCode(3, new String[] {"family", "type", "flags"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "socket", false, false, funcTable, 5, null, null, 0, 1);
            c$6_bind = Py.newCode(3, new String[] {"self", "addr", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "bind", false, false, funcTable, 6, null, null, 0, 1);
            c$7_listen = Py.newCode(2, new String[] {"self", "backlog", "a", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "listen", false, false, funcTable, 7, null, null, 0, 1);
            c$8_accept = Py.newCode(1, new String[] {"self", "port", "sock", "conn", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "accept", false, false, funcTable, 8, null, null, 0, 1);
            c$9_connect = Py.newCode(3, new String[] {"self", "addr", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "connect", false, false, funcTable, 9, null, null, 0, 1);
            c$10__setup = Py.newCode(2, new String[] {"self", "sock"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "_setup", false, false, funcTable, 10, null, null, 0, 1);
            c$11_recv = Py.newCode(2, new String[] {"self", "n", "m", "data"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "recv", false, false, funcTable, 11, null, null, 0, 1);
            c$12_send = Py.newCode(2, new String[] {"self", "s", "n"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "send", false, false, funcTable, 12, null, null, 0, 1);
            c$13_getsockname = Py.newCode(1, new String[] {"self", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "getsockname", false, false, funcTable, 13, null, null, 0, 1);
            c$14_getpeername = Py.newCode(1, new String[] {"self", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "getpeername", false, false, funcTable, 14, null, null, 0, 1);
            c$15_setsockopt = Py.newCode(4, new String[] {"self", "level", "optname", "value"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "setsockopt", false, false, funcTable, 15, null, null, 0, 1);
            c$16_getsockopt = Py.newCode(3, new String[] {"self", "level", "optname"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "getsockopt", false, false, funcTable, 16, null, null, 0, 1);
            c$17_makefile = Py.newCode(3, new String[] {"self", "mode", "bufsize", "file"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "makefile", false, false, funcTable, 17, null, null, 0, 1);
            c$18___init__ = Py.newCode(3, new String[] {"self", "socket", "file"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "__init__", false, false, funcTable, 18, null, null, 0, 1);
            c$19_close = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "close", false, false, funcTable, 19, null, null, 0, 1);
            c$20_FileWrapper = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "FileWrapper", false, false, funcTable, 20, null, null, 0, 0);
            c$21_shutdown = Py.newCode(2, new String[] {"self", "how"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "shutdown", false, false, funcTable, 21, null, null, 0, 1);
            c$22_close = Py.newCode(1, new String[] {"self", "ostream", "sock", "istream"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "close", false, false, funcTable, 22, null, null, 0, 1);
            c$23__tcpsocket = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "_tcpsocket", false, false, funcTable, 23, null, null, 0, 0);
            c$24___init__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "__init__", false, false, funcTable, 24, null, null, 0, 1);
            c$25_bind = Py.newCode(3, new String[] {"self", "addr", "port", "a", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "bind", false, false, funcTable, 25, null, null, 0, 1);
            c$26_connect = Py.newCode(3, new String[] {"self", "addr", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "connect", false, false, funcTable, 26, null, null, 0, 1);
            c$27_sendto = Py.newCode(3, new String[] {"self", "data", "addr", "packet", "n", "port", "a", "host", "bytes"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "sendto", false, false, funcTable, 27, null, null, 0, 1);
            c$28_send = Py.newCode(2, new String[] {"self", "data"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "send", false, false, funcTable, 28, null, null, 0, 1);
            c$29_recvfrom = Py.newCode(2, new String[] {"self", "n", "packet", "port", "m", "host", "bytes"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "recvfrom", false, false, funcTable, 29, null, null, 0, 1);
            c$30_recv = Py.newCode(2, new String[] {"self", "n", "m", "bytes", "packet"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "recv", false, false, funcTable, 30, null, null, 0, 1);
            c$31_getsockname = Py.newCode(1, new String[] {"self", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "getsockname", false, false, funcTable, 31, null, null, 0, 1);
            c$32_getpeername = Py.newCode(1, new String[] {"self", "port", "host"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "getpeername", false, false, funcTable, 32, null, null, 0, 1);
            c$33___del__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "__del__", false, false, funcTable, 33, null, null, 0, 1);
            c$34_close = Py.newCode(1, new String[] {"self", "sock"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "close", false, false, funcTable, 34, null, null, 0, 1);
            c$35__udpsocket = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "_udpsocket", false, false, funcTable, 35, null, null, 0, 0);
            c$36_test = Py.newCode(0, new String[] {"s", "data"}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "test", false, false, funcTable, 36, null, null, 0, 1);
            c$37_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\socket.py", "main", false, false, funcTable, 37, null, null, 0, 0);
        }
