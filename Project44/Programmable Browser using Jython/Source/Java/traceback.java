...
public class traceback extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$49 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\traceback.py");
            funcTable = new _PyInner();
            c$0__print = Py.newCode(3, new String[] {"file", "str", "terminator"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "_print", false, false, funcTable, 0, null, null, 0, 1);
            c$1_print_list = Py.newCode(2, new String[] {"extracted_list", "file", "line", "filename", "name", "lineno"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "print_list", false, false, funcTable, 1, null, null, 0, 1);
            c$2_format_list = Py.newCode(1, new String[] {"extracted_list", "line", "filename", "name", "item", "list", "lineno"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "format_list", false, false, funcTable, 2, null, null, 0, 1);
            c$3_print_tb = Py.newCode(3, new String[] {"tb", "limit", "file", "filename", "name", "lineno", "n", "f", "co", "line"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "print_tb", false, false, funcTable, 3, null, null, 0, 1);
            c$4_format_tb = Py.newCode(2, new String[] {"tb", "limit"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "format_tb", false, false, funcTable, 4, null, null, 0, 1);
            c$5_extract_tb = Py.newCode(2, new String[] {"tb", "limit", "filename", "name", "lineno", "n", "f", "list", "co", "line"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "extract_tb", false, false, funcTable, 5, null, null, 0, 1);
            c$6_print_exception = Py.newCode(5, new String[] {"etype", "value", "tb", "limit", "file", "line", "lines"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "print_exception", false, false, funcTable, 6, null, null, 0, 1);
            c$7_format_exception = Py.newCode(4, new String[] {"etype", "value", "tb", "limit", "list"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "format_exception", false, false, funcTable, 7, null, null, 0, 1);
            c$8_format_exception_only = Py.newCode(2, new String[] {"etype", "value", "stype", "msg", "offset", "lineno", "line", "s", "filename", "i", "list", "c"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "format_exception_only", false, false, funcTable, 8, null, null, 0, 1);
            c$9__some_str = Py.newCode(1, new String[] {"value"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "_some_str", false, false, funcTable, 9, null, null, 0, 1);
            c$10_print_exc = Py.newCode(2, new String[] {"limit", "file", "tb", "etype", "value"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "print_exc", false, false, funcTable, 10, null, null, 0, 1);
            c$11_print_last = Py.newCode(2, new String[] {"limit", "file"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "print_last", false, false, funcTable, 11, null, null, 0, 1);
            c$12_print_stack = Py.newCode(3, new String[] {"f", "limit", "file"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "print_stack", false, false, funcTable, 12, null, null, 0, 1);
            c$13_format_stack = Py.newCode(2, new String[] {"f", "limit"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "format_stack", false, false, funcTable, 13, null, null, 0, 1);
            c$14_extract_stack = Py.newCode(2, new String[] {"f", "limit", "filename", "name", "lineno", "n", "list", "co", "line"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "extract_stack", false, false, funcTable, 14, null, null, 0, 1);
            c$15_tb_lineno = Py.newCode(1, new String[] {"tb", "tab", "i", "c", "addr", "stopat", "line"}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "tb_lineno", false, false, funcTable, 15, null, null, 0, 1);
            c$16_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\traceback.py", "main", false, false, funcTable, 16, null, null, 0, 0);
        }
