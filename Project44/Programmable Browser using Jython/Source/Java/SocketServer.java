...
public class SocketServer extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$51 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py");
            funcTable = new _PyInner();
            c$0___init__ = Py.newCode(3, new String[] {"self", "server_address", "RequestHandlerClass"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "__init__", false, false, funcTable, 0, null, null, 0, 1);
            c$1_server_activate = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "server_activate", false, false, funcTable, 1, null, null, 0, 1);
            c$2_serve_forever = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "serve_forever", false, false, funcTable, 2, null, null, 0, 1);
            c$3_handle_request = Py.newCode(1, new String[] {"self", "client_address", "request"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "handle_request", false, false, funcTable, 3, null, null, 0, 1);
            c$4_verify_request = Py.newCode(3, new String[] {"self", "request", "client_address"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "verify_request", false, false, funcTable, 4, null, null, 0, 1);
            c$5_process_request = Py.newCode(3, new String[] {"self", "request", "client_address"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "process_request", false, false, funcTable, 5, null, null, 0, 1);
            c$6_server_close = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "server_close", false, false, funcTable, 6, null, null, 0, 1);
            c$7_finish_request = Py.newCode(3, new String[] {"self", "request", "client_address"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "finish_request", false, false, funcTable, 7, null, null, 0, 1);
            c$8_close_request = Py.newCode(2, new String[] {"self", "request"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "close_request", false, false, funcTable, 8, null, null, 0, 1);
            c$9_handle_error = Py.newCode(3, new String[] {"self", "request", "client_address", "traceback"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "handle_error", false, false, funcTable, 9, null, null, 0, 1);
            c$10_BaseServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "BaseServer", false, false, funcTable, 10, null, null, 0, 0);
            c$11___init__ = Py.newCode(3, new String[] {"self", "server_address", "RequestHandlerClass"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "__init__", false, false, funcTable, 11, null, null, 0, 1);
            c$12_server_bind = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "server_bind", false, false, funcTable, 12, null, null, 0, 1);
            c$13_server_activate = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "server_activate", false, false, funcTable, 13, null, null, 0, 1);
            c$14_server_close = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "server_close", false, false, funcTable, 14, null, null, 0, 1);
            c$15_fileno = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "fileno", false, false, funcTable, 15, null, null, 0, 1);
            c$16_get_request = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "get_request", false, false, funcTable, 16, null, null, 0, 1);
            c$17_close_request = Py.newCode(2, new String[] {"self", "request"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "close_request", false, false, funcTable, 17, null, null, 0, 1);
            c$18_TCPServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "TCPServer", false, false, funcTable, 18, null, null, 0, 0);
            c$19_get_request = Py.newCode(1, new String[] {"self", "client_addr", "data"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "get_request", false, false, funcTable, 19, null, null, 0, 1);
            c$20_server_activate = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "server_activate", false, false, funcTable, 20, null, null, 0, 1);
            c$21_close_request = Py.newCode(2, new String[] {"self", "request"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "close_request", false, false, funcTable, 21, null, null, 0, 1);
            c$22_UDPServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "UDPServer", false, false, funcTable, 22, null, null, 0, 0);
            c$23_collect_children = Py.newCode(1, new String[] {"self", "status", "pid", "options"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "collect_children", false, false, funcTable, 23, null, null, 0, 1);
            c$24_process_request = Py.newCode(3, new String[] {"self", "request", "client_address", "pid"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "process_request", false, false, funcTable, 24, null, null, 0, 1);
            c$25_ForkingMixIn = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ForkingMixIn", false, false, funcTable, 25, null, null, 0, 0);
            c$26_process_request = Py.newCode(3, new String[] {"self", "request", "client_address", "t", "threading"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "process_request", false, false, funcTable, 26, null, null, 0, 1);
            c$27_ThreadingMixIn = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ThreadingMixIn", false, false, funcTable, 27, null, null, 0, 0);
            c$28_ForkingUDPServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ForkingUDPServer", false, false, funcTable, 28, null, null, 0, 0);
            c$29_ForkingTCPServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ForkingTCPServer", false, false, funcTable, 29, null, null, 0, 0);
            c$30_ThreadingUDPServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ThreadingUDPServer", false, false, funcTable, 30, null, null, 0, 0);
            c$31_ThreadingTCPServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ThreadingTCPServer", false, false, funcTable, 31, null, null, 0, 0);
            c$32_UnixStreamServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "UnixStreamServer", false, false, funcTable, 32, null, null, 0, 0);
            c$33_UnixDatagramServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "UnixDatagramServer", false, false, funcTable, 33, null, null, 0, 0);
            c$34_ThreadingUnixStreamServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ThreadingUnixStreamServer", false, false, funcTable, 34, null, null, 0, 0);
            c$35_ThreadingUnixDatagramServer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "ThreadingUnixDatagramServer", false, false, funcTable, 35, null, null, 0, 0);
            c$36___init__ = Py.newCode(4, new String[] {"self", "request", "client_address", "server"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "__init__", false, false, funcTable, 36, null, null, 0, 1);
            c$37_setup = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "setup", false, false, funcTable, 37, null, null, 0, 1);
            c$38___del__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "__del__", false, false, funcTable, 38, null, null, 0, 1);
            c$39_handle = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "handle", false, false, funcTable, 39, null, null, 0, 1);
            c$40_finish = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "finish", false, false, funcTable, 40, null, null, 0, 1);
            c$41_BaseRequestHandler = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "BaseRequestHandler", false, false, funcTable, 41, null, null, 0, 0);
            c$42_setup = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "setup", false, false, funcTable, 42, null, null, 0, 1);
            c$43_finish = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "finish", false, false, funcTable, 43, null, null, 0, 1);
            c$44_StreamRequestHandler = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "StreamRequestHandler", false, false, funcTable, 44, null, null, 0, 0);
            c$45_setup = Py.newCode(1, new String[] {"self", "StringIO"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "setup", false, false, funcTable, 45, null, null, 0, 1);
            c$46_finish = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "finish", false, false, funcTable, 46, null, null, 0, 1);
            c$47_DatagramRequestHandler = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "DatagramRequestHandler", false, false, funcTable, 47, null, null, 0, 0);
            c$48_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\SocketServer.py", "main", false, false, funcTable, 48, null, null, 0, 0);
        }
        ...
        private static PyObject setup$46(PyFrame frame) {
            ...
            frame.getlocal(0).__setattr__("wfile", frame.getlocal(1).__getattr__("StringIO").__call__(frame.getlocal(0).__getattr__("packet")));
            return Py.None;
        }
