...
public class javapath extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$49 = Py.newString("{");
            s$50 = Py.newString("}");
            s$51 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\javapath.py");
            funcTable = new _PyInner();
            c$0__tostr = Py.newCode(2, new String[] {"s", "method", "org"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "_tostr", false, false, funcTable, 0, null, null, 0, 1);
            c$1_dirname = Py.newCode(1, new String[] {"path", "result"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "dirname", false, false, funcTable, 1, null, null, 0, 1);
            c$2_basename = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "basename", false, false, funcTable, 2, null, null, 0, 1);
            c$3_split = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "split", false, false, funcTable, 3, null, null, 0, 1);
            c$4_splitext = Py.newCode(1, new String[] {"path", "i", "c", "n"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "splitext", false, false, funcTable, 4, null, null, 0, 1);
            c$5_splitdrive = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "splitdrive", false, false, funcTable, 5, null, null, 0, 1);
            c$6_exists = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "exists", false, false, funcTable, 6, null, null, 0, 1);
            c$7_isabs = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "isabs", false, false, funcTable, 7, null, null, 0, 1);
            c$8_isfile = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "isfile", false, false, funcTable, 8, null, null, 0, 1);
            c$9_isdir = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "isdir", false, false, funcTable, 9, null, null, 0, 1);
            c$10_join = Py.newCode(2, new String[] {"path", "args", "a", "g", "f"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "join", true, false, funcTable, 10, null, null, 0, 1);
            c$11_normcase = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "normcase", false, false, funcTable, 11, null, null, 0, 1);
            c$12_commonprefix = Py.newCode(1, new String[] {"m", "i", "item", "prefix"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "commonprefix", false, false, funcTable, 12, null, null, 0, 1);
            c$13_islink = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "islink", false, false, funcTable, 13, null, null, 0, 1);
            c$14_samefile = Py.newCode(2, new String[] {"path", "path2", "f", "f2"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "samefile", false, false, funcTable, 14, null, null, 0, 1);
            c$15_ismount = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "ismount", false, false, funcTable, 15, null, null, 0, 1);
            c$16_walk = Py.newCode(3, new String[] {"top", "func", "arg", "name", "names"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "walk", false, false, funcTable, 16, null, null, 0, 1);
            c$17_expanduser = Py.newCode(1, new String[] {"path", "c"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "expanduser", false, false, funcTable, 17, null, null, 0, 1);
            c$18_getuser = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "getuser", false, false, funcTable, 18, null, null, 0, 1);
            c$19_gethome = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "gethome", false, false, funcTable, 19, null, null, 0, 1);
            c$20_normpath = Py.newCode(1, new String[] {"path", "comps", "i", "pardir", "string", "slashes", "curdir", "sep"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "normpath", false, false, funcTable, 20, null, null, 0, 1);
            c$21_abspath = Py.newCode(1, new String[] {"path"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "abspath", false, false, funcTable, 21, null, null, 0, 1);
            c$22_getsize = Py.newCode(1, new String[] {"path", "size", "f"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "getsize", false, false, funcTable, 22, null, null, 0, 1);
            c$23_getmtime = Py.newCode(1, new String[] {"path", "f"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "getmtime", false, false, funcTable, 23, null, null, 0, 1);
            c$24_getatime = Py.newCode(1, new String[] {"path", "f"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "getatime", false, false, funcTable, 24, null, null, 0, 1);
            c$25_expandvars = Py.newCode(1, new String[] {"path", "varchars", "string", "index", "res", "c", "pathlen", "var"}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "expandvars", false, false, funcTable, 25, null, null, 0, 1);
            c$26_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\javapath.py", "main", false, false, funcTable, 26, null, null, 0, 0);
        }
