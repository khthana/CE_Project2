...
public class sre extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$46 = Py.newString("");
            s$47 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\sre.py");
            funcTable = new _PyInner();
            c$0_match = Py.newCode(3, new String[] {"pattern", "string", "flags"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "match", false, false, funcTable, 0, null, null, 0, 1);
            c$1_search = Py.newCode(3, new String[] {"pattern", "string", "flags"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "search", false, false, funcTable, 1, null, null, 0, 1);
            c$2_sub = Py.newCode(4, new String[] {"pattern", "repl", "string", "count"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "sub", false, false, funcTable, 2, null, null, 0, 1);
            c$3_subn = Py.newCode(4, new String[] {"pattern", "repl", "string", "count"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "subn", false, false, funcTable, 3, null, null, 0, 1);
            c$4_split = Py.newCode(3, new String[] {"pattern", "string", "maxsplit"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "split", false, false, funcTable, 4, null, null, 0, 1);
            c$5_findall = Py.newCode(3, new String[] {"pattern", "string", "maxsplit"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "findall", false, false, funcTable, 5, null, null, 0, 1);
            c$6_compile = Py.newCode(2, new String[] {"pattern", "flags"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "compile", false, false, funcTable, 6, null, null, 0, 1);
            c$7_purge = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "purge", false, false, funcTable, 7, null, null, 0, 1);
            c$8_template = Py.newCode(2, new String[] {"pattern", "flags"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "template", false, false, funcTable, 8, null, null, 0, 1);
            c$9_escape = Py.newCode(1, new String[] {"pattern", "i", "s", "c"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "escape", false, false, funcTable, 9, null, null, 0, 1);
            c$10__join = Py.newCode(2, new String[] {"seq", "sep"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_join", false, false, funcTable, 10, null, null, 0, 1);
            c$11__compile = Py.newCode(1, new String[] {"key", "p", "flags", "pattern", "v"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_compile", true, false, funcTable, 11, null, null, 0, 1);
            c$12__compile_repl = Py.newCode(1, new String[] {"key", "p", "repl", "pattern", "v"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_compile_repl", true, false, funcTable, 12, null, null, 0, 1);
            c$13__expand = Py.newCode(3, new String[] {"pattern", "match", "template"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_expand", false, false, funcTable, 13, null, null, 0, 1);
            c$14__sub = Py.newCode(4, new String[] {"pattern", "template", "string", "count"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_sub", false, false, funcTable, 14, null, null, 0, 1);
            c$15_filter = Py.newCode(2, new String[] {"match", "template"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "filter", false, false, funcTable, 15, null, null, 0, 1);
            c$16__subn = Py.newCode(4, new String[] {"pattern", "template", "string", "count", "filter", "append", "n", "m", "i", "e", "c", "b", "s"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_subn", false, false, funcTable, 16, null, null, 0, 1);
            c$17__split = Py.newCode(3, new String[] {"pattern", "string", "maxsplit", "append", "n", "m", "i", "g", "e", "extend", "c", "b", "s"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_split", false, false, funcTable, 17, null, null, 0, 1);
            c$18__pickle = Py.newCode(1, new String[] {"p"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "_pickle", false, false, funcTable, 18, null, null, 0, 1);
            c$19___init__ = Py.newCode(2, new String[] {"self", "lexicon", "p", "SUBPATTERN", "phrase", "action", "BRANCH", "s"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "__init__", false, false, funcTable, 19, null, null, 0, 1);
            c$20_scan = Py.newCode(2, new String[] {"self", "string", "append", "m", "action", "j", "i", "match", "result"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "scan", false, false, funcTable, 20, null, null, 0, 1);
            c$21_Scanner = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "Scanner", false, false, funcTable, 21, null, null, 0, 0);
            c$22_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre.py", "main", false, false, funcTable, 22, null, null, 0, 0);
        }
