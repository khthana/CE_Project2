...
public class sre_parse extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$107 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py");
            funcTable = new _PyInner();
            c$0___init__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__init__", false, false, funcTable, 0, null, null, 0, 1);
            c$1_opengroup = Py.newCode(2, new String[] {"self", "name", "gid"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "opengroup", false, false, funcTable, 1, null, null, 0, 1);
            c$2_closegroup = Py.newCode(2, new String[] {"self", "gid"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "closegroup", false, false, funcTable, 2, null, null, 0, 1);
            c$3_checkgroup = Py.newCode(2, new String[] {"self", "gid"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "checkgroup", false, false, funcTable, 3, null, null, 0, 1);
            c$4_Pattern = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "Pattern", false, false, funcTable, 4, null, null, 0, 0);
            c$5___init__ = Py.newCode(3, new String[] {"self", "pattern", "data"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__init__", false, false, funcTable, 5, null, null, 0, 1);
            c$6_dump = Py.newCode(2, new String[] {"self", "level", "nl", "av", "i", "op", "a"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "dump", false, false, funcTable, 6, null, null, 0, 1);
            c$7___repr__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__repr__", false, false, funcTable, 7, null, null, 0, 1);
            c$8___len__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__len__", false, false, funcTable, 8, null, null, 0, 1);
            c$9___delitem__ = Py.newCode(2, new String[] {"self", "index"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__delitem__", false, false, funcTable, 9, null, null, 0, 1);
            c$10___getitem__ = Py.newCode(2, new String[] {"self", "index"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__getitem__", false, false, funcTable, 10, null, null, 0, 1);
            c$11___setitem__ = Py.newCode(3, new String[] {"self", "index", "code"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__setitem__", false, false, funcTable, 11, null, null, 0, 1);
            c$12___getslice__ = Py.newCode(3, new String[] {"self", "start", "stop"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__getslice__", false, false, funcTable, 12, null, null, 0, 1);
            c$13_insert = Py.newCode(3, new String[] {"self", "index", "code"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "insert", false, false, funcTable, 13, null, null, 0, 1);
            c$14_append = Py.newCode(2, new String[] {"self", "code"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "append", false, false, funcTable, 14, null, null, 0, 1);
            c$15_getwidth = Py.newCode(1, new String[] {"self", "hi", "lo", "op", "av", "l", "j", "i", "h"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "getwidth", false, false, funcTable, 15, null, null, 0, 1);
            c$16_SubPattern = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "SubPattern", false, false, funcTable, 16, null, null, 0, 0);
            c$17___init__ = Py.newCode(2, new String[] {"self", "string"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "__init__", false, false, funcTable, 17, null, null, 0, 1);
            c$18__Tokenizer__next = Py.newCode(1, new String[] {"self", "char", "c"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "_Tokenizer__next", false, false, funcTable, 18, null, null, 0, 1);
            c$19_match = Py.newCode(3, new String[] {"self", "char", "skip"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "match", false, false, funcTable, 19, null, null, 0, 1);
            c$20_get = Py.newCode(1, new String[] {"self", "this"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "get", false, false, funcTable, 20, null, null, 0, 1);
            c$21_tell = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "tell", false, false, funcTable, 21, null, null, 0, 1);
            c$22_seek = Py.newCode(2, new String[] {"self", "index"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "seek", false, false, funcTable, 22, null, null, 0, 1);
            c$23_Tokenizer = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "Tokenizer", false, false, funcTable, 23, null, null, 0, 0);
            c$24_isident = Py.newCode(1, new String[] {"char"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "isident", false, false, funcTable, 24, null, null, 0, 1);
            c$25_isdigit = Py.newCode(1, new String[] {"char"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "isdigit", false, false, funcTable, 25, null, null, 0, 1);
            c$26_isname = Py.newCode(1, new String[] {"name", "char"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "isname", false, false, funcTable, 26, null, null, 0, 1);
            c$27__group = Py.newCode(2, new String[] {"escape", "groups", "gid"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "_group", false, false, funcTable, 27, null, null, 0, 1);
            c$28__class_escape = Py.newCode(2, new String[] {"source", "escape", "code"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "_class_escape", false, false, funcTable, 28, null, null, 0, 1);
            c$29__escape = Py.newCode(3, new String[] {"source", "escape", "state", "here", "code", "group"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "_escape", false, false, funcTable, 29, null, null, 0, 1);
            c$30__parse_sub = Py.newCode(3, new String[] {"source", "state", "nested", "subpattern", "prefix", "items", "set", "item"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "_parse_sub", false, false, funcTable, 30, null, null, 0, 1);
            c$31__parse = Py.newCode(2, new String[] {"source", "state", "code", "this", "name", "group", "code2", "code1", "max", "start", "set", "item", "subpattern", "lo", "here", "char", "gid", "p", "dir", "min", "hi"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "_parse", false, false, funcTable, 31, null, null, 0, 1);
            c$32_parse = Py.newCode(3, new String[] {"str", "flags", "pattern", "source", "p", "tail"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "parse", false, false, funcTable, 32, null, null, 0, 1);
            c$33_literal = Py.newCode(2, new String[] {"literal", "p"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "literal", false, false, funcTable, 33, null, null, 0, 1);
            c$34_parse_template = Py.newCode(2, new String[] {"source", "pattern", "code", "this", "literals", "index", "group", "s", "sep", "p", "i", "literal", "groups", "char", "c", "a", "name"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "parse_template", false, false, funcTable, 34, null, null, 0, 1);
            c$35_expand_template = Py.newCode(2, new String[] {"template", "match", "literals", "groups", "g", "index", "group", "s", "sep"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "expand_template", false, false, funcTable, 35, null, null, 0, 1);
            c$36_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_parse.py", "main", false, false, funcTable, 36, null, null, 0, 0);
        }
