...
public class sre_compile extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$14 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py");
            funcTable = new _PyInner();
            c$0_fixup = Py.newCode(2, new String[] {"literal", "flags"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "fixup", false, false, funcTable, 0, null, null, 0, 1);
            c$1_lambda = Py.newCode(1, new String[] {"x"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "<lambda>", false, false, funcTable, 1, null, null, 0, 1);
            c$2__compile = Py.newCode(3, new String[] {"code", "pattern", "flags", "av", "emit", "skip", "lo", "op", "fixup", "hi", "tail"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "_compile", false, false, funcTable, 2, null, null, 0, 1);
            c$3_lambda = Py.newCode(1, new String[] {"x"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "<lambda>", false, false, funcTable, 3, null, null, 0, 1);
            c$4__compile_charset = Py.newCode(4, new String[] {"charset", "flags", "code", "fixup", "op", "av", "emit"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "_compile_charset", false, false, funcTable, 4, null, null, 0, 1);
            c$5__optimize_charset = Py.newCode(2, new String[] {"charset", "fixup", "op", "v", "av", "charmap", "p", "n", "m", "runs", "i", "out", "c", "data"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "_optimize_charset", false, false, funcTable, 5, null, null, 0, 1);
            c$6__simple = Py.newCode(1, new String[] {"av", "hi", "lo"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "_simple", false, false, funcTable, 6, null, null, 0, 1);
            c$7__compile_info = Py.newCode(3, new String[] {"code", "pattern", "flags", "hi", "charset", "lo", "op", "av", "emit", "p", "skip", "prefix", "i", "mask", "table", "c", "prefix_skip"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "_compile_info", false, false, funcTable, 7, null, null, 0, 1);
            c$8__code = Py.newCode(2, new String[] {"p", "flags", "code"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "_code", false, false, funcTable, 8, null, null, 0, 1);
            c$9_compile = Py.newCode(2, new String[] {"p", "flags", "groupindex", "code", "indexgroup", "k", "i", "sre_parse", "pattern"}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "compile", false, false, funcTable, 9, null, null, 0, 1);
            c$10_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\sre_compile.py", "main", false, false, funcTable, 10, null, null, 0, 0);
        }
