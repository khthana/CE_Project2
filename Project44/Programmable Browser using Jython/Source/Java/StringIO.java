...
public class StringIO extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$23 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py");
            funcTable = new _PyInner();
            c$0___init__ = Py.newCode(2, new String[] {"self", "buf"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "__init__", false, false, funcTable, 0, null, null, 0, 1);
            c$1_close = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "close", false, false, funcTable, 1, null, null, 0, 1);
            c$2_isatty = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "isatty", false, false, funcTable, 2, null, null, 0, 1);
            c$3_seek = Py.newCode(3, new String[] {"self", "pos", "mode"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "seek", false, false, funcTable, 3, null, null, 0, 1);
            c$4_tell = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "tell", false, false, funcTable, 4, null, null, 0, 1);
            c$5_read = Py.newCode(2, new String[] {"self", "n", "r", "newpos"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "read", false, false, funcTable, 5, null, null, 0, 1);
            c$6_readline = Py.newCode(2, new String[] {"self", "length", "i", "r", "newpos"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "readline", false, false, funcTable, 6, null, null, 0, 1);
            c$7_readlines = Py.newCode(2, new String[] {"self", "sizehint", "line", "lines", "total"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "readlines", false, false, funcTable, 7, null, null, 0, 1);
            c$8_truncate = Py.newCode(2, new String[] {"self", "size"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "truncate", false, false, funcTable, 8, null, null, 0, 1);
            c$9_write = Py.newCode(2, new String[] {"self", "s", "newpos"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "write", false, false, funcTable, 9, null, null, 0, 1);
            c$10_writelines = Py.newCode(2, new String[] {"self", "list"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "writelines", false, false, funcTable, 10, null, null, 0, 1);
            c$11_flush = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "flush", false, false, funcTable, 11, null, null, 0, 1);
            c$12_getvalue = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "getvalue", false, false, funcTable, 12, null, null, 0, 1);
            c$13_StringIO = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "StringIO", false, false, funcTable, 13, null, null, 0, 0);
            c$14_test = Py.newCode(0, new String[] {"length", "file", "f", "list", "here", "line2", "text", "sys", "lines", "line"}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "test", false, false, funcTable, 14, null, null, 0, 1);
            c$15_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\StringIO.py", "main", false, false, funcTable, 15, null, null, 0, 0);
        }
