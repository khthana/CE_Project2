...
public class atexit extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$12 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\atexit.py");
            funcTable = new _PyInner();
            c$0__run_exitfuncs = Py.newCode(0, new String[] {"targs", "func", "kargs"}, "C:\\jdk1.4\\jython2.1\\Lib\\atexit.py", "_run_exitfuncs", false, false, funcTable, 0, null, null, 0, 1);
            c$1_register = Py.newCode(3, new String[] {"func", "targs", "kargs"}, "C:\\jdk1.4\\jython2.1\\Lib\\atexit.py", "register", true, true, funcTable, 1, null, null, 0, 1);
            c$2_x1 = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\atexit.py", "x1", false, false, funcTable, 2, null, null, 0, 1);
            c$3_x2 = Py.newCode(1, new String[] {"n"}, "C:\\jdk1.4\\jython2.1\\Lib\\atexit.py", "x2", false, false, funcTable, 3, null, null, 0, 1);
            c$4_x3 = Py.newCode(2, new String[] {"n", "kwd"}, "C:\\jdk1.4\\jython2.1\\Lib\\atexit.py", "x3", false, false, funcTable, 4, null, null, 0, 1);
            c$5_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\atexit.py", "main", false, false, funcTable, 5, null, null, 0, 0);
        }
