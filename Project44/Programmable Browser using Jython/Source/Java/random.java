...
public class random extends java.lang.Object {
    ...
    public static class _PyInner extends PyFunctionTable implements PyRunnable {
        ...
        private static void initConstants() {
            ...
            s$112 = Py.newString("C:\\jdk1.4\\jython2.1\\Lib\\random.py");
            funcTable = new _PyInner();
            c$0__verify = Py.newCode(3, new String[] {"name", "computed", "expected"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "_verify", false, false, funcTable, 0, null, null, 0, 1);
            c$1___init__ = Py.newCode(2, new String[] {"self", "x"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "__init__", false, false, funcTable, 1, null, null, 0, 1);
            c$2_seed = Py.newCode(2, new String[] {"self", "a", "time", "z", "y", "x"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "seed", false, false, funcTable, 2, null, null, 0, 1);
            c$3_random = Py.newCode(1, new String[] {"self", "x", "z", "y"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "random", false, false, funcTable, 3, null, null, 0, 1);
            c$4_getstate = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "getstate", false, false, funcTable, 4, null, null, 0, 1);
            c$5_setstate = Py.newCode(2, new String[] {"self", "state", "version"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "setstate", false, false, funcTable, 5, null, null, 0, 1);
            c$6_jumpahead = Py.newCode(2, new String[] {"self", "n", "x", "z", "y"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "jumpahead", false, false, funcTable, 6, null, null, 0, 1);
            c$7__Random__whseed = Py.newCode(4, new String[] {"self", "x", "y", "z", "time", "t"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "_Random__whseed", false, false, funcTable, 7, null, null, 0, 1);
            c$8_whseed = Py.newCode(2, new String[] {"self", "a", "x", "z", "y"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "whseed", false, false, funcTable, 8, null, null, 0, 1);
            c$9___getstate__ = Py.newCode(1, new String[] {"self"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "__getstate__", false, false, funcTable, 9, null, null, 0, 1);
            c$10___setstate__ = Py.newCode(2, new String[] {"self", "state"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "__setstate__", false, false, funcTable, 10, null, null, 0, 1);
            c$11_randrange = Py.newCode(6, new String[] {"self", "start", "stop", "step", "int", "default", "istep", "n", "istart", "istop"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "randrange", false, false, funcTable, 11, null, null, 0, 1);
            c$12_randint = Py.newCode(3, new String[] {"self", "a", "b"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "randint", false, false, funcTable, 12, null, null, 0, 1);
            c$13_choice = Py.newCode(2, new String[] {"self", "seq"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "choice", false, false, funcTable, 13, null, null, 0, 1);
            c$14_shuffle = Py.newCode(4, new String[] {"self", "x", "random", "int", "j", "i"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "shuffle", false, false, funcTable, 14, null, null, 0, 1);
            c$15_uniform = Py.newCode(3, new String[] {"self", "a", "b"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "uniform", false, false, funcTable, 15, null, null, 0, 1);
            c$16_normalvariate = Py.newCode(3, new String[] {"self", "mu", "sigma", "u2", "u1", "random", "zz", "z"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "normalvariate", false, false, funcTable, 16, null, null, 0, 1);
            c$17_lognormvariate = Py.newCode(3, new String[] {"self", "mu", "sigma"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "lognormvariate", false, false, funcTable, 17, null, null, 0, 1);
            c$18_cunifvariate = Py.newCode(3, new String[] {"self", "mean", "arc"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "cunifvariate", false, false, funcTable, 18, null, null, 0, 1);
            c$19_expovariate = Py.newCode(2, new String[] {"self", "lambd", "u", "random"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "expovariate", false, false, funcTable, 19, null, null, 0, 1);
            c$20_vonmisesvariate = Py.newCode(3, new String[] {"self", "mu", "kappa", "random", "theta", "z", "r", "u3", "u2", "u1", "f", "c", "b", "a"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "vonmisesvariate", false, false, funcTable, 20, null, null, 0, 1);
            c$21_gammavariate = Py.newCode(3, new String[] {"self", "alpha", "beta", "ainv"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "gammavariate", false, false, funcTable, 21, null, null, 0, 1);
            c$22_stdgamma = Py.newCode(5, new String[] {"self", "alpha", "ainv", "bbb", "ccc", "random", "z", "x", "v", "u", "r", "p", "u2", "u1", "b"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "stdgamma", false, false, funcTable, 22, null, null, 0, 1);
            c$23_gauss = Py.newCode(3, new String[] {"self", "mu", "sigma", "x2pi", "random", "g2rad", "z"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "gauss", false, false, funcTable, 23, null, null, 0, 1);
            c$24_betavariate = Py.newCode(3, new String[] {"self", "alpha", "beta", "y"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "betavariate", false, false, funcTable, 24, null, null, 0, 1);
            c$25_paretovariate = Py.newCode(2, new String[] {"self", "alpha", "u"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "paretovariate", false, false, funcTable, 25, null, null, 0, 1);
            c$26_weibullvariate = Py.newCode(3, new String[] {"self", "alpha", "beta", "u"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "weibullvariate", false, false, funcTable, 26, null, null, 0, 1);
            c$27_Random = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "Random", false, false, funcTable, 27, null, null, 0, 0);
            c$28__test_generator = Py.newCode(2, new String[] {"n", "funccall", "smallest", "code", "sum", "largest", "time", "x", "t1", "t0", "avg", "i", "stddev", "sqsum"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "_test_generator", false, false, funcTable, 28, null, null, 0, 1);
            c$29__test = Py.newCode(1, new String[] {"N", "r2", "r1", "i", "s"}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "_test", false, false, funcTable, 29, null, null, 0, 1);
            c$30_main = Py.newCode(0, new String[] {}, "C:\\jdk1.4\\jython2.1\\Lib\\random.py", "main", false, false, funcTable, 30, null, null, 0, 0);
        }
