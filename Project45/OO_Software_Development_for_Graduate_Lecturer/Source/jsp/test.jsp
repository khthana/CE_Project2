			...
			<td width="778"  valign="top"> 
              ...
              <br>			  			
                <center>
                	...
                	<table width="650" border="1" cellspacing="0" cellpadding="0" bordercolor="#E8EBF6">
                  	<tr> 
                    	<td height="25" align="right"   bgcolor="#B3BEF5"><font class="myfont2"  >ชื่อ&nbsp;</font></td>
                    	<td align="left"  bgcolor="#CBD2F4"><font class="myfont2"> รศ.ดร.</font></td>
                  	</tr>
                  	<tr> 
                    	<td width="216" bgcolor="#B3BEF5">&nbsp;</td>
                    	<td bgcolor="#CBD2F4">&nbsp;</td>
                  	</tr>
                	</table>
