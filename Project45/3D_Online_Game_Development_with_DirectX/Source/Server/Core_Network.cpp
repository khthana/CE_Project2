...
BOOL cNetworkServer::Host(GUID *guidAdapter, long Port, char *SessionName, char *Password, long MaxPlayers)
{
  ...
  /*  if(FAILED(DirectPlay8AddressCreate(&IID_IDirectPlay8Address, (void**)&pDPAddress, NULL)))
      return FALSE;
  */
  if(FAILED(CoCreateInstance(CLSID_DirectPlay8Address, NULL, CLSCTX_ALL, IID_IDirectPlay8Address, (void**)&pDPAddress)))
	return FALSE;
...
BOOL cNetworkClient::Connect(GUID *guidAdapter, char *IP, long Port, char *PlayerName, char *SessionName, char *SessionPassword)
{
  ...
  */
  if(FAILED(CoCreateInstance(CLSID_DirectPlay8Address, NULL, CLSCTX_ALL, IID_IDirectPlay8Address, (void**)&pDPAddress)))
	return FALSE;
  if(FAILED(CoCreateInstance(CLSID_DirectPlay8Address, NULL, CLSCTX_ALL, IID_IDirectPlay8Address, (void**)&pDPDevice)))
  {	pDPAddress->Release();
	return FALSE;
  }
