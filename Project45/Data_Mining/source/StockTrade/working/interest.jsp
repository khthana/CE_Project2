...
<table width="70%" height="90" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr bordercolor="#000000" bgcolor="#CCCC99" >
    ...
    <td width="18%"><div align="center"><a href="Graphs.jsp" target="_blank">กราฟราคาหุ้น</a></div></td>
...
<p><font color="#000066"><strong>แนะนำหุ้นที่น่าเล่น:</strong></font></p>
<table width="73%" height="172" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="20">
<p><font color="#3366FF"><strong>ควรซื้อ:</strong></font></p>
      </td>
  </tr>
  <%if( buy !=null ){
...
<table width="73%" height="172" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="20"> <p><font color="#3366FF"><strong>ควรขาย:</strong></font></p></td>
  </tr>
  <%if( sell !=null ){
