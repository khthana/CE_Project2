...
<form name="SelectGraph" action="Graphs.jsp" method="get">
  ...
  <td valign="top" align="center">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td><font color="#999933" face="Courier New, Courier, mono"><strong>ดูกราฟราคาหุ้น</strong></font></td>
      </tr>
      <tr>
...
%>
                ...
                <tr>
                 ...
                 if( i==1 ){
                   out.print("ราคาปิดน่าจะปรับตัวสูงขึ้น");
                 }
                 else if( i==-1 ){
                   out.print("ราคาปิดน่าจะปรับตัวลดลง");
                 }
                 else if( i==0 ){
                   out.print("ราคาปิดน่าจะยังทรงตัว");
                 }
                }
                catch( Exception e ){
                  System.out.print( e );
          ...
          <tr>
            <td height="29"><font color="#3366FF">หุ้น <%out.print(stock);%></font></td>
          </tr>
          <tr>
            <td height="125">&nbsp;</td>
          </tr>
