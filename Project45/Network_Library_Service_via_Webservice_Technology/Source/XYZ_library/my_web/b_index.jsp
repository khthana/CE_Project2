...
<html>
<head>
<title>Wellcome to Main KMITL's Library</title>
...
<table width="100%" border="1">
  ...
  <tr> 
    <td width="30%" ><form name="form1" method="post" action="login.jsp">
	<table width="100%" border="1">
        <tr> 
          <td>username</td>
          <td>
      ...
      <form name="form3" method="post" action="">
        <table width="100%" border="1">
          <tr> 
            <td><div align="center">Registry for a new member</div></td>
          </tr>
          <tr> 
            <td> <div align="center"> 
