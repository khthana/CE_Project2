...
<% System.out.println("***************---------/////-----------*****************");  %>
<%	
		user_name = new String(request.getParameter("username").getBytes("iso-8859-1"), "tis-620");
		library = new String(request.getParameter("library").getBytes("iso-8859-1"), "tis-620");
