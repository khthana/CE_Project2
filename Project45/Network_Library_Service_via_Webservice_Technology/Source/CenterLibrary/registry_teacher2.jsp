...
String library = new String(request.getParameter("library").getBytes("iso-8859-1"),"tis-620");	System.out.println("step /////1/////");
...
String month = new String(request.getParameter("mouth").getBytes("iso-8859-1"),"tis-620");		System.out.println("step /////1.2/////");
...
String work_add1 = new String(request.getParameter("workadd1").getBytes("iso-8859-1"),"tis-620");		
String work_add2 = new String(request.getParameter("workadd2").getBytes("iso-8859-1"),"tis-620");		
...
String address = new String(request.getParameter("address").getBytes("iso-8859-1"),"tis-620");	System.out.println("step /////2/////");																																		
...
String road = new String(request.getParameter("road").getBytes("iso-8859-1"),"tis-620");	System.out.println("step /////2.1/////");
...
String province = new String(request.getParameter("province").getBytes("iso-8859-1"),"tis-620");	System.out.println("step /////2.2/////");
...
String phone3 = new String(request.getParameter("phone3").getBytes("iso-8859-1"),"tis-620");
String phone4 = new String(request.getParameter("phone4").getBytes("iso-8859-1"),"tis-620");										
String email = new String(request.getParameter("email").getBytes("iso-8859-1"),"tis-620");	System.out.println("step /////3/////");
String news_type1 = "0";
String news_type2 = "0";
String news_type3 = "0";
String news_type4 = "0"; 
...
<table width="100%" border="0">
  ...
  <tr> 
    <td>&nbsp;</td>
    <td colspan="2" rowspan="2"> <table width="100%" border="0" cellspacing="7"  background="fill_whi_M2.gif">
        <tr> 
          <td colspan="2"> </td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td colspan="2"><font  face="AngsanaUPC, BrowalliaUPC, CordiaUPC">โทรศัพท์ที่ทำงาน 
            ...
            ต่อ 
            <input name="phone3" type="text" size="5" maxlength="5" disabled value="<%=phone3 %>">
            </font><font size="+1" face="AngsanaUPC, BrowalliaUPC, CordiaUPC">โทรสาร 
            <input name="phone4" type="text" size="12" maxlength="12" disabled value="<%=phone4 %>">
            </font></td>
        </tr>
        <tr> 
...
<jsp:useBean id="errorMessages" scope="request" class="java.util.Vector"/>
	...
	%></td>
		...
		<input name="phone2" type="hidden" value="<%=phone2+"ต่อ"+phone3+" fax:"+phone4 %>">
