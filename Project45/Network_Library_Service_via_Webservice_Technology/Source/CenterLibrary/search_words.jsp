    ...
    <td colspan="5"><table width="92%" border="0">
                                <tr> 
                                        ...
                                        <td colspan="2" ><div align="left"><font size="-1"><strong>ค้นหาโดย 
                                                        คำสำคัญ </strong></font></div></td>
                                        <td width="44%" >&nbsp;</td>
                                        <td width="6%">&nbsp;</td>
                                </tr>
                                <tr> 
                                        <td height="40">&nbsp;</td>
                                        <td colspan="3"><font size="-1">ใส่คำสำคัญในกล่องข้อความด้านล่าง</font></td>
                                        <td>&nbsp;</td>
                                </tr>
                                <tr> 
                                        <td>&nbsp;</td>
                                                        ...
                                                        <table width="100%" border="0">
                                                                <tr> 
                                                                        <td width="52%"><div align="center"> 
                                                                                        ...
                                                                                        <input name="search_from" type="hidden" value="words">
                                ...
                                <tr> 
                                        <td rowspan="2">&nbsp;</td>
                                        <td colspan="3"><font size="-1">คำสำคัญ 
                                                อาจเป็นคำบางส่วนจากชื่อเรื่ง, 
                                                ชื่อผู้แต่ง, หัวเรื่อง หรือส่วนหนึ่งจากบันทึกย่อภายในหนังสือ</font></td>
                                        <td rowspan="2">&nbsp;</td>
                                </tr>
                                <tr> 
