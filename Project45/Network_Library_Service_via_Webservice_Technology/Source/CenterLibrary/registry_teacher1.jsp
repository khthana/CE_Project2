...
%>
<% System.out.println("***********************");
String username=new String(request.getParameter("username").getBytes("iso-8859-1"), "tis-620");	System.out.println("step 1");
...
String last_name = new String(request.getParameter("last_name").getBytes("iso-8859-1"),"utf-8"); System.out.println("step 2");
...
String status = new String(request.getParameter("status").getBytes("iso-8859-1"),"utf-8"); System.out.println("step 3");
String work_add1 = new String(request.getParameter("workadd1").getBytes("iso-8859-1"),"utf-8");	System.out.println(work_add1);
String work_add2 = new String(request.getParameter("workadd2").getBytes("iso-8859-1"),"utf-8");
String home_num = new String(request.getParameter("home_num").getBytes("iso-8859-1"),"utf-8"); System.out.println("step 3.1");
String address = new String(request.getParameter("address").getBytes("iso-8859-1"),"utf-8");
String village = new String(request.getParameter("village").getBytes("iso-8859-1"),"utf-8"); System.out.println("step 3.2");
...
String road = new String(request.getParameter("road").getBytes("iso-8859-1"),"utf-8"); System.out.println("step 4");
...
String phone1 = new String(request.getParameter("phone1").getBytes("iso-8859-1"),"utf-8"); System.out.println("step 5");
String phone2 = new String(request.getParameter("phone2").getBytes("iso-8859-1"),"utf-8");System.out.println("step 6");
String email = new String(request.getParameter("email").getBytes("iso-8859-1"),"utf-8");System.out.println("step 7");

System.out.println("this is news_type");

System.out.println("---------------------");
System.out.println(request.getParameter("category_a"));
%>
<%	
...
// ให้ค่าไปหน้า ต่อไป
	%><jsp:forward page="registry_teacher2.jsp"/> 
	<% ;}
	%>
