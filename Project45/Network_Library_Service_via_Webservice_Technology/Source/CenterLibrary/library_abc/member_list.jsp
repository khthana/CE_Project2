    ...
    <td colspan="2"> <div align="center">
        <form name="form1" method="post" action="">
          <table width="75%" border="1">
            <tr bgcolor="#99CC00"> 
              <td width="24%"><div align="center"><font color="#000000" size="-1"><strong>username</strong></font></div></td>
              <td width="35%"><div align="center"><font color="#000000" size="-1"><strong>ชื่อ</strong></font></div></td>
              <td width="41%"><div align="center"><font color="#000000" size="-1"><strong>นามสกุล</strong></font></div></td>
            </tr>
            <tr> 
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            ...
            <tr> 
              ...
              <td><div align="center"> 
                  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="100" height="20">
                    ...
                    <param name="quality" value="high">
                    <param name="base" value=".">
                    <embed src="button41.swf" base="."  quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="100" height="20" ></embed> 
                  </object>
                </div></td>
              <td><div align="center"> 
                  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="50" height="37">
                    ...
                    <param name="quality" value="high">
                    <embed src="button26.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="50" height="37" ></embed> 
                  </object>
                </div></td>
              <td><div align="center"> 
                  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="50" height="37">
