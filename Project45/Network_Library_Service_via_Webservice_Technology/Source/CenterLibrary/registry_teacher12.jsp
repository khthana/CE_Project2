    ...
    <td colspan="2" rowspan="2"> <table width="100%" border="0" cellspacing="7"  background="fill_whi_M2.gif">
        ...
        <tr> 
          <td colspan="2"><table width="100%" border="1" cellpadding="4" cellspacing="0" frame="below">
              ...
              <tr> 
                <td rowspan="3">&nbsp;</td>
                <td><%if ((request.getParameter("news_type")).equals("1"))out.println(text1);%>
			<%if ((request.getParameter("news_type")).equals("2"))out.println(text2);%>
			<%if ((request.getParameter("news_type")).equals("3"))out.println(text3);%>
			<%if ((request.getParameter("news_type")).equals("4"))out.println(text4);%>		
		</td>
                <td rowspan="3">&nbsp;</td>
              </tr>
              <tr> 
                <td><font face="AngsanaUPC, BrowalliaUPC, CordiaUPC">&nbsp; </font> 
                </td>
              </tr>
              <tr> 
