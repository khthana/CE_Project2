...
<frameset rows="80,*" cols="*" frameborder="NO" border="0" framespacing="0">
  <frame src="../proxy/my_web/user_head_frame.jsp" name="user_page_head_frame" scrolling="yes"  >
  <frameset cols="80,*" frameborder="NO" border="0" framespacing="0">
    <frame src="../proxy/my_web/user_left_frame.jsp" name="user_page_left_frame" scrolling="NO" noresize>
    <frame src="../proxy/my_web/user_center_frame.jsp" name="user_page_center_frame">
  </frameset>
</frameset>
<noframes> 
<body>
