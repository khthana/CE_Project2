...
<table width="100%" border="0">
  ...
  <tr> 
	...
	<%	
		...
		try{	
			String detail1 = "Title";
			String detail2 = "Author";
			if(search_from.equals("author"))	{ books=soapProxy.searchBookByAuthor(a);  detail1="Author"; detail2="Title";		System.out.println("Author");}
	...
	%>
        <tr> 
          <td width="4%" bgcolor="#3399FF"><div align="center"><font color="#FFFFFF" size="-2"><strong>Num</strong></font></div></td>
          ...
          <td width="6%" bgcolor="#3399FF"><div align="center"><font color="#FFFFFF" size="-2"><strong>years</strong></font></div></td>
          <td width="14%" bgcolor="#3399FF"><div align="center"><font color="#FFFFFF" size="-2"><strong>entries 
              found</strong></font></div></td>
        </tr>
        <!-- เริ่มแสดงรายการหนังสือที่ค้นหาได้ -->
        
        <tr> 
          <td><%=c%></td>
          <%	if(searh_from.equals("author")){
	  %>
