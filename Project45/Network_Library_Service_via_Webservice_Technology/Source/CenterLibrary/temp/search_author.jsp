...
<%String library_temp = request.getParameter("library");%>
    ...
    <td colspan="5"><table width="92%" border="0">
        <tr> 
          ...
          <td colspan="2" ><div align="left"><font size="-1"><strong>ค้นหาโดย 
              ชื่อผู้แต่ง</strong></font></div></td>
          <td width="44%" >&nbsp;</td>
          <td width="6%">&nbsp;</td>
        </tr>
        <tr> 
          <td height="40">&nbsp;</td>
          <td colspan="3"><font size="-1">ใส่ชื่อผู้แต่งในกล่องข้อความด้านล่าง</font></td>
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
          <td colspan="3"><form name="form1" method="post" action="search_resualt.jsp">
              <table width="100%" border="0">
                <tr>
                  <td width="52%"><div align="center">
                      <input type="text" name="key">
		      <input name="library" type="hidden" value="<%= session.getAttribute("library")%>">
		       <input name="start" type="hidden" value="0">
                    </div></td>
                  <td width="48%"><input type="submit" name="Submit" value=" ���� "></td>
                </tr>
              </table>
            </form></td>
          <td>&nbsp;</td>
        ...
        <tr> 
          <td>&nbsp;</td>
          <td width="7%">&nbsp;</td>
          <td width="40%">- ชัยชาญ รักการงาน</td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr> 
          ...
          <td>&nbsp;</td>
          <td>- Smith, john</td>
          <td><font color="#330099" size="-2">* ใส่นามสกุลก่อนชื่อสำหรับภาษาต่างประเทศ</font></td>
          <td>&nbsp;</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        ...
        <tr> 
          <td rowspan="5">&nbsp;</td>
          <td colspan="3"><font size="-1">ท่านสามารถพิมพ์ชื่อนักประพันธ์, ผู้รวบรวม, 
            หน่วยงานรัฐบาล, องค์กร เป็นต้น ได้ด้วย</font></td>
          <td rowspan="5">&nbsp;</td>
        </tr>
        <tr> 
          <td colspan="2">ตัวอย่าง</td>
