...
<table width="100%" border="0">
  ...
  <tr> 
    ...
    <td colspan="5"><table width="82%" border="0">
        <form name="form1" method="post" action="search2.jsp">
          <tr> 
            <td>&nbsp;</td>
            <td colspan="2" ><font color="#0066CC" size="-1"><strong>การจองสื่อสารนิเทศ</strong></font></td>
            <td ><font color="#0066CC" size="-2">&nbsp;</font></td>
            <td>&nbsp;</td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
            <td width="6%" ><font color="#0066CC" size="-2">&nbsp;</font></td>
            <td colspan="2" ><font color="#0066CC" size="-1">- ทำการค้นหาหังสือที่ต้องการจองจาก 
              ชื่อเรื่อง ชื่อผู้แต่ง หัวเรื่อง คำสำคัญ ฯลฯ<br>
              - เลือกหนังสือจากรายการผลลัพ์การค้นหา<br>
              - คลิกปุ่ม จอง ด้านล่างของรายละเอียดหนังสือที่ต้องการจอง</font><font color="#0066CC" size="-2"><br>
              </font></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr> 
            <td width="4%">&nbsp;</td>
            <td colspan="2" ><div align="center"><font size="-1"><strong>กำหนดขอบเขตในการค้นหา</strong></font></div></td>
            <td width="44%" > <select name="library">
          ...
          <tr> 
            <td>&nbsp;</td>
            <td colspan="2"><div align="center"><strong><font size="-1">สืบค้นโดย</font></strong></div></td>
