...
static unsigned long xdata KnL[32] = { 0L };
static unsigned long xdata KnR [32] = { 0L };
static unsigned long xdata Kn3[32] = { 0L };
static unsigned char xdata Df_Key[24] = {
       0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef,
       0xfe,0xdc,0xba,0x98,0x76,0x54,0x32,0x10,
       0x89,0xab,0xcd,0xef,0x01,0x23,0x45,0x67 };

static unsigned short xdata bytebit[8]    = {
...
/*2*/void deskey(unsigned char *key, short edf)  {
...
/*1*/void des_key(des_ctx *dc, unsigned char *key){
  deskey(key,EN0);
  cpkey(dc->ek);
  deskey(key,DE1);
  cpkey(dc->dk);
