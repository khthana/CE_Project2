...
// Implementation
public:
	BOOLEAN NewPic;				// New input Picture Status
	BOOLEAN ST_PictureIN;		// Picture is exist Status
	BITMAPINFOHEADER bmInfoHeader;	// Header of bitmap
	BITMAPFILEHEADER bmFileHeader;	// Header of File bitmap
	BITMAPINFO* bmInfo;			// bminfo to use StretchDIBits show picture in View
	BYTE* bmPixel;				// bitmap data
	long Pixelsize;				// bitmap pixel size
