...
class LinkListPointer   // for link pointer from left to right block
{
public:
	//long minpixelminpixel;		
	//long maxpixel;
	int ListSize;			// Number of Block in Block Row 
	LinkList* Tail;			// Tail List
	LinkList* Head;			// Head List
	LinkListPointer();
