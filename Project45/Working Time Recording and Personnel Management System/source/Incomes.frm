...
MSHFlexGrid1.TextMatrix(0, 0) = "Incomes Code"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("IncomesCode") + Chr(9) + tRs("TH_Title") + Chr(9) + tRs("EN_Title")
...
Dim frmCalled As New IncomesDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_incomes_delete"
...
frmCaller.IncCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
