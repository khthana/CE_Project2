...
MSHFlexGrid1.TextMatrix(0, 1) = "TH_BankName"
MSHFlexGrid1.ColAlignment(1) = flexAlignLeftCenter
MSHFlexGrid1.ColWidth(1) = 3000

MSHFlexGrid1.TextMatrix(0, 2) = "EN_BankName"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("BankID") + Chr(9) + tRs("TH_BankName") + Chr(9) + tRs("EN_BankName")
...
Dim frmCalled As New BankDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_bank_delete"
...
frmCaller.BankCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
