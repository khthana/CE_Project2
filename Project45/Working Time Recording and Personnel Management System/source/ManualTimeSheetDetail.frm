...
Begin VB.Form ManualTimeSheetDetail 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Manual Time Sheet Detail"
   ClientHeight    =   4725
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8430
   Icon            =   "ManualTimeSheetDetail.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "ManualTimeSheetDetail"
...
Select Case frmStatus
    ...
    Case Is = FormState.Modify
        ...
        tCmd.CommandText = "ta_manual_time_sheet_update"
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "ta_manual_time_sheet_select"
