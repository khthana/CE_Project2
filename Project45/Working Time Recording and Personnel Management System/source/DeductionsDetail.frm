...
Begin VB.Form DeductionsDetail 
   ...
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "DeductionsDetail.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command5 
         Height          =   315
         Left            =   6480
         Picture         =   "DeductionsDetail.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   2460
         Width           =   375
      ...
      Begin VB.ComboBox DedCb 
         ForeColor       =   &H00C00000&
         Height          =   315
         ItemData        =   "DeductionsDetail.frx":0544
         Left            =   1920
         List            =   "DeductionsDetail.frx":0560
         TabIndex        =   8
         Text            =   "DedCb"
         Top             =   2460
         Width           =   4575
      ...
      Begin VB.ComboBox Combo1 
         ForeColor       =   &H00C00000&
         Height          =   315
         ItemData        =   "DeductionsDetail.frx":05F6
         Left            =   1920
         List            =   "DeductionsDetail.frx":060F
         TabIndex        =   5
         Text            =   "Combo1"
         Top             =   1380
         Width           =   2055
   ...
   End
End
Attribute VB_Name = "DeductionsDetail"
...
Select Case frmStatus
    Case Is = FormState.Create
        ...
        tCmd.CommandText = "hrm_Deduction_insert"

        Set tPr(0) = tCmd.CreateParameter("CID", adVarChar, adParamInput, 3, CurCmp)
        Set tPr(1) = tCmd.CreateParameter("DeductionCode", adVarChar, adParamInput, 8, Text1.Text)
        ...
        If Option1.Value = True Then
            ...
            Set tPr(6) = tCmd.CreateParameter("dDeductionCode ", adVarChar, adParamInput, 8, Null)
        ...
        Else
            ...
            Set tPr(6) = tCmd.CreateParameter("dDeductionCode", adVarChar, adParamInput, 8, Trim(Left(DedCb.Text, 8)))
    ...
    Case Is = FormState.Modify
        ...
        tCmd.CommandType = adCmdStoredProc
        tCmd.CommandText = "hrm_Deduction_update"

        Set xPr(0) = tCmd.CreateParameter("CID", adVarChar, adParamInput, 3, CurCmp)
        Set xPr(1) = tCmd.CreateParameter("oldDeductionCode", adVarChar, adParamInput, 8, OldCode)
        Set xPr(2) = tCmd.CreateParameter("DeductionCode", adVarChar, adParamInput, 8, Text1.Text)
        ...
        If Option1.Value = True Then
            ...
            Set xPr(7) = tCmd.CreateParameter("dDeductionCode ", adVarChar, adParamInput, 8, Null)
        ...
        Else
            ...
            Set xPr(7) = tCmd.CreateParameter("dDeductionCode", adVarChar, adParamInput, 8, Trim(Left(DedCb.Text, 8)))
...
Else
    Option2.Value = True
    Option2_Click
    DedCbSelect tRs("dDeductionCode")
...
For i = 0 To DedCb.ListCount - 1
    If DedCb.List(i) = DedCb.Text Then
        GoTo FoundDedCb
    End If
Next i
...
Do While Not tRs.EOF
    ...
    If Trim(tRs("DeductionCode")) <> Trim(OldCode) Then
