...
tCmd.CommandText = "hrm_department_select_all_h"
tPr(0) = CurCmp
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("LV1") + Chr(9) + tRs("LV2") + Chr(9) + tRs("LV3") + Chr(9) + tRs("TH_DepartmentName") + Chr(9) + tRs("EN_DepartmentName")
...
Dim frmCalled As New DepartmentDetail
...
frmCalled.ViewDetail MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, SelectedCode)
Me.Enabled = False
...
frmCalled.Show
Set frmCalled.Caller = Me
frmCalled.ModifyDetail MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, SelectedCode)
Me.Enabled = False
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_department_delete"

tPr(0) = CurCmp
tPr(1) = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, SelectedCode)
...
If MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 2) <> "" Then
    frmCaller.DeptCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 2)
ElseIf MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1) <> "" Then
    frmCaller.DeptCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1)
Else
    frmCaller.DeptCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 0)
End If
...
Private Function SelectedCode() As Integer
