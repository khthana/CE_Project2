...
Begin VB.Form PositionDetail 
   ...
   End
End
Attribute VB_Name = "PositionDetail"
...
Dim tPr(5) As Variant
Dim xPr(6) As Variant
Dim i As Long
...
Select Case frmStatus
    Case Is = FormState.Create
        ...
        tCmd.CommandText = "hrm_position_insert"
    ...
    Case Is = FormState.Modify
        ...
        tCmd.CommandType = adCmdStoredProc
        tCmd.CommandText = "hrm_position_update"
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_position_select"
...
Text1.Text = tRs("PositionCode")
Text2.Text = tRs("TH_PositionName")
Text3.Text = tRs("EN_PositionName")
