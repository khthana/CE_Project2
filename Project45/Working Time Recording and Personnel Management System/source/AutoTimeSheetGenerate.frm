...
Begin VB.Form AutoTimeSheetGenerate 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Generate New Automatic Time Sheet"
   ClientHeight    =   6780
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8415
   Icon            =   "AutoTimeSheetGenerate.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame2 
      Caption         =   "List of Employee to generate Automatic Time Sheet"
      Height          =   3615
      Left            =   240
      TabIndex        =   11
      Top             =   2160
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command1 
         Height          =   315
         Left            =   6000
         Picture         =   "AutoTimeSheetGenerate.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   300
         Width           =   375
   ...
   End
End
Attribute VB_Name = "AutoTimeSheetGenerate"
...
Co = MsgBox("Do you want to generate auto time sheet(s) for above employee(s)?", vbQuestion + vbYesNo)
If Co = vbYes Then
    ...
    For j = 1 To numRec
        ...
        tCmd.CommandText = "ta_auto_time_sheet_generate"
