...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("JobCode") + Chr(9) + tRs("TH_JobName") + Chr(9) + tRs("EN_JobName")
...
Dim frmCalled As New JobDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_job_delete"
...
frmCaller.JobCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
