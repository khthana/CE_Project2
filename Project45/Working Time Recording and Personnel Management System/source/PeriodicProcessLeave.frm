...
Begin VB.Form PeriodicProcessLeave 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Periodic Process for Leave"
   ClientHeight    =   1950
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4965
   Icon            =   "PeriodicProcessLeave.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Process Date for Earning per Period"
      Height          =   975
      Left            =   240
      TabIndex        =   3
      Top             =   240
   ...
   End
End
Attribute VB_Name = "PeriodicProcessLeave"
...
Co = MsgBox("Do you want to do periodic leave process?", vbQuestion + vbYesNo)
If Co = vbYes Then
