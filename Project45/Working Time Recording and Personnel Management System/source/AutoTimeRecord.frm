...
Begin VB.Form AutoTimeRecord 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   315
         Left            =   7680
         Picture         =   "AutoTimeRecord.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   300
         Width           =   375
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Automatic Time Records"
      Height          =   4575
      Left            =   240
      TabIndex        =   14
      Top             =   1920
   ...
   End
End
Attribute VB_Name = "AutoTimeRecord"
...
If Check1.Value = Unchecked Then
    ...
    tCmd.CommandText = "ta_auto_time_record_select_by_RecordDateTime"
...
Else
    ...
    Set tCmd.ActiveConnection = sConn
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "ta_auto_time_record_select_by_EID"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem Format(tRs("ID"), "0") + Chr(9) + Format(tRs("RecordDateTime"), "dd/MM/yyyy HH:mm:ss") + Chr(9) + tRs("EID") + Chr(9) + INOUT$ + Chr(9) + tRs("RecorderID") + Chr(9) + Format(tRs("Cancelled"), "Yes/No") + Chr(9) + Format(tRs("Transferred"), "Yes/No")
...
If Co = vbYes Then
    ...
    Set tCmd.ActiveConnection = sConn
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "ta_auto_time_record_cancel_update"
...
If Co = vbYes Then
    ...
    Set tCmd.ActiveConnection = sConn
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "ta_auto_time_record_delete"
