...
Begin VB.Form Holiday 
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Holiday of Current Data Year"
      Height          =   4575
      Left            =   240
      TabIndex        =   7
      Top             =   240
...
MSHFlexGrid1.TextMatrix(0, 0) = "Holiday"
...
tCmd.CommandText = "hrm_holiday_select_all"
tPr(0) = CurCmp
tPr(1) = CurDyr
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem Format(tRs("Holiday"), "dd/MM/yyyy") + Chr(9) + tRs("Description")
...
Dim frmCalled As New HolidayDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_holiday_delete"
...
frmCaller.HolidayCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
