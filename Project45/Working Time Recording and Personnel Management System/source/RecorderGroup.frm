...
Begin VB.Form RecorderGroup 
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Recorder Group"
      Height          =   4575
      Left            =   240
      TabIndex        =   7
      Top             =   240
   ...
   End
End
Attribute VB_Name = "RecorderGroup"
...
MSHFlexGrid1.TextMatrix(0, 0) = "RCGCode"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("RecorderGroupCode") + Chr(9) + tRs("Description")
...
Dim frmCalled As New RecorderGroupDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "ta_recordergroup_delete"
...
frmCaller.RCGCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
