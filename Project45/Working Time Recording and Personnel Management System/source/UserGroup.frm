...
MSHFlexGrid1.TextMatrix(0, 0) = "UserGroupCode"
MSHFlexGrid1.ColAlignment(0) = flexAlignLeftCenter
MSHFlexGrid1.ColWidth(0) = 2000

MSHFlexGrid1.TextMatrix(0, 1) = "UserGroup Name"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("UserGroupCode") + Chr(9) + tRs("UserGroupName")
...
Dim frmCalled As New UserGroupDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "app_user_group_delete"
...
frmCaller.UsrGrpCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
