...
Begin VB.Form UserGroupDetail 
   ...
   End
End
Attribute VB_Name = "UserGroupDetail"
...
Select Case frmStatus
    Case Is = FormState.Create
        ...
        tCmd.CommandText = "app_user_group_insert"
    ...
    Case Is = FormState.Modify
        ...
        tCmd.CommandType = adCmdStoredProc
        tCmd.CommandText = "app_user_group_update"
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "app_user_group_select"

tPr(0) = CodeParam

Set tRs = tCmd.Execute(, tPr)

Text1.Text = tRs("UserGroupCode")
Text2.Text = tRs("UserGroupName")
