...
Begin VB.Form RecorderGroupList 
   ...
   ClientTop       =   435
   ClientWidth     =   8790
   Icon            =   "RecorderGroupList.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "RecorderGroupList"
...
MSHFlexGrid1.TextMatrix(0, 0) = "RCG Code"
MSHFlexGrid1.ColAlignment(0) = flexAlignLeftCenter
MSHFlexGrid1.ColWidth(0) = 800

MSHFlexGrid1.TextMatrix(0, 1) = "RecorderID"
...
MSHFlexGrid1.TextMatrix(0, 3) = "Enabled"
...
tCmd.CommandText = "ta_recordergrouplist_select_all"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("RecorderGroupCode") + Chr(9) + tRs("RecorderID") + Chr(9) + tRs("Location") + Chr(9) + Format(tRs("Enabled"), "Yes/No")
...
Dim frmCalled As New RecorderGroupListDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "ta_recordergrouplist_delete"

tPr(0) = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 1)
...
frmCaller.RCDCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
