...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("EID") + Chr(9) + tRs("TH_Title") + tRs("TH_FirstName") + " " + tRs("TH_LastName") + Chr(9) + tRs("EN_Title") + tRs("EN_FirstName") + " " + tRs("EN_LastName")
...
Dim frmCalled As New EmployeeDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_employee_delete"
...
frmCaller.EmpCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
