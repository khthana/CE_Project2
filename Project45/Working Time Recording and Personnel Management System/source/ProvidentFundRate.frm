...
Begin VB.Form ProvidentFundRate 
   ...
   ClientTop       =   435
   ClientWidth     =   8790
   Icon            =   "ProvidentFundRate.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Provident Fund Rate"
      Height          =   4575
      Left            =   240
      TabIndex        =   7
      Top             =   240
   ...
   End
End
Attribute VB_Name = "ProvidentFundRate"
...
tCmd.CommandText = "pr_pfr_select_all"
tPr(0) = CurCmp
...
Dim frmCalled As New ProvidentFundRateDetail
