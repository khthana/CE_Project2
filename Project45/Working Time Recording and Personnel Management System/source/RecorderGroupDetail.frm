...
Begin VB.Form RecorderGroupDetail 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Recorder Group Information"
   ClientHeight    =   3195
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "RecorderGroupDetail.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "RecorderGroupDetail"
...
Select Case frmStatus
    Case Is = FormState.Create
        ...
        tCmd.CommandText = "ta_recordergroup_insert"
    ...
    Case Is = FormState.Modify
        ...
        tCmd.CommandType = adCmdStoredProc
        tCmd.CommandText = "ta_recordergroup_update"
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "ta_recordergroup_select"

tPr(0) = CodeParam

Set tRs = tCmd.Execute(, tPr)

Text1.Text = tRs("RecorderGroupCode")
Text2.Text = tRs("Description")
