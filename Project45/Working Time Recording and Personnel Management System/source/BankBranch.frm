...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("BankID") + Chr(9) + tRs("BankBrID") + Chr(9) + tRs("TH_BankBrName") + Chr(9) + tRs("EN_BankBrName")
...
Dim frmCalled As New BankBranchDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_bankbranch_delete"
...
frmCaller.BankBrCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 1)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
