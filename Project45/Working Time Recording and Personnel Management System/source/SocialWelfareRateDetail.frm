...
Begin VB.Form SocialWelfareRateDetail 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Social Welfare Rate Information"
   ClientHeight    =   7500
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8415
   Icon            =   "SocialWelfareRateDetail.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "SocialWelfareRateDetail"
...
For i = 1 To numRec
    ...
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "pr_swr_insert"
    ...
    Set iPr(3) = tCmd.CreateParameter("SWLevel", adTinyInt, adParamInput, 1)
    Set iPr(4) = tCmd.CreateParameter("SWBaseBasis", adCurrency, adParamInput, 8)
    Set iPr(5) = tCmd.CreateParameter("SWBaseCutOff", adCurrency, adParamInput, 8)
    Set iPr(6) = tCmd.CreateParameter("SWRateEmp", adCurrency, adParamInput, 8)
    Set iPr(7) = tCmd.CreateParameter("SWAccumulatedBFEmp", adCurrency, adParamInput, 8)
    Set iPr(8) = tCmd.CreateParameter("SWRateEmp", adCurrency, adParamInput, 8)
    Set iPr(9) = tCmd.CreateParameter("SWAccumulatedBFEmp", adCurrency, adParamInput, 8)
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "pr_swr_select"
...
If tRs.EOF = False Then
    ...
    Do While Not tRs.EOF
        ...
        MSHFlexGrid1.AddItem TTi(tRs("SWLevel")) + Chr(9) + TTc(tRs("SWBaseBasis")) + Chr(9) + TTc(tRs("SWBaseCutOff")) + Chr(9) + TTc(tRs("SWRateEmp")) + Chr(9) + TTc(tRs("SWAccumulatedBFEmp")) + Chr(9) + TTc(tRs("SWRateCmp")) + Chr(9) + TTc(tRs("SWAccumulatedBFCmp"))
...
MSHFlexGrid1.TextMatrix(0, 3) = "SWRate Emp"
...
MSHFlexGrid1.TextMatrix(0, 5) = "SWRate Cmp"
