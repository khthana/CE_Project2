...
Begin VB.Form AutoTimeSheet 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   315
         Left            =   7680
         Picture         =   "AutoTimeSheet.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   300
         Width           =   375
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Automatic Time Sheet"
      Height          =   4575
      Left            =   240
      TabIndex        =   16
      Top             =   1920
   ...
   End
End
Attribute VB_Name = "AutoTimeSheet"
...
If Check1.Value = Unchecked Then
    ...
    tCmd.CommandText = "ta_auto_time_sheet_select_by_WorkDate"
...
Else
    ...
    Set tCmd.ActiveConnection = sConn
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "ta_auto_time_sheet_select_by_EID"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("EID") + Chr(9) + Format(tRs("WorkDate"), "dd/MM/yyyy") + Chr(9) + Format(tRs("FromTime"), "HH:mm:ss") + Chr(9) + Format(tRs("ToTime"), "HH:mm:ss") + Chr(9) + tRs("IncomesCode") + Chr(9) + Sec2HourDSP(tRs("WorkSec")) + Chr(9) + Sec2HourDSP(tRs("ApprovedWorkSec")) + Chr(9) + Sec2HourDSP(tRs("LateSec")) + Chr(9) + Sec2HourDSP(tRs("ApprovedLateSec")) + Chr(9) + Format(tRs("Approved"), "Yes/No") + Chr(9) + Format(tRs("Transferred"), "Yes/No") + Chr(9) + Format(tRs("FromTime"), "dd/MM/yyyy HH:mm:ss")
...
Dim frmCalled As New AutoTimeSheetDetail
...
frmCalled.ModifyDetail MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 0), MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1), MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 11)
...
Dim frmCalled As New AutoTimeSheetGenerate
Load frmCalled
frmCalled.Show
Set frmCalled.Caller = Me
...
If Check1.Value = Unchecked Then
    ...
    Set tCmd.ActiveConnection = sConn
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "ta_auto_time_sheet_approve_by_WorkDate"
...
Else
    ...
    Set tCmd.ActiveConnection = sConn
    tCmd.CommandType = adCmdStoredProc
    tCmd.CommandText = "ta_auto_time_sheet_approve_by_EID"
