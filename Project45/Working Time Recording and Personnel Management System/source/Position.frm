...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("PositionCode") + Chr(9) + tRs("TH_PositionName") + Chr(9) + tRs("EN_PositionName")
...
Dim frmCalled As New PositionDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_position_delete"
...
frmCaller.PosCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
