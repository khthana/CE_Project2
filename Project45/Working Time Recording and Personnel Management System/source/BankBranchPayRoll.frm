...
Begin VB.Form BankBranchPayRoll 
   ...
   ClientTop       =   435
   ClientWidth     =   8790
   Icon            =   "BankBranchPayRoll.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of PayRoll-Supported Bank Branch"
      Height          =   4575
      Left            =   240
      TabIndex        =   6
      Top             =   240
   ...
   End
End
Attribute VB_Name = "BankBranchPayRoll"
...
tCmd.CommandText = "hrm_bankbranchpayroll_select_all"
tPr(0) = CurCmp
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("BankID") + Chr(9) + tRs("BankBrID") + Chr(9) + tRs("TH_BankBrName") + Chr(9) + tRs("EN_BankBrName") + Chr(9) + tRs("CustomerID")
...
Dim frmCalled As New BankBranchPayRollDetail
...
frmCalled.Show
Set frmCalled.Caller = Me
frmCalled.ViewDetail MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1)
Me.Enabled = False
...
frmCalled.Show
Set frmCalled.Caller = Me
frmCalled.ModifyDetail MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1)
Me.Enabled = False
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_bankbranchpayroll_delete"

tPr(0) = CurCmp
tPr(1) = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1)
...
frmCaller.BankBrPrCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
