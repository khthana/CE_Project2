...
Begin VB.Form WagePaymentDetail 
   ...
   ClientTop       =   435
   ClientWidth     =   7845
   Icon            =   "WagePaymentDetail.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "WagePaymentDetail"
...
Select Case frmStatus
    Case Is = FormState.Create
        ...
        tCmd.CommandText = "pr_wage_payment_insert"
