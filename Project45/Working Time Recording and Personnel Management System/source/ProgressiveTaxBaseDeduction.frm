...
Begin VB.Form ProgressiveTaxBaseDeduction 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Progressive Tax Base Deduction"
   ClientHeight    =   5325
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8790
   Icon            =   "ProgressiveTaxBaseDeduction.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Progressive Tax Base Deduction"
      Height          =   4575
      Left            =   240
      TabIndex        =   7
      Top             =   240
   ...
   End
End
Attribute VB_Name = "ProgressiveTaxBaseDeduction"
...
tCmd.CommandText = "pr_ptbd_select_all"
tPr(0) = CurCmp
...
Dim frmCalled As New ProgressiveTaxBaseDeductionDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "pr_ptbd_delete"
