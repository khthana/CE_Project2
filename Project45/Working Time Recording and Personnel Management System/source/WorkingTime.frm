...
MSHFlexGrid1.TextMatrix(0, 0) = "wtCode"
MSHFlexGrid1.ColAlignment(0) = flexAlignLeftCenter
MSHFlexGrid1.ColWidth(0) = 1000

MSHFlexGrid1.TextMatrix(0, 1) = "wtName"
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("wtCode") + Chr(9) + tRs("wtName")
...
Dim frmCalled As New WorkingTimeDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_workingtime_delete"
...
frmCaller.wtCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
