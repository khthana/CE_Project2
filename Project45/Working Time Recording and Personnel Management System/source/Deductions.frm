...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem tRs("DeductionCode") + Chr(9) + tRs("TH_Title") + Chr(9) + tRs("EN_Title")
...
Dim frmCalled As New DeductionsDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "hrm_deduction_delete"

tPr(0) = CurCmp
tPr(1) = MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
...
frmCaller.DedCbSelect MSHFlexGrid1.TextMatrix(MSHFlexGrid1.RowSel, 0)
Unload Me
frmCaller.ZOrder 0
frmCaller.SetFocus
