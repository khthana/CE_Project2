...
Begin VB.Form WageCalculation 
   ...
   Begin VB.Frame Frame2 
      Caption         =   "List of Wage Calculation"
      Height          =   5055
      Left            =   240
      TabIndex        =   9
      Top             =   240
   ...
   End
End
Attribute VB_Name = "WageCalculation"
...
tCmd.CommandText = "pr_wage_calc_select_all"
tPr(0) = CurCmp
...
Do While Not tRs.EOF
    ...
    MSHFlexGrid1.AddItem Format(tRs("CalDate"), "dd/MM/yyyy") + Chr(9) + Format(tRs("BeginDate"), "dd/MM/yyyy") + Chr(9) + Format(tRs("EndDate"), "dd/MM/yyyy") + Chr(9) + Format(tRs("Approved"), "Yes/No")
...
Dim frmCalled As New WageCalculationDTL
...
frmCalled.DTLDisplay MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 0), MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 1), MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 2)
Me.Enabled = False
...
Dim frmCalled As New WageCalculationDetail
...
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "pr_wage_calc_delete"

Set tPr(0) = tCmd.CreateParameter("CID", adVarChar, adParamInput, 3, CurCmp)
Set tPr(1) = tCmd.CreateParameter("CalDate", adDBTimeStamp, adParamInput, 8, CDateX(MSHFlexGrid1.TextMatrix(MSHFlexGrid1.Rowsel, 0)))
...
Set tCmd.ActiveConnection = sConn
tCmd.CommandType = adCmdStoredProc
tCmd.CommandText = "pr_wage_calc_approve"
