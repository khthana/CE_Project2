...
Begin VB.Form ProgressiveTaxRate 
   ...
   ClientTop       =   435
   ClientWidth     =   8790
   Icon            =   "ProgressiveTaxRate.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame1 
      Caption         =   "List of Progressive Tax Rate"
      Height          =   4575
      Left            =   240
      TabIndex        =   7
      Top             =   240
   ...
   End
End
Attribute VB_Name = "ProgressiveTaxRate"
...
tCmd.CommandText = "pr_ptr_select_all"
tPr(0) = CurCmp
...
Dim frmCalled As New ProgressiveTaxRateDetail
