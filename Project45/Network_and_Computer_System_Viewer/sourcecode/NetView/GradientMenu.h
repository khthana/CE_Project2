//********************************************************
//                                                            
//	FILENAME	: CGradientMenu.h
//	CONTENTS	: CGradientMenu class header file.
//
...
#if !defined(AFX_CGradientMenu_H__53F51970_5150_11D3_AB49_0004AC25CC15__INCLUDED_)
#define AFX_CGradientMenu_H__53F51970_5150_11D3_AB49_0004AC25CC15__INCLUDED_
...
//**Old Comment block from CBmpMenu***********************************************************************************
// The CGradientMenu class provides a way to create popup menus with vertical bitmap
//(like windows start bitmap). Also an user can show a child controls by the
//side of menu items. CGradientMenu window provides a placeholder window for child controls.
//The menu behavior is implemented using a toolbar window, of type MenuToolBar class. 
//
//In order to use CGradientMenu class, user needs to use the functions implemented by CMenu for 
//showing a popup menu. All the Microsoft documentation for popup menus applies to CGradientMenu class.
...
//
//     CGradientMenu(int nBitmapW=0, BOOL bShowBmp4SubMenu=FALSE, HBITMAP hBitmap=0, BOOL bStretchBmp=TRUE);
...
//    lParam = (HEND)hWindow; //handle of menu window(menu window is of type CGradientMenu)
//
//	  Remarks:
...
/////////////////////////////////////////////////////////////////////////////
// CGradientMenu window

class CGradientMenu : public CWnd, public CMenu
{
	DECLARE_DYNAMIC(CGradientMenu);
...
private:
	...
	CGradientMenu*		m_pSubMenuWnd;	//pointer to submenu window
...
#endif // !defined(AFX_CGradientMenu_H__53F51970_5150_11D3_AB49_0004AC25CC15__INCLUDED_)
