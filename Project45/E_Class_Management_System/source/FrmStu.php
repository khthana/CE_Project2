  ...
  <tr valign="top">
	...
	<table width="776" border="0" cellspacing="0" cellpadding="0">
        <tr> 
		  ...
		  <tr>  <td >
		  <table width="100%" border="0" cellpadding="0" cellspacing="8" bgcolor="#99AAFF">
		     <tr>
                      <td> <table width="202" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            ...
                            <td width="89" bgcolor="#8397C4"  align="right" class="header"> 
                              <strong>ข้อมูลส่วนตัว</strong></td>
                            <td bgcolor="#8397C4" align="right" width="82">&nbsp;</td>
            ...
            width=1></td>
                                                ...
                                                <tr> 
                                                  <td width=1 bgcolor=#ffffff><img height=1 
            src="images/dot.gif" width=1></td>
                                                  <td> <table cellspacing=0 cellpadding=4 width=99% border=0>
                                                      <tbody>
                                                        <tr bgcolor=#ececec> 
            ...
            width=1></td>
                                        ...
                                        <tr> 
                                          <td colspan="4" bgcolor="#ececec"> <table cellspacing=0 cellpadding=0 width=100% border=0>
                                              <tbody>
                                                <tr bgcolor=#ffffff> 
                                                  <td colspan=3><img height=1 src="images/dot.gif" 
            width=1></td>
                                                ...
                                                <tr> 
                                                  <td width=1 bgcolor=#ffffff><img height=1 
            src="images/dot.gif" width=1></td>
                                                  <td width="192"> <table cellspacing=0 cellpadding=4 width=98% border=0>
                                                      <tbody>
                                                        <tr bgcolor=#ececec> 
                                                          <td bgcolor="#DDE1EE" class="text"> 
                                                            <b>ตารางนัดหมาย</b> 
                                                          </td>
                                                        </tr>
                                                      </tbody>
            ...
            width=1></td>
                                        ...
                                        <tr> 
                                          <td colspan="4" bgcolor="#ececec" align="center"> 
                                            <?php //date
          ...
          <td width="70%" valign="top" ><table width="100%" border="0" cellpadding="8" cellspacing="0" >
              <tr>
                <td height="22"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td colspan="7" valign="middle" class="title">รายวิชา</td>
                    </tr>
                    <tr> 
                      <td colspan="7" valign="middle">&nbsp;</td>
                    </tr>
                    <tr  class="text"  > 
                      <td width = "10"><img src="Picture/cn2_lt.gif" width="10" height="16"></td>
                      <td width="59" valign="middle" bgcolor="#869DB9"><div align="center"><strong><font color="#FFFFFF">รหัสวิชา</font></strong></div></td>
                      <td width="161" valign="middle" bgcolor="#869DB9"><div align="center"><strong><font color="#FFFFFF">ชื่อวิชา</font></strong></div></td>
                      <td width="68" valign="middle" bgcolor="#869DB9"><div align="center"><strong><font color="#FFFFFF">สถานะ</font></strong></div></td>
                      <td width="74" valign="middle" bgcolor="#869DB9"><div align="center"><strong></strong></div>
                        <div align="center"><strong><font color="#FFFFFF">ผลการเรียน</font></strong></div></td>
                      <td width="148" valign="middle" bgcolor="#869DB9"><div align="center"><strong><font color="#FFFFFF">อาจารย์ผู้สอน</font></strong></div></td>
                      <td valign="middle"><img src="Picture/cn2_rt.gif" width="10" height="16"></td>
                    </tr>
                    <tr  class="text"  > 
                      <td colspan="7" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td>
                              <?php require ("./StuCourse.php"); ?>
                            </td>
                          </tr>
                        </table></td>
                    </tr>
                    <!--<tr  class="text"  > 
                      <td width="10" ><img src="Picture/cn2_lb.gif" width="10" height="11"></td>
                      <td colspan="5" valign="middle" bgcolor="#869DB9"><strong></strong> 
                        <div align="center"><strong></strong></div>
                        <div align="center"><strong></strong></div>
                        <div align="center"><strong></strong></div>
                        <div align="center"><strong></strong></div></td>
                      <td width="10" valign="middle"><img src="Picture/cn2_rb.gif" width="10" height="11"></td>
                    </tr>-->
                  </table>
...
<!--<form name="form1" method="post" action="">-->
                            คลิ๊ก &quot;ลงทะเบียน&quot; เพื่อลงทะเบียนเรียน 
                            <input name="imageField" type="image" src="Picture/regis.gif" align="absbottom" width="109" height="16" border="0" onClick="return regis()">
                          <!--</form>-->
                        </div></td>
                    </tr>
                  </table></td>
...
<script language="JavaScript">
	function regis(){
		window.open('SelectCourse.php','Course','scrollbars=1,width = 640,height = 500,top = 20,left = 80');
	}
</script>
<?php 
}
...
{
	print "<center><font color='#FF0000'><b>กรุณา LOGIN ก่อนที่จะเข้าใช้งานด้วยครับ</b></font></center><br>
