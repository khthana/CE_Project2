...
<table width="780" border="0" cellspacing="0" cellpadding="0"  align="center">
  ...
  <tr>
	...
	<td width="14%" valign="top" >
	   ...
	   <tr><td   bgcolor="#0099FF" width="136" valign="top">
		  ...
		  <?php
							...
							echo"<br><br>";
							echo"<table align=center border=0 width=80% class='text' >";
							echo"<tr bgcolor=AA99DD>";
							echo"<td width=20% align=left>จำนวนข้อสอบที่มีอยู่ทั้งหมด</td>";
							echo"<td width=20% align=center>".($row1[0]+$row2[0])."   ข้อ</td>";
							echo"</tr>";
							echo"<tr bgcolor=AA99DD>";
							echo"<td width=20% align=left>จำนวนข้อสอบแบบถูกผิดมีอยู่ทั้งหมด</td>";
							echo"<td width=20% align=center>".$row1[0]."   ข้อ</td>";
							echo"</tr>";
							echo"<tr bgcolor=AA99DD>";
							echo"<td width=20% align=left>จำนวนข้อสอบแบบช้อยมีอยู่ทั้งหมด</td>";
							echo"<td width=20% align=center>".$row2[0]."   ข้อ</td>";
							echo"</tr>";
							echo"</table>";
							mysql_close();
	?>
	...
	<tr>
	<td align="center">
	<form action="make_question.php" method="post" name="menu">
	<input name="open" type="submit" value="สร้างคำถาม" >
	<?php
