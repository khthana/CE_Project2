...
<table width="780" border="0" cellspacing="0" cellpadding="0"  align="center">
  ...
  <tr>
   ...
   <script language="JavaScript">
	function go_back(CID,Chapter)
	{
		var url;
		url ="./S_show_subject.php?CID="+CID+"&Chapter="+Chapter;
		location.href=url;
	}
	</script>
  <?PHP
	...
	//connect Db 
	connect_db();
	$sql="select Document ,Html from documents where CID=$CID and Chapter='$Chapter' and Subject='$Subject'";
	...
	echo "<table bgcolor='#FFFFFF' align='center' border=0 cellpadding=0 cellspacing=0 class='normal' height=100% width=100%>";
	echo "<tr><td bgcolor='#006699' align='center' height=7% width=100% ><font  color='#FF6600'><b>".$Subject."</b></font></td></tr>";
	echo "<tr><td bgcolor='#EEEEEE' valign='top'>".$row[0]."</td></tr>";
	echo "<tr><td bgcolor='#EEEEEE' align='center'></td></tr>";
	echo "<tr><td bgcolor='#EEEEEE' align='center'><form action='edit_document_form.php' method='post'>
				<input type='button' name='back' value='ย้อนกลับ' onClick=\"go_back('$CID','$Chapter')\">
				</form></td></tr>";
	echo $SID;
	echo "</table>";
	mysql_close();
