...
<table width="780" border="0" cellspacing="0" cellpadding="0"  align="center">
  ...
  <tr valign="top">
	...
	function go_back(ID,TID,Chapter)
	{
		var url;
		url ="./show_subject.php?ID="+ID+"&TID="+TID+"&Chapter="+Chapter;
		location.href=url;
	}
	</script>
...
<?php
	...
	<table  align="center"bgcolor="#99CCCC"width="90%" border="0" cellspacing="5" cellpadding="0"  class="text">
                ...
                <tr> 
                  <td><b>หัวข้อ</b></td>
                  <?php echo"<td><input type='text' name='Subject'> <font class='text' color='#FF0000' >*</font></td>";?>
                </tr>
                <tr> 
                  <td><b>รูปแบบ</b></td>
                ...
                <tr> 
                  ...
                  <td>
				   <textarea name="Document" rows="20" cols="90" wrap="soft">
					</textarea>
					</td>
                </tr>
             	<tr>
              ...
              <!--input type="submit" name="Submit" value="Submit"-->
                ...
                <tr> 
				  ...
				  <input type="submit" name="add_document" value="เพิ่มเอกสาร"> 
				  <input type="button" name="back" value="ย้อนกลับ" onClick="go_back('<?php echo $ID;?>',<?php echo $TID; ?>,'<?php echo $Chapter; ?>')">
                  </td>
                </tr>
              </table>
	</td>
