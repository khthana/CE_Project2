...
//		var password = document.addstu.pw.value.length;
...
<body bgcolor="white">
<form name="addstu" enctype = "multipart/form-data" method = "post" action = "InsMember.php" onsubmit = "return check_blank()"><input type="hidden"  name="MAX_FILE_SIZE" value="512000">
  <table cellspacing="0" cellpadding="0" border="0" class="text" width="540" >
    <tr> 
      <td width="562" class="title">สมัครสมาชิกผู้เรียน</td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td width="562" bgcolor="#869DB9"> 
        <table width="100%" border="0" cellspacing="1" cellpadding="4" class="text">
          <tr bgcolor="#E9E9E9" align="left"> 
            <td bgcolor="#FAF7EA"> 
              <table class="text" width="100%" border="0" cellspacing="1" cellpadding="4">
                <tr> 
                  <!-- Name -->
                ...
                <tr> 
                  <td><div align="right"><b>การศึกษา <font color="red">*</font></b></div></td>
                  <td><select name="edu">
                ...
                <tr> 
                  <td width="28%"> <div align="right"><b> รูป</b> (gif or jpeg 
                      file)</div></td>
                  <td width="72%"><input type = "file" name = "pic" > </td>
                </tr>
                <tr> 
                  <td><div align="right"><b>หมายเลข ICQ</b></div></td>
                  <td><input name="icq" type="text" size="15" maxlength="15"  class = "text" value = ""><!--onKeyPress="check_int()"--></td>
                </tr>
              </table>
            </td>
          </tr>		  
              ...
              <table class="text" width="100%" border="0" cellspacing="1" cellpadding="4">
                ...
                <tr> 
                  ...
                  <td> <input type="text" name="mail" maxlength="100" size="30" value="" class="text">
                    <font color="#FF0000">( password จะส่งไปตามอีเมล์นี้)</font></td>
                </tr>
                <tr> 
                  <!-- Tel -->
    ...
    <tr> 
      <td bgcolor="#869DB9" width="562"> 
        <table width="100%" border="0" cellspacing="1" cellpadding="4" class="text">
          <tr bgcolor="#E9E9E9" align="left"> 
            <td  bgcolor="#FAF7EA" > 
              <table class="text" width="100%" border="0" cellspacing="1" cellpadding="4">
                <tr bgcolor="#E0DDBC"> 
                  <td colspan="4"> <b>"รหัสผ่านเข้าสู่ระบบ"</b> ต้องมีความยาว 
                    4-12 ตัวอักษร 
                ...
                <tr> 
                  ...
                  <td width="128"> <div align="right"> 
                      <input  type="button" name="chkuser" value="ตรวจสอบ username" onClick="window.open('Frm_ChkUser.php','ChkUser','scrollbars = 0,width =400,height=150,top =130,left=200')">
                    </div></td>
                  <td width="88">&nbsp;</td>
                </tr>
                <!--<tr> 
