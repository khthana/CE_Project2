	   ...
	   <tr><td bgcolor="#0099FF" width="136" valign="top">
          ...
          <td  valign="top"><!-- InstanceBeginEditable name="data" -->
		    <?php
				$TID=$SESSION[id];
				connect_db();
				$sql="select ID,Subject from documents where CID=$CID and Chapter='$Chapter'";
				?>
				<table border="0" cellpadding="0" cellspacing="1" class="text" width="100%">
				<tr><td bgcolor="#006699" align="center"><font color="#FF6600" class="text"><b>หัวข้อเรื่อง</b></font></td></tr>
				<?php
				$result=mysql_query($sql);
				while($row=mysql_fetch_row($result))
				{
				 			$row[1]=stripslashes($row[1]);
							echo "<tr><td bgcolor='#EEEEEE' align='center'><a href='S_show_document.php?CID=$CID&SID=$SID&Chapter=$Chapter&Subject=$row[1]'>$row[1]</a></td><td></td></tr>";
				}
				?>
				</table>
				<?php
