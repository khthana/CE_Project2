  ...
  <tr valign="top">
    <td width="100%"  valign="top" height="100%"><!-- InstanceBeginEditable name="data" -->
      <table width="780" border="0" cellspacing="10" cellpadding="0">
        <tr> 
          <td><form method=post action="ShowPwd.php" name="ReForm" >
              <hr>
              <table width="211" cellspacing="1" border="0" bordercolor="#000000" bgcolor="#000000" height="80" cellpadding="1" align="center">
                <tr> 
                  <td bgcolor="#66BBFF" class="header"><div align="center"><strong>กรอก 
                      คำตอบ ของท่าน</strong></div></td>
                </tr>
                <td bgcolor="#FFFFFF" class="header"><div align="center"> 
                      <table width="100%" border="0" bgcolor="#FF99FF">
                        <tr> 
                          <td width="32%" class="text" > <div align="right">คำถาม 
                              :</div></td>
                          <td width="68%" class="text" ><?php echo $SESSION[question]; ?></td>
                        </tr>
                        <tr> 
                          <td  class="text"><div align="right">คำตอบ 
                              : </div>
                          </td>
                          <td><input name="Ans" type="text" id="Ans" size="15"></td>
                        </tr>
                        <tr> 
                          <td colspan="2"> 
                            <div align="center"> 
                            <input name="Image" type="image" onMouseOver="MM_swapImage('Image','','./Picture/ok1.gif',1)"  onMouseOut="MM_swapImgRestore()"  value="ok" src="./Picture/ok.gif" align="top" width="45" height="16" border="0" onClick="return check()" img>
                              </div></td>
                        </tr>
                      </table>
                  </div></td>
              ...
              <hr>
              <div align="center"  class="normal">กรอกคำตอบของท่านที่ท่านได้ลงทะเบียนไว้</div>
            </form>
            </td>
        </tr>
      </table>
...
<script language="JavaScript">
	function check(){
		if(document.ReForm.Ans.value ==''){
			alert('กรุณากรอก คำตอบของคุณ');
			document.ReForm.Ans.focus();
			return false;
		 }
	}
