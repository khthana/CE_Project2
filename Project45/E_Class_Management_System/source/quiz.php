  ...
  <tr>
	...
	<td width="14%" valign="top" >
	   ...
	   <tr><td   bgcolor="#0099FF" width="136" valign="top">
		  ...
		  <form action="save_quiz.php" method="post" name="menu">
		  <?php
		  					$TID=$SESSION[id];
							connect_db();
							$sql="select distinct ID,Chapter,TF,CH,Pass from chapters where CID='$ID'";
							$result=mysql_query($sql);
							echo"<table align='center' width=80% border='0' cellpadding='0' cellspacing='1' class='text' >";
							echo"<tr bgcolor=AA99DD>";
							echo"<td  align=center colspan=5><b>สร้างคำถามเก็บเอาไว้ที่นี่</b></td>";
							echo"</tr>";
							while($row=mysql_fetch_row($result))
							{
								$row[1]=stripslashes($row[1]);
								echo"<tr bgcolor=#6699FF>";
								echo"<td  align=center width=5%><input name='chapter[ ]' type='checkbox' value=$row[0]></td>";
								//echo"<td  align=center width=5%><input name='chapter' type='radio' value=$row[0]></td>";
								echo"<td  align=center width=35%>".$row[1]."</td>";
								echo"<td  align=center width=20%>".$row[2]."</td>";
								echo"<td  align=center width=20%>".$row[3]."</td>";
								echo"<td  align=center width=20%>".$row[4]."</td>";
								echo"</tr>";
							}
							echo"</table>";
							mysql_close();
							connect_db();
							$sql="select  count(*)  from questionTF".$ID;
							$result1=mysql_query($sql);
							$sql="select  count(*)  from questionCH".$ID;
							...
							echo"<table align='center' width=80% border='0' cellpadding='0' cellspacing='1' class='text' >";
							echo"<tr bgcolor=AA99DD>";
							echo"<td width=30% align=left><b>จำนวนข้อสอบที่มีอยู่ทั้งหมด</b></td>";
							echo"<td width=30% align=center><b>".($row1[0]+$roe2[0])."   ข้อ</b></td>";
							echo"<td width=20% align=left><b>ต้องการเลือกใช้</b></td>";
							echo"</tr>";
							echo"<tr bgcolor=#6699FF>";
							echo"<td width=30% align=left>จำนวนข้อสอบแบบถูกผิดมีอยู่ทั้งหมด</td>";
							echo"<td width=30% align=center>".$row1[0]."   ข้อ</td>";
							echo"<td width=20% align=left><input name='TF' type='text' size='5'> ข้อ</td>";
							echo"</tr>";
							echo"<tr bgcolor=#6699FF>";
							echo"<td width=30% align=left>จำนวนข้อสอบแบบช้อยมีอยู่ทั้งหมด</td>";
							echo"<td width=30% align=center>".$row2[0]."   ข้อ</td>";
							echo"<td width=20% align=left><input name='CH' type='text' size='5'> ข้อ</td>";
							echo"</tr>";
							echo"<tr bgcolor=#6699FF>";
							echo"<td colspan=2 align=left>&nbsp;เกณฑ์การสอบผ่าน</td>";
							echo"<td width=20%><input name='Pass' type='text' size='5'> เปอร์เซนต์</td>";
							echo"</tr>";
							echo"</table>";
							mysql_close();
	?>
