...
//          TryChangBus(buffer);
          ...
          if (buffer.getID() == 1 || buffer.getID() == 2 || buffer.getID() == 3) {
            MainFrame.messagestatus.setText(MainFrame.messagestatus.getText() + "Data Error Message ID" + buffer.getID() + " Frame number " + AcknowledgeThread.sequence[buffer.getID() - 1].getValue() + "\n");
