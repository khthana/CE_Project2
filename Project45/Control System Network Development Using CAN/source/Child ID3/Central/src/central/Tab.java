...
class SnoopTab extends Container {										// Snoop Tab GUI
  ...
  SnoopTab() {
    ...
    checkbox.setBounds(x + 120, y + 70, 70, 20);
...
class StatusTab extends Container{						// Status Tab GUI
  ...
  public void paint(Graphics g) {
    ...
    g.drawString("Module 1 Last Respond Time :   " + moduletime[0], 290, 80);
    g.drawString("Module 2 Last Respond Time :   " + moduletime[1], 290, 110);
    g.drawString("Module 3 Last Respond Time :   " + moduletime[2], 290, 140);
...
/*class DeviceTab extends Container{						// Device Tab GUI

  public static String Motor1temp = "0";
  public static String Motor2temp = "0";
  public static String Motor1rpm = "0";
  public static String Motor2rpm = "0";

  DeviceTab() { }

  public void paint(Graphics g) {

    JTextField M1config = new JTextField();

    // Device
    g.drawRect(50, 50 ,600 ,300);                     // BIg Rect
    g.drawRoundRect(250, 100, 70, 120, 40, 40);
    g.fillOval(270, 110, 30, 30);
    g.drawLine(220, 125, 270, 125);
    g.drawRect(130, 110, 90, 30);
    g.drawString("Motor 1 ", 150, 100);
    g.drawString(Motor1rpm + " RPM", 150, 130);
    g.drawString(Motor1temp + " 'C", 270, 170);
    g.drawRoundRect(500, 100, 70, 120, 40, 40);
    g.fillOval(520, 110, 30, 30);
    g.drawLine(470, 125, 520, 125);
    g.drawRect(380, 110, 90, 30);
    g.drawString("Motor 2 ", 400, 100);
    g.drawString(Motor2rpm + " RPM", 400, 130);
    g.drawString(Motor2temp + " 'C", 520, 170);
  }
}
*/
...
class HistoryTab extends Container {
  ...
  HistoryTab() {
    ...
    sday.setBounds(100, 350, 50, 20);
    sdaytxt.setBounds(170, 350, 50, 20);
    shour.setBounds(250, 350, 50, 20);
    shourtxt.setBounds(320, 350, 50, 20);
    sminute.setBounds(400, 350, 50, 20);
    sminutetxt.setBounds(470, 350, 50, 20);
    eday.setBounds(100, 400, 50, 20);
    edaytxt.setBounds(170, 400, 50, 20);
    ehour.setBounds(250, 400, 50, 20);
    ehourtxt.setBounds(320, 400, 50, 20);
